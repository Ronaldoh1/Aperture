...
struct ChristWithinView: View {
    ...
    private var ritualsContent: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            Text("Every ritual has a hidden meaning. They make you perform these acts without knowing what you're actually invoking.")
    ...
    private var crossCubeRevelation: some View {
        VStack(spacing: 16) {
            ...
            Text("The cross is the UNFOLDED NET of Saturn's cube. When you make the sign of the cross, you're tracing the cube on your body.")
                .font(.system(size: 13, weight: .medium, design: .rounded))
            ...
            VStack(spacing: 12) {
                ...
                HStack(spacing: 16) {
                    ...
                    cubeWorshipItem(symbol: "✝️", religion: "Christians", action: "TRACE", description: "the cube")
                    cubeWorshipItem(symbol: "☪️", religion: "Muslims", action: "CIRCLE", description: "the cube")
                }
    ...
    private func cubeWorshipItem(symbol: String, religion: String, action: String, description: String) -> some View {
        VStack(spacing: 4) {
            Text(symbol)
                .font(.system(size: 24))
            Text(religion)
    ...
    private var calcificationContent: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("They put substances in your food, water, and products that literally turn your third eye to STONE.")
                .font(.system(size: 13, weight: .medium, design: .rounded))
                .foregroundColor(.white.opacity(0.8))
                .padding(.bottom, 8)
    ...
    private var electromagneticSection: some View {
        VStack(spacing: 12) {
            ...
            Text("Your heart's EM field is measurable 3+ feet away. Your brain produces electricity. You are a FIELD of consciousness connected to the quantum field — not just a meat suit.")
                .font(.system(size: 13, weight: .medium, design: .rounded))
                .foregroundColor(.white.opacity(0.9))
                .multilineTextAlignment(.center)
                .lineSpacing(4)
            
            Text("You don't need a dark church to connect to Source.\nJust awareness. Breath. Sun. Silence.")
    ...
    private var hiddenContent: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("The pineal gland / pine cone / third eye is EVERYWHERE in ancient art and architecture. They know. They just don't tell YOU.")
                .font(.system(size: 13, weight: .medium, design: .rounded))
                .foregroundColor(.white.opacity(0.8))
                .padding(.bottom, 8)
    ...
    private var sovereigntyContent: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("You don't need a priest, a church, or permission. You ARE the temple. Here's how to reconnect:")
                .font(.system(size: 13, weight: .medium, design: .rounded))
                .foregroundColor(.white.opacity(0.8))
                .padding(.bottom, 8)
