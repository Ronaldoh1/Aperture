...
protocol AwakeningArsenalInteractorProtocol {
  ...
  func endPractice(session: PracticeSession, notes: String?, mood: PracticeLog.PracticeMood?)
    async throws
...
class AwakeningArsenalInteractor: AwakeningArsenalInteractorProtocol, ObservableObject {
  ...
  init(
    service: AwakeningArsenalServiceProtocol = FirebaseAwakeningService(),
  ...
  func getMethodsByCategory(_ category: AwakeningCategory) -> [AwakeningMethod] {
    ...
    case .indigenous:
      traditions = [
        "Shamanism", "Ancient Egyptian", "Australian Aboriginal", "Mesoamerican (Maya/Aztec)",
        "Yoruba / Ifa",
      ]
    case .modern:
...
class AwakeningArsenalPresenter: AwakeningArsenalPresenterProtocol {
  ...
  func selectMethod(_: AwakeningMethod) {
...
enum AwakeningArsenalAssembly {
  ...
  static func build(serviceType _: AwakeningServiceFactory.ServiceType = .firebase) -> some View {
