...
enum CouncilOfNicaeaCourse {
  ...
  static let modules: [NicaeaModule] = [
    ...
    NicaeaModule(
      ...
      icon: "crown.fill",
      description:
        "Constantine didn't convert to Christianity. He converted Christianity to himself.",
      lessons: [
        NicaeaLesson(
          ...
          reflection:
            "What current 'consensus' views might be manufactured for political unity rather than truth?"
        ),
        ...
        NicaeaLesson(
          ...
          content: """
            ...
            **The Real Product:**
            ...
            """,
          keyInsight:
            "The council wasn't about finding truth — it was about creating controllable consensus.",
          reflection:
            "What modern institutions serve similar functions of defining 'acceptable' belief?"
        ),
        ...
        NicaeaLesson(
          ...
          content: """
            ...
            **The Pattern Today:**
            ...
            """,
          keyInsight:
            "Nicaea didn't establish truth. It established the infrastructure for controlling what truth could be.",
          reflection:
            "Can you map today's information control systems onto this ancient architecture?"
        ),
      ]
    ),
    ...
    NicaeaModule(
      ...
      icon: "scissors",
      description:
        "The texts they destroyed taught one dangerous idea: you don't need intermediaries.",
      lessons: [
        NicaeaLesson(
          id: "gospel_thomas",
          ...
          content: """
            ...
            **Modern Parallel:**
            ...
            """,
          keyInsight:
            "Thomas was cut because it taught the kingdom is within — no intermediary required.",
          reflection:
            "What truth are you hiding from yourself that, if brought forth, might save you?"
        ),
        ...
        NicaeaLesson(
          ...
          content: """
            ...
            **Pattern Recognition:**
            ...
            """,
          keyInsight:
            "Mary was erased because feminine spiritual authority threatened the patriarchal control structure.",
          reflection:
            "Whose voice has been discredited before you could hear what they actually said?"
        ),
        ...
        NicaeaLesson(
          ...
          content: """
            ...
            **The Serpent Connection:**
            ...
            """,
          keyInsight:
            "Gnosticism was destroyed because it taught you can KNOW directly — no intermediary needed.",
          reflection:
            "What have you experienced directly that contradicts what you've been told to believe?"
        ),
        ...
        NicaeaLesson(
          ...
          reflection:
            "What modern information is being 'burned' — made inaccessible, discredited, or illegal to share?"
        ),
      ]
    ),
    ...
    NicaeaModule(
      ...
      description:
        "They didn't just change the story. They changed the NAME — severing the vibrational connection.",
      lessons: [
        NicaeaLesson(
          id: "yeshua_original",
          ...
          content: """
            ...
            **Why Change It:**
            ...
            """,
          keyInsight:
            "Changing the name severed the connection to the original meaning and tradition.",
          reflection:
            "What else has been 'renamed' in ways that disconnect it from its original essence?"
        ),
        ...
        NicaeaLesson(
          ...
          content: """
            ...
            **The Principle:**
            ...
            """,
          keyInsight:
            "The name Yeshua encodes teachings in its very letters. The name Jesus encodes nothing.",
          reflection:
            "What names or words in your life have lost their original meaning through standardization?"
        ),
        ...
        NicaeaLesson(
          ...
          content: """
            ...
            **Why the Inversion:**
            ...
            """,
          keyInsight:
            "The original message was inverted to create dependency instead of sovereignty.",
          reflection:
            "Where in your life have you been taught to seek outside what can only be found within?"
        ),
      ]
    ),
    ...
    NicaeaModule(
      ...
      lessons: [
        NicaeaLesson(
          ...
          content: """
            ...
            **The Pattern:**
            ...
            """,
          keyInsight:
            "Christianity was merged with Sol Invictus worship — December 25th, Sunday, halos are all solar cult elements.",
        ...
        NicaeaLesson(
          ...
          reflection:
            "What movements or ideas have been absorbed and neutralized by the systems they once opposed?"
        ),
        ...
        NicaeaLesson(
          ...
          content: """
            ...
            **Pattern Recognition:**
            ...
            """,
          keyInsight:
            "The church adopted Roman imperial hierarchy — the exact structure Jesus rejected.",
          reflection:
            "What movements have you seen adopt the structures of what they claimed to oppose?"
        ),
      ]
    ),
    ...
    NicaeaModule(
      ...
      icon: "repeat",
      description:
        "The control architecture created at Nicaea is still running. Only the technology has updated.",
      lessons: [
        NicaeaLesson(
          ...
          content: """
            ...
            **The Update History:**
            ...
            """,
          keyInsight:
            "The same control architecture has been running for 1,700 years — only the technology updates.",
        ...
        NicaeaLesson(
          ...
          content: """
            ...
            **The Meta-Pattern:**
            ...
            """,
          keyInsight:
            "Every control system follows the same Nicaea blueprint. Learning to see it is the exit.",
          reflection:
            "Pick a major narrative in today's world and run it through the five-question framework."
        ),
        ...
        NicaeaLesson(
          ...
          content: """
            ...
            **You're remembering now.**
            """,
          keyInsight:
            "The truth they've hidden for 1,700 years is simple: the divine is already within you.",
    ...
    NicaeaModule(
      ...
      description:
        "Despite 1,700 years of suppression, the original message survived. It's time to hear it.",
      lessons: [
        NicaeaLesson(
          id: "kingdom_within",
          ...
          content: """
            ...
            **Your Turn:**
            ...
            """,
          keyInsight:
            "The kingdom of God is within you — not requiring belief, institution, or intermediary.",
        ...
        NicaeaLesson(
          ...
          content: """
            ...
            **Reclaiming:**
            ...
            """,
          keyInsight:
            "The teacher didn't claim unique divinity — he pointed to the divinity in everyone.",
