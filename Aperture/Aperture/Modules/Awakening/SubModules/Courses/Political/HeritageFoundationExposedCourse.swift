...
struct HeritageFoundationExposedCourse: View {
    ...
    VStack(alignment: .leading, spacing: 16) {
      ...
      VStack(spacing: 12) {
        ...
        figureCard(
          ...
          background:
            "Controls $1.6B dark money network. Selected all Trump Supreme Court justices.",
          quote: nil
        )
  ...
  private func figureCard(name: String, role: String, background: String, quote: String?)
    -> some View
  {
      ...
      HeritageLesson(
        ...
        content: """
          ...
          **They coordinate. They're patient. They're effective.**
          """,
        keyTakeaway:
          "Heritage Foundation writes policy, trains operatives, and places them in government. They implemented 60% of their recommendations under Reagan. This is their stated strategy, funded by dark money."
      ),
      HeritageLesson(
        ...
        content: """
          ...
          **They're not hiding this. It's on their website.**
          """,
        keyTakeaway:
          "Project 2025 is a public 920-page blueprint to reshape the government. Schedule F would let them fire 50,000+ career employees. They've pre-vetted 20,000 loyalists ready to replace them."
      ),
      HeritageLesson(
        ...
        content: """
          ...
          **Leonard Leo's network funded some of this.**
          ...
          """,
        keyTakeaway:
          "The Federalist Society spent 50 years capturing the courts. Leonard Leo controls $1.6B in dark money and selected all Trump's Supreme Court picks. 6-3 conservative majority is their victory."
      ),
      HeritageLesson(
        ...
        content: """
          ...
          *Source: ALEC Exposed (Center for Media and Democracy)*
          """,
        keyTakeaway:
          "ALEC brings corporations and legislators together to write 'model bills.' Stand Your Ground, voter ID, right-to-work—all started as ALEC model legislation written by corporate lobbyists."
      ),
      HeritageLesson(
        ...
        content: """
          ...
          *Source: OpenSecrets.org, ProPublica*
          """,
        keyTakeaway:
          "Dark money hides donor identities. Leonard Leo received $1.6 billion in a single donation. The Koch network spends ~$500M per cycle. Citizens United made this possible. It's untraceable influence."
      ),
      HeritageLesson(
        ...
        content: """
          ...
          **This is not alarmism. This is their stated plan.**
          """,
        keyTakeaway:
          "Project 2025 is being implemented now despite denials. 140+ Trump officials wrote it. Heritage-vetted appointees fill the administration. The policies match the document exactly."
      ),
      HeritageLesson(
        ...
        content: """
          ...
          **Every one of these is something you can help with.**
          """,
        keyTakeaway:
          "Individual actions: stay informed, educate others, vote in every election. Support dark money disclosure, judicial reform, voting rights. Back organizations fighting back. The machine is powerful but not invincible."
      ),
      HeritageLesson(
        ...
        content: """
          ...
          **Now you know what you're dealing with.**
          """,
        keyTakeaway:
          "Heritage is following an authoritarian template used in Hungary, Poland, and Turkey. Kevin Roberts called it a 'revolution' that will be 'bloodless if the left allows it.' This is a serious threat to democracy—but it can be stopped."
      ),
    ]
  }
}
