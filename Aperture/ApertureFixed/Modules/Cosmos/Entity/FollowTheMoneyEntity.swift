...
struct FollowTheMoney {
    ...
    struct PalantirProfits {
        ...
        static let contracts: [Contract] = [
            Contract(amount: "$30M", purpose: "ImmigrationOS — real-time immigrant tracking", year: "2025"),
    ...
    struct MileiProfile {
        ...
        static let receipts: [Receipt] = [
            Receipt(claim: "\"I don't go to church, I go to SYNAGOGUE\"", source: "His interview", emoji: "🕍"),
            ...
            Receipt(claim: "First non-Jew to win 'Jewish Nobel' (Genesis Prize)", source: "2025 award", emoji: "🏆"),
            Receipt(claim: "Moving Argentina embassy to JERUSALEM", source: "Announced policy", emoji: "🇮🇱"),
    ...
    struct WhoBenefits {
        ...
        static let losers: [Beneficiary] = [
            Beneficiary(who: "Immigrants", how: "Surveillance, separation, deportation theater", emoji: "👨‍👩‍👧"),
            ...
            Beneficiary(who: "American taxpayers", how: "Funding Palantir + Argentina bailout", emoji: "🇺🇸"),
