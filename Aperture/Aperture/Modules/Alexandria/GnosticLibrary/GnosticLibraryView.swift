...
struct GnosticText: Identifiable {
  ...
  let furtherReadingURLs: [GnosticFurtherReading]
  let dragonComment: String
  let isPublicDomain: Bool
  let difficulty: Int  // 1-5
}

struct GnosticFurtherReading: Identifiable {
  let id = UUID()
  let title: String
  let url: String
  let type: GnosticReadingType
}

enum GnosticReadingType: String {
...
enum GnosticCollection: String, CaseIterable {
  ...
  var description: String {
    ...
    case .nagHammadi:
      return
        "Discovered in 1945 in Egypt. 13 codices containing 52 texts buried around 367 CE to preserve them from destruction. The Rosetta Stone of Gnostic Christianity."
    case .berlinCodex:
      return
        "Acquired in Cairo in 1896 by Dr. Karl Reinhardt. Contains the most complete copy of the Gospel of Mary plus other key Gnostic texts."
    case .bruceCodex:
      return
        "Named after James Bruce who acquired it in Egypt. Contains the Books of Jeu and other complex Gnostic cosmological works."
    case .askewCodex:
      return
        "Purchased by the British Museum in 1785 from Dr. Askew's heirs. Contains the massive Pistis Sophia text."
    case .hermetica:
      return
        "Attributed to Hermes Trismegistus (Thrice-Great Hermes). Bridges Egyptian wisdom and Greek philosophy. 'As above, so below' originates here."
    case .mandaean:
      return
        "Living Gnostic tradition still practiced in Iraq and Iran. Revere John the Baptist, practice ritual immersion. 2000+ years of continuous tradition."
    case .valentinian:
      return
        "The most sophisticated Gnostic school. Valentinus nearly became Pope. Operated within the Church while teaching deeper mysteries to initiates."
    case .other:
...
enum GnosticRealm: String, CaseIterable {
  ...
  var description: String {
    ...
    case .pleroma:
      return
        "The eternal, spiritual realm of perfection—beyond time, space, and matter. The 'Fullness' of all divine potential, inhabited by aeons as emanations of the ultimate God."
    case .monad:
      return
        "The unknowable, supreme being—beyond comprehension, purely spirit, the One beyond Being. Source of all aeons via passive emanation."
    case .aeons:
      return
        "Hypostatic ideas or intelligences—immaterial beings in syzygies (male-female pairs). Often 30 in total, arranged in hierarchies forming the Pleroma's structure."
    case .sophia:
      return
        "The lowest aeon, embodying divine wisdom. Her 'error'—desiring to know the unknowable Father without her pair—birthed the Demiurge outside the Pleroma."
    case .demiurge:
      return
        "Sophia's aborted offspring—a semi-divine, ignorant creator who fashions the material cosmos as a flawed imitation of the Pleroma. Often identified with the Old Testament God."
    case .archons:
      return
        "Demiurge's offspring—7 planetary powers enforcing fate, ignorance, and material bonds. Oppressive gatekeepers trapping souls in matter."
    case .material:
      return
        "Our flawed physical reality—created by the Demiurge in ignorance. Humans contain divine sparks from Sophia, trapped in material bodies."
    }
  }
...
enum GnosticLibraryDatabase {
  ...
  static let cosmologyBeings: [GnosticBeing] = [
    ...
    GnosticBeing(
      name: "The Monad",
      alternateNames: [
        "The Father", "The One", "The Invisible Spirit", "Bythos (Depth)", "The First Principle",
      ],
      realm: .monad,
      description:
        "The unknowable, supreme being—beyond comprehension, purely spirit, the One beyond Being. Source of all aeons via passive emanation (thoughts overflowing as entities). Not a creator-god; immutable, perfect, and transcendent.",
      role: "The ultimate source of all existence, from which all divine emanations flow",
      symbolism:
        "Represents pure consciousness before differentiation—the infinite potential before creation"
    ),
    ...
    GnosticBeing(
      ...
      realm: .aeons,
      description:
        "The first emanation from the Monad. Often depicted as the female aspect of the divine, the 'Mother' who receives the Monad's light and gives birth to all subsequent aeons.",
    ...
    GnosticBeing(
      ...
      realm: .aeons,
      description:
        "The 'Self-Generated One' - an aeon who emerges from Barbelo and the Monad. In Sethian texts, identified with the heavenly Christ who descends to awaken humanity.",
    ...
    GnosticBeing(
      ...
      realm: .sophia,
      description:
        "The lowest aeon, embodying divine wisdom. Her 'error'—desiring to know the unknowable Father without her pair—hypostatizes as a flawed entity, birthing the Demiurge outside the Pleroma. She's not evil but reckless; her fall disrupts harmony, creating chaos/matter.",
      role: "The bridge between divine and material realms; her fall creates our world",
      symbolism:
        "Human longing for divine union gone awry—curiosity without balance. Also represents the divine spark trapped in matter."
    ),
    ...
    GnosticBeing(
      name: "Yaldabaoth",
      alternateNames: [
        "The Demiurge", "Saklas (The Fool)", "Samael (Blind God)", "The Chief Archon", "Ialdabaoth",
      ],
      realm: .demiurge,
      description:
        "Sophia's aborted offspring—a semi-divine, ignorant creator who fashions the material cosmos as a flawed imitation of the Pleroma. Hubristic: Declares 'I am God and there is no other' (echoing Isaiah, but Gnostics flip it as arrogance). Often depicted as lion-headed serpent.",
      role: "Creates the material world in ignorance; rules via archons; keeps humans trapped",
      symbolism:
        "Cosmic ignorance personified; the false god of material religion. In Christian Gnosticism: identified with the OT God."
    ),
    ...
    GnosticBeing(
      ...
      realm: .archons,
      description:
        "Demiurge's offspring—7 planetary powers enforcing fate, ignorance, and material bonds. Names vary (Yao, Sabaoth, Adonaios, Astaphaios, etc.); tied to zodiac/heavens. Oppressive gatekeepers trapping souls.",
    ...
    GnosticBeing(
      ...
      realm: .pleroma,
      description:
        "The perfect, archetypal human who exists in the Pleroma. The template from which earthly Adam was created—but earthly Adam is a flawed copy made by the Demiurge.",
    ...
    GnosticBeing(
      ...
      realm: .pleroma,
      description:
        "The third son of Adam in Gnostic mythology, but elevated to a divine savior figure. The Sethians believed they were the spiritual descendants of Seth, carriers of the divine seed.",
  ...
  static let allTexts: [GnosticText] =
    nagHammadiTexts + berlinCodexTexts + hermeticTexts + pistisSophiaTexts + mandaeanTexts
    + otherTexts
  ...
  static let nagHammadiTexts: [GnosticText] = [
    GnosticText(
      ...
      significance:
        "The foundational text of Sethian Gnosticism. If you read only one Gnostic text, read this one. It provides the complete cosmological framework that all other Gnostic texts reference.",
      textURL: "http://www.gnosis.org/naghamm/apocjn-davies.html",
      pdfURL:
        "https://gnosis.study/library/%D0%93%D0%BD%D0%BE%D0%B7%D0%B8%D1%81/%D0%98%D1%81%D1%81%D0%BB%D0%B5%D0%B4%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F/ENG/Davies%20S.%20-%20The%20Secret%20Book%20of%20John.%20The%20Gnostic%20Gospel.pdf",
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Frederik Wisse Translation", url: "http://www.gnosis.org/naghamm/apocjn.html",
          type: .fullText),
        GnosticFurtherReading(
          title: "Marvin Meyer Translation", url: "http://www.gnosis.org/naghamm/apocjn-meyer.html",
          type: .fullText),
        GnosticFurtherReading(
          title: "Long Version (Waldstein & Wisse)",
          url: "http://www.gnosis.org/naghamm/apocjn-long.html", type: .fullText),
        GnosticFurtherReading(
          title: "Wikipedia", url: "https://en.wikipedia.org/wiki/Apocryphon_of_John",
          type: .wikipedia),
        GnosticFurtherReading(
          title: "Early Christian Writings",
          url: "https://www.earlychristianwritings.com/apocryphonjohn.html", type: .scholarly),
      ],
      dragonComment:
    ...
    GnosticText(
      ...
      significance:
        "The most accessible Gnostic text and possibly the earliest gospel we have. Essential reading for understanding Jesus outside institutional Christianity. Over 50% of its sayings parallel the canonical Gospels.",
      textURL: "http://www.gnosis.org/naghamm/gosthom.html",
      pdfURL: nil,
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Thomas Collection (Multiple Translations)",
          url: "http://www.gnosis.org/naghamm/nhl_thomas.htm", type: .fullText),
        GnosticFurtherReading(
          title: "Lambdin Translation", url: "http://www.gnosis.org/naghamm/gthlamb.html",
          type: .fullText),
        GnosticFurtherReading(
          title: "Marvin Meyer Translation",
          url: "http://www.gnosis.org/naghamm/gosthom-meyer.html", type: .fullText),
        GnosticFurtherReading(
          title: "Stevan Davies Translation",
          url: "http://www.gnosis.org/naghamm/gosthom-davies.html", type: .fullText),
        GnosticFurtherReading(
          title: "Patterson & Robinson Translation",
          url: "http://www.gnosis.org/naghamm/gth_pat_rob.htm", type: .fullText),
        GnosticFurtherReading(
          title: "Bibliography & Manuscripts",
          url: "http://www.gnosis.org/naghamm/gth_bibliography.htm", type: .scholarly),
      ],
      dragonComment:
        "114 sayings. No miracles, no resurrection narrative, no church. Just the teachings. What was Jesus actually saying before the religion formed around him? 🐉",
      isPublicDomain: true,
      difficulty: 2
    ),
    ...
    GnosticText(
      ...
      significance:
        "The primary source for Jesus-Mary Magdalene relationship speculation. More importantly, a window into Valentinian Christianity's sophisticated sacramental theology.",
      textURL: "http://www.gnosis.org/naghamm/gop.html",
      pdfURL: nil,
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Wesley Isenberg Translation", url: "http://www.gnosis.org/naghamm/gop.html",
          type: .fullText),
        GnosticFurtherReading(
          title: "Wikipedia", url: "https://en.wikipedia.org/wiki/Gospel_of_Philip",
          type: .wikipedia),
      ],
      dragonComment:
        "The text they don't want you to read. Not because of the kiss, but because it shows early Christianity included mystical sacraments the Church later suppressed. 🐉",
      isPublicDomain: true,
      difficulty: 3
    ),
    ...
    GnosticText(
      ...
      significance:
        "The most elegant and accessible Gnostic treatise. Shows Gnosticism's philosophical sophistication. If attributed to Valentinus, this is as close as we get to the master's own words.",
      textURL: "http://gnosis.org/naghamm/got.html",
      pdfURL: nil,
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Robert Grant Translation", url: "http://gnosis.org/naghamm/got.html",
          type: .fullText),
        GnosticFurtherReading(
          title: "Wikipedia", url: "https://en.wikipedia.org/wiki/Gospel_of_Truth", type: .wikipedia
        ),
      ],
      dragonComment:
        "Read this when you need to feel the warmth beneath the Gnostic cosmos. The Father isn't angry. He's searching for you. You just forgot the way home. 🐉",
      isPublicDomain: true,
      difficulty: 2
    ),
    ...
    GnosticText(
      ...
      significance:
        "The clearest Gnostic retelling of Genesis. Essential for understanding how Gnostics read the Old Testament as the story of the jailer, not the savior.",
      textURL: "http://www.gnosis.org/naghamm/hypostas.html",
      pdfURL: nil,
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Full Text", url: "http://www.gnosis.org/naghamm/hypostas.html", type: .fullText),
        GnosticFurtherReading(
          title: "Wikipedia", url: "https://en.wikipedia.org/wiki/Hypostasis_of_the_Archons",
          type: .wikipedia),
      ],
      dragonComment:
    ...
    GnosticText(
      ...
      significance:
        "The most comprehensive Gnostic cosmology text. Fills in details missing from other sources. Essential for serious students of Gnostic worldview.",
      textURL: "http://www.gnosis.org/naghamm/origin.html",
      pdfURL: nil,
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Full Text", url: "http://www.gnosis.org/naghamm/origin.html", type: .fullText),
        GnosticFurtherReading(
          title: "Wikipedia", url: "https://en.wikipedia.org/wiki/On_the_Origin_of_the_World",
          type: .wikipedia),
      ],
      dragonComment:
        "Want to understand the architecture of the Matrix? This is the blueprint. Dense, but every detail matters. 🐉",
      isPublicDomain: true,
      difficulty: 4
    ),
    ...
    GnosticText(
      ...
      significance:
        "Unique in ancient literature. Possibly the closest we get to a feminine divine voice speaking directly. Influenced modern poetry and feminist theology.",
      textURL: "http://www.gnosis.org/naghamm/thunder.html",
      pdfURL: nil,
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Full Text", url: "http://www.gnosis.org/naghamm/thunder.html", type: .fullText),
        GnosticFurtherReading(
          title: "Wikipedia", url: "https://en.wikipedia.org/wiki/Thunder,_Perfect_Mind",
          type: .wikipedia),
      ],
      dragonComment:
    ...
    GnosticText(
      ...
      significance:
        "The ultimate Gnostic reversal—the villain as hero. Shows how radically Gnostics reinterpreted Christian narrative. Challenges everything we think we know about betrayal.",
      textURL: "http://www.gnosis.org/library/judas.htm",
      pdfURL: nil,
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Full Text", url: "http://www.gnosis.org/library/judas.htm", type: .fullText),
        GnosticFurtherReading(
          title: "Wikipedia", url: "https://en.wikipedia.org/wiki/Gospel_of_Judas", type: .wikipedia
        ),
      ],
      dragonComment:
        "The ultimate plot twist. The 'traitor' was the only one who understood. Everyone else was worshipping the warden. 🐉",
      isPublicDomain: true,
      difficulty: 3
    ),
    ...
    GnosticText(
      ...
      significance:
        "Important for understanding how Gnostic teachings were Christianized. Comparison with Eugnostos shows the process of religious adaptation.",
      textURL: "http://www.gnosis.org/naghamm/sjc.html",
      pdfURL: nil,
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Full Text", url: "http://www.gnosis.org/naghamm/sjc.html", type: .fullText),
        GnosticFurtherReading(
          title: "Eugnostos the Blessed (Source Text)",
          url: "http://www.gnosis.org/naghamm/eug.html", type: .fullText),
      ],
      dragonComment:
        "Watch Gnostic ideas get a Christian skin in real-time. Same teachings, different revealer. The content matters more than the label. 🐉",
      isPublicDomain: true,
      difficulty: 3
    ),
    ...
    GnosticText(
      ...
      significance:
        "Key text for understanding Gnostic eschatology. Shows the fundamental split between Gnostic and orthodox Christian views of resurrection.",
      textURL: "http://www.gnosis.org/naghamm/res.html",
      pdfURL: nil,
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Full Text", url: "http://www.gnosis.org/naghamm/res.html", type: .fullText)
      ],
      dragonComment:
        "They told you to wait for resurrection after death. The Gnostics said: wake up now, while you're still breathing. 🐉",
      isPublicDomain: true,
      difficulty: 2
    ),
  ]
  ...
  static let berlinCodexTexts: [GnosticText] = [
    GnosticText(
      ...
      significance:
        "The strongest early Christian text arguing for women's spiritual authority. Shows the gender conflicts that shaped early Christianity. Mary as visionary leader, not just follower.",
      ...
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Full Text (Gnosis.org)", url: "http://www.gnosis.org/library/marygosp.htm",
          type: .fullText),
        GnosticFurtherReading(
          title: "Karen L. King Introduction",
          url: "http://www.gnosis.org/library/GMary-King-Intro.html", type: .scholarly),
        GnosticFurtherReading(
          title: "The Gospel of Mary Website", url: "https://www.thegospelofmary.org/the-gospel",
          type: .fullText),
        GnosticFurtherReading(
          title: "Wikipedia", url: "https://en.wikipedia.org/wiki/Gospel_of_Mary", type: .wikipedia),
      ],
      dragonComment:
        "The woman they tried to silence. Peter couldn't handle that she saw more than him. 2000 years later, we finally get to hear her. 🐉",
      isPublicDomain: true,
      difficulty: 2
    )
  ]
  ...
  static let hermeticTexts: [GnosticText] = [
    GnosticText(
      ...
      significance:
        "The foundation of Western esotericism. Influenced alchemy, Renaissance magic, Freemasonry, and modern occultism. Shows the synthesis of Egyptian and Greek wisdom traditions.",
      ...
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Complete Corpus Hermeticum", url: "http://www.gnosis.org/library/hermet.htm",
          type: .fullText),
        GnosticFurtherReading(
          title: "I. Poimandres", url: "http://www.gnosis.org/library/hermes1.html", type: .fullText
        ),
        GnosticFurtherReading(
          title: "X. The Key", url: "http://www.gnosis.org/library/hermes10.html", type: .fullText),
        GnosticFurtherReading(
          title: "XI. Mind Unto Hermes", url: "http://www.gnosis.org/library/hermes11.html",
          type: .fullText),
        GnosticFurtherReading(
          title: "Sacred Texts Collection", url: "https://sacred-texts.com/chr/herm/index.htm",
          type: .fullText),
        GnosticFurtherReading(
          title: "Wikipedia", url: "https://en.wikipedia.org/wiki/Corpus_Hermeticum",
          type: .wikipedia),
      ],
      dragonComment:
        "The crossroads where Egypt met Greece met Gnosis. Every Western magical tradition traces back here. 'As above, so below'—the original debug statement. 🐉",
      isPublicDomain: true,
      difficulty: 3
    )
  ]
  ...
  static let pistisSophiaTexts: [GnosticText] = [
    GnosticText(
      ...
      significance:
        "The longest surviving Gnostic text. Before Nag Hammadi, this was our main window into Gnosticism. Preserves unique material including Odes of Solomon fragments.",
      ...
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Complete Text Index",
          url: "http://www.gnosis.org/library/pistis-sophia/index.htm", type: .fullText),
        GnosticFurtherReading(
          title: "Chapter 1", url: "http://www.gnosis.org/library/pistis-sophia/ps005.htm",
          type: .fullText),
        GnosticFurtherReading(
          title: "Sacred Texts Version", url: "https://sacred-texts.com/chr/ps/index.htm",
          type: .fullText),
        GnosticFurtherReading(
          title: "Archive.org PDF", url: "https://archive.org/details/pistissophiagnos00mead",
          type: .pdf),
        GnosticFurtherReading(
          title: "Wikipedia", url: "https://en.wikipedia.org/wiki/Pistis_Sophia", type: .wikipedia),
      ],
      dragonComment:
        "844 pages of cosmic secrets. Mary Magdalene asked so many questions Peter complained. That alone tells you who was really paying attention. 🐉",
      isPublicDomain: true,
      difficulty: 5
    )
  ]
  ...
  static let mandaeanTexts: [GnosticText] = [
    GnosticText(
      ...
      significance:
        "Living proof that Gnosticism survived. The Mandaeans have maintained continuous tradition for 2000 years. They still baptize in rivers, still read their scriptures, still transmit their teachings.",
      textURL: "http://www.gnosis.org/library/ginza.htm",
      pdfURL: nil,
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "Ginza Excerpts", url: "http://www.gnosis.org/library/ginza.htm", type: .fullText),
        GnosticFurtherReading(
          title: "Wikipedia - Mandaeism", url: "https://en.wikipedia.org/wiki/Mandaeism",
          type: .wikipedia),
      ],
      dragonComment:
        "They told you Gnosticism was dead. 30,000 Mandaeans in Iraq would disagree. The tradition never stopped—it just went underground. 🐉",
      isPublicDomain: true,
      difficulty: 4
    )
  ]
  ...
  static let otherTexts: [GnosticText] = [
    GnosticText(
      ...
      significance:
        "Rare survival of Gnostic ritual practice. Shows Gnosticism wasn't just philosophy but active spiritual technology. Visual diagrams unique in Gnostic literature.",
      textURL: "http://www.gnosis.org/library/1jeub.htm",
      pdfURL: nil,
      furtherReadingURLs: [
        GnosticFurtherReading(
          title: "First Book of Jeu", url: "http://www.gnosis.org/library/1jeub.htm",
          type: .fullText),
        GnosticFurtherReading(
          title: "Second Book of Jeu", url: "http://www.gnosis.org/library/2jeub.htm",
          type: .fullText),
      ],
      dragonComment:
        "The cheat codes for escaping the simulation. Passwords, diagrams, secret names—they weren't playing around. 🐉",
      isPublicDomain: true,
      difficulty: 5
    )
  ]
...
struct GnosticLibraryView: View {
  ...
  private var filteredTexts: [GnosticText] {
    GnosticLibraryDatabase.allTexts.filter { text in
      ...
      let matchesSearch =
        searchText.isEmpty || text.name.localizedCaseInsensitiveContains(searchText)
      ...
      ScrollView(.horizontal, showsIndicators: false) {
        HStack(spacing: 8) {
          ...
          ForEach(GnosticCollection.allCases, id: \.self) { collection in
            collectionPill(
              collection,
              collection.rawValue.components(separatedBy: " ").first ?? collection.rawValue)
          }
        }
      }
  ...
  private func collectionSection(_ collection: GnosticCollection, _ texts: [GnosticText])
    -> some View
  {
      ...
      Text(title)
        ...
        .background(
          selectedCollection == collection
            ? (collection?.color ?? .white) : Color.white.opacity(0.1)
        )
        .cornerRadius(16)
    }
  }
