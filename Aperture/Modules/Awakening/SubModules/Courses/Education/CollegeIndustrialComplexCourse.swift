...
struct CollegeIndustrialComplexCourse: View {
    ...
    private var shockingStats: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("College costs increased 1,200% since 1980. Wages increased 236%. This isn't education—it's extraction.")
                .font(.system(size: 12))
    ...
    private var majorRealitySection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Note: These are MEDIAN starting salaries. Half make less. And you're starting with $30-100K+ in debt.")
    ...
    private func majorRow(_ major: String, _ salary: String, _ reality: String, _ color: Color) -> some View {
        HStack {
    ...
    private var internationalSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("These countries have higher quality of life, longer life expectancy, and their graduates aren't drowning in debt.")
                .font(.system(size: 11, weight: .medium))
                .foregroundColor(.cyan)
        }
        .padding()
    ...
    private func countryRow(_ country: String, _ cost: String, _ note: String, _ color: Color) -> some View {
        HStack {
            Text(country)
                .font(.system(size: 13, weight: .semibold))
                .foregroundColor(.white)
    ...
    private var actionSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("College CAN be worth it—but only with eyes wide open about the real costs and outcomes.")
                .font(.system(size: 12, weight: .medium))
                .foregroundColor(.green)
        }
        .padding()
        ...
        [
            CollegeLesson(
                ...
                **The system is working exactly as designed—for them.**
                """,
                keyTakeaway: "College tuition increased 1,200% since 1980 while wages increased 236%. It's not about education—it's a $700B industry. Administrative bloat, amenities arms race, and guaranteed federal loans enable endless price increases."
            ),
            CollegeLesson(
                ...
                **That's exactly what they're afraid of.**
                """,
                keyTakeaway: "College selection is confusing BY DESIGN. Rankings reward spending, not outcomes. Campus visits are sales pitches. Financial aid letters disguise loans as 'awards.' If you could easily compare, you'd make different choices—and they know it."
            ),
            CollegeLesson(
                ...
                **"Financial aid" often just means "debt you qualify for."**
                """,
                keyTakeaway: "Less than 1% get full rides. Average scholarship still leaves $33K/year to pay. 'Award' letters include loans as 'aid.' A $57K 'package' might only be $22K in actual free money. Work-study is just a job they count as aid."
            ),
            CollegeLesson(
                ...
                **The knowledge should be free. It's only expensive because of artificial scarcity.**
                """,
                keyTakeaway: "Textbook prices rose 1,041% since 1977—3x faster than inflation. 'New editions' often change almost nothing. Access codes eliminated the used book market. Three publishers control 80% of the market. Fight back: library, older editions, international versions, split costs."
            ),
            CollegeLesson(
                ...
                **You cannot escape the "investment" in your education.**
                """,
                keyTakeaway: "$1.77 trillion in student debt. In 2005, bankruptcy protection was removed—you can NEVER escape. Interest capitalizes during deferment. A $40K loan becomes $60K+ over time. The government profits billions from your debt."
            ),
            CollegeLesson(
                ...
                **4 years of sitting in lectures is often the least important part.**
                ...
                """,
                keyTakeaway: "Most degrees could be completed in 1-2 years. General education requirements are revenue generation. Other countries do bachelor's in 3 years. Average US completion is 5.1 years. Credit transfers are designed to keep you locked in."
            ),
            CollegeLesson(
                ...
                **Pay extra. Because lines on a map.**
                """,
                keyTakeaway: "Out-of-state tuition is $52K+ more over 4 years—for the same education. State funding is now only 10-20% of school budgets, so 'taxpayer' argument is outdated. It's arbitrary punishment for mobility. We're supposed to be one country."
            ),
            CollegeLesson(
                ...
                **Pulled the ladder up behind them.**
                ...
                """,
                keyTakeaway: "UC was FREE until 1970. A summer job could pay for a year of college in the 1970s. State funding dropped from 70% to 20-30%. The shift from 'public good' to 'private investment' was deliberate policy. The generation that got free college pulled the ladder up."
            ),
            CollegeLesson(
                ...
                **Know which category your goal fits.**
                """,
                keyTakeaway: "Skilled trades pay $50-100K+ with no debt. Tech bootcamps are 3-6 months and lead to $67K+ jobs. Many companies (Google, Apple, IBM) dropped degree requirements. True cost of college + lost wages = $300K+. Know when a degree actually matters vs propaganda."
            ),
            CollegeLesson(
                ...
                **Don't let emotion or prestige bankrupt your future.**
                """,
                keyTakeaway: "Community college first saves $30-60K. State over private unless full ride. Graduate on time—each extra semester costs $40-60K. Total debt should be less than expected first year salary. Treat it like a business decision, not an emotional one."
            ),
            CollegeLesson(
                ...
                **Is that harder than $200K in debt?**
                """,
                keyTakeaway: "Germany offers FREE university—even for Americans. Many European programs are in English. 4 years in Germany costs $55-65K total vs $200K+ in US. International degrees are recognized and valued. It's an option they don't want you to know about."
            ),
            CollegeLesson(
                ...
                **Other countries have this. We can too.**
                ...
                It's a choice.
                """,
                keyTakeaway: "Free public college would cost $80B/year—10% of military budget. Germany, Norway, Finland prove it works. Debt cancellation, interest caps, and bankruptcy rights are all possible. Who opposes: universities, banks, some politicians, and people who don't understand how bad it's gotten."
            )
        ]
    }
}
