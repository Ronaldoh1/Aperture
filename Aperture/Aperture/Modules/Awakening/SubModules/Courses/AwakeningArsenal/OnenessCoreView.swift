...
struct OnenessCoreView: View {
  ...
  let traditions: [TraditionNode] = [
    TraditionNode(
      name: "Kundalini", icon: "🐍", color: .red, energyTerm: "Shakti", egoTerm: "Ego Death",
      unityTerm: "Samadhi", angle: 0),
    TraditionNode(
      name: "Qi", icon: "☯️", color: .green, energyTerm: "Qi/Chi", egoTerm: "Wu Wei",
      unityTerm: "Tao", angle: 25.7),
    TraditionNode(
      name: "Buddhism", icon: "🪷", color: .yellow, energyTerm: "Prana", egoTerm: "Anatta",
      unityTerm: "Nibbana", angle: 51.4),
    TraditionNode(
      name: "Sufism", icon: "🌹", color: .pink, energyTerm: "Baraka", egoTerm: "Fana",
      unityTerm: "Baqa", angle: 77.1),
    TraditionNode(
      name: "Christ", icon: "✝️", color: .purple, energyTerm: "Holy Spirit", egoTerm: "Kenosis",
      unityTerm: "Theosis", angle: 102.9),
    TraditionNode(
      name: "Kabbalah", icon: "✡️", color: .blue, energyTerm: "Shefa", egoTerm: "Bitul",
      unityTerm: "Devekut", angle: 128.6),
    TraditionNode(
      name: "Shamanism", icon: "🦅", color: .brown, energyTerm: "Power", egoTerm: "Soul Loss",
      unityTerm: "Wholeness", angle: 154.3),
    TraditionNode(
      name: "Egypt", icon: "𓂀", color: Palette.accent.gold, energyTerm: "Ka", egoTerm: "Weighing",
      unityTerm: "Akh", angle: 180),
    TraditionNode(
      name: "Zen", icon: "🎎", color: .gray, energyTerm: "Ki", egoTerm: "No-Self",
      unityTerm: "Satori", angle: 205.7),
    TraditionNode(
      name: "Aboriginal", icon: "🌌", color: .indigo, energyTerm: "Mana", egoTerm: "Dissolution",
      unityTerm: "Dreamtime", angle: 231.4),
    TraditionNode(
      name: "Maya/Aztec", icon: "🌞", color: .orange, energyTerm: "Tonalli", egoTerm: "Death",
      unityTerm: "Cosmic Union", angle: 257.1),
    TraditionNode(
      name: "Yoruba", icon: "🥁", color: .red, energyTerm: "Ashe", egoTerm: "Surrender",
      unityTerm: "Ori Alignment", angle: 282.9),
    TraditionNode(
      name: "Druidism", icon: "🌳", color: .green, energyTerm: "Awen", egoTerm: "Sacrifice",
      unityTerm: "Otherworld", angle: 308.6),
    TraditionNode(
      name: "Sikhism", icon: "☬", color: .orange, energyTerm: "Naam", egoTerm: "Haumai",
      unityTerm: "Waheguru", angle: 334.3),
  ]
  ...
  private func outerRingArc(index i: Int) -> some View {
    ...
    return Path { path in
      ...
      path.addArc(
        center: center, radius: 140, startAngle: .degrees(startAngle), endAngle: .degrees(endAngle),
        clockwise: false)
    }
    .stroke(
      LinearGradient(
  ...
  private func stageColumn(_ stage: String, _ term: String, _ color: Color, _ icon: String)
    -> some View
  {
    VStack(spacing: 8) {
  ...
  private var coreMechanismCard: some View {
    VStack(alignment: .leading, spacing: 16) {
      ...
      VStack(alignment: .leading, spacing: 12) {
        mechanismRow(
          "1", "Energy Activation", "Dormant force awakens (whatever they call it)", .red)
      ...
      Text(
        "The map is not the territory. The name is not the thing. But all maps point to the same mountain."
      )
      .font(.system(size: 12))
  ...
  private func mechanismRow(_ num: String, _ title: String, _ desc: String, _ color: Color)
    -> some View
  {
    HStack(spacing: 12) {
      ZStack {
