      ...
      LiesModule(
        ...
        lies: [
          ExposedLie(
            ...
            whobenefits:
              "Medical researchers got 40 years of data on untreated syphilis. The subjects got death."
          ),
          ...
          ExposedLie(
            ...
            whobenefits:
              "The CIA wanted to develop mind control techniques. American citizens were the lab rats."
          ),
          ...
          ExposedLie(
            ...
            whobenefits:
              "US researchers got data. Guatemalans got infected. The doctor got promoted to Tuskegee."
          ),
        ]
      ),
      ...
      LiesModule(
        ...
        lies: [
          ExposedLie(
            ...
            whobenefits:
              "The $12 billion/year antidepressant industry. 85% of people believe a marketing slogan is science."
          ),
      ...
      LiesModule(
        ...
        lies: [
          ...
          ExposedLie(
            ...
            whobenefits:
              "Company profits came before infant safety. One FDA reviewer had to stand alone."
          ),
        ]
      ),
      ...
      LiesModule(
        ...
        lies: [
          ExposedLie(
            ...
            whobenefits:
              "The children of the elite get taught to rule. Everyone else gets taught to work."
          ),
      ...
      LiesModule(
        ...
        lies: [
          ExposedLie(
            ...
            whobenefits:
              "Textbook publishers who don't update. Teachers who teach what they were taught."
          ),
          ...
          ExposedLie(
            ...
            whobenefits:
              "Simplicity over accuracy. Easy to test, easy to grade, easy to forget questioning."
          ),
          ...
          ExposedLie(
            ...
            whobenefits:
              "Sugar industry. Statin manufacturers. Everyone except people trying to be healthy."
          ),
        ]
      ),
    ]
