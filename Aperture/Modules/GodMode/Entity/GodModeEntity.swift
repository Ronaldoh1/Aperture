...
struct BardoPractice: Identifiable, Codable {
    ...
    enum BardoType: String, Codable, CaseIterable {
        ...
        var guidance: String {
            ...
            case .peacefulVisions: return "Blissful states arise. Don't grasp. Recognize as your own light."
            case .wrathfulVisions: return "Fear arises. Face it. These are shadow aspects seeking integration."
...
struct MonadAffirmation: Identifiable {
    ...
    static let library: [MonadAffirmation] = [
        ...
        MonadAffirmation(text: "I am the operant power. Nothing acts upon me without my consent.", category: .identity),
        ...
        // Reality
        MonadAffirmation(text: "Assumption hardens into fact. I assume my desired reality now.", category: .reality),
        MonadAffirmation(text: "Everyone is me pushed out. As I change, they change.", category: .reality),
        MonadAffirmation(text: "The bridge of incidents is already forming. I don't need to know how.", category: .reality),
        MonadAffirmation(text: "I live in the end. It is done.", category: .reality),
        
        // Power
        MonadAffirmation(text: "My imagination is God in action. What I imagine, I become.", category: .power),
        MonadAffirmation(text: "3-6-9: I plant, I embody, I complete. The universe responds.", category: .power),
        MonadAffirmation(text: "Feeling is the secret. I feel it real, therefore it is.", category: .power),
        MonadAffirmation(text: "I think from the wish fulfilled, not of it.", category: .power),
        
        // Protection
        MonadAffirmation(text: "My vibration is sovereign. No external force can lower it.", category: .protection),
        MonadAffirmation(text: "I am shielded by my own light. Low energies dissolve before me.", category: .protection),
        MonadAffirmation(text: "I protect my energy as I protect my spark. It is sacred.", category: .protection),
        
        // Manifestation
        MonadAffirmation(text: "It is done. I give thanks for the swift manifestation.", category: .manifestation),
        MonadAffirmation(text: "Isn't it wonderful? My desire is already fulfilled.", category: .manifestation),
        MonadAffirmation(text: "I fell asleep in the state of the wish fulfilled. It is law.", category: .manifestation),
        MonadAffirmation(text: "9 is completion. My intention reaches 9 and manifests.", category: .manifestation)
    ]
}
