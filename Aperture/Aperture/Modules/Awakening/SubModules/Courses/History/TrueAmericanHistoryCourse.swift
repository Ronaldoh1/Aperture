...
struct TrueAmericanHistoryCourse: View {
  ...
  private var truthWarning: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      Text(
        "This course presents documented historical facts that were deliberately omitted from standard American education. Every claim is sourced from primary documents, academic research, and historical records. The truth may be uncomfortable, but it is necessary for genuine understanding."
      )
      .font(.system(size: 12))
      .foregroundColor(.gray)
      .lineSpacing(4)
      ...
      HistoryLesson(
        ...
        content: """
          ...
          **Source:** Koch et al., "Earth system impacts of the European arrival" (2019)
          """,
        keyTakeaway:
          "The Americas had 60-100 million people in sophisticated civilizations before 1492. The 'discovery' narrative erases this and justified genocide through the Doctrine of Discovery, which remains in U.S. law today."
      ),
      HistoryLesson(
        ...
        content: """
          ...
          **The Contradiction Intentional:**
          ...
          """,
        keyTakeaway:
          "The Constitution was designed to protect slavery while proclaiming liberty. 8 of the first 12 presidents owned enslaved people. The Three-Fifths Compromise gave slave states extra political power."
      ),
      HistoryLesson(
        ...
        content: """
          ...
          **Source:** Federal Reserve Survey of Consumer Finances
          """,
        keyTakeaway:
          "Enslaved people were worth more than all U.S. railroads, factories, and banks combined. Northern banks, insurers, and universities profited. The 13th Amendment's exception led to convict leasing. The wealth gap persists today."
      ),
      HistoryLesson(
        ...
        content: """
          ...
          **Today:**
          ...
          """,
        keyTakeaway:
          "90%+ of Native Americans died from disease, military campaigns, forced removal, and cultural destruction. 370+ treaties were signed and every one was broken. Boarding schools attempted cultural genocide into the 1960s."
      ),
      HistoryLesson(
        ...
        content: """
          ...
          **Source:** W.E.B. Du Bois, "Black Reconstruction in America"
          """,
        keyTakeaway:
          "Reconstruction saw 2,000+ Black officials and real progress toward equality. This was deliberately destroyed through terrorism and the federal government's abandonment of Black citizens in the Compromise of 1877."
      ),
      HistoryLesson(
        ...
        content: """
          ...
          **Similar massacres in:**
          ...
          """,
        keyTakeaway:
          "4,400+ documented lynchings terrorized Black communities for decades. Congress never passed anti-lynching legislation until 2022. Massacres like Tulsa destroyed thriving Black communities and were hidden from history."
      ),
      HistoryLesson(
        ...
        content: """
          ...
          **The Forgotten History:**
          ...
          """,
        keyTakeaway:
          "Workers fought and died for 8-hour days, weekends, and safety laws. The government used troops to break strikes. The Ludlow Massacre killed 11 children. This history is hidden because it shows solidarity's power."
      ),
      HistoryLesson(
        ...
        content: """
          ...
          **The Lessons:**
          ...
          """,
        keyTakeaway:
          "120,000 Japanese Americans (62% citizens) were imprisoned without charge based solely on race. The Supreme Court upheld it. It took 46 years to apologize. The same logic is used for immigration detention today."
      ),
      HistoryLesson(
        title: "COINTELPRO",
        period: "1956-1971",
        ...
        content: """
          ...
          **Today:**
          ...
          """,
        keyTakeaway:
          "FBI's COINTELPRO surveilled, harassed, and killed Americans exercising their rights. MLK received FBI letters urging suicide. Fred Hampton was drugged and assassinated in his bed. Similar tactics continue today."
      ),
      HistoryLesson(
        ...
        content: """
          ...
          **What Remains Undone:**
          ...
          """,
        keyTakeaway:
          "MLK was deeply unpopular and radical—against capitalism and war. The movement faced systematic violence and murder. The Voting Rights Act was gutted in 2013. The backlash never stopped."
      ),
      HistoryLesson(
        ...
        content: """
          ...
          **The Alternative:**
          ...
          """,
        keyTakeaway:
          "Mass incarceration was deliberately created to target Black communities (Nixon aide admitted it). Prison corporations profit from bodies. 1 in 3 Black men will be incarcerated. This is the new Jim Crow."
      ),
      HistoryLesson(
        title: "The Pattern",
        period: "1492-Present",
        ...
        content: """
          ...
          **The Choice:**
          ...
          """,
        keyTakeaway:
          "American history follows a pattern: exploitation, ideology, progress through struggle, backlash, new exploitation. Slavery became Jim Crow became mass incarceration. Knowing the pattern helps you see it repeating today."
      ),
    ]
  }
}
