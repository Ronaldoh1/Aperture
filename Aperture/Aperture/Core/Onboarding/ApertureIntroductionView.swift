...
struct ApertureIntroductionView: View {
  ...
  private let pages: [IntroPage] = [
    IntroPage(
      ...
      bodyText:
        "Aperture is built for those who ask deeper questions. We believe critical thinking is a skill worth cultivating, and that exploring diverse perspectives makes us wiser.",
    ...
    IntroPage(
      ...
      bodyText:
        "Access historical texts, philosophical traditions, and perspectives that don't always make it into mainstream conversation. From Gnostic manuscripts to consciousness research—we curate what's worth exploring.",
    ...
    IntroPage(
      ...
      bodyText:
        "We don't tell you what to think. We present information, multiple viewpoints, and let you draw your own conclusions. Healthy skepticism—even of us—is encouraged.",
    ...
    IntroPage(
      ...
      bodyText:
        "Beyond information, we offer meditation practices, consciousness exercises, and daily tools to help you develop clarity, presence, and inner peace. Growth happens one insight at a time.",
    ...
    IntroPage(
      ...
      bodyText:
        "We present alternative perspectives alongside mainstream views. We cite our sources. We respect your intelligence. This is a judgment-free space for genuine seekers ready to question, explore, and grow.",
      accentColor: Palette.accent.gold
    ),
  ]
  ...
  private var bottomControls: some View {
    VStack(spacing: 24) {
      ...
      // Shake tip (show on last page only)
      if currentPage == pages.count - 1 {
        HStack(spacing: 6) {
          Image(systemName: "iphone.radiowaves.left.and.right").font(.system(size: 11))
            .foregroundColor(.cyan.opacity(0.4))
          Text("Shake your phone anytime to send feedback").font(.system(size: 11, weight: .medium))
...
struct IntroFlowerOfLifeShape: Shape {
...
struct ApertureQuickInfoSheet: View {
      ...
      ScrollView {
        VStack(alignment: .leading, spacing: 24) {
          ...
          infoSection(
            ...
            text:
              "Aperture is a consciousness education platform designed for curious minds who want to explore ideas beyond mainstream discourse. We curate alternative perspectives, ancient wisdom, and tools for personal growth.",
          ...
          infoSection(
            ...
            title: "Our Approach",
            text:
              "We present multiple viewpoints and encourage you to think critically. We cite sources, acknowledge uncertainty, and never claim to have all the answers. Your conclusions are your own.",
  ...
  private var whatYoullFindSection: some View {
    VStack(alignment: .leading, spacing: 16) {
      ...
      featureRow(
        icon: "book.closed.fill", text: "Suppressed historical texts & Gnostic manuscripts",
        color: Palette.primary.violet)
      featureRow(
        icon: "brain.head.profile", text: "Consciousness practices & meditation tools",
        color: Color.green)
      featureRow(
        icon: "lightbulb.fill", text: "Critical thinking frameworks", color: Palette.accent.gold)
      featureRow(
        icon: "globe.americas.fill", text: "Alternative perspectives on history & society",
        color: Palette.primary.cyan)
      featureRow(
        icon: "heart.fill", text: "Personal growth & awakening resources", color: Color.pink)
    }
    .padding(16)
  ...
  private var trustSection: some View {
    VStack(spacing: 12) {
      ...
      Text(
        "Including us. We encourage healthy skepticism and independent verification. Your journey of discovery is yours alone."
      )
      .font(.system(size: 14))
      .foregroundColor(.white.opacity(0.7))
      .multilineTextAlignment(.center)
