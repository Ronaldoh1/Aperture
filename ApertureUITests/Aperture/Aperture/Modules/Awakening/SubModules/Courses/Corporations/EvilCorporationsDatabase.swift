...
struct EvilCorporationsDatabase: View {
  ...
  private var bigPictureSection: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      Text(
        "While they blame immigrants, workers, and regulations—corporations extract record wealth from America."
      )
      .font(.system(size: 12))
  ...
  private var systemSection: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      Text(
        "These corporations aren't exceptions—they're the system working as designed. Capitalism without restraint produces extraction, not prosperity."
      )
      .font(.system(size: 13))
      .foregroundColor(.white.opacity(0.8))
  ...
  private var allCorporations: [DatabaseEvilCorp] {
    [
      ...
      DatabaseEvilCorp(
        ...
        evilScore: 95,
        primaryCrime:
          "Controls $10 TRILLION in assets—buys up housing, votes shares to cut worker pay",
        allCrimes: [
        ...
        politicalInfluence:
          "Larry Fink connected to both parties. Revolving door with Treasury, Fed.",
      ...
      DatabaseEvilCorp(
        ...
        evilScore: 92,
        primaryCrime:
          "Bet against clients in 2008 crash, multiple executives became Treasury Secretary",
        allCrimes: [
        ...
        politicalInfluence:
          "Alumni throughout government: Treasury, NEC, Fed, World Bank. Both parties.",
      ...
      DatabaseEvilCorp(
        ...
        politicalInfluence:
          "Jamie Dimon is Wall Street's main spokesman, regular White House access",
      ...
      DatabaseEvilCorp(
        ...
        evilScore: 93,
        primaryCrime:
          "Paid $0 federal tax in 2018, workers pee in bottles, destroyed small business",
        allCrimes: [
      ...
      DatabaseEvilCorp(
        ...
        evilScore: 94,
        primaryCrime:
          "Internal docs show they KNEW Instagram harms teen mental health, did nothing",
        allCrimes: [
        ...
        politicalInfluence:
          "Zuckerberg meets with Trump, massive lobbying, hires from both parties",
      ...
      DatabaseEvilCorp(
        ...
        politicalInfluence:
          "Built modern conservative infrastructure, controls GOP primaries in many states",
      ...
      DatabaseEvilCorp(
        ...
        evilScore: 88,
        primaryCrime:
          "Former CEO said 'water is not a human right,' baby formula scandal killed babies",
        allCrimes: [
      ...
      DatabaseEvilCorp(
        ...
        evilScore: 78,
        primaryCrime:
          "Major contributor to obesity epidemic, funded junk science to blame consumers",
        allCrimes: [
      ...
      DatabaseEvilCorp(
        ...
        politicalInfluence:
          "Donates to 'tough on crime' candidates, lobbies for mandatory minimums",
      ...
      DatabaseEvilCorp(
        ...
        evilScore: 92,
        primaryCrime:
          "Largest health insurer—denies 32% of claims, uses AI to reject without review",
        allCrimes: [
      ...
      DatabaseEvilCorp(
        ...
        evilScore: 75,
        primaryCrime:
          "Owns NBC/MSNBC while being your internet provider—massive conflict of interest",
        allCrimes: [
