        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(spacing: 4) {
                ForEach(TrackerAwakeningPhase.allCases, id: \.self) { phase in
                    Rectangle()
                        .fill(phaseIndex(phase) <= phaseIndex(tracker.journey.currentPhase) ? phase.color : Color.white.opacity(0.1))
                        .frame(height: 6)
                        .cornerRadius(3)
                }
            }
...
class AwakeningTrackerManager: ObservableObject {
    ...
    static var defaultMilestones: [AwakenMilestone] {
        [
            // Awareness
            AwakenMilestone(id: UUID(), title: "First Glimpse", description: "Experienced a moment where reality felt different", category: .awareness, isCompleted: false),
            AwakenMilestone(id: UUID(), title: "Observer Mode", description: "Noticed thoughts as separate from self", category: .awareness, isCompleted: false),
            AwakenMilestone(id: UUID(), title: "Synchronicity Spotted", description: "Recognized meaningful coincidences", category: .awareness, isCompleted: false),
            
            // Beliefs
            AwakenMilestone(id: UUID(), title: "First Belief Questioned", description: "Actively questioned a long-held belief", category: .beliefs, isCompleted: false),
            AwakenMilestone(id: UUID(), title: "Narrative Unpacked", description: "Traced a belief back to its source", category: .beliefs, isCompleted: false),
            AwakenMilestone(id: UUID(), title: "Mind Changed", description: "Changed a significant belief based on new evidence", category: .beliefs, isCompleted: false),
            
            // Patterns
            AwakenMilestone(id: UUID(), title: "Pattern Recognized", description: "Noticed a repeating life pattern", category: .patterns, isCompleted: false),
            AwakenMilestone(id: UUID(), title: "Trigger Mapped", description: "Identified emotional trigger and root cause", category: .patterns, isCompleted: false),
            AwakenMilestone(id: UUID(), title: "Pattern Broken", description: "Successfully changed a habitual response", category: .patterns, isCompleted: false),
            
            // Relationships
            AwakenMilestone(id: UUID(), title: "Mirror Seen", description: "Recognized others reflecting your own aspects", category: .relationships, isCompleted: false),
            AwakenMilestone(id: UUID(), title: "Boundary Set", description: "Established a healthy boundary with love", category: .relationships, isCompleted: false),
            AwakenMilestone(id: UUID(), title: "Forgiveness Given", description: "Released resentment toward someone", category: .relationships, isCompleted: false),
            
            // Purpose
            AwakenMilestone(id: UUID(), title: "Gift Identified", description: "Recognized your unique contribution", category: .purpose, isCompleted: false),
            AwakenMilestone(id: UUID(), title: "Passion Pursued", description: "Took action on what lights you up", category: .purpose, isCompleted: false),
            AwakenMilestone(id: UUID(), title: "Service Given", description: "Helped someone on their journey", category: .purpose, isCompleted: false),
            
            // Integration
            AwakenMilestone(id: UUID(), title: "Dark Night Survived", description: "Made it through an ego death experience", category: .integration, isCompleted: false),
            AwakenMilestone(id: UUID(), title: "Grounded Mystic", description: "Integrated insights into practical life", category: .integration, isCompleted: false),
            AwakenMilestone(id: UUID(), title: "Both/And Embraced", description: "Held paradox without needing resolution", category: .integration, isCompleted: false),
        ]
    }
}
...
struct NewJournalEntryView: View {
    ...
    private func toggleRecording() {
        if isRecording {
            ...
            transcribedText = "Voice note recorded. Transcription would appear here with SFSpeechRecognizer."
        } else {
