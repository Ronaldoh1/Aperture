...
class ModuleTutorialManager: ObservableObject {
  ...
  @AppStorage("seenTutorials") private var seenTutorialsData: Data = .init()
  ...
  static let timeline = ModuleTutorialContent(
    ...
    pages: [
      TutorialPage(
        ...
        description:
          "The Timeline reveals historical events and patterns that have been hidden, suppressed, or misrepresented throughout human history.",
        tips: [
          "Swipe through different eras", "Tap events to see hidden connections",
          "Each discovery earns a sacred geometry badge",
        ]
      ),
      TutorialPage(
        ...
        description:
          "Every historical event has multiple layers. The Timeline shows you what they didn't teach in school—the real stories behind the stories.",
        tips: [
          "Look for 🔮 symbols for gnostic insights", "Connect patterns across different eras",
  ...
  static let cosmos = ModuleTutorialContent(
    ...
    pages: [
      TutorialPage(
        ...
        description:
          "The Cosmos contains interconnected realms of esoteric knowledge—from ancient wisdom traditions to modern consciousness research.",
        tips: [
          "Explore different realms by category", "Each realm contains deep courses",
      ...
      TutorialPage(
        ...
        description:
          "As you explore, you'll unlock sacred geometries and hidden teachings. The deeper you go, the more patterns you'll recognize.",
        tips: [
          "Start with realms that resonate with you", "Return often—new content is added regularly",
          "Share insights with fellow seekers",
        ]
      ),
    ],
  ...
  static let awakening = ModuleTutorialContent(
    ...
    pages: [
      TutorialPage(
        ...
        description:
          "Awakening offers 13 different spiritual traditions and consciousness practices. No single path is 'right'—find what resonates with your soul.",
        tips: [
          "Take the consciousness assessment first", "Try practices from multiple traditions",
      ...
      TutorialPage(
        ...
        description:
          "Knowledge without practice is just information. Each tradition includes guided meditations, exercises, and daily rituals to integrate the teachings.",
        tips: [
          "Set a daily practice reminder", "Start with 5-10 minutes", "Journal your experiences",
        ]
      ),
      TutorialPage(
        ...
        description:
          "Awakening can be disorienting. Remember: millions are on this journey with you. The discomfort is temporary; the clarity is permanent.",
        tips: [
          "Reach out if you feel overwhelmed", "Trust your direct experience",
          "The path unfolds at your pace",
        ]
      ),
    ],
  ...
  static let alexandria = ModuleTutorialContent(
    ...
    pages: [
      TutorialPage(
        ...
        description:
          "Named after the legendary library, Alexandria contains the knowledge that was meant to be lost—forbidden texts, suppressed research, and hidden wisdom.",
        tips: [
          "Browse by category or search", "Bookmark important materials",
      ...
      TutorialPage(
        ...
        title: "Discern Truth",
        description:
          "Not everything here is 'true' in the conventional sense. Your job is to develop discernment—to recognize patterns and test ideas against your direct experience.",
        tips: [
          "Cross-reference multiple sources", "Trust but verify", "Your intuition is a valid tool",
        ]
      ),
    ],
    accentColor: Palette.primary.violet
  ...
  static let godMode = ModuleTutorialContent(
    ...
    pages: [
      TutorialPage(
        ...
        description:
          "This section contains advanced esoteric knowledge—etymology secrets, hermetic principles, gnostic texts, and consciousness tools for the serious seeker.",
        tips: [
          "Complete the Etymology course first", "Tools are for regular practice",
      ...
      TutorialPage(
        ...
        description:
          "The Etymology course reveals how language shapes reality. You'll never hear or speak words the same way again. This is powerful—use it wisely.",
        tips: [
          "Practice the I AM declarations daily", "Notice word spells in media",
      ...
      TutorialPage(
        ...
        description:
          "The seven hermetic principles form the foundation of all esoteric knowledge. Master these, and you hold the keys to understanding reality itself.",
        tips: [
          "Study one principle per week", "Apply principles to daily life",
  ...
  static let flowState = ModuleTutorialContent(
    ...
    pages: [
      TutorialPage(
        ...
        description:
          "Flow State helps you optimize your daily rhythms, eliminate distractions, and enter states of peak performance and presence.",
        tips: [
          "Complete the initial setup", "Sync with your calendar",
      ...
      TutorialPage(
        ...
        description:
          "Modern life is designed to fragment your attention. The Distraction Audit helps you identify and eliminate the inputs that keep you unconscious.",
        tips: [
          "Be honest in your audit", "Start with one distraction at a time",
      ...
      HStack(spacing: 8) {
        ForEach(content.pages.indices, id: \.self) { index in
          Capsule()
            ...
            .shadow(
              color: currentPage == index ? content.accentColor.opacity(0.5) : .clear, radius: 4
            )
