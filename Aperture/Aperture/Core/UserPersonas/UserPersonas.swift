...
enum AwakeningPersona: String, CaseIterable, Identifiable {
  ...
  var description: String {
    ...
    case .deeplyProgrammed:
      return
        "You might think this is all there is—work, consume, die. The programming runs deep, but the spark is still there, waiting."
    case .institutionalSkeptic:
      return
        "You saw through organized religion, but other institutions still have their hooks in you. School, government, media—different cages, same bars."
    case .meditationSeeker:
      return
        "You've tried meditation, breathwork, maybe even plant medicine. You feel glimpses but can't sustain the breakthrough. There's a missing piece."
    case .eternalQuestioner:
      return
        "You've always questioned everything. Teachers hated you. Bosses hate you. But your mind won't rest because something doesn't add up."
    case .rabbitHoleDweller:
      return
        "You went deep. Maybe too deep. Conspiracies within conspiracies. Now you need help separating signal from noise, grounding the knowledge."
    case .scientificMaterialist:
      return
        "You believe in evidence and reason. That's good. But mainstream science has its own dogmas. You're ready for the physics that broke physicists."
    case .spirituallyWounded:
      return
        "Religion hurt you. Spiritual communities hurt you. The cynicism is protective—but it's also blocking something real."
    case .newlyAwakening:
      return
        "Something cracked recently. A loss. A crisis. A glimpse you can't explain. You're disoriented but know the old story doesn't fit anymore."
    case .chosenSurvivor:
      return
        "Life broke you multiple times. Trauma that should have destroyed you. But you kept getting up. The difficulty was training. You're here for a reason."
    case .integrationSeeker:
      return
        "You've had the experiences—awakening, revelation, maybe even ego death. Now you need to integrate it into daily life. Make it practical. Sustainable."
    }
  }
...
enum PersonalizedWelcome {
  static func message(for persona: AwakeningPersona?) -> String {
    ...
    case .institutionalSkeptic:
      return
        "You've already seen through some of the lies. Let's show you the ones that are harder to spot."
    case .meditationSeeker:
    ...
    case .newlyAwakening:
      return
        "The confusion is normal. The old map doesn't fit the new territory. We'll help you navigate."
    case .chosenSurvivor:
      return
        "You weren't broken for nothing. Everything you survived was preparation. Let's activate it."
    case .integrationSeeker:
