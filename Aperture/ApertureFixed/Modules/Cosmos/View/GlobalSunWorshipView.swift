...
struct GlobalSunWorshipView: View {
    ...
    private var openingWisdom: some View {
        VStack(spacing: 12) {
            ...
            Text("Every culture on Earth — YOUR ancestors — revered the Sun before imperialism erased it.")
    ...
    private var truthSection: some View {
        VStack(spacing: 16) {
            ...
            VStack(spacing: 12) {
                Text("Your Mayan ancestors, Egyptian priests, Slavic shamans, and Japanese emperors were ALL observing the SAME REALITY:")
                    .font(.system(size: 14, weight: .medium, design: .rounded))
                    .foregroundColor(.white.opacity(0.9))
                    .multilineTextAlignment(.center)
                    .lineSpacing(4)
