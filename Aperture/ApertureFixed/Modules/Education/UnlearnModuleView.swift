...
struct DeprogramJournalEntry: Identifiable, Codable {
    ...
    init(id: String = UUID().uuidString, prompt: String, response: String = "", date: Date = Date(), category: String = "reflection") {
        self.id = id; self.prompt = prompt; self.response = response
...
class UnlearnManager: ObservableObject {
    ...
    var overallProgress: Double {
        let biasScore = biasScores.isEmpty ? 0.0 : Double(biasScores.values.reduce(0, +)) / Double(biasScores.count * 3)
    ...
    private func persist() {
        let model = UnlearnStorageModel(biasScores: biasScores, assessmentsTaken: assessmentsTaken,
...
struct UnlearnContentDatabase {
    
    // MARK: - Bias Questions
    
    static let biasQuestions: [BiasQuestion] = [
        BiasQuestion(text: "When you see a group of young Black men walking toward you at night, your first instinct is:", category: .racial, options: [
        ...
        BiasQuestion(text: "If a Muslim woman in hijab sat next to you on a plane, you'd feel:", category: .racial, options: [
        ...
        BiasQuestion(text: "When someone says 'systemic racism,' your reaction is:", category: .systemic, options: [
        ...
        BiasQuestion(text: "Your reaction to learning that identical resumes with 'Black-sounding' names get 50% fewer callbacks:", category: .systemic, options: [
        ...
        BiasQuestion(text: "How often do you consume media (movies, music, books) created by people of a different race than you?", category: .cultural, options: [
        ...
        BiasQuestion(text: "If your child wanted to marry someone of a different race, your honest reaction would be:", category: .racial, options: [
        ...
        BiasQuestion(text: "When you hear about police violence against unarmed Black people, your first thought is:", category: .empathy, options: [
        ...
        BiasQuestion(text: "How well can you name 5 contributions to science, art, or civilization from non-European cultures?", category: .cultural, options: [
            BiasOption(text: "Easily — algebra (Islamic), gunpowder (Chinese), surgery (Egyptian)...", score: 0),
        ...
        BiasQuestion(text: "Have you ever examined whether beliefs you hold about other groups came from your own experience or were inherited?", category: .selfAwareness, options: [
        ...
        BiasQuestion(text: "If someone called you 'racist,' your response would be:", category: .selfAwareness, options: [
    ...
    static let scenarios: [EmpathyScenario] = [
        EmpathyScenario(
            ...
            avatar: "Marcus", avatarDescription: "28-year-old Black software engineer driving home from work",
            scene: "You're driving your new car through a suburban neighborhood. Blue lights flash behind you.",
            situation: "The officer approaches your window and immediately asks you to step out of the vehicle. His hand is on his holster. You haven't been told why you were stopped.",
            choices: [
                EmpathyChoice(text: "Comply slowly with hands visible, stay calm", outcome: "After 20 minutes of questioning, searching your car, and running your plates twice, you're let go with 'a warning.' For what? You still don't know. You're late for dinner. Your hands won't stop shaking.", stressImpact: -2, dignityImpact: -2, followUp: "Marcus experiences this 3-4 times per year. His white coworker has been pulled over once in 5 years."),
                EmpathyChoice(text: "Politely ask why you're being stopped", outcome: "The officer's tone hardens. 'I'm asking the questions.' Backup is called. You spend 40 minutes on the curb while they search your car without consent. Nothing found. No apology.", stressImpact: -3, dignityImpact: -3, followUp: "Asking 'why' while Black can escalate a routine stop into a life-threatening situation. This fear is taught, not imagined."),
                EmpathyChoice(text: "Record the interaction on your phone", outcome: "The officer orders you to put the phone down. When you say it's your right, things escalate fast. More units arrive. You end up handcuffed 'for officer safety.' Released an hour later with no charges.", stressImpact: -3, dignityImpact: -1, followUp: "Recording is legal, but asserting your rights while Black is statistically more dangerous than compliance.")
            ],
            realWorldStat: "Black drivers are 20% more likely to be stopped than white drivers. Once stopped, they're twice as likely to be searched, despite being less likely to be found with contraband.",
            reflectionPrompt: "Imagine this happening to you 3-4 times a year since you turned 16. How would that shape your relationship with 'safety' and 'authority'?"
        ),
        EmpathyScenario(
            title: "The Job Interview",
            avatar: "Priya", avatarDescription: "32-year-old Indian-American data scientist, Stanford PhD",
            scene: "You walk into the interview. The panel of four interviewers are all white men. One of them mispronounces your name badly, then says 'I'll just call you P.'",
            situation: "During the technical portion, you answer everything correctly. The interviewer says 'Wow, your English is really good.' You were born in Ohio.",
            choices: [
                EmpathyChoice(text: "Smile and say 'Thanks, I was born here'", outcome: "Awkward silence. The interview continues but the energy shifts. You don't get a callback. The position goes to someone with less experience.", stressImpact: -1, dignityImpact: -2, followUp: "Priya has heard 'your English is great' over 200 times. She's a third-generation American."),
                EmpathyChoice(text: "Let it go and keep performing", outcome: "You finish strong. HR sends a rejection two weeks later: 'not a culture fit.' Your qualifications exceeded every requirement.", stressImpact: -2, dignityImpact: -2, followUp: "'Culture fit' is the most common legal way to reject qualified candidates of color. It's unmeasurable and unchallengeable."),
                EmpathyChoice(text: "Correct your name pronunciation firmly", outcome: "The lead interviewer seems put off. Another panelist becomes your ally and uses your name correctly. You get the job, but your first year is spent proving you 'belong' there.", stressImpact: -1, dignityImpact: 1, followUp: "Even when you 'win,' the tax of constantly asserting your humanity in professional spaces is exhausting.")
            ],
            realWorldStat: "Applicants with Asian names need 50% more applications to get a callback. Studies show identical resumes with 'white-sounding' names receive significantly more interview requests.",
            reflectionPrompt: "What if every time you walked into a room, people assumed you were foreign? How would that shape your confidence over decades?"
        ),
        EmpathyScenario(
            title: "The Grocery Store",
            avatar: "DeShawn", avatarDescription: "17-year-old Black teen shopping with friends",
            scene: "You and two friends walk into a grocery store after school to buy snacks. A security guard starts following your group within 30 seconds.",
            situation: "As you browse, an employee 'straightens shelves' next to wherever you go. At checkout, the cashier asks to see inside your backpack. Your white classmate behind you isn't asked.",
            choices: [
                EmpathyChoice(text: "Open the backpack without comment", outcome: "Inside: textbooks, a calculator, earbuds. The cashier doesn't apologize. Your friends are humiliated. One says 'I'm never coming back here.' You've lost your appetite for the snacks.", stressImpact: -2, dignityImpact: -3, followUp: "DeShawn is 17. He's been followed in stores since he was 12. He learned early: your skin is a shoplifting suspect."),
                EmpathyChoice(text: "Ask 'Are you asking everyone, or just us?'", outcome: "The cashier gets flustered, calls the manager. Manager says it's 'policy.' You point to the white student behind you who wasn't asked. Silence. You leave without buying anything.", stressImpact: -1, dignityImpact: 0, followUp: "Standing up for yourself at 17 feels brave but costs energy. By 30, the accumulated weight of these moments becomes chronic stress."),
                EmpathyChoice(text: "Film the interaction and post it", outcome: "The video gets 200K views. The store issues a corporate apology. Your school congratulates your 'bravery.' But next week, a different store does the same thing. Nothing changed.", stressImpact: -2, dignityImpact: 1, followUp: "Going viral doesn't fix the system. It just proves the system exists — again — for people who weren't paying attention.")
            ],
            realWorldStat: "Black and Latino shoppers are 2-3x more likely to be followed or monitored in retail stores. This 'shopping while Black' phenomenon is documented across all income levels.",
            reflectionPrompt: "When's the last time you were followed in a store? If the answer is 'never,' consider that your skin color bought you that freedom."
        ),
    ]
    ...
    static let myths: [MythReality] = [
        MythReality(myth: "Christopher Columbus discovered America", reality: "Vikings arrived around 1002 CE (Leif Erikson). Indigenous peoples had been living across the Americas for 15,000+ years. Columbus never set foot on mainland North America. He enslaved the Taíno people and launched a genocide.", source: "Primary sources: Columbus's own journals, Bartolomé de las Casas accounts", category: "History", icon: "globe.americas.fill"),
        MythReality(myth: "The Civil War was about 'states' rights'", reality: "It was about the right to own slaves. The Confederate states' own declarations of secession explicitly name slavery as the cause. Mississippi's declaration mentions 'slavery' 7 times in the opening paragraph. The 'states' rights' reframe was a post-war Lost Cause propaganda effort.", source: "Confederate Declarations of Secession (primary documents)", category: "History", icon: "flag.fill"),
        MythReality(myth: "Vikings wore horned helmets", reality: "No archaeological evidence of horned helmets exists. This myth comes from 19th-century Romantic artists and Wagner operas. Real Viking helmets were simple iron or leather.", source: "National Museum of Denmark, archaeological evidence", category: "Culture", icon: "shield.fill"),
        MythReality(myth: "George Washington chopped down a cherry tree", reality: "Completely fabricated by Mason Locke Weems in an 1806 biography to sell books. No historical evidence supports this. It's nationalist mythology designed to create a perfect founding father.", source: "Mount Vernon Historical Association", category: "Mythology", icon: "tree.fill"),
        MythReality(myth: "Ancient Egypt was a 'white' civilization", reality: "Ancient Egyptians were Northeast African people. DNA analysis of mummies shows sub-Saharan African ancestry. Greek historians like Herodotus described them as 'dark-skinned with woolly hair.' The whitewashing of Egypt is one of history's most persistent erasures.", source: "DNA studies (Nature Communications 2017), Herodotus Book II", category: "Erasure", icon: "pyramid.fill"),
        MythReality(myth: "Africa had no civilization before Europeans arrived", reality: "The Kingdom of Kush predates Rome. Great Zimbabwe was a massive stone city. Mali's Mansa Musa was the richest person in human history. Timbuktu had universities and libraries while Europe was in the Dark Ages. This myth justified colonialism.", source: "UNESCO World Heritage, African historiography", category: "Erasure", icon: "building.columns.fill"),
        MythReality(myth: "Paul Revere shouted 'The British are coming!'", reality: "He said 'the Regulars are coming' — everyone was British at the time. He wasn't the only rider; at least 40 others carried the warning. Samuel Prescott actually completed the ride. Revere was captured.", source: "Paul Revere's own account, Massachusetts Historical Society", category: "History", icon: "bell.fill"),
        MythReality(myth: "Edison invented the light bulb", reality: "Humphry Davy created the first electric light in 1802. Edison improved on designs by many inventors to make a commercially practical version in 1879. Edison was a genius marketer who took credit for others' work (see: Tesla, Nikola).", source: "Smithsonian Institution", category: "Science", icon: "lightbulb.fill"),
        MythReality(myth: "Thanksgiving was a friendly feast between Pilgrims and Native Americans", reality: "The 1621 event was a political alliance meal, not a celebration. Within a generation, colonists were waging genocidal wars against the same peoples. The 'Thanksgiving' myth erases centuries of Indigenous genocide, forced displacement, and cultural destruction.", source: "Wampanoag oral history, primary colonial accounts", category: "History", icon: "leaf.fill"),
        MythReality(myth: "The 'War on Drugs' was about public health", reality: "Nixon aide John Ehrlichman admitted in 1994: 'The Nixon campaign had two enemies: the antiwar left and Black people... We knew we couldn't make it illegal to be Black, but by getting the public to associate Blacks with heroin and hippies with marijuana, we could disrupt those communities.'", source: "John Ehrlichman interview, Harper's Magazine 2016", category: "System", icon: "pills.fill"),
    ]
...
""", "Divide and conquer: documented colonial strategy since Rome", "lock.shield.fill"),
    ...
    static let awakeningPaths: [(name: String, tradition: String, mechanism: String, endGoal: String, icon: String)] = [
        ("Kundalini Awakening", "Hindu/Yogic", "Energy rises through chakras via meditation, breathwork, or spontaneous activation", "Union with Brahman — the realization that Atman (individual soul) IS Brahman (universal consciousness)", "flame.fill"),
        ("Gnosis", "Gnostic Christianity", "Direct experiential knowledge of the divine, bypassing institutional religion", "Recognition that you are a divine spark trapped in matter, and the 'God' of this world is not the true Source", "eye.fill"),
        ("Satori / Kensho", "Zen Buddhism", "Sudden insight through meditation (zazen), koans, or direct pointing", "Seeing your original nature — no self, no other, just this", "circle.fill"),
        ("Fana", "Sufism (Islamic Mysticism)", "Annihilation of the ego-self through devotion, dhikr, and surrender", "Union with Allah — 'I am the Truth' (Ana al-Haqq) — the mystic and the divine become one", "moon.stars.fill"),
        ("Tikkun", "Kabbalah (Jewish Mysticism)", "Repair of the shattered vessels through righteous action and meditation on the Sefirot", "Restoration of divine unity — Ein Sof flowing unobstructed through creation", "sparkles"),
        ("Christ Consciousness", "Esoteric Christianity", "Awakening the Christ within — not worship of an external savior but activation of your own divine nature", "Becoming what Christ demonstrated: fully human AND fully divine, simultaneously", "sun.max.fill"),
        ("Ubuntu", "South African / Bantu", "'I am because we are' — the self exists only through community and mutual recognition", "The dissolution of individual ego into collective humanity — you cannot be fully human alone", "person.3.fill"),
        ("The Red Road", "Indigenous / Native American", "Walking in balance with all creation through ceremony, vision quests, and ancestral connection", "Understanding that humans are not above nature but part of it — every being is a relative", "leaf.fill"),
    ]
    
    // MARK: - Journal Prompts
    
    static let journalPrompts: [(prompt: String, category: String)] = [
        ("What's one belief about another race or culture that you hold but have never questioned? Where did it come from?", "self-awareness"),
        ("Describe a time you were treated differently because of how you look. If you can't think of one, what does that tell you?", "privilege"),
        ("If you woke up tomorrow in a different body — different skin color, different country — what would scare you most?", "empathy"),
        ("What's something your parents or grandparents said about other groups that you now realize was wrong?", "inherited"),
        ("Think about the neighborhood you grew up in. Who lived there? Who didn't? Was that by accident?", "systemic"),
        ("When you picture a 'terrorist,' a 'criminal,' a 'genius,' a 'leader' — what face appears? Why that face?", "bias"),
        ("What would it take for you to feel truly safe sitting in a room where you are the only person of your race?", "comfort"),
        ("Name three things you learned in school about non-white civilizations. If you struggle, why do you think that is?", "education"),
        ("If racism ended tomorrow, who would lose power? Follow that thread.", "systemic"),
        ("Write a letter to the version of yourself that existed before you started questioning your programming.", "growth"),
    ]
}
...
struct UnlearnModuleView: View {
    ...
    private var unlearnBackground: some View {
        LinearGradient(
            colors: [Color(red: 0.04, green: 0.06, blue: 0.12), Color(red: 0.06, green: 0.08, blue: 0.16), Color(red: 0.03, green: 0.04, blue: 0.10)],
    ...
    private var heroSection: some View {
        VStack(spacing: 12) {
            ZStack {
                Circle().fill(Color(red: 1.0, green: 0.85, blue: 0.3).opacity(0.1)).frame(width: 80, height: 80)
            ...
            Text("Question what was installed in you before\nyou could consent. No shame. Just awareness.")
    ...
    private var progressCard: some View {
        VStack(spacing: 12) {
            HStack {
                ...
                VStack(alignment: .trailing, spacing: 4) {
                    ...
                    Text("awareness").font(.system(size: 9, weight: .medium)).foregroundColor(.white.opacity(0.3))
                }
            }
        ...
        .padding(16)
        .background(RoundedRectangle(cornerRadius: 16).fill(Color.cyan.opacity(0.04))
            ...
            LazyVGrid(columns: [GridItem(.flexible(), spacing: 10), GridItem(.flexible(), spacing: 10)], spacing: 10) {
                ForEach(UnlearnSection.allCases) { section in
                    Button { selectedSection = section } label: {
                        HStack(spacing: 10) {
                            Image(systemName: section.icon).font(.system(size: 18)).foregroundColor(section.color).frame(width: 28)
                            VStack(alignment: .leading, spacing: 2) {
                                Text(section.rawValue).font(.system(size: 12, weight: .bold)).foregroundColor(.white)
                                Text(section.subtitle).font(.system(size: 9, weight: .medium)).foregroundColor(.white.opacity(0.4))
                            }
                            Spacer()
                        }
                        .padding(12)
                        .background(RoundedRectangle(cornerRadius: 12).fill(section.color.opacity(0.06))
                            .overlay(RoundedRectangle(cornerRadius: 12).stroke(section.color.opacity(0.12), lineWidth: 1)))
                    }
                }
            }
        }
    ...
    private var onenessPreview: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("We are one consciousness experiencing the 3D through different expressions. Your skin, your language, your culture — these are not who you ARE. They are how Source chose to experience this particular life. Hating another expression of Source is hating yourself.")
                .font(.system(size: 12, weight: .medium, design: .rounded))
                .foregroundColor(.white.opacity(0.6)).lineSpacing(4)
            Button { selectedSection = .oneness } label: {
                Text("Go Deeper →").font(.system(size: 12, weight: .bold))
                    .foregroundColor(Color(red: 1.0, green: 0.85, blue: 0.3))
            }
        }
        .padding(16)
        .background(RoundedRectangle(cornerRadius: 16).fill(Color(red: 1.0, green: 0.85, blue: 0.3).opacity(0.04))
            .overlay(RoundedRectangle(cornerRadius: 16).stroke(Color(red: 1.0, green: 0.85, blue: 0.3).opacity(0.12), lineWidth: 1)))
    }
    
    private var privacyNote: some View {
        HStack(spacing: 10) {
            Image(systemName: "lock.shield.fill").font(.system(size: 16)).foregroundColor(.green.opacity(0.6))
            VStack(alignment: .leading, spacing: 2) {
                Text("100% PRIVATE").font(.system(size: 10, weight: .bold)).foregroundColor(.green.opacity(0.6))
                Text("All your responses, journal entries, and bias scores are stored locally on this device only. Nothing is uploaded. Nothing is collected. This is between you and yourself.")
        ...
        VStack(spacing: 24) {
            ...
            VStack(spacing: 16) {
                HStack(spacing: 6) {
                    ...
                    Text(q.category.rawValue).font(.system(size: 10, weight: .bold)).foregroundColor(q.category.color)
                }
    ...
    private var resultsView: some View {
        ScrollView(showsIndicators: false) {
            VStack(spacing: 20) {
                ...
                Text("Remember: this isn't about shame. It's about seeing clearly.\nAwareness is the first step to freedom.")
                ...
                ForEach(BiasCategory.allCases, id: \.self) { category in
                    ...
                    HStack {
                        ...
                        ProgressView(value: Double(maxScore - score), total: Double(maxScore))
                            ...
                            .frame(width: 80)
                        Text(awarenessLabel(score)).font(.system(size: 10, weight: .bold)).foregroundColor(awarenessColor(score))
                ...
                Text("Take this again anytime to track your growth. Your old scores are saved privately so you can see change over time.")
                    .font(.system(size: 12, weight: .medium)).foregroundColor(.white.opacity(0.4))
                    .multilineTextAlignment(.center).lineSpacing(3)
                    .padding(.top, 10)
...
struct EmpathyEngineView: View {
                    ...
                    VStack(spacing: 20) {
                        ...
                        Button { showLifeSim = true } label: {
                            HStack(spacing: 12) {
                                ...
                                VStack(alignment: .leading, spacing: 3) {
                                    HStack(spacing: 6) {
                                        Text("Walk A Mile").font(.system(size: 14, weight: .bold)).foregroundColor(.white)
                        ...
                        VStack(alignment: .leading, spacing: 14) {
                            HStack {
                                ...
                                Spacer()
                                Text("\(currentScenario + 1)/\(scenarios.count)").font(.system(size: 11, weight: .medium)).foregroundColor(.white.opacity(0.3))
                            }
                            
                            HStack(spacing: 8) {
                                Text("🧑🏾").font(.system(size: 28))
                                VStack(alignment: .leading, spacing: 2) {
                                    Text("You are: \(scenario.avatar)").font(.system(size: 13, weight: .bold)).foregroundColor(.white)
                                    Text(scenario.avatarDescription).font(.system(size: 11, weight: .medium)).foregroundColor(.white.opacity(0.5))
                                }
                            }
                            .padding(10)
                            ...
                            Text(scenario.scene)
                                .font(.system(size: 13, weight: .medium)).foregroundColor(.white.opacity(0.7)).lineSpacing(4)
                        ...
                        if showOutcome, let choice = selectedChoice {
                            ...
                            VStack(spacing: 10) {
                                Text("WHAT DO YOU DO?").font(.system(size: 10, weight: .bold)).tracking(2).foregroundColor(.white.opacity(0.3))
                                ForEach(scenario.choices) { choice in
                                    Button {
                                        ...
                                        Text(choice.text)
                                            ...
                                            .background(RoundedRectangle(cornerRadius: 12).fill(Color(red: 0.3, green: 0.5, blue: 0.8).opacity(0.1))
                                                .overlay(RoundedRectangle(cornerRadius: 12).stroke(Color(red: 0.3, green: 0.5, blue: 0.8).opacity(0.2), lineWidth: 1)))
                                    }
                                }
                            }
                        }
    ...
    private func statusBar(_ label: String, value: Int, color: Color, icon: String) -> some View {
        VStack(spacing: 4) {
            ...
            ProgressView(value: Double(value), total: 100).progressViewStyle(LinearProgressViewStyle(tint: color))
        }
    }
    ...
    private func outcomeCard(_ choice: EmpathyChoice, scenario: EmpathyScenario) -> some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text(choice.outcome).font(.system(size: 13, weight: .medium)).foregroundColor(.white.opacity(0.8)).lineSpacing(4)
            ...
            VStack(alignment: .leading, spacing: 6) {
                Text("REAL WORLD DATA").font(.system(size: 9, weight: .bold)).tracking(1).foregroundColor(.orange.opacity(0.6))
                Text(scenario.realWorldStat).font(.system(size: 12, weight: .regular)).foregroundColor(.white.opacity(0.6)).lineSpacing(3)
            }
            .padding(10).background(RoundedRectangle(cornerRadius: 8).fill(Color.orange.opacity(0.04)))
            
            VStack(alignment: .leading, spacing: 6) {
                Text("REFLECT").font(.system(size: 9, weight: .bold)).tracking(1).foregroundColor(.purple.opacity(0.6))
                Text(scenario.reflectionPrompt).font(.system(size: 12, weight: .medium)).foregroundColor(.purple.opacity(0.8)).lineSpacing(3)
            }
    ...
    private func mythCard(_ item: MythReality) -> some View {
        ...
        return VStack(alignment: .leading, spacing: 0) {
            Button {
                ...
                HStack(spacing: 10) {
                    Image(systemName: item.icon).font(.system(size: 16)).foregroundColor(.orange).frame(width: 24)
                    VStack(alignment: .leading, spacing: 2) {
                        Text("MYTH").font(.system(size: 8, weight: .bold)).tracking(1).foregroundColor(.red.opacity(0.6))
                        Text(item.myth).font(.system(size: 13, weight: .semibold)).foregroundColor(.white).lineLimit(isExpanded ? nil : 2)
                    }
                    Spacer()
                    Image(systemName: isExpanded ? "chevron.up" : "chevron.down").font(.system(size: 11)).foregroundColor(.white.opacity(0.3))
                }
                .padding(14)
            }
            if isExpanded {
                VStack(alignment: .leading, spacing: 10) {
                    Divider().background(Color.white.opacity(0.08))
                    Text("REALITY").font(.system(size: 8, weight: .bold)).tracking(1).foregroundColor(.green.opacity(0.6))
                    Text(item.reality).font(.system(size: 13, weight: .regular)).foregroundColor(.white.opacity(0.8)).lineSpacing(4)
                    HStack(spacing: 4) {
        ...
        .background(RoundedRectangle(cornerRadius: 14).fill(Color.white.opacity(0.03))
            .overlay(RoundedRectangle(cornerRadius: 14).stroke(Color.orange.opacity(isExpanded ? 0.15 : 0.06), lineWidth: 1)))
    }
}
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 16) {
                        ForEach(Array(UnlearnContentDatabase.onenessTeachings.enumerated()), id: \.offset) { _, teaching in
                            VStack(alignment: .leading, spacing: 12) {
                                HStack(spacing: 8) {
                                    Image(systemName: teaching.icon).font(.system(size: 18))
                                        .foregroundColor(Color(red: 1.0, green: 0.85, blue: 0.3))
                                    Text(teaching.title).font(.system(size: 15, weight: .bold)).foregroundColor(.white)
                                }
                                Text(teaching.teaching).font(.system(size: 13, weight: .regular)).foregroundColor(.white.opacity(0.7)).lineSpacing(5)
                                HStack(spacing: 4) {
                                    Image(systemName: "book.fill").font(.system(size: 9))
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 14) {
                        Text("Different names. Different traditions. Same destination.\nEvery culture found the same truth independently.")
                            .font(.system(size: 13, weight: .medium)).foregroundColor(.white.opacity(0.5))
                            .multilineTextAlignment(.center).lineSpacing(3).padding(.bottom, 8)
                        
                        ForEach(Array(UnlearnContentDatabase.awakeningPaths.enumerated()), id: \.offset) { _, path in
                            VStack(alignment: .leading, spacing: 10) {
                                HStack(spacing: 8) {
                                    ...
                                    VStack(alignment: .leading, spacing: 2) {
                                        ...
                                        Text(path.tradition).font(.system(size: 10, weight: .medium)).foregroundColor(.purple.opacity(0.7))
                                    }
                                    Spacer()
                                }
                                VStack(alignment: .leading, spacing: 6) {
                                    Text("MECHANISM").font(.system(size: 8, weight: .bold)).tracking(1).foregroundColor(.cyan.opacity(0.5))
                                    Text(path.mechanism).font(.system(size: 12, weight: .regular)).foregroundColor(.white.opacity(0.6)).lineSpacing(3)
                                }
                                VStack(alignment: .leading, spacing: 6) {
                                    Text("END GOAL").font(.system(size: 8, weight: .bold)).tracking(1).foregroundColor(Color(red: 1.0, green: 0.85, blue: 0.3).opacity(0.5))
                                    Text(path.endGoal).font(.system(size: 12, weight: .medium, design: .rounded))
                                        .foregroundColor(Color(red: 1.0, green: 0.85, blue: 0.3).opacity(0.7)).lineSpacing(3)
                                }
                            }
                            .padding(14)
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 16) {
                        ...
                        if let prompt = selectedPrompt {
                            VStack(alignment: .leading, spacing: 12) {
                                Text(prompt.prompt).font(.system(size: 14, weight: .medium)).foregroundColor(.cyan).lineSpacing(3)
                                ...
                                HStack {
                                    Button {
                                        let entry = DeprogramJournalEntry(prompt: prompt.prompt, response: journalText, category: prompt.category)
                                    ...
                                    Button { selectedPrompt = nil; journalText = "" } label: {
                                        Text("Cancel").font(.system(size: 13)).foregroundColor(.white.opacity(0.4))
                                    }
                                }
                            }
                            .padding(14).background(RoundedRectangle(cornerRadius: 14).fill(Color.cyan.opacity(0.04))
                                .overlay(RoundedRectangle(cornerRadius: 14).stroke(Color.cyan.opacity(0.15), lineWidth: 1)))
                        } else {
                            // Prompt picker
                            VStack(alignment: .leading, spacing: 8) {
                                Text("PICK A PROMPT").font(.system(size: 9, weight: .bold)).tracking(1.5).foregroundColor(.white.opacity(0.3))
                        ...
                        if !manager.journalEntries.isEmpty {
                            VStack(alignment: .leading, spacing: 8) {
                                Text("PAST ENTRIES (\(manager.journalEntries.count))").font(.system(size: 9, weight: .bold)).tracking(1.5).foregroundColor(.white.opacity(0.3))
                                ForEach(manager.journalEntries) { entry in
                                    VStack(alignment: .leading, spacing: 6) {
                                        Text(entry.prompt).font(.system(size: 11, weight: .medium)).foregroundColor(.cyan.opacity(0.7)).lineLimit(2)
                                        Text(entry.response).font(.system(size: 12, weight: .regular)).foregroundColor(.white.opacity(0.6)).lineLimit(3).lineSpacing(2)
                                        Text(entry.date, style: .date).font(.system(size: 9, weight: .medium)).foregroundColor(.white.opacity(0.2))
                                    }
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 20) {
                        ...
                        VStack(spacing: 10) {
                            ...
                            Text("Awareness Score").font(.system(size: 13, weight: .medium)).foregroundColor(.white.opacity(0.4))
                            Text("\(manager.streakDays)-day streak")
                        ...
                        // Activity
                        VStack(alignment: .leading, spacing: 10) {
                            Text("ACTIVITY").font(.system(size: 9, weight: .bold)).tracking(1.5).foregroundColor(.white.opacity(0.3))
                            HStack(spacing: 0) {
                        ...
                        if manager.biasHistory.count >= 2 {
                            Text("You've taken the assessment \(manager.biasHistory.count) times. Growth isn't linear — some days you'll feel like you slid back. That's part of the process. Keep going.")
                        ...
                        Button {
                            ...
                            Text("Reset All Data").font(.system(size: 12, weight: .medium)).foregroundColor(.red.opacity(0.4))
                        }.padding(.top, 20)
