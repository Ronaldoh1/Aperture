...
struct PalestineHistory: View {
  ...
  private var approachNote: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      Text(
        "Palestinians are often spoken about but rarely heard. This course centers Palestinian experiences and scholarship while using documented historical sources. Understanding Palestinian history is essential for understanding the present."
      )
      .font(.system(size: 12))
      .foregroundColor(.gray)
      .lineSpacing(4)
      ...
      PalestineLesson(
        ...
        content: """
          ...
          **Why This Matters:**
          ...
          """,
        keyTakeaway:
          "Palestinians are the indigenous people of Palestine with roots going back centuries. The 'land without a people' was a myth—in 1882, 470,000 Arabs lived there compared to 24,000 Jews."
      ),
      PalestineLesson(
        ...
        content: """
          ...
          **Legacy of British Rule:**
          ...
          """,
        keyTakeaway:
          "Britain promised Arabs independence, then gave away their land. When Palestinians revolted, Britain crushed them—killing 5,000+ and destroying political leadership. Palestinians entered 1948 weakened while Zionist forces were organized and armed."
      ),
      PalestineLesson(
        ...
        content: """
          ...
          **Why?**
          ...
          """,
        keyTakeaway:
          "700,000-750,000 Palestinians were expelled or fled in 1948. 400+ villages were destroyed. Massacres spread terror. UN called for return. Israel refused. Most refugees' villages no longer exist. Their descendants remain refugees 75+ years later."
      ),
      PalestineLesson(
        ...
        content: """
          ...
          **The question remains:**
          ...
          """,
        keyTakeaway:
          "5.9 million Palestinian refugees exist today—the world's longest-running refugee crisis. UN affirmed their right to return. Israel refuses. Many families still have their house keys 75+ years later. Peace without addressing refugees is impossible."
      ),
      PalestineLesson(
        ...
        content: """
          ...
          **Palestinian voices:**
          ...
          """,
        keyTakeaway:
          "Daily life under occupation means checkpoints, permits, home demolitions, night raids, and child detention. 700+ checkpoints. 55,000+ structures demolished. Systematic humiliation designed to force Palestinians to leave their homeland."
      ),
      PalestineLesson(
        ...
        content: """
          ...
          **Resilience:**
          ...
          """,
        keyTakeaway:
          "Palestinians resist through sumud (staying), political organization, popular uprising, BDS, and cultural preservation. 75+ years of dispossession have not broken Palestinian identity or determination. Their presence itself is resistance."
      ),
      PalestineLesson(
        title: "Gaza",
        period: "2005-Present",
        ...
        content: """
          ...
          **The Core Issue:**
          ...
          """,
        keyTakeaway:
          "2.3 million people live in Gaza under blockade. 95% of water undrinkable. 4-8 hours of electricity. Repeated wars kill thousands. UN said Gaza would be uninhabitable by 2020. The blockade is a policy choice, not a necessity."
      ),
      PalestineLesson(
        ...
        content: """
          ...
          **Final Thought:**
          ...
          """,
        keyTakeaway:
          "Palestinians ask for basic rights everyone else has: to live in their homeland, move freely, not be bombed, keep their children safe, and be seen as human. Many Jews and global movements stand in solidarity. Education leads to action."
      ),
    ]
  }
}
