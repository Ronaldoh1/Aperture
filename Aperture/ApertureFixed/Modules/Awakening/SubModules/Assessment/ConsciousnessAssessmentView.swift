...
struct AssessmentResultView: View {
    ...
    private func recommendationsSection(_ archetype: ConsciousnessArchetype) -> some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            ForEach(Array(archetype.courseRecommendations.enumerated()), id: \.element.id) { index, recommendation in
    ...
    var body: some View {
        Button {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                Text("Take a quick assessment to discover which courses are right for where you are right now.")
                    .font(.caption)
                    .foregroundColor(.white.opacity(0.7))
                    .lineLimit(2)
        ...
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Take a 2-minute assessment and we'll recommend the perfect courses for where you are right now.")
                        .font(.body)
                        .foregroundColor(.white.opacity(0.7))
                        .multilineTextAlignment(.center)
                }
