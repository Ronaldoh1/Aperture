...
struct AboutApertureView: View {
  ...
  private var missionSection: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      Text(
        "Aperture exists to synthesize the world's wisdom traditions, reveal hidden historical patterns, and provide practical tools for conscious evolution."
      )
      .font(.system(size: 15))
      ...
      Text(
        "We believe awakening is humanity's birthright—not a privilege reserved for monks, mystics, or the initiated few. By showing the common thread across all traditions, we help you find your path without dogma, gurus, or gatekeepers."
      )
      .font(.system(size: 15))
      .foregroundColor(.white.opacity(0.9))
      .lineSpacing(4)
  ...
  private var trustSection: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      VStack(alignment: .leading, spacing: 10) {
        trustPoint(
          "Educational, not ideological",
          "We present information for your consideration, not beliefs for your adoption.")
        trustPoint(
          "Question everything—including us",
          "A healthy skepticism is part of awakening. We encourage you to verify, challenge, and form your own conclusions."
        )
        trustPoint(
          "No gurus, no gatekeepers",
          "Your spiritual journey belongs to you. We're tools, not teachers.")
        trustPoint(
          "Privacy protected",
          "Your inner journey is sacred. We don't sell your data or exploit your trust.")
      }
    }
    .padding()
    .background(
