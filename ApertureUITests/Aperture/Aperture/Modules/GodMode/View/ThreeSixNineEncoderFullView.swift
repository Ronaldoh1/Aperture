      ...
      SwiftUI.TimelineView(.animation) { timeline in
        Canvas { context, size in
          ...
          for i in 0..<36 {
            ...
            let opacity = 0.3 + sin(time * 2 + seed * 0.5) * 0.2
  ...
  private var intentionInputView: some View {
    VStack(spacing: 32) {
      ...
      VStack(alignment: .leading, spacing: 12) {
        ...
        Text(
          "Write as if it's already true. Example: \"I am abundant and wealth flows to me effortlessly.\""
        )
        ...
        .background(
          Capsule()
            .fill(
              LinearGradient(
                colors: [
                  Color(red: 0.6, green: 0.3, blue: 1), Color(red: 0.9, green: 0.4, blue: 0.8),
                ],
                startPoint: .leading,
                endPoint: .trailing
              )
