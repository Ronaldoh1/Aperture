...
extension CircadianPhase {
    ...
    static let phases: [CircadianPhase] = [
        ...
        CircadianPhase(
            ...
            description: "Cortisol surge begins. Body temperature rises. The transition from sleep to wakefulness. Protect this window - it sets the tone for the entire day.",
            optimalActivities: [
        ...
        CircadianPhase(
            ...
            description: "PRIME TIME. Cortisol peaks. Body temperature optimal. Prefrontal cortex fully online. This is your most valuable cognitive real estate. Protect it ruthlessly.",
            optimalActivities: [
        ...
        CircadianPhase(
            ...
            description: "Post-lunch dip incoming. Blood flow shifts to digestion. This is NOT a bug - it's a feature. Use it wisely.",
            optimalActivities: [
        ...
        CircadianPhase(
            ...
            description: "Second wind begins around 3-4 PM. Body temperature rises again. Good for physical performance and collaborative work.",
            optimalActivities: [
        ...
        CircadianPhase(
            ...
            description: "Transition toward rest. Melatonin production begins as light dims. Critical window for next-day preparation.",
            optimalActivities: [
        ...
        CircadianPhase(
            ...
            description: "Sleep is not passive. It's when memory consolidation, cellular repair, and emotional processing happen. Protect it like your life depends on it - because it does.",
            optimalActivities: [
            ...
            hormoneProfile: "Melatonin high, growth hormone released during deep sleep, cortisol at lowest",
...
extension Chronotype {
    ...
    static let types: [Chronotype] = [
        ...
        Chronotype(
            ...
            icon: "sunrise.fill",
            color: Color(hex: "#FFD700"),
            description: "Early risers. Peak energy in the morning. Most productive before noon. Often fade in the evening.",
        ...
        Chronotype(
            ...
            description: "The majority chronotype. Follows the solar cycle closely. Most productive mid-morning to early afternoon.",
        ...
        Chronotype(
            ...
            icon: "moon.fill",
            color: Color(hex: "#5C6BC0"),
            description: "Night owls. Peak creativity and energy in the evening. Morning is difficult. Often most productive after 5 PM.",
        ...
        Chronotype(
            ...
            description: "Light sleepers with irregular patterns. Often anxious or perfectionistic. Peak productivity comes in bursts.",
...
extension CircadianAnchor {
    ...
    static let anchors: [CircadianAnchor] = [
        ...
        CircadianAnchor(
            ...
            icon: "sun.max.fill",
            description: "The single most powerful circadian anchor. Morning light exposure sets the master clock for the entire day.",
            howTo: "Get 10-30 minutes of sunlight exposure within 1 hour of waking. Overcast counts (still 10,000+ lux). No sunglasses. Direct sun on face and eyes.",
            scienceBehind: "Morning light triggers melanopsin receptors in the eye, which signal the suprachiasmatic nucleus (SCN) to reset the circadian clock. This sets the timer for melatonin release 14-16 hours later.",
            priority: 1
        ),
        ...
        CircadianAnchor(
            ...
            icon: "alarm.fill",
            description: "More important than bedtime. Your wake time anchors the entire circadian system. Variation disrupts everything.",
            howTo: "Wake at the same time every day, including weekends. ±30 minutes maximum variation. If you need more sleep, go to bed earlier - don't sleep in.",
            scienceBehind: "The circadian system runs on a 24.2-hour cycle. Without consistent anchoring, it drifts later each day. Consistent wake time prevents this drift.",
            priority: 2
        ),
        ...
        CircadianAnchor(
            ...
            icon: "fork.knife",
            description: "Peripheral clocks in organs are set by meal timing. Erratic eating confuses the system.",
            howTo: "Eat within a consistent 10-12 hour window each day. First meal and last meal at roughly the same times. Avoid eating within 3 hours of sleep.",
            scienceBehind: "Peripheral oscillators in the liver, gut, and other organs are entrained by food intake. Consistent meal timing synchronizes these clocks with the master clock.",
            priority: 3
        ),
        ...
        CircadianAnchor(
            ...
            icon: "moon.fill",
            description: "Artificial light after sunset delays melatonin release. Darkness is the signal for sleep preparation.",
            howTo: "Dim lights 2-3 hours before bed. Use red/amber light. Blue light blocking glasses if screens are necessary. Make bedroom completely dark.",
            scienceBehind: "Light suppresses melatonin production via the same melanopsin pathway. Even dim artificial light (100 lux) significantly delays melatonin onset.",
            priority: 4
        ),
        ...
        CircadianAnchor(
            ...
            description: "Body temperature drops at night and rises in the morning. Working with this rhythm improves sleep quality.",
            howTo: "Cool bedroom (65-68°F). Hot bath 1-2 hours before bed (the subsequent cooling helps sleep onset). Morning exercise or cold exposure to raise temperature.",
            scienceBehind: "Core body temperature needs to drop 2-3°F to initiate sleep. The circadian system controls this rhythm. Artificial manipulation can shift timing.",
            priority: 5
        ),
        ...
        CircadianAnchor(
            ...
            icon: "figure.run",
            description: "Exercise is a powerful circadian anchor. Timing matters - morning exercise advances the clock, evening exercise delays it.",
            howTo: "Exercise at the same time each day. Morning exercise is best for most people. Avoid intense exercise within 3 hours of bedtime.",
            scienceBehind: "Exercise raises core body temperature and releases cortisol. These signals help entrain the circadian system. Consistent timing reinforces the rhythm.",
            priority: 6
        )
...
extension SleepStage {
    ...
    static let stages: [SleepStage] = [
        ...
        SleepStage(
            ...
            function: "Physical restoration. Growth hormone release. Immune function. Cellular repair. Memory consolidation.",
        ...
        SleepStage(
            ...
            function: "Emotional processing. Procedural memory. Creativity and insight. Dreams. Brain 'defragmentation'.",
            disrupts: ["Alcohol (strongly suppresses)", "Cannabis", "Antidepressants (some)", "Early waking"]
        )
