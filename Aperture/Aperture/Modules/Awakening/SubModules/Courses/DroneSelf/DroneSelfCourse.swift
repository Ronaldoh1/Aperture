...
""",
                    keyInsight: "The inventor of the microprocessor proved that consciousness cannot be reduced to computation — it's the field that makes computation possible.",
                    exercise: DroneExercise(
                        title: "The Awareness Location Test",
                        prompt: "Close your eyes. Notice you are aware. Now ask: WHERE is this awareness located? Is it in your head? Your chest? Can you find its edges? Notice that awareness itself has no location — it's the space in which locations appear.",
                        duration: "5 minutes"
                    )
                ),
...
""",
                    keyInsight: "All of quantum physics can be derived from information theory — meaning information (and consciousness) is more fundamental than matter.",
                    exercise: DroneExercise(
                        title: "The Qualia Location Test",
                        prompt: "Look at something red. Follow the experience: light hits your retina → electrical signals travel the optic nerve → visual cortex processes them → and then... WHERE is the redness? Not the wavelength. The EXPERIENCE of red. Can you find it in your neurons? Or is it in the field that's reading those neurons?",
                        duration: "3 minutes"
                    )
                )
            ]
...
""",
                    keyInsight: "Your body is an interface (drone) operated by your consciousness field (pilot). Most people live entirely on autopilot.",
                    exercise: DroneExercise(
                        title: "The Drone Journal — Day 1",
                        prompt: "For the next hour, observe your body as if it were a drone you're piloting. Track: (1) What sensor data is coming in? (2) What instructions are you sending? (3) When does autopilot take over? Write down every moment you catch yourself on autopilot vs. conscious piloting.",
                        duration: "1 hour"
                    )
                ),
...
""",
                    keyInsight: "Near-death experience evidence aligns perfectly with the drone model — consciousness persists and expands when the body-interface shuts down.",
                    exercise: DroneExercise(
                        title: "The Interface Gratitude Practice",
                        prompt: "Consider your body as an interface you chose. What unique data does THIS interface provide? What can you experience through these exact senses, this exact body, this exact life situation that no other interface could? Write a brief gratitude letter to your drone for the data it provides.",
                        duration: "10 minutes"
                    )
                ),
...
""",
                    keyInsight: "Awakening exists on a spectrum from deep autopilot to full field awareness. The practice is noticing when autopilot takes over and choosing to pilot consciously.",
                    exercise: DroneExercise(
                        title: "The Autopilot Detector",
                        prompt: "Set 5 random alarms throughout tomorrow. When each alarm goes off, immediately ask: 'Was I on autopilot or conscious piloting?' Don't judge — just notice. Track the ratio. Most people discover they're on autopilot 80%+ of the day.",
                        duration: "Full day"
                    )
                )
            ]
...
""",
                    keyInsight: "The brain-as-computer model fails because cells are holographic, experience is unified, and qualia cannot be computed — only experienced.",
                    exercise: DroneExercise(
...
""",
                    keyInsight: "Quantum information theory proves information is more fundamental than matter — and consciousness is the field that gives quantum information its meaning through the act of free will choice.",
                    exercise: DroneExercise(
                        title: "The Choice Awareness Practice",
                        prompt: "For the next 30 minutes, notice every CHOICE you make — no matter how small. Reaching for your phone: choice. Breathing deeper: choice. Thinking about the future: choice (or is it? autopilot thought?). Each conscious choice is a quantum collapse — you selecting one reality from infinite possibilities.",
                        duration: "30 minutes"
                    )
                ),
...
""",
                    keyInsight: "Your inner experience is quantum information — unclonable, irreducible, infinitely richer than any classical description. This is mathematically proven, not philosophy.",
                    exercise: DroneExercise(
                        title: "The Representation Gap",
                        prompt: "Choose an intense experience from your past. Try to describe it completely in words — every detail, every feeling, every nuance. Then notice: how much was LOST in translation? That gap between experience and description is the gap between quantum and classical information. It's infinite.",
                        duration: "10 minutes"
                    )
                )
            ]
...
""",
                    keyInsight: "Cells are quantum-classical bridges. Quantum biology proves your body is not merely a classical machine but a quantum interface designed to translate field consciousness into physical experience.",
                    exercise: DroneExercise(
...
""",
                    keyInsight: "Reality is made of fields, not particles. Consciousness is the most fundamental field — and individual awareness is a localized excitation of universal consciousness.",
                    exercise: DroneExercise(
                        title: "The Wave Identity Practice",
                        prompt: "Next time you look at another person, try this shift: instead of seeing two separate bodies (particles), see two waves in the same ocean of consciousness. You're both temporary patterns in one field. Notice how this changes the feeling of separation.",
...
""",
                    keyInsight: "Space is the memory of cosmic self-knowledge expanding. The present moment is the only point where consciousness interfaces with reality. Being present IS piloting.",
                    exercise: DroneExercise(
                        title: "The Now Point Practice",
                        prompt: "For 2 minutes, notice: everything you experience is happening NOW. Your memory of 5 seconds ago? You're remembering NOW. Your plan for tomorrow? You're planning NOW. Can you actually find a moment that isn't now? This 'now point' is where you — the field — interface with reality. Rest there.",
                        duration: "2 minutes"
                    )
                )
            ]
...
""",
                    keyInsight: "Transformation comes from daily practice, not one-time insight. Track your Pilot-to-Autopilot Ratio (PAR) and watch it shift over weeks.",
                    exercise: DroneExercise(
                        title: "The Full Protocol — Day 1",
                        prompt: "Implement the complete protocol today: Morning boot-up (5 min), 3 midday checks (30 sec each), evening debrief (5 min). That's only ~12 minutes of active practice. Track your PAR estimate at end of day.",
...
""",
                    keyInsight: "Meditation, nature, creative flow, dream work, and conscious physical practice all optimize the connection between your consciousness field and your body-interface.",
                    exercise: DroneExercise(
                        title: "The Signal Clarity Test",
                        prompt: "Try two versions of the same activity today: (1) Eat one meal on autopilot — phone in hand, distracted, eating fast. (2) Eat one meal as pilot — no distractions, full attention on taste, texture, the experience of nourishment. Compare. The difference in experience IS the difference in signal clarity.",
                        duration: "Two meals"
                    )
                ),
...
""",
                    keyInsight: "The five traps: spiritual ego, interface obsession, signal confusion, guru fallacy, and dissociation. Real awakening is grounded, humble, and always tested against direct experience.",
                    exercise: DroneExercise(
...
""",
                    keyInsight: "Faggin's theory is scientific because it's falsifiable. Current evidence supports field-based consciousness, but remains open to disproof.",
                    exercise: DroneExercise(
                        title: "The Personal Falsification Test",
                        prompt: "What would prove the drone model wrong FOR YOU? Not intellectually — experientially. What experience would you need to have to be convinced your consciousness IS your brain and nothing more? Can you even conceive of such an experience? If not, why not?",
                        duration: "Reflection"
                    )
                ),
...
""",
                    keyInsight: "Personal experiments in free will detection, field resonance, lucid dreaming, and meditation can provide direct experiential evidence — but only if you remain honestly open to whatever you find.",
                    exercise: DroneExercise(
                        title: "Choose Your Experiment",
                        prompt: "Select ONE experiment from this lesson and commit to running it this week. Write down: (1) What you expect to find. (2) What would change your mind. (3) Your honest results after running it. This IS science — personal, rigorous, honest.",
                        duration: "1 week"
                    )
                )
            ]
...
""",
                    keyInsight: "When consciousness fields resonate, they co-create beyond individual capacity. Society designed from field awareness would prioritize cooperation, presence-based education, and technology that enhances connection.",
                    exercise: DroneExercise(
                        title: "The Co-Creation Experiment",
                        prompt: "Find one person willing to experiment. Sit facing each other in silence for 5 minutes. Then, without planning, create something together — draw, write, cook, play music. Notice: does the result feel like it came from either of you individually? Or from a third thing — the resonance between your fields?",
                        duration: "30 minutes"
                    )
                ),
...
""",
                    keyInsight: "You exist because the universal consciousness needs YOUR unique perspective to know itself. Your life is irreplaceable cosmic data. Awakening is remembering you're both the unique perspective AND the whole.",
                    exercise: DroneExercise(
                        title: "The Perspective Meditation",
                        prompt: "Sit quietly and consider: What can the One experience through YOUR interface that it could never experience through any other? What is YOUR unique angle on existence? Don't rush this. Let the answer come from the field, not the mind. Write it down — this is your mission statement.",
                        duration: "20 minutes"
                    )
                )
            ]
...
struct DroneProgress: Codable {
    ...
    static var `default`: DroneProgress { DroneProgress(completedLessons: [], lastAccessed: nil, pilotRatio: nil) }
}
