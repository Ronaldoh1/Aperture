...
struct ScoringRubricView: View {
  ...
  private var headerSection: some View {
    VStack(spacing: 16) {
      ...
      Text(
        "We believe voters deserve complete transparency. Here's exactly how we calculate Integrity Scores."
      )
      .font(.system(size: 14))
  ...
  private var philosophySection: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      VStack(alignment: .leading, spacing: 12) {
        philosophyPoint(
          "Follow the Money", "Campaign funding reveals true allegiances better than speeches.")
        philosophyPoint("Actions Over Words", "Voting records matter more than campaign promises.")
        philosophyPoint(
          "Institutional Connections",
          "Think tank and NGO affiliations indicate ideological capture.")
        philosophyPoint(
          "Transparency Matters", "Candidates who hide funding sources have something to hide.")
      }
    }
    .padding()
  ...
  private var scoringCategories: [ScoringCategory] {
    [
      ScoringCategory(
        ...
        criteria: [
          ScoringCriterion(
            points: 20, requirement: "70%+ from small donors", example: "Bernie Sanders 2020: 60%"),
          ...
          ScoringCriterion(
            points: 0, requirement: "<15% from small donors", example: "Most incumbents"),
        ],
      ...
      ScoringCategory(
        ...
        criteria: [
          ...
          ScoringCriterion(
            points: 0, requirement: "<40% alignment", example: "Says one thing, votes another"),
        ],
