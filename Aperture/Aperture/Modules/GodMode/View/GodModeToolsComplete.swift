...
extension SATSChamberFullView.SATSPhase: CaseIterable {
  static var allCases: [SATSChamberFullView.SATSPhase] = [
    .preparation, .relaxation, .visualization, .feeling, .completion,
  ]
}
...
struct SolarSyncFullView: View {
        ...
        ScrollView {
          VStack(spacing: 24) {
            ...
            VStack(spacing: 8) {
              ...
              Text(
                "Only practice sun gazing during safe hours (first/last hour of daylight). Start with 10 seconds, increase gradually. Never look directly at bright sun."
              )
              .font(.caption2)
              .foregroundStyle(.white.opacity(0.6))
              .multilineTextAlignment(.center)
  ...
  private func protocolDescription(_ proto: SolarProtocol) -> String {
    switch proto {
    case .sungazing:
      return "Gaze at sun during safe hours. Start 10 sec, add 10 sec daily. Max 44 minutes."
    case .morningLight: return "Get bright light exposure within 30 min of waking. No sunglasses."
    case .pinealActivation:
      return "Visualize sunlight entering third eye during sunrise/sunset meditation."
...
struct BardoNavigatorFullView: View {
  ...
  let stages = [
    (
      ...
      "Clear Light of Reality appears. Recognize it as your own mind."
    ),
    (
      "🌀", "Chonyid Bardo", "Reality hallucinations",
      "Peaceful and wrathful deities appear. They are projections of your mind."
    ),
    (
      "🔄", "Sidpa Bardo", "Rebirth process",
      "Karmic visions lead to next incarnation. Maintain awareness to choose wisely."
    ),
  ]
          ...
          VStack(spacing: 24) {
            ...
            VStack(spacing: 8) {
              Text("🔑 KEY TEACHING")
                ...
                .foregroundStyle(Color(hex: "FFD700"))
              Text(
                "\"All appearances are projections of your own mind. Recognize this and you are free.\""
              )
              .font(.caption)
              .italic()
...
struct VibrationShieldFullView: View {
                ...
                Button(action: { selectedShield = shield }) {
                  ...
                  .background(
                    selectedShield == shield
                      ? Color(hex: "00BFFF").opacity(0.1) : Color.white.opacity(0.05)
                  )
                  .cornerRadius(12)
                }
                .buttonStyle(.plain)
  ...
  private func shieldVisualization(_ shield: ShieldType) -> String {
    ...
    case .mirror:
      return
        "Visualize a mirror surrounding your body. Any negative energy sent your way reflects back to its source, transformed."
    case .golden:
      return
        "See yourself inside a golden egg of light. This egg filters out all negative energy while allowing love and positivity through."
    case .violet:
      return
        "Invoke the violet flame of transmutation. See it burning around you, transforming all lower energies into light."
    case .grounding:
      return
        "Visualize roots extending from your feet deep into the Earth. Feel the stable, nurturing energy rising up through your body."
    case .bubble:
      return
        "Create a bubble of pure white light around you. This bubble is permeable only to high-vibration energy."
    }
  }
}
