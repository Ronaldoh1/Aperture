...
struct AwakeningArsenalData {
    ...
    static let kundalini = AwakeningMethod(
        ...
        **Warning:** Kundalini awakening can be intense. Build gradually and seek guidance from experienced teachers if symptoms become overwhelming.
        ...
        resources: [
            AwakeningResource(id: "kr1", title: "The Serpent Power", type: .book, url: nil, description: "Classic text by Arthur Avalon on Kundalini"),
            AwakeningResource(id: "kr2", title: "Kundalini Yoga as Taught by Yogi Bhajan", type: .book, url: nil, description: "Comprehensive practice guide"),
            AwakeningResource(id: "kr3", title: "Spiritual Emergency Network", type: .community, url: "https://spiritualemergence.org", description: "Support for intense spiritual experiences")
        ],
    ...
    static let taoism = AwakeningMethod(
        ...
        resources: [
            AwakeningResource(id: "tr1", title: "The Tao Te Ching", type: .book, url: nil, description: "Foundation text by Lao Tzu"),
            AwakeningResource(id: "tr2", title: "The Root of Chinese Qigong", type: .book, url: nil, description: "By Dr. Yang Jwing-Ming"),
            AwakeningResource(id: "tr3", title: "Mantak Chia teachings", type: .website, url: "https://mantakchia.com", description: "Universal Healing Tao system")
        ],
        voiceGuidanceAvailable: true
    )
    ...
    static let christianity = AwakeningMethod(
        ...
        resources: [
            AwakeningResource(id: "cr1", title: "The Cloud of Unknowing", type: .book, url: nil, description: "14th century mystical classic"),
            AwakeningResource(id: "cr2", title: "Open Mind, Open Heart", type: .book, url: nil, description: "Thomas Keating on Centering Prayer"),
            AwakeningResource(id: "cr3", title: "Contemplative Outreach", type: .community, url: "https://contemplativeoutreach.org", description: "Centering Prayer community")
        ],
        voiceGuidanceAvailable: true
    )
    ...
    static let buddhism = AwakeningMethod(
        ...
        resources: [
            AwakeningResource(id: "br1", title: "Mindfulness in Plain English", type: .book, url: nil, description: "Bhante Gunaratana - excellent intro"),
            AwakeningResource(id: "br2", title: "The Mind Illuminated", type: .book, url: nil, description: "Comprehensive meditation manual"),
            AwakeningResource(id: "br3", title: "Dharma Seed", type: .website, url: "https://dharmaseed.org", description: "Free meditation talks")
        ],
        voiceGuidanceAvailable: true
    )
