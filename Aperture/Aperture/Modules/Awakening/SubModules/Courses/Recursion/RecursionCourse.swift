      ...
      lessons: [
        RecursionLesson(
          ...
          codeExample: """
            ...
            """,
          realWorldExample:
            "Russian nesting dolls (matryoshka): each doll contains a smaller version of itself"
        ),
        ...
        RecursionLesson(
          ...
          codeExample: """
            ...
            """,
          realWorldExample:
            "Romanesco broccoli: zoom in on any part and you see the same spiral pattern"
        ),
        ...
        RecursionLesson(
          ...
          codeExample: """
            ...
            """,
          realWorldExample:
            "A painting of an artist painting the same painting—infinite regression of self-reference"
        ),
      ]
    ),
      ...
      lessons: [
        ...
        RecursionLesson(
          ...
          codeExample: """
            ...
            """,
          realWorldExample:
            "A seed contains the pattern of the whole tree, which creates seeds that contain the pattern..."
        ),
      ]
    ),
      ...
      lessons: [
        ...
        RecursionLesson(
          ...
          codeExample: """
            ...
            """,
          realWorldExample:
            "You, right now, reading about recursion—which is the universe learning about its own patterns through your eyes"
        ),
      ]
    ),
  ]
...
struct RecursionProgress: Codable {
  ...
  static var `default`: RecursionProgress {
    RecursionProgress(completedLessons: [], lastAccessed: nil)
  }
}
