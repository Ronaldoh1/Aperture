...
struct MatrixEducationView: View {
            ...
            VStack(spacing: 0) {
                ...
                HStack {
                    VStack(alignment: .leading, spacing: 4) {
                        Text("The Matrix Decoded").font(.system(size: 20, weight: .bold, design: .rounded)).foregroundColor(Palette.text.primary)
                        Text("Understanding the system is the first step").font(.system(size: 13, weight: .medium, design: .rounded)).foregroundColor(Palette.primary.red)
                    }
                    Spacer()
    ...
    private var headerSection: some View {
        VStack(spacing: 16) {
            ZStack {
                Circle()
                    .fill(RadialGradient(colors: [Palette.primary.red.opacity(0.4), Color.clear], center: .center, startRadius: 0, endRadius: 50))
            ...
            Text("Most people think awakening means discovering a hidden layer.\nIt usually means seeing that the layers exist at all.")
    ...
    private var progressSection: some View {
        VStack(spacing: 12) {
            ...
            GeometryReader { geo in
                ZStack(alignment: .leading) {
                    ...
                    RoundedRectangle(cornerRadius: 5)
                        .fill(LinearGradient(
                            colors: [Palette.primary.red, Palette.primary.orange, Palette.accent.gold, Color.green, Palette.primary.cyan],
                            startPoint: .leading,
                            endPoint: .trailing
                        ))
        ...
        .background(
            RoundedRectangle(cornerRadius: 14, style: .continuous)
                ...
                .overlay(RoundedRectangle(cornerRadius: 14, style: .continuous).stroke(Palette.primary.cyan.opacity(0.2), lineWidth: 1))
        )
    }
    ...
    private var importantInsight: some View {
        VStack(alignment: .leading, spacing: 12) {
            HStack(spacing: 8) {
                ...
                Text("KEY INSIGHT").font(.system(size: 12, weight: .bold, design: .rounded)).tracking(1).foregroundColor(Palette.primary.cyan)
            }
            
            Text("You do not smash the Matrix. You debug it.\n\nThe exit is not rage or rejection. It is pattern recognition, boundary setting, and reclaiming agency one layer at a time.")
                .font(.system(size: 14, weight: .medium, design: .rounded))
                .foregroundColor(Palette.text.primary)
                .lineSpacing(5)
        }
        ...
        .background(
            RoundedRectangle(cornerRadius: 14, style: .continuous)
                ...
                .overlay(RoundedRectangle(cornerRadius: 14, style: .continuous).stroke(Palette.primary.cyan.opacity(0.3), lineWidth: 1))
        )
    }
