    ...
    ZStack {
      ...
      TabView(selection: $selectedTab) {
        ...
        .tabItem {
          Label(
            "Timeline",
            systemImage: selectedTab == 1 ? "clock.arrow.circlepath" : "clock.arrow.circlepath")
        }
        .tag(1)
        ...
        MoreView(selectedTab: $selectedTab)
          .tabItem {
            Label(
              "More", systemImage: selectedTab == 5 ? "ellipsis.circle.fill" : "ellipsis.circle")
          }
          .tag(5)
      }
...
struct AwakeningTabView: View {
  ...
  init() {
    ...
    presenter = AppContainer.shared.container.resolve(AwakeningPresenterType.self)!
  }
