  ...
  private var whyPodcastsSection: some View {
    VStack(alignment: .leading, spacing: 16) {
      ...
      VStack(alignment: .leading, spacing: 12) {
        whyRow(
          "🚇", "Commute Alchemy",
          "Transform dead time into growth time. Subway rides become enlightenment portals.")
        whyRow(
          "🔄", "Passive Rewiring",
          "Audio bypasses the critical mind. Wisdom absorbs while you're 'just listening.'")
        whyRow(
          "🌍", "Global Teachers",
          "Access masters you'd never meet in person. The world's best, in your pocket.")
        whyRow(
          "📴", "Offline Ready", "Download episodes. No Wi-Fi? No problem. Growth happens anywhere.")
        whyRow(
          "🧠", "Repetition = Integration",
          "Re-listen to episodes that hit. Each time, you hear something new.")
      }
    }
    .padding()
