...
struct LayerDetailView: View {
        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                HStack {
                    ...
                    Spacer()
                    Text("Layer \(layer.id)").font(.system(size: 14, weight: .bold, design: .rounded)).foregroundColor(Palette.text.muted)
                    Spacer()
                    if isCompleted {
                        Image(systemName: "checkmark.circle.fill").font(.system(size: 24)).foregroundColor(Color.green)
                    } else {
    ...
    private var headerSection: some View {
        VStack(spacing: 16) {
            ZStack {
                Circle()
                    .fill(RadialGradient(colors: [layer.color.opacity(0.4), layer.color.opacity(0.05)], center: .center, startRadius: 0, endRadius: 45))
    ...
    private var questionsSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            sectionHeader("QUESTIONS TO ASK YOURSELF", icon: "questionmark.circle.fill", color: Palette.accent.gold)
...
struct LayerIntegrationSheet: View {
    ...
    private func integrationOption(icon: String, title: String, subtitle: String, color: Color, action: @escaping () -> Void) -> some View {
