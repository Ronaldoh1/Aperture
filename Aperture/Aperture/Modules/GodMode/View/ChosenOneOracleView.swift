              ...
              Button(action: {
                ...
                if currentQuestion < questions.count - 1 {
                  ...
                  let archetypes: [String: ChosenArchetype] = [
                    "Prophet": ChosenArchetype(
                      name: "The Prophet", icon: "👁️", description: "You see what others cannot.",
                      traits: [], mission: "", color: Color(hex: "9B59B6")),
                    "Hermit": ChosenArchetype(
                      name: "The Hermit", icon: "🏔️", description: "You find wisdom in solitude.",
                      traits: [], mission: "", color: Color(hex: "34495E")),
                    "Healer": ChosenArchetype(
                      name: "The Healer", icon: "💚", description: "You transform others' pain.",
                      traits: [], mission: "", color: Color(hex: "27AE60")),
                    "Empath": ChosenArchetype(
                      name: "The Empath Soul", icon: "🌊",
                      description: "You feel the collective field.", traits: [], mission: "",
                      color: Color(hex: "3498DB")),
                    "Endurer": ChosenArchetype(
                      name: "The Endurer", icon: "⚔️", description: "Your scars are wisdom.",
                      traits: [], mission: "", color: Color(hex: "7D3C98")),
                    "Rebel": ChosenArchetype(
                      name: "The Rebel", icon: "🔥", description: "You refuse to comply.",
                      traits: [], mission: "", color: Color(hex: "E74C3C")),
                    "Warrior": ChosenArchetype(
                      name: "The Warrior", icon: "🛡️", description: "You defend the innocent.",
                      traits: [], mission: "", color: Color(hex: "F39C12")),
                    "Seeker": ChosenArchetype(
                      name: "The Seeker", icon: "🔍", description: "You seek hidden truth.",
                      traits: [], mission: "", color: Color(hex: "1ABC9C")),
                  ]
