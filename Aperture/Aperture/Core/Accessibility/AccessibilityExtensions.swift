...
extension View {
    ...
    func accessibleLoading(_ isLoading: Bool, message: String = "Loading") -> some View {
        self.onChange(of: isLoading) { _, loading in
            if loading {
...
extension View {
    ...
    /// Make dragon companion accessible
    func accessibleDragonCompanion(
        isVisible: Bool,
        currentMessage: String?
    ) -> some View {
        let label = "Dragon companion"
        let value = currentMessage ?? "Ready to guide you"
        
        return self
            .accessibilityLabel(label)
            .accessibilityValue(value)
            .accessibilityHint("Your awakening guide. Swipe to interact.")
    }
    ...
    func accessibleTimelineEra(
        ...
        return self
            .accessibilityLabel("\(title), \(year). \(status)")
