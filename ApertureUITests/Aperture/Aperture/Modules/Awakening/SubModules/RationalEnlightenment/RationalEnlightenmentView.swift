      ...
      VStack(spacing: 24) {
        ...
        VStack(alignment: .leading, spacing: 16) {
          ...
          principleCard(
            ...
            desc:
              "Every insight backed by cognitive science, neuropsych, and peer-reviewed research.")
          principleCard(
            icon: "🔢", title: "Data-Driven",
            desc: "Transform intuition into measurable metrics. Track progress empirically.")
          principleCard(
            icon: "🧪", title: "Testable Hypotheses",
            desc: "Frame beliefs as experiments. Gather evidence. Update models.")
          principleCard(
            icon: "🚫", title: "Zero Woo-Woo",
            desc: "No chakras, no spirits, no faith leaps. Just neurons and neural networks.")
        }
    ...
    ScrollView {
      VStack(spacing: 16) {
        ...
        NavigationLink(destination: NeuralCorrelatesMapView()) {
          toolCard(
            icon: "🧠", title: "Neural Correlates Map", desc: "Brain regions and their functions")
        }
  ...
  private func exerciseCard(_ exercise: RationalExercise, isPremium: Bool = false) -> some View {
    HStack(spacing: 16) {
      Text(exercise.icon)
        ...
        .background(
          isPremium ? Color(hex: "FFD700").opacity(0.2) : Color(hex: "27AE60").opacity(0.2)
        )
        .cornerRadius(12)
...
struct RationalExercise: Identifiable {
  ...
  static let freeExercises: [RationalExercise] = [
    RationalExercise(
      ...
      fullDescription:
        "Log a recent decision and systematically identify potential cognitive biases that may have influenced it. This trains your meta-cognitive awareness.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "Visualize brain regions via diagrams; note emotions and link to neural functions. Builds self-awareness through neuroscience, not spirits.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "Transform a personal belief into a testable hypothesis. Gather evidence for and against it daily. Trains scientific skepticism applied to your own mind.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "Recall a habit or impulse and trace it to potential evolutionary origins. Understanding why we have certain drives demystifies 'inner demons.'",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "Estimate the odds of a worry actually occurring, then update with Bayesian reasoning. Empirically reduces anxiety by confronting actual probabilities.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "Timed silence where you observe and categorize thoughts as logical or illogical. Reveals the noise in your mental processes—no spiritual framing needed.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "List a perceived flaw and reframe it as an adaptive trait. Use evolutionary lens for self-acceptance based on function, not judgment.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "Track physical cues (pulse, tension, temperature) and correlate them to mental states. Somatic science without the mysticism.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "Log positive events and quantify their impact on your mood using a simple scale. Evidence-based approach to the 'gratitude' practice.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "Each day, question one assumption you hold. Research a quick fact-check. Builds the habit of intellectual humility and continuous learning.",
      steps: [
  ...
  static let premiumExercises: [RationalExercise] = [
    RationalExercise(
      ...
      fullDescription:
        "Input a scenario and let AI models identify common cognitive traps, suggesting countermeasures based on psychological studies.",
      steps: [
      ...
      scienceSource:
        "AI model trained on Cognitive Bias Codex (Benson, 2016) and behavioral economics literature.",
      isPremium: true
    ),
    RationalExercise(
      number: 12,
      ...
      fullDescription:
        "AI generates perspectives from different brain models—experience a 'debate' between your prefrontal cortex and limbic system.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "Log dreams and receive AI correlation to sleep science—REM patterns, memory consolidation—without any mystical interpretation.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "AR overlays probability waves on your decisions. AI explains quantum metaphors for interconnectedness and uncertainty—no mysticism, just physics analogies.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "Guided isolation with biofeedback monitoring. AI analyzes stress data patterns to identify when insights typically emerge.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "Model your repressed traits as variables in an equation. AI solves for integration equilibria—Jung's shadow work, quantified.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "AI maps your emotional triggers to life data and uses regression analysis to predict future trigger events.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "AI proposes math-inspired creative expressions—fractal art for chaos theory, golden ratio compositions. Upload for algorithmic refinement.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "Virtual group discussions with AI moderation ensuring debates stay grounded in sources. No echo chambers, only evidence.",
      steps: [
    ...
    RationalExercise(
      ...
      fullDescription:
        "AI simulates alternate outcomes via probabilistic branching. Enhances decision foresight by exploring the many worlds of your choices.",
      steps: [
