...
struct RealPhysicsView: View {
    ...
    let topics: [(String, String, String)] = [
        ("⚡", "Electric Universe Theory", "Gravity is not the dominant force. Electromagnetic forces shape galaxies, stars, and planets."),
        ("🌀", "Vortex Mathematics", "The universe operates through vortex dynamics. Marko Rodin's work reveals hidden patterns."),
        ("💫", "Ether/Aether Physics", "Space is not empty. The ether was removed from physics for control, not science."),
        ("🧲", "Suppressed Free Energy", "Tesla, Schauberger, and others discovered energy technologies that threatened oil interests."),
        ("📐", "Sacred Geometry in Nature", "Fibonacci, phi, and platonic solids aren't coincidence. They're the architecture of reality."),
        ("🌊", "Cymatics", "Sound creates form. Water, sand, and matter organize into geometric patterns through vibration."),
        ("⏱️", "Time as Illusion", "Linear time is a construct. All moments exist simultaneously. Physics increasingly confirms this."),
        ("🔭", "Plasma Cosmology", "Stars are not nuclear furnaces. They're electrical phenomena in a cosmic plasma network.")
    ]
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            Text("Dr. David Hawkins calibrated human consciousness on a logarithmic scale from 1-1000. Below 200 is destructive; above 200 is constructive. Each level has its own emotional signature and life view.")
                                .font(.caption)
                        ...
                        VStack(spacing: 8) {
                            ...
                            Text("200 (Courage) is the dividing line between power and force. Above 200, you contribute to the world. Below 200, you drain it.")
                                .font(.caption)
                                .foregroundStyle(.white.opacity(0.8))
                                .multilineTextAlignment(.center)
                        }
...
struct NutritionAwakeningView: View {
    ...
    let truths: [(String, String, String)] = [
        ("🌾", "Wheat/Gluten", "Modern wheat is hybridized beyond recognition. Gluten damages gut lining, causes brain fog."),
        ("🥛", "Dairy Industry", "Humans don't need cow's milk. It's inflammatory, full of hormones and pus."),
        ("🍬", "Sugar Addiction", "Sugar is 8x more addictive than cocaine. It's in everything by design."),
        ("🧪", "Seed Oils", "Canola, soybean, corn oils are inflammatory. They didn't exist 100 years ago."),
        ("💊", "Vitamin Deficiency", "Modern farming depletes soil. Most people are deficient in D3, magnesium, B12."),
        ...
        ("💧", "Water Fluoridation", "Fluoride calcifies the pineal gland. It was Nazi-era population control tech.")
    ]
    
    let pinealFoods = ["Raw cacao", "Chlorella", "Spirulina", "Apple cider vinegar", "Lemon water", "Oregano oil", "Iodine", "Turmeric"]
...
struct DivisionDeprogrammingView: View {
    ...
    let divisions: [(String, String, String)] = [
        ("🔴🔵", "Left vs Right", "Same puppet masters, different puppets. They agree on war, surveillance, corporate welfare."),
                    ...
                    VStack(spacing: 24) {
                        ...
                        VStack(spacing: 8) {
                            Text("🔑 THE KEY INSIGHT")
                                .font(.caption)
                                .foregroundStyle(Color(hex: "FFD700"))
                            Text("If they can keep you fighting your neighbor, you won't notice who's robbing the house.")
                                .font(.body)
                                .italic()
...
struct AwakeningFoundationsView: View {
    ...
    let laws: [(String, String, String)] = [
        ...
        ("14", "Correspondence", "Patterns repeat across all scales. Understand one level, understand all.")
    ]
