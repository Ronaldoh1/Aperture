...
class ToxicDrinksDatabase: ObservableObject {
  ...
  private func loadDrinks() {
    drinks = [
      ...
      ToxicDrink(
        ...
        harmfulIngredients: [
          .init(
            name: "Aspartame", effect: "Neurotoxin, breaks down into methanol and formaldehyde"),
        ...
        reality:
          "Zero sugar, maximum chemicals. Aspartame is classified as 'possibly carcinogenic' by WHO.",
      ...
      ToxicDrink(
        ...
        harmfulIngredients: [
          ...
          .init(
            ...
            effect: "Banned in EU/Japan, accumulates in tissues"),
          .init(
            name: "Yellow 5 (Tartrazine)",
            effect: "Hyperactivity, allergies, possibly lowers sperm count"),
        ...
        reality:
          "Contains an ingredient banned in over 100 countries. 'Mountain Dew Mouth' is a documented condition.",
      ...
      ToxicDrink(
        ...
        reality:
          "Red Bull gives you cardiovascular stress. Banned or restricted in several countries.",
      ...
      ToxicDrink(
        ...
        harmfulIngredients: [
          .init(
            name: "Sugar/Dextrose",
            effect: "36g sugar - designed for elite athletes, not desk workers"),
      ...
      ToxicDrink(
        ...
        harmfulIngredients: [
          ...
          .init(
            name: "Contains only 2% juice", effect: "It's basically orange-colored sugar water"),
        ],
        healthEffects: [
      ...
      ToxicDrink(
        ...
        harmfulIngredients: [
          .init(
            name: "Concentrated Fruit Sugars", effect: "53g sugar - all 'natural' but still sugar"),
  ...
  func searchDrinks(_ query: String) -> [ToxicDrink] {
    ...
    return drinks.filter {
      $0.name.lowercased().contains(searchTerm) || $0.brand.lowercased().contains(searchTerm)
    }
  }
}
