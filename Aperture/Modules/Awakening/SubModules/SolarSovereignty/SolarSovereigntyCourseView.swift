        ...
        return VStack(spacing: 12) {
            ...
            HStack(spacing: 6) {
                ForEach(0..<7, id: \.self) { i in
                    ...
                    let completed = streak?.completionHistory.contains { Calendar.current.isDate($0, inSameDayAs: date) } ?? false
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            ZStack {
                ...
                // Gene cycle
                ForEach(Array(zip(["BMAL1", "CLOCK", "PER", "CRY"].indices, ["BMAL1", "CLOCK", "PER", "CRY"])), id: \.0) { index, gene in
