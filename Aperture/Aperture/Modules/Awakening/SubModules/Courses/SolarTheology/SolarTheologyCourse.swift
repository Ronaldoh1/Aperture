...
struct SolarTheologyCourseContent {
    
    static let course = SolarTheologyCourse(
        id: "solar_theology",
        title: "Solar Theology",
        subtitle: "The Astrotheological Origins of Religion",
        description: "Discover how the world's major religions trace back to ancient sun worship, Hindu traditions, and Egyptian mysticism. Nothing is as it seems.",
            ...
            lessons: [
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "What if the founding patriarch of Judaism was never a real person, but a borrowed concept from a much older tradition?",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .etymology,
                            content: "In India, the highest priests who represented God were called BRAHMANS. The supreme creator deity was BRAHMA.",
                            revealContent: "Put an 'A' in front of Brahman... and you get A-BRAHM. The Bible itself tells us Abraham's original name was ABRAM before becoming Abraham.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .comparison,
                            ...
                            comparison: SymbolComparison(
                                ...
                                connection: "Both are the 'founding fathers' of their traditions. Both names share the same root: BRM/BRHM."
                            )
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"The Brahman priests in India had a very special river that they would bathe in, called the waters of God. That river was called the Saraswati River. So there you have it—Abraham and Sarah. No, it's Brahman and Saraswati.\"",
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "The six-pointed star is perhaps the most recognizable symbol of Judaism. But its origins tell a very different story.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .reveal,
                            content: "The six-pointed star, the 'Star of David,' was originally a Hindu symbol. It was later adopted by the Buddhists.",
                            revealContent: "It only became known as the 'Star of David' in the 1890s. Before then, Jews had never heard of any 'Star of David.' There was a hexagram, yes—but it was not called the Star of David.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .comparison,
                            ...
                            comparison: SymbolComparison(
                                ...
                                connection: "Both represent the union of opposites—masculine/feminine, fire/water, above/below. Same symbol, different branding."
                            )
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"Point of fact: there was no King David. He never existed. The Jewish religion is filled with Hindu and Buddhist symbols borrowed thousands of years after their original creation.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "All religions in the world are based on a triangle—a pyramid. Three points. Three aspects of God. This is no coincidence.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                            ...
                            comparison: SymbolComparison(
                                ...
                                connection: "Creator, Preserver, Destroyer — the same cosmic functions under different names."
                            )
                        ),
                        SolarTheologySection(
                            type: .comparison,
                            ...
                            comparison: SymbolComparison(
                                ...
                                connection: "Father, Mother/Wife, Son — the archetypal family replicated across all traditions."
                            )
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"A rabbi once told me: 'Was there a Brahma, Vishnu, Shiva?' I said, 'No, those are just metaphor names for gods.' He said, 'Well, that's what Abraham, Isaac, and Jacob is.' There was no Abraham, Isaac, or Jacob.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
            ...
            lessons: [
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "On the first day of summer, the sun is at its highest point in the northern hemisphere. The constellation that begins summer is LEO, the Lion.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                            ...
                            revealContent: "God's SUN, the light of the world, our risen savior, is Lord of Lords and King of Kings. Every badge, every state symbol, every institution has a SUN on it. Why? Because it's the only thing that causes life on Earth.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .calendar,
                            content: "SUMMER → FALL → WINTER → SPRING\n\nThe sun was hot. 90 days later, it's FALLING—losing power. We call it FALL.\n\nIt falls all the way down until December 21st. Now it's DEAD.\n\n90 days later, it's SPRINGING back to life. We call it SPRING.",
                            revealContent: nil,
                            comparison: nil
                        )
                    ],
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "On December 21st, the sun hits its lowest point—the winter solstice. Something remarkable happens for the next three days.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .reveal,
                            content: "On December 22nd, 23rd, and 24th, the sun does not move. It sits on the same degree for THREE DAYS.",
                            revealContent: "Anything that has been moving every day and suddenly stops for three days... is DEAD.\n\nGod's SUN was DEAD in its tomb for THREE DAYS.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .reveal,
                            content: "Then on DECEMBER 25th, the sun moves one degree northward.",
                            revealContent: "It has been BORN AGAIN. It's come back to life. It begins its annual journey back to the northern hemisphere.\n\nThis is the REAL meaning of Christmas—the birth of God's SUN.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .quote,
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "90 days after December 25th, the sun crosses back over the equator. A great celebration occurs—God's sun is returning!",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                        ...
                        SolarTheologySection(
                            ...
                            comparison: SymbolComparison(
                                ...
                                connection: "The sun PASSES OVER the equator. It is RESURRECTED from its winter death. Same astronomical event, different religious branding."
                            )
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"When someone dies, we say they 'passed.' Grandmother passed last night. Passed over. Passed away. Passed on. The SUN was dead in winter, but it has PASSED OVER the equator.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "Jesus said, 'I am the way, the truth, and the light. No man comes to the Father except through me.'",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                            ...
                            revealContent: "You can do anything in the dark—nobody sees you.\n\nBut anything done at 12:00 noon, in the SUN... everybody sees you.\n\nThat's the truth and the light. The SUN reveals all.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .reveal,
                            content: "Jesus had 12 apostles who followed him.",
                            revealContent: "The SUN has 12 followers:\n\n• 12 signs of the zodiac\n• 12 months of the year\n• 12 hours of day, 12 hours of night\n\nThe apostles are the zodiac signs that follow the sun through the heavens.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"Once you understand that Jesus did not exist as a man—there was no such man as Jesus—it's a story. A metaphor. A symbolic story. Jesus represents the SUN, the light of the world.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
            ...
            lessons: [
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "Moses received the Ten Commandments on Mount Sinai. But what does 'Sinai' actually mean?",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .etymology,
                            content: "In ancient Arabic, the MOON GOD was named SIN (S-I-N). Look it up in any dictionary—it was the name of the moon deity.",
                            revealContent: "The people in Egypt and Sinai would see the moon rise from behind the mountains every night. Obviously, the moon must LIVE in the mountain.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .reveal,
                            content: "In ancient Arabic, a MOUNTAIN was called 'AI.'",
                            revealContent: "SIN (moon god) + AI (mountain) = SINAI\n\nMount Sinai = The Moon God's Mountain\n\nThe 'holy mountain' is a temple to lunar worship.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"There's nothing holy in Jerusalem. The only thing holy in Israel are the stories that come out of it—they're full of HOLES.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "The religion we call Islam was already fully developed and in existence centuries before any Muhammad would have lived.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .reveal,
                            content: "The whole Islamic religion was already in place—it was worship of the planet SATURN and the MOON.",
                            revealContent: "This is why:\n\n• All Islamic flags are GREEN (Venus's color)\n• Mosques display a CRESCENT and STAR\n• The star = Venus (morning star)\n• The crescent = Venus rising, always appearing as a crescent",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .comparison,
                            ...
                            comparison: SymbolComparison(
                                ...
                                connection: "Same celestial symbols, rebranded as 'Islamic.' The worship predates the religion by millennia."
                            )
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"I got news for you—Muhammad never existed. There was no such man named Muhammad. As far as I'm concerned, no such man ever existed.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        ...
                        SolarTheologySection(
                            ...
                            revealContent: "Why? Because that's when the MOON comes out.\n\nJudaism at its core is MOON WORSHIP—lunar calendar, lunar holidays, celebrations when the moon appears.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .narration,
                            content: "This is why the Jewish calendar is lunar-based, why the High Holy Days shift each year, and why Shabbat begins at sunset Friday.",
                            revealContent: nil,
                            comparison: nil
                        )
                    ],
            ...
            lessons: [
                SolarTheologyLesson(
                    ...
                    sections: [
                        ...
                        SolarTheologySection(
                            ...
                            revealContent: "First under the CAESARS (700 years)\nThen under the VATICAN (1,600 years)\n\nIt's still Caesar. He's still 'God.' And everyone still crawls on their knees.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .reveal,
                            content: "Europe dominated the entire Earth—Portuguese, Spanish, British, French, Germans.",
                            revealContent: "The whole world has been dominated by Europe.\nEurope has been dominated by Rome.\n\nALL ROADS LEAD TO ROME.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .narration,
                            content: "All the drug cartels in South America, the Nazis in Brazil and Argentina—all these countries are very Catholic, very Roman. Paraguay and Uruguay were founded by the Jesuits.",
                            revealContent: nil,
                            comparison: nil
                        )
                    ],
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        ...
                        SolarTheologySection(
                            ...
                            revealContent: "They're far superior to MI5, MI6, NSA, or CIA.\n\nWhy? They've been doing it for 1,600 YEARS.\n\nYou just came into existence 200 years ago. They've had 16 centuries of practice.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .narration,
                            content: "The CIA was originally called the OSS. The Vatican actually helped create it during World War II, sharing their intelligence methodologies.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"If you want to know what's going on on Earth today, you better look at Rome. I hear all this stuff about 'the Jews doing this'—no, it's not the Jews as much as the guys who've been in power for 2,300 years.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "The Roman system is based on an ancient Venetian-Canaanite system that predates Rome itself.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                        ...
                        SolarTheologySection(
                            ...
                            comparison: SymbolComparison(
                                ...
                                connection: "Same secret society, same symbols. The black square represents Saturn. The pirates of the Caribbean were Templars."
                            )
                        )
                    ],
            ...
            lessons: [
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "There probably was no Moses—at least not as described in the Bible. But there WAS a line of pharaohs whose name reveals everything.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "The Vatican didn't just hide the truth—they systematically fragmented it so no one could reassemble the whole picture.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .reveal,
                            content: "When priests were ordered to translate texts, the Vatican gave one monastery HALF the truth, and another monastery the OTHER HALF.",
                            revealContent: "These monasteries would never meet.\n\nNo one could ever know the WHOLE truth.\n\nDivide and conquer. Keep everybody stupid.\n\nThe guys on top control everything.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"People will finance and support what they WANT to hear. They will NOT finance what they DON'T want to hear. The truth hurts—so they're not going to pay you to tell them the truth.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
            ...
            lessons: [
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "Where is the home office of the Federal Reserve and Internal Revenue Service? The answer will surprise you.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "In 1938, Dr. Hans Heyman of Rutgers University published a book that predicted everything.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .reveal,
                            content: "The book 'Plans for Permanent Peace' said a world war would start next year in Germany and end around 1945.",
                            revealContent: "The book contained FOUR FOLD-OUT CHARTS showing:\n\n• How the world would be reorganized after the war\n• A new monetary system\n• A political super-government\n• How all banks would be connected worldwide\n\nAll planned years in advance.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"All the money around the world is being manipulated by the bankers. It's always been controlled by a handful of families.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        ...
                        SolarTheologySection(
                            ...
                            revealContent: "A court 'hearing' says the event starts at a certain time.\n\nIt's nothing but a big GAME. A show.\n\nThe legal system is theater—and you're the unwitting participant.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"The world today is crawling with occult symbols, words, terms, numbers, numerology—but it's over the head of 99% of people. They have no idea what's going on. None. Nobody ever tells them anything.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
            ...
            lessons: [
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "The Egyptian sun god was named HORUS. His life was divided into 12 parts as he walked across the sky.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        ...
                        SolarTheologySection(
                            type: .etymology,
                            content: "HORIZON",
                            revealContent: "HORUS + RISING = HORIZON\n\nThe HORIZON is literally 'Horus Rising.'\n\nEvery sunrise, you witness the Egyptian sun god being born again.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"Horus is risen! Even today when the sun comes up, we call it the sun rising on the HORIZON—Horus Rising.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        ...
                        SolarTheologySection(
                            ...
                            revealContent: "AMEN = AMUN (also spelled AMON, AMEN)\n\nAMUN-RA was the Egyptian sun god—'King of the Gods.'\n\nChristians say: 'You can't talk to God directly, only through his Son.'\n\nSo they end prayers with AMEN—invoking the sun god to deliver their prayer.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"Christians pray to God's son, the light of the world. And at the end of their prayer, they say AMEN—because they're sending their prayer to God through God's son.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "When you're troubled, you seek comfort. There's a word for this peace of mind.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "Jesus died wearing a 'crown of thorns.' But what is a crown of thorns really?",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "The Trinity is said to be a 'great mystery.' But it's not mysterious at all.",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                ...
                SolarTheologyLesson(
                    ...
                    sections: [
                        SolarTheologySection(
                            type: .narration,
                            content: "The Bible says Jesus was teaching in the temple at age 12. But is that what it really means?",
                            revealContent: nil,
                            comparison: nil
                        ),
                        SolarTheologySection(
                            ...
                            revealContent: "The sun at 12 NOON is in 'the temple' (heaven) teaching wisdom.\n\nNot 12 YEARS old.\n12 O'CLOCK.\n\nThe sun at noon—the Most High—illuminating all truth.\n\nAt HIGH NOON, no shadow is cast. All is revealed.",
                            comparison: nil
                        ),
                        SolarTheologySection(
                            type: .quote,
                            content: "\"If you can't learn anything at 12 noon, then you're really in the dark.\"",
                            revealContent: "— Jordan Maxwell",
                            comparison: nil
                        )
                    ],
