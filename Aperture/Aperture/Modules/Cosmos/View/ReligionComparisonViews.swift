...
struct PreDatedSaviorsView: View {
    ...
    private var preDatedHeader: some View {
        VStack(spacing: 12) {
            ...
            Text("The Jesus story existed THOUSANDS of years before Bethlehem.\nThey didn't write an original — they COPIED.")
                .font(.system(size: 14, weight: .medium))
                .foregroundColor(.white.opacity(0.6))
                .multilineTextAlignment(.center)
        }
    ...
    private var thePointCard: some View {
        VStack(spacing: 12) {
            ...
            Text("It's the SUN's journey through the zodiac — personified as a savior figure in every culture that observed the sky.")
                .font(.system(size: 14, weight: .semibold))
                .foregroundColor(.white)
                .multilineTextAlignment(.center)
            
            Text("Born December 25 (winter solstice), dies for 3 days, rises again.\nIt's not history. It's ASTRONOMY.")
