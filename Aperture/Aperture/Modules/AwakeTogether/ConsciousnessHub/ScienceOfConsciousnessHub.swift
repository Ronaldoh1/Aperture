...
struct ScienceOfConsciousnessHubView: View {
  ...
  var filteredResources: [ConsciousnessResource] {
    resources.filter { resource in
      ...
      let matchesSearch =
        searchText.isEmpty || resource.title.localizedCaseInsensitiveContains(searchText)
  ...
  private func categoryPill(_ category: ConsciousnessCategory?, _ title: String) -> some View {
    Button(action: { selectedCategory = category }) {
      ...
      .padding(.vertical, 8)
      .background(
        selectedCategory == category ? (category?.color ?? Color.cyan) : Color.white.opacity(0.1)
      )
      .cornerRadius(20)
    }
  }
  ...
  private func typePill(_ type: HubResourceType?, _ title: String) -> some View {
    Button(action: { selectedType = type }) {
      ...
      .padding(.vertical, 6)
      .background(
        selectedType == type ? (type?.color ?? Color.white.opacity(0.3)) : Color.white.opacity(0.05)
      )
      .cornerRadius(16)
    }
  }
  ...
  private var learningPathSection: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      VStack(alignment: .leading, spacing: 8) {
        ...
        pathStep(
          3, "Watch David Chalmers on Hard Problem", "Understand the philosophical questions")
...
enum ConsciousnessLibrary {
  static let allResources: [ConsciousnessResource] =
    tedTalks + youtubeChannels + books + researchers + podcasts
  ...
  static let tedTalks: [ConsciousnessResource] = [
    ...
    ConsciousnessResource(
      ...
      category: .philosophy,
      description:
        "Our consciousness is a fundamental aspect of our existence, says philosopher David Chalmers: 'There's nothing we know about more directly… but at the same time it's the most mysterious phenomenon in the universe.' He explores the 'hard problem of consciousness' - explaining subjective experience.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .philosophy,
      description:
        "Philosopher Dan Dennett makes a compelling argument that not only don't we understand our own consciousness, but that half the time our brains are actively deceiving us.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .physics,
      description:
        "MIT physicist Max Tegmark proposes that consciousness is a state of matter, like gas or liquid, with specific mathematical properties. He argues consciousness could emerge from complex information processing patterns.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .neuroscience,
      description:
        "Brain researcher Jill Bolte Taylor studied her own stroke as it happened - and has become a powerful voice for brain recovery. In this profound talk, she describes experiencing nirvana when her left brain shut down.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .neuroscience,
      description:
        "Neurologist Oliver Sacks brings our attention to Charles Bonnet syndrome - when visually impaired people experience lucid hallucinations. He describes the experiences his patients have had, illuminating the brain's capacity to generate conscious experience.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .neuroscience,
      description:
        "Who are you, really? Neuroscientist Anil Seth lays out his fascinating new theory of consciousness and self, centered on the notion that we 'predict' the world into existence. From sleep to memory and everything in between.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      description:
        "In this provocative talk, Dada Gunamuktananda presents consciousness as the essence of the universe, arguing that mind is not a byproduct of matter, but the foundation of reality itself.",
      keyInsights: [
  ...
  static let youtubeChannels: [ConsciousnessResource] = [
    ConsciousnessResource(
      ...
      category: .spirituality,
      description:
        "Eckhart Tolle is widely recognized as one of the most original and inspiring spiritual teachers of our time. His teachings focus on the power of presence and living in the now.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .spirituality,
      description:
        "Sadhguru, a yogi, mystic and visionary, offers profound spiritual teachings with humor and practical wisdom. His channel covers inner transformation, yoga, and modern life.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .awakening,
      description:
        "Deep philosophical and consciousness explorations. Leo Gura covers topics like self-actualization, enlightenment, psychedelics, and understanding reality at the deepest levels.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .philosophy,
      description:
        "Alan Watts was a British philosopher known for interpreting Eastern philosophy for Western audiences. His lectures on Zen, consciousness, and the nature of reality remain timeless.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .spirituality,
      description:
        "Rupert Spira is a teacher of non-dual awareness. His approach is contemporary and direct, focusing on the recognition of our true nature as pure awareness.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .awakening,
      description:
        "Aaron Doughty focuses on raising consciousness, manifestation, and understanding reality. His content is practical and accessible for spiritual beginners.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .psychology,
      description:
        "Teal Swan offers teachings on emotional healing, shadow work, and spiritual growth. Known for her direct approach to addressing trauma and unconscious patterns.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .neuroscience,
      description:
        "Dr. Joe Dispenza combines neuroscience, epigenetics, and quantum physics to explain how thoughts change brain and body. His meditations have helped millions.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .physics,
      description:
        "In-depth interviews with physicists, mathematicians, and philosophers exploring consciousness, physics, and the nature of reality at the highest intellectual level.",
      keyInsights: [
  ...
  static let books: [ConsciousnessResource] = [
    ConsciousnessResource(
      ...
      category: .neuroscience,
      description:
        "A groundbreaking exploration of consciousness from one of the world's leading neuroscientists. Seth presents the idea that we don't perceive reality but predict it into existence.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .spirituality,
      description:
        "Dr. Hawkins' famous Map of Consciousness, a logarithmic scale from 0-1000 charting human consciousness from shame to enlightenment. A practical tool for understanding emotional and spiritual evolution.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .spirituality,
      description:
        "The seminal guide to spiritual enlightenment that has transformed millions of lives. Tolle teaches how to quiet the mind and live fully in the present moment.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .spirituality,
      description:
        "Tolle's follow-up masterpiece exploring the evolution of human consciousness and how awakening from ego can save humanity and the planet.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .philosophy,
      description:
        "The definitive philosophical exploration of the 'hard problem' of consciousness - why we have subjective experience at all. A landmark in consciousness studies.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .meditation,
      description:
        "A rational, scientific approach to spirituality and meditation. Harris explores how one can pursue spiritual experiences without religious dogma.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .psychology,
      description:
        "An evolutionary psychology perspective on Buddhist insights about the mind. Wright shows how meditation and Buddhist philosophy align with modern science.",
      keyInsights: [
  ...
  static let researchers: [ConsciousnessResource] = [
    ConsciousnessResource(
      ...
      category: .neuroscience,
      description:
        "Professor of Cognitive and Computational Neuroscience and Director of the Centre for Consciousness Science. Pioneer of the 'controlled hallucination' theory of consciousness.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .philosophy,
      description:
        "Distinguished Professor of Philosophy, known for formulating the 'hard problem of consciousness' and his work on the philosophy of mind.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .neuroscience,
      description:
        "Creator of Integrated Information Theory (IIT), one of the leading scientific theories of consciousness. His work attempts to mathematically quantify consciousness.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .neuroscience,
      description:
        "Chief Scientist at the Allen Institute for Brain Science. Pioneer in neural correlates of consciousness research and collaborator with Francis Crick.",
      keyInsights: [
  ...
  static let podcasts: [ConsciousnessResource] = [
    ConsciousnessResource(
      ...
      category: .philosophy,
      description:
        "Sam Harris explores questions about the human mind, consciousness, meditation, AI, and the nature of reality through conversations with leading thinkers.",
      keyInsights: [
    ...
    ConsciousnessResource(
      ...
      category: .spirituality,
      description:
        "Deep conversations about the big questions of meaning, faith, ethics, and ideas at the center of human life. Features poets, scientists, and spiritual teachers.",
      keyInsights: [
