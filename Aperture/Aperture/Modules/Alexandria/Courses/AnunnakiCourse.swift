...
struct AnunnakiCourse {
    static let course = AlexandriaCourse(
        ...
        modules: [
            ACModule(id: "an1", number: 1, title: "The Timeline They Buried in Clay", subtitle: "450,000 years of history on stone tablets", icon: "clock.arrow.circlepath", lessons: [
...
""",
                    keyInsight: "Sumerian texts predate the Bible by 2,000+ years and describe humanity's creation with a divine spark intentionally embedded — shared equally by all people, not reserved for any bloodline or chosen group.",
                    practice: "Read the Epic of Atrahasis (available free online). Notice how many Genesis parallels you find — then ask which came first.",
                    interactiveElement: .timeline(events: [
                        ...
                        (year: "~300,000 BCE", event: "Enki proposes a new creation", significance: "A conscious being blending cosmic awareness with earthly form"),
                        (year: "~250,000 BCE", event: "Creation of the Adamu", significance: "First human — carrying a divine spark of self-awareness"),
                        (year: "~100,000 BCE", event: "Knowledge transfer accelerates", significance: "Humans develop rapidly — civilization seeds planted"),
                        (year: "~13,000 BCE", event: "The Great Flood", significance: "Enki secretly saves humanity — values the consciousness he helped create"),
                        (year: "~4,000 BCE", event: "Sumerian civilization 'appears'", significance: "Writing, agriculture, astronomy, mathematics — all at once")
                    ])
                )
            ])
        ],
        sources: ["Zecharia Sitchin, \"The 12th Planet\" (1976)", "Samuel Noah Kramer, \"History Begins at Sumer\"", "The Epic of Atrahasis — Sumerian creation text", "Enuma Elish — Babylonian creation epic", "Archaeological records from Eridu, Ur, and Nippur"],
        dragonComment: "The oldest written records on Earth say every human carries the same divine spark. Not some bloodline. Not a chosen few. Everyone. The Bible told you the story 2,000 years later and made it exclusive. 🐉"
    )
}
