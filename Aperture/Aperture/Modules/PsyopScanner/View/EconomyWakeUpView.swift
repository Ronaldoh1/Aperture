...
enum EconomyWakeUpDatabase {
  static let realities: [EconomicReality] = [
    ...
    EconomicReality(
      ...
      explanation:
        "The US national debt grows by approximately $1 trillion every 100 days. The interest payments alone now exceed the entire defense budget. This isn't a future problem — it's a math problem happening NOW.",
      whileYouWere:
        "While you were arguing about which party spends more, BOTH parties approved every spending bill. Debt is bipartisan.",
    ...
    EconomicReality(
      ...
      explanation:
        "The federal government now pays more in interest on existing debt than on the entire military. This means a growing portion of your tax dollars goes to bondholders — many of them foreign governments — not services for you.",
      whileYouWere:
        "While you debated military spending, the interest bill quietly became the largest expense nobody talks about.",
    ...
    EconomicReality(
      ...
      explanation:
        "When Nixon ended the gold standard in 1971, the dollar became backed by nothing but trust. Since then, the Fed has printed trillions. Your grandparents' dollar buys two cents of what it used to. This isn't inflation — it's devaluation by design.",
      whileYouWere:
        "While you celebrated a 3% raise, your currency lost 7% in purchasing power. You got a pay cut and didn't know it.",
    ...
    EconomicReality(
      ...
      explanation:
        "Central banks — the institutions that PRINT money — are buying gold at the highest rate in decades. Ask yourself: if the people who create dollars are converting those dollars to gold, what do THEY know about the future of the dollar?",
      whileYouWere:
        "While you debated crypto vs stocks, the institutions that control the money supply quietly positioned into the oldest store of value on Earth.",
    ...
    EconomicReality(
      ...
      explanation:
        "China, Russia, India, Brazil, South Africa — and new members including Egypt, Ethiopia, Iran, UAE — are actively building trade systems that bypass the US dollar. De-dollarization isn't conspiracy — it's published economic policy.",
      whileYouWere:
        "While you watched domestic politics, the rest of the world started building an economy that doesn't need the dollar.",
    ...
    EconomicReality(
      ...
      explanation:
        "BlackRock, Vanguard, Invitation Homes, and other institutional investors are buying single-family homes at scale. They convert them to rentals. The American Dream of homeownership is being transformed into a subscription model — you'll rent from corporations.",
      whileYouWere:
        "While you blamed millennials for 'not saving enough,' trillion-dollar corporations were outbidding them with cash offers.",
    ...
    EconomicReality(
      ...
      explanation:
        "Home prices surged while wages barely moved. The median home now costs 7-8x median income — historically, this ratio was 3-4x. An entire generation is being priced out of ownership, creating a permanent renter class.",
      whileYouWere:
        "While the news covered interest rate decisions as if they were sports scores, the gap between housing costs and wages became an unbridgeable canyon.",
    ...
    EconomicReality(
      ...
      stat: "250% vs 16%",
      explanation:
        "Workers produce 250% more value than in 1971. Their wages increased 16%. Where did the other 234% go? Corporate profits, executive compensation, and shareholder returns. This isn't an accident — it's the design of the system since Reaganomics.",
      whileYouWere:
        "While you argued about minimum wage, the REAL wage theft happened at every level: you produce more, get paid less, and the difference funds billionaire lifestyles.",
    ...
    EconomicReality(
      ...
      explanation:
        "When the Fed prints money, it doesn't create value — it dilutes existing value. Your dollar buys less. This is a tax on savings that requires no legislation and no vote. The poorest are hit hardest because they spend the highest percentage of income on essentials.",
      whileYouWere:
        "While politicians blamed each other for inflation, the institution that actually controls the money supply (the Federal Reserve) is not elected and not accountable to voters.",
    ...
    EconomicReality(
      ...
      explanation:
        "In 1983, 50 companies controlled the majority of US media. Today: Comcast, Disney, Warner Bros Discovery, Paramount, Fox, and a few others control almost everything you read, watch, and hear. Your information ecosystem is a funnel, not an ocean.",
      whileYouWere:
        "While you debated 'media bias,' the real story was consolidation — it doesn't matter which 'side' the news is on if six companies control all of it.",
    ...
    EconomicReality(
      ...
      explanation:
        "When one system owns every hospital in your region, they set the price. Your 'choice' of healthcare is an illusion in many markets. This consolidation directly increases what you pay for everything from emergency care to prescriptions.",
      whileYouWere:
        "While the healthcare debate focused on insurance, the real power play was hospitals and pharmaceutical companies merging into regional monopolies.",
    ...
    EconomicReality(
      ...
      explanation:
        "For every dollar spent on lobbying, corporations see over $200 in favorable legislation — through tax breaks, subsidies, deregulation, or favorable contracts. This is the most profitable investment in existence. And it's legal.",
      whileYouWere:
        "While you voted every 2-4 years, lobbyists worked 365 days a year. Their investment in politicians dwarfs your vote's impact on policy.",
    ...
    EconomicReality(
      ...
      explanation:
        "Central Bank Digital Currencies give governments complete visibility into every transaction. Unlike cash, CBDCs can be programmed: expiration dates, spending restrictions, geographic limits. China's digital yuan is already in pilot. This is programmable money controlled by the state.",
      whileYouWere:
        "While you debated cryptocurrency regulation, governments worldwide were building their own digital currencies — with total surveillance built in.",
  ...
  static let resets: [FourthTurningReset] = [
    FourthTurningReset(
      ...
      year: "1780s-1790s",
      lessons:
        "Continental dollars became worthless during the war. 'Not worth a Continental' became a saying. Paper promises backed by nothing failed. The new system was backed by gold and silver."
    ),
    FourthTurningReset(
      era: "Civil War",
      ...
      year: "1860s",
      lessons:
        "Confederate currency became worthless. The Union printed 'greenbacks' (fiat currency) to fund the war. National banking system standardized money. The transition destroyed Southern wealth overnight."
    ),
    FourthTurningReset(
      ...
      year: "1930s-1944",
      lessons:
        "FDR confiscated private gold in 1933 (Executive Order 6102). Bretton Woods pegged all currencies to the dollar, and the dollar to gold. This made America the center of global finance — for one saeculum."
    ),
    FourthTurningReset(
      era: "Current Crisis",
      ...
      year: "2008-~2033",
      lessons:
        "The current system is 80 years old — one full cycle. Central banks buying gold. BRICS building alternatives. National debt unsustainable. The reset IS coming. The only question is its form."
    ),
  ]
}
...
struct EconomyWakeUpView: View {
    ...
    NavigationStack {
      ...
      .toolbar {
        ...
        ToolbarItem(placement: .principal) {
          HStack(spacing: 6) {
            Image(systemName: "banknote.fill").foregroundColor(
  ...
  private var heroSection: some View {
    VStack(spacing: 10) {
      ZStack {
        ...
        Image(systemName: "banknote.fill").font(.system(size: 28)).foregroundColor(
          Color(red: 1.0, green: 0.85, blue: 0.3))
      }
      ...
      Text(
        "While you argued left vs right,\nthe economy was being restructured.\nNobody asked your opinion."
      )
      ...
      if expandedReality == reality.id {
        VStack(alignment: .leading, spacing: 10) {
          ...
          .padding(10).background(
            RoundedRectangle(cornerRadius: 8).fill(Color.orange.opacity(0.05)))

          // Source
          HStack(spacing: 4) {
            Image(systemName: "doc.text.fill").font(.system(size: 8)).foregroundColor(
              .white.opacity(0.2))
      ...
      RoundedRectangle(cornerRadius: 14).fill(Color.white.opacity(0.03))
        .overlay(
          RoundedRectangle(cornerRadius: 14).stroke(
            reality.category.color.opacity(0.1), lineWidth: 1)))
  }
  ...
  private var monetaryResetsSection: some View {
    VStack(alignment: .leading, spacing: 12) {
      Button {
        ...
        HStack(spacing: 8) {
          Image(systemName: "clock.arrow.2.circlepath").foregroundColor(
            Color(red: 1.0, green: 0.85, blue: 0.3))
          ...
          VStack(alignment: .leading, spacing: 8) {
            ...
            HStack(spacing: 8) {
              VStack(alignment: .leading, spacing: 2) {
                ...
                Text(reset.oldSystem).font(.system(size: 10, weight: .medium)).foregroundColor(
                  .red.opacity(0.7))
              }
              .frame(maxWidth: .infinity, alignment: .leading)

              Image(systemName: "arrow.right").font(.system(size: 10)).foregroundColor(
                .white.opacity(0.2))

              VStack(alignment: .leading, spacing: 2) {
                Text("NEW").font(.system(size: 8, weight: .bold)).foregroundColor(
                  .green.opacity(0.5))
                Text(reset.newSystem).font(.system(size: 10, weight: .medium)).foregroundColor(
                  .green.opacity(0.7))
              }
              .frame(maxWidth: .infinity, alignment: .leading)
            }
    ...
    .padding(14)
    .background(
      RoundedRectangle(cornerRadius: 16).fill(Color(red: 1.0, green: 0.85, blue: 0.3).opacity(0.03))
        .overlay(
  ...
  private var fourthTurningLink: some View {
    Button {
      showFourthTurningCourse = true
    } label: {
      HStack(spacing: 12) {
        ZStack {
          Circle().fill(Color(red: 0.17, green: 0.24, blue: 0.31).opacity(0.3)).frame(
            width: 44, height: 44)
          Image(systemName: "clock.arrow.2.circlepath").font(.system(size: 18)).foregroundColor(
            .cyan)
        }
        VStack(alignment: .leading, spacing: 3) {
          HStack(spacing: 6) {
            Text("THE FOURTH TURNING").font(.system(size: 11, weight: .bold)).foregroundColor(
              .white)
      ...
      .background(
        RoundedRectangle(cornerRadius: 14).fill(Color.cyan.opacity(0.04))
          .overlay(
            RoundedRectangle(cornerRadius: 14).stroke(Color.cyan.opacity(0.15), lineWidth: 1)))
    }
  }
  ...
  private var moneyDecodedLink: some View {
    Button {
      showMoneyDecodedCourse = true
    } label: {
      HStack(spacing: 12) {
        ZStack {
          Circle().fill(Color(red: 0.95, green: 0.77, blue: 0.06).opacity(0.2)).frame(
            width: 44, height: 44)
          Image(systemName: "banknote.fill").font(.system(size: 18)).foregroundColor(
            Color(red: 1.0, green: 0.85, blue: 0.3))
        }
        VStack(alignment: .leading, spacing: 3) {
          HStack(spacing: 6) {
      ...
      .background(
        RoundedRectangle(cornerRadius: 14).fill(
          Color(red: 1.0, green: 0.85, blue: 0.3).opacity(0.04)
        )
        .overlay(
          RoundedRectangle(cornerRadius: 14).stroke(
            Color(red: 1.0, green: 0.85, blue: 0.3).opacity(0.15), lineWidth: 1)))
    }
  }
  ...
  private var bookSection: some View {
    VStack(alignment: .leading, spacing: 10) {
      ...
      VStack(alignment: .leading, spacing: 6) {
        ...
        Text("William Strauss & Neil Howe (1997)")
          .font(.system(size: 11, weight: .medium)).foregroundColor(.white.opacity(0.4))
        Text(
          "Written in 1997, this book predicted the 2008 financial crisis, rising populism, institutional collapse, and a generational crisis climaxing around 2025. It's not prophecy — it's pattern recognition over 500 years of Anglo-American history."
        )
        .font(.system(size: 11, weight: .medium)).foregroundColor(.white.opacity(0.5)).lineSpacing(
          3)

        Text(
          "Also read: Neil Howe's 'The Fourth Turning Is Here' (2023) — an updated analysis of where we are in the cycle now."
        )
        .font(.system(size: 11, weight: .medium)).foregroundColor(.cyan.opacity(0.6)).lineSpacing(2)

        HStack(spacing: 8) {
          Text("Available:").font(.system(size: 9, weight: .bold)).foregroundColor(
            .white.opacity(0.3))
    ...
    .padding(14)
    .background(
      RoundedRectangle(cornerRadius: 14).fill(Color(red: 1.0, green: 0.85, blue: 0.3).opacity(0.03))
        .overlay(
          RoundedRectangle(cornerRadius: 14).stroke(
            Color(red: 1.0, green: 0.85, blue: 0.3).opacity(0.1), lineWidth: 1)))
  }
