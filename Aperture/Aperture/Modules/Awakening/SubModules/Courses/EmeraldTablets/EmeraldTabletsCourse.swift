...
""",
                    keyInsight: "The wisdom of Atlantis wasn't lost—it was hidden, waiting for those ready to receive it.",
                    practice: "Sit quietly and ask: 'What do I remember about who I really am?' Don't force answers. Just notice what arises.",
                    visualType: .atlantis
                ),
...
""",
                    keyInsight: "The fall of Atlantis was a fall of consciousness—and its rising is happening within you now.",
                    practice: "Notice today where you reach for external solutions before consulting your inner wisdom. This is the Atlantean pattern in miniature.",
                    visualType: .fall
                ),
...
""",
                    keyInsight: "The Great Pyramid is an initiation chamber, not a tomb—and its real counterpart exists within your own consciousness.",
                    practice: "Visualize a pyramid of light surrounding you, apex above your head. Breathe as if the geometry itself is breathing with you.",
                    visualType: .pyramid
                )
            ]
        ),
...
""",
                    keyInsight: "The Halls of Amenti exist between dimensions—a place you've visited in dreams without knowing it.",
                    practice: "Before sleep tonight, set the intention: 'I will remember my journey.' Keep a journal by your bed.",
                    visualType: .halls
                ),
...
""",
                    keyInsight: "We exist within cycles within cycles. Alignment with these rhythms is wisdom; fighting them creates suffering.",
                    practice: "Map your personal cycles: What patterns keep repeating in your life? What is the lesson they're trying to teach?",
                    visualType: .cycles
                ),
...
""",
                    keyInsight: "Sacred geometry isn't decorative—it's the operating system of creation, and you're built from it.",
                    practice: "Draw or visualize the Flower of Life. As you do, feel how your consciousness naturally organizes around pattern and relationship.",
                    visualType: .geometry
                )
            ]
        ),
...
""",
                    keyInsight: "Darkness isn't a force to fight—it's an absence to fill. Your awareness is the light that transforms.",
                    practice: "Notice an area of 'darkness' in your life—fear, confusion, pain. Instead of fighting it, simply bring gentle attention to it.",
                    visualType: .light
                ),
...
""",
                    keyInsight: "The Dweller on the Threshold is your own shadow. It dissolves not through fighting but through loving acceptance.",
                    practice: "Identify one quality in yourself you've been ashamed of. Say to it: 'I see you. You are part of me. I accept you.'",
                    visualType: .dweller
                )
            ]
        ),
...
""",
                    keyInsight: "Magic isn't supernatural—it's the fuller use of natural law. Consciousness is the technology.",
                    practice: "Choose one small outcome you'd like to manifest. Hold the image of it already completed for 5 minutes, feeling as if it's already real.",
                    visualType: .magic
                ),
...
""",
                    keyInsight: "Protection isn't fear-based defense—it's maintaining energetic clarity so you can serve without interference.",
                    practice: "Each morning, visualize a sphere of golden light surrounding you. Set the intention that only love and wisdom may enter.",
...
""",
                    keyInsight: "Separation is functional, not fundamental. You are the One experiencing itself as many.",
                    practice: "Look at another person today—anyone. Recognize: 'That is the One, appearing as them. We are the same consciousness in different forms.'",
                    visualType: .unity
                ),
...
""",
                    keyInsight: "The ultimate tablet isn't ancient text—it's the living wisdom encoded in your own awakened being.",
                    practice: "Write your personal 'Emerald Tablet'—3 to 5 core truths you've realized through direct experience, not just study.",
