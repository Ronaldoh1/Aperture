  ...
  static let americanDreamAnalysis = StackAnalysis(
    ...
    layers: [
      LayerAnalysis(
        ...
        name: "Narrative",
        content:
          "\"Meritocracy. Equal opportunity. Hard work = success. The American Dream is available to anyone willing to work for it.\""
      ),
      LayerAnalysis(
        layer: 6,
        name: "Relationships",
        content:
          "Who tells this story? Government, corporations, media, schools. It's repeated in every graduation speech, job interview, political campaign. The entire culture reinforces it."
      ),
      LayerAnalysis(
        layer: 5,
        name: "Incentives",
        content:
          "Why push this narrative? It keeps workers compliant. If you believe failure is YOUR fault (not working hard enough), you won't question the system. You'll blame yourself, not the structure."
      ),
      LayerAnalysis(
        layer: 4,
        name: "Institutions",
      ...
      LayerAnalysis(
        ...
        name: "Biology",
        content:
          "Humans need food, shelter, safety. When these are scarce, desperation sets in. Desperation = compliance. You'll take any job, accept any condition, because the alternative is homelessness."
      ),
      LayerAnalysis(
        layer: 1,
        name: "Physics",
        content:
          "Resources exist. Food, housing, energy - all exist in abundance. Distribution is a POLICY CHOICE, not natural law. Scarcity is manufactured to maintain control."
      ),
    ],
    synthesis: """
      **BOTTOM-UP SYNTHESIS:**
