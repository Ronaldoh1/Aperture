...
struct AwakeningView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .sheet(isPresented: $showSystemicExposure) {
    ...
    private var featureCardsSection: some View {
        VStack(spacing: 14) {
            ...
            featureCard(icon: "eye.trianglebadge.exclamationmark.fill", title: "Systemic Exposure", subtitle: "What else did they lie about?", stat: "Northern Triangle • Solar Theology • Documented Lies", color: Color.red) { showSystemicExposure = true }
            featureCard(icon: "brain.head.profile", title: "Neuroscience", subtitle: "Know your brain. Become unhackable.", stat: "Limbic System • NPC Scripts • 404 Love Protocol", color: Color.pink) { showNeuroscience = true }
        }
    }
