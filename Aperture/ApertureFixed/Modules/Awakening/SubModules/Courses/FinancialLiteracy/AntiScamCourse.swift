...
""",
                    ...
                    realExample: "In 2022, a Stanford professor lost $50,000 to a 'Geek Squad' refund scam. Intelligence doesn't protect you."
                ),
                AntiScamLesson(
...
""",
                    ...
                    realExample: "Fake guru screenshots: Many use trading simulators or paper trading to show 'profits' that aren't real money."
                ),
                AntiScamLesson(
...
""",
                    ...
                    realExample: "The 'Tinder Swindler' stole an estimated $10 million from multiple women by posing as a wealthy businessman."
                )
            ]
        ),
...
""",
                    ...
                    realExample: "Madoff's fund showed steady 10-12% returns for DECADES, through market crashes. That should have been impossible - and it was."
                ),
                AntiScamLesson(
                    id: "crypto-scams",
...
""",
                    ...
                    realExample: "Squid Game Token: Rose 75,000% then crashed 99.99% in minutes. Investors couldn't sell - the code prevented it."
                ),
                AntiScamLesson(
                    id: "guru-scams",
...
""",
                    ...
                    realExample: "Multiple 'Amazon FBA' gurus were caught teaching outdated strategies that no longer work while making millions from course sales."
                )
            ]
        ),
...
""",
                    ...
                    realExample: "In 2022, a phishing campaign impersonating Microsoft stole credentials from over 10,000 organizations."
                ),
                AntiScamLesson(
                    id: "identity-theft",
...
""",
                    ...
                    realExample: "The 2017 Equifax breach exposed 147 million Americans' Social Security numbers. If you had credit, you were likely affected."
                )
            ]
        ),
...
""",
                    ...
                    realExample: "A simple Google search of '[Company] + scam' has saved countless people from losing money. Make it a habit."
                ),
                AntiScamLesson(
...
""",
                    ...
                    realExample: "Reporting scams is critical - the FTC uses reports to identify patterns and shut down scam operations. Your report could save someone else."
                )
            ]
        )
    ]
