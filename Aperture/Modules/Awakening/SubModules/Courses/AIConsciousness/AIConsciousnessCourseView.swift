    ...
    private var headerSection: some View {
        VStack(spacing: 16) {
            ...
            HStack(alignment: .top, spacing: 10) {
                ...
                Text("\"They're building minds in silicon and nobody's asking what a mind actually IS. Finally, the question humanity dodged for millennia has an expiration date.\"")
