...
struct SunFlowStateView: View {
    ...
    private var overviewSection: some View {
        ...
        VStack(spacing: 20) {
            ...
            conceptCard(
                title: "What is Flow?",
                content: "Flow is the optimal state of consciousness where you feel your best and perform your best. Time dilates. The inner critic goes quiet. Action and awareness merge. You are completely absorbed.",
                icon: "water.waves",
            ...
            conceptCard(
                ...
                content: "This isn't just about feeling good. It's about building the capacity to enter flow on command - and stay there. We combine flow triggers, circadian optimization, and practical protocols.",
                icon: "sun.max.fill",
            ...
            conceptCard(
                ...
                content: "In Dragon Ball, Ultra Instinct is when the body reacts without conscious thought. That's flow. The goal is to make this your default operating system.",
                icon: "sparkles",
                color: Color.white
            )
    ...
    private var circadianSection: some View {
        ...
        VStack(spacing: 16) {
            ...
            sectionHeader(title: "CIRCADIAN CALIBRATION", subtitle: "Work with your biology, not against it")
    ...
    private func circadianNavCard(title: String, subtitle: String, icon: String, color: Color) -> some View {
