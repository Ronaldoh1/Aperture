...
struct DroneSelfCourseView: View {
    ...
    private func moduleCard(_ module: DroneModule) -> some View {
        ...
        let moduleProgress = Double(moduleLessons.intersection(completedLessons).count) / Double(module.lessons.count)
                ...
                HStack(spacing: 14) {
                    ...
                    ZStack {
                        Circle()
                            .fill(
                                moduleCompleted
                                    ? LinearGradient(colors: [accentColor, fieldGold], startPoint: .topLeading, endPoint: .bottomTrailing)
                                    : LinearGradient(colors: [accentColor.opacity(0.2), accentColor.opacity(0.1)], startPoint: .topLeading, endPoint: .bottomTrailing)
                            )
                            .frame(width: 44, height: 44)
    ...
    private var scientificResourcesSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(alignment: .top, spacing: 8) {
                ...
                Text("This model is a THEORY, not absolute truth. Test it in your experience. Your direct knowing is more important than any framework.")
