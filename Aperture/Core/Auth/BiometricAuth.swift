...
final class BiometricAuthManager: ObservableObject {
    ...
    func authenticate(reason: String = "Authenticate to access Aperture") async -> Result<Bool, AuthError> {
        let context = LAContext()
    ...
    func authenticateWithPasscodeFallback(reason: String = "Authenticate to access Aperture") async -> Result<Bool, AuthError> {
        let context = LAContext()
...
class AppLockSettings: ObservableObject {
    ...
    private init() {
        self.isAppLockEnabled = UserDefaults.standard.bool(forKey: "aperture_app_lock_enabled")
        self.lockOnBackground = UserDefaults.standard.bool(forKey: "aperture_lock_on_background")
        self.requireAuthForPremium = UserDefaults.standard.bool(forKey: "aperture_require_auth_premium")
    }
}
