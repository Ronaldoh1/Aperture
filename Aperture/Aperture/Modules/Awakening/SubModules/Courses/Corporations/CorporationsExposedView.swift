...
struct CorporationsExposedView: View {
  ...
  private var bigPictureSection: some View {
    VStack(alignment: .leading, spacing: 16) {
      ...
      Text(
        "While politicians blame immigrants, 'welfare queens,' and foreign countries, the real extraction of American wealth happens in corporate boardrooms."
      )
      .font(.system(size: 15))
      .foregroundColor(.white)
    ...
    VStack(alignment: .leading, spacing: 16) {
      ...
      VStack(spacing: 12) {
        scapegoatRow(
          ...
          blame: "Immigrants",
          reality:
            "BlackRock & investors bought 1 in 4 homes. Zoning laws restrict building. Airbnb removes housing stock."
        )
        ...
        scapegoatRow(
          ...
          reality:
            "Union busting, stock buybacks ($1T+/year), CEO pay explosion. Policy choices, not immigration."
        )
        ...
        scapegoatRow(
          ...
          reality:
            "Insurance company profits, pharma pricing power, administrative bloat (30% of costs). Other countries do it cheaper."
        )
        ...
        scapegoatRow(
          ...
          reality:
            "Corporate profit margins at 70-year highs during 'inflation.' Greedflation is documented."
        )
        ...
        scapegoatRow(
          ...
          reality:
            "Poverty, inequality, lack of mental health services. Crime actually down from 1990s peaks."
        )
      }
    }
    .padding()
  ...
  private var allCorporations: [EvilCorp] {
    [
      ...
      EvilCorp(
        ...
        politicalDonations:
          "Donates to both parties. Larry Fink is connected to everyone in power.",
