      ...
      ZionismLesson(
        ...
        content: """
          ...
          **Key Development:**
          ...
          """,
        keyTakeaway:
          "Zionism emerged from real persecution of Jews in Europe. From the beginning, Zionist leaders knew Palestine was inhabited. Early immigration displaced Arab workers through 'Hebrew labor' policies. These tensions were recognized from the start."
      ),
      ZionismLesson(
        ...
        content: """
          ...
          **The Mandate document incorporated Balfour Declaration** and committed Britain to:
          ...
          """,
        keyTakeaway:
          "Britain promised Palestine to Zionists without consulting the 90% Arab population—while also promising Arabs independence. These contradictory promises created a conflict that continues today."
      ),
      ZionismLesson(
        ...
        content: """
          ...
          **Britain Gives Up:**
          ...
          """,
        keyTakeaway:
          "Under British rule, Jewish immigration changed demographics from 11% to 33% Jewish. Arab revolt was crushed. Zionist militias fought British and Arabs. The Holocaust accelerated emigration. Britain eventually gave up."
      ),
      ZionismLesson(
        ...
        content: """
          ...
          **Source:** UN Archives; UNRWA
          """,
        keyTakeaway:
          "700,000-750,000 Palestinians fled or were expelled in 1948. Israeli historians have documented direct expulsions, massacres, and psychological warfare. UN called for their return. Israel refused. Their descendants remain refugees today."
      ),
      ZionismLesson(
        ...
        content: """
          ...
          **Source:** Israeli media archives
          """,
        keyTakeaway:
          "Israel has occupied the West Bank for 57+ years—one of history's longest occupations. 700,000+ settlers live in territories the entire world considers illegally occupied. Palestinians live under military law while settlers have civil rights."
      ),
      ZionismLesson(
        ...
        content: """
          ...
          **Source:** Gallup, Pew polling
          """,
        keyTakeaway:
          "The U.S. gives Israel $3.8 billion/year and has vetoed 50+ UN resolutions protecting it. AIPAC is one of the most powerful lobbies. This support continues regardless of Israeli policies, unlike any other bilateral relationship."
      ),
      ZionismLesson(
        ...
        content: """
          ...
          **The Response:**
          ...
          """,
        keyTakeaway:
          "Amnesty International, Human Rights Watch, B'Tselem (Israeli organization), and UN bodies have concluded Israel practices apartheid. This is based on documented facts and international legal definitions, not opinion."
      ),
      ZionismLesson(
        ...
        content: """
          ...
          **Final Thought:**
          ...
          """,
        keyTakeaway:
          "This documented history shows a pattern of displacement, occupation, and human rights violations—recognized by international law and human rights organizations. Understanding this history is the first step toward justice."
      ),
    ]
  }
}
