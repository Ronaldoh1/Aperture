...
struct AwakeningPathsSynthesis {
    ...
    static let paths: [AwakeningPath] = [
        ...
        AwakeningPath(
            ...
            trigger: "Crisis, loss, breakdown, spontaneous Kundalini activation, near-death experience, betrayal",
            characteristics: [
            ...
            outcome: "If you survive, extremely powerful. You've been forged in fire. You can guide others through what you endured.",
            famousExamples: [
            ...
            forWhom: "Those whose souls chose the accelerated path. Often has past-life preparation. Not chosen consciously — it chooses you.",
            color: "#F44336",
            icon: "flame.fill",
            detailedDescription: """
            **THE TRAUMA PATH**
        ...
        AwakeningPath(
            ...
            outcome: "Integrated awakening, less trauma, more grounded. The consciousness shift happens gradually, allowing full integration.",
            famousExamples: [
                "Thich Nhat Hanh (decades of practice)",
                "Dalai Lama (monastic training since childhood)",
                "Adyashanti (years of Zen before awakening)"
            ],
            forWhom: "Those who prefer stability over intensity. Those with time and patience. Those with access to teachers and community.",
            color: "#4CAF50",
            icon: "leaf.fill",
            detailedDescription: """
            **THE MEDITATION PATH**
        ...
        AwakeningPath(
            ...
            outcome: "Profound insight, but temporary. The glimpse shows what's possible but must translate to daily life through integration work.",
            famousExamples: [
            ...
            forWhom: "Those seeking a glimpse to validate the path. Those stuck in intellectual understanding who need experiential knowing. Those with proper set, setting, and integration support.",
            color: "#9C27B0",
            icon: "sparkles",
            detailedDescription: """
        ...
        AwakeningPath(
            ...
            trigger: "Relentless questioning, systems analysis, philosophy, comparative religion, pattern recognition",
            characteristics: [
            ...
            outcome: "Clear frameworks, articulate teaching ability, but must eventually drop into embodiment. The map isn't the territory.",
            famousExamples: [
                "Ken Wilber (Integral Theory)",
                "Alan Watts (comparative religion)",
                "Jiddu Krishnamurti (philosophical inquiry)"
            ],
            forWhom: "Those with strong analytical minds. Researchers, academics, engineers who need to understand before they believe. Those who enjoy study and synthesis.",
            color: "#3F51B5",
            icon: "brain",
            detailedDescription: """
        ...
        AwakeningPath(
            ...
            outcome: "Embodied compassion, natural teacher/healer. The awakening is grounded in real-world benefit, not abstract realization.",
            famousExamples: [
                "Mother Teresa (service to the poorest)",
                "Thich Nhat Hanh (engaged Buddhism)",
                "Nelson Mandela (service through justice)"
            ],
            forWhom: "Those who feel called to serve. Natural caregivers, healers, activists. Those who awaken best by forgetting themselves in service to others.",
            color: "#FF9800",
            icon: "heart.fill",
            detailedDescription: """
