...
struct GodModeHubView: View {
    ...
    enum GodModeTool: String, CaseIterable {
        ...
        var gradient: [Color] {
            switch self {
            case .monadForge: return [Color(red: 1, green: 0.5, blue: 0), Color(red: 1, green: 0.2, blue: 0)]
            case .sats: return [Color(red: 0.3, green: 0.3, blue: 0.8), Color(red: 0.1, green: 0.1, blue: 0.4)]
            case .threeSixNine: return [Color(red: 0.6, green: 0.3, blue: 1), Color(red: 0.4, green: 0.1, blue: 0.8)]
            case .revision: return [Color(red: 0, green: 0.8, blue: 0.6), Color(red: 0, green: 0.5, blue: 0.4)]
            case .mentalDiet: return [Color(red: 0.2, green: 0.7, blue: 1), Color(red: 0.1, green: 0.4, blue: 0.8)]
            case .solarSync: return [Color(red: 1, green: 0.84, blue: 0), Color(red: 1, green: 0.6, blue: 0)]
            case .bardoNavigator: return [Color(red: 0.3, green: 0.1, blue: 0.3), Color(red: 0.1, green: 0, blue: 0.2)]
            case .vibrationShield: return [Color(red: 0, green: 0.9, blue: 1), Color(red: 0.4, green: 0.6, blue: 1)]
            case .dailyCheckIn: return [Color(red: 0.2, green: 0.8, blue: 0.4), Color(red: 0.1, green: 0.5, blue: 0.3)]
            case .synchronicities: return [Color(red: 0.9, green: 0.4, blue: 0.8), Color(red: 0.6, green: 0.2, blue: 0.6)]
            }
        }
    }
        ...
        VStack(spacing: 16) {
            ...
            if manager.dailyStreakDays > 0 {
                HStack {
                    ...
                    Text("Next: \(manager.nextLevelThreshold - manager.realityShiftsCompleted) shifts to level up")
...
struct RevisionLabView: View {
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                LinearGradient(colors: [Color(hex: "0a0a1a"), Color(hex: "0a1a2a")], startPoint: .top, endPoint: .bottom).ignoresSafeArea()
                VStack(spacing: 20) {
                    Text("🔄").font(.system(size: 60))
                    Text("Revision Lab").font(.title2).fontWeight(.bold).foregroundStyle(.white)
                    Text("Rewrite past events in your imagination.\nRemember them differently until the memory feels natural.")
                        .font(.body).foregroundStyle(.white.opacity(0.7)).multilineTextAlignment(.center).padding()
                }
            }
            .navigationTitle("Revision Lab")
            .navigationBarTitleDisplayMode(.inline)
            .toolbar { ToolbarItem(placement: .navigationBarTrailing) { Button("Done") { dismiss() }.foregroundStyle(Color(hex: "00BFFF")) } }
        }
    }
}
...
struct MonadCheckInView: View {
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                LinearGradient(colors: [Color(hex: "0a0a1a"), Color(hex: "1a2a1a")], startPoint: .top, endPoint: .bottom).ignoresSafeArea()
                VStack(spacing: 20) {
                    Text("✅").font(.system(size: 60))
            ...
            .navigationBarTitleDisplayMode(.inline)
            .toolbar { ToolbarItem(placement: .navigationBarTrailing) { Button("Done") { dismiss() }.foregroundStyle(Color(hex: "27AE60")) } }
        }
    }
}
