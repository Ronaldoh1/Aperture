...
""",
                    ...
                    whoBenefits: "Banks (mortgages), corporations (workers who can't quit), government (stable tax base)",
...
""",
                    ...
                    whatToDoInstead: "Work smart, not just hard. Build assets, not just income. Change the game, don't just play it."
                ),
...
""",
                    ...
                    whoBenefits: "Employers who don't pay pensions. Government that collects more than it pays.",
                    whatToDoInstead: "Build passive income. Create assets. Don't trade 40 years of life for a maybe-retirement."
                )
            ]
        ),
...
""",
                    ...
                    whatToDoInstead: "Consider trade schools, apprenticeships, self-education, building skills directly. College can be valuable—but it's not the only path."
                ),
...
""",
                    ...
                    whatToDoInstead: "If you go, minimize debt. Community college first. In-state schools. Scholarships. Or skip entirely and build skills."
                ),
...
""",
                    ...
                    whatToDoInstead: "Learn skills that matter. Build a portfolio. Create proof of competence, not just credentials."
                )
            ]
        ),
...
""",
                    ...
                    whatToDoInstead: "Pay in full every month or don't use cards. Use debit. Build emergency fund. Live below means."
                ),
...
""",
                    whoCreatedIt: "Government (guaranteed the loans), banks (lobbied for no bankruptcy discharge)",
                    whoBenefits: "Loan servicers, universities, collection agencies",
                    whatToDoInstead: "Minimize borrowing. Understand the terms. Consider alternatives. If you have loans, aggressive payoff > minimum payments."
                ),
...
""",
                    ...
                    whatToDoInstead: "Understand the game. Play it strategically. But recognize it's a game designed for their benefit, not yours."
                )
            ]
        ),
...
""",
                    ...
                    whatToDoInstead: "Vote. Organize. Demand accountability. Question every budget that claims there's 'no money' for domestic needs."
                ),
...
""",
                    ...
                    whoBenefits: "Defense contractors, military officials, politicians who receive contributions",
                    whatToDoInstead: "Support military audit requirements. Question 'defense' spending. Demand domestic investment."
                ),
...
""",
                    ...
                    whatToDoInstead: "Support universal healthcare. Understand that 'we can't afford it' is a lie—we already pay more than universal would cost."
                )
            ]
        )
    ]
