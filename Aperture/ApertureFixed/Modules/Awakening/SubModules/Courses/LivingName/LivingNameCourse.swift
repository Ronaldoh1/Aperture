...
""",
                    keyInsight: "Yeshua wasn't just a name—it was a frequency, a code pointing to a state of being to be realized, not a person to be worshipped.",
                    practice: "Say 'Yeshua' out loud slowly. Notice how different it feels from 'Jesus.' Feel the breath required for each syllable."
                ),
...
""",
                    keyInsight: "Each translation stripped away sacred sounds—the Shin (fire), the breath, the depth. By the time we got 'Jesus,' the vibration was gone.",
                    practice: "Research the letter J. It didn't exist until the 1500s. What does this mean for how we've been pronouncing sacred names?"
                ),
...
""",
                    keyInsight: "The inversion: from 'become like him' to 'worship him forever separate.' From inner awakening to outer obedience.",
                    practice: "List three things you were taught to seek outside yourself that Yeshua said were within you."
                )
            ]
        ),
...
""",
                    keyInsight: "Constantine needed religious unity for political control. A decentralized mystical movement had to become a centralized institution.",
                    practice: "Research what Constantine's actual religious beliefs were. Notice: he wasn't baptized until his deathbed."
                ),
...
""",
                    keyInsight: "The Nicene Creed established who Christ was—but conspicuously left out what he actually taught about the kingdom within.",
                    practice: "Read the Nicene Creed. Notice: it's entirely about believing facts about Jesus, not practicing what he taught."
                ),
...
""",
                    keyInsight: "The Nag Hammadi texts reveal an original Christianity focused on becoming, not believing—on inner awakening, not outer worship.",
                    practice: "Read Gospel of Thomas, Saying 3. Compare it to anything you were taught in Sunday school."
                )
            ]
        ),
...
""",
                    keyInsight: "Yeshua's letters spell a process: Divine spark → Fire of transformation → Connection/spine → Spiritual sight.",
                    practice: "Draw each Hebrew letter. Meditate on what it represents. Feel the journey encoded in the name."
                ),
...
""",
                    keyInsight: "Yeshua contains the sacred name YHVH with Shin (fire) inserted—the divine made manifest, the Logos encoded.",
                    practice: "Write YHVH. Then write Yeshua. See how the fire (Shin) transforms the unmanifest into the manifest."
                ),
...
""",
                    keyInsight: "Speaking 'Yeshua' with breath and intention isn't worship—it's activation. The name is technology for awakening.",
                    practice: "In a quiet space, breathe the name Yeshua three times. Feel the vibration in your chest, your spine, your head."
                )
            ]
        ),
...
""",
                    keyInsight: "Pistis: believe and be saved someday. Gnosis: know yourself and realize you are already saved now.",
                    practice: "Ask yourself: Am I practicing faith in external authority, or cultivating direct inner knowing?"
                ),
...
""",
                    keyInsight: "Gnosis was declared heresy not because it was wrong, but because it made the institution unnecessary.",
                    practice: "Consider: What would change in your spiritual life if you truly believed you had direct access to the divine?"
                ),
...
""",
                    keyInsight: "'The kingdom is spread out upon the earth and people do not see it.' — Gospel of Thomas. It's already here. You just need eyes to see.",
                    practice: "Read Gospel of Thomas in full. It's available free online. Notice how different it feels from the canonical gospels."
                )
            ]
        ),
...
""",
                    keyInsight: "Christos means 'anointed'—and the mystery schools taught this anointing was an actual substance produced in the body.",
                    practice: "Research the claustrum in neuroscience. Notice how little is known about its function."
                ),
...
""",
                    keyInsight: "33 vertebrae, 33 years, 33 degrees—the resurrection is an inner ascent, the Christ rising within the human spine.",
                    practice: "Sit upright. Breathe into the base of your spine. Visualize light rising through each vertebra. This is the path."
                ),
...
""",
                    keyInsight: "Yeshua was the template, not the exception. 'Greater works than these shall you do.' The resurrection is available to you.",
                    practice: "Re-read John 14:12 until it sinks in. He said you would do GREATER works. What would you do if you believed this?"
                )
            ]
        ),
...
""",
                    keyInsight: "This isn't learning—it's remembrance. Your soul has been waiting for permission to know what it already knows.",
                    practice: "Sit with the weight of what you've learned. Let it integrate. Don't rush to conclusions—let it settle."
                ),
...
""",
                    keyInsight: "Declaration is activation. Speaking these truths with intention is not affirmation—it's awakening.",
                    practice: "Speak the declaration aloud. Daily. Until it moves from words to knowing to being."
                ),
...
🔥 **Yeshua. It is done.**
""",
                    keyInsight: "The name is the practice. Breathe it. Feel it. Let it rise. You are not learning about awakening—you are awakening.",
                    practice: "Make this a daily practice. Morning. Evening. Breathe the name. Feel the light. Remember."
                )
            ]
        )
    ]
...
extension LivingNameModule: Equatable {
    static func == (lhs: LivingNameModule, rhs: LivingNameModule) -> Bool { lhs.id == rhs.id }
}

extension LivingNameLesson: Equatable {
    static func == (lhs: LivingNameLesson, rhs: LivingNameLesson) -> Bool { lhs.id == rhs.id }
}
