...
extension TimelineDragonSceneView {
  final class Coordinator {
    ...
    private var dragonNode: SCNNode = .init()
    private var coreNode: SCNNode = .init()
    private var textNode: SCNNode = .init()
    ...
    private func makeTextNode(string: String, fontName: String, fontSize: CGFloat) -> SCNNode {
      ...
      text.flatness = 0.2
      text.font =
        UIFont(name: fontName, size: 24)
        ?? UIFont.monospacedSystemFont(ofSize: 24, weight: .regular)
