...
struct BothSidesData {
    ...
    static let democratReceipts: [PoliticalReceipt] = [
        ...
        PoliticalReceipt(
            ...
            receipt: "Highest single-year removals in 2024. 60,000+ migrants went missing under his watch",
    ...
    static let commonGround: [CommonGround] = [
        ...
        CommonGround(
            ...
            actualTruth: "ALL corporate media serves corporate interests. Different flavors, same owners.",
            icon: "tv"
        ),
        CommonGround(
