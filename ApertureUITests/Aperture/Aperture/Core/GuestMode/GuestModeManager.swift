...
enum SampleContentProvider {
  ...
  static let alexandriaSamples: [AlexandriaSample] = [
    AlexandriaSample(
      ...
      whyHidden:
        "Excluded from the Bible because it emphasized personal revelation over institutional authority. The sayings suggest that each person can access divine wisdom directly, without priests or church hierarchy.",
      color: "#E67E22"
    ),
    AlexandriaSample(
      id: "apocryphon_john",
      ...
      whyHidden:
        "This text was actively suppressed because it presents a completely different creation story, identifies the Old Testament god as a villain, and teaches that salvation comes through knowledge rather than faith.",
      color: "#3498DB"
    ),
    AlexandriaSample(
      ...
      whyHidden:
        "Hermetic texts were not as actively suppressed as Gnostic ones, but they were marginalized as 'pagan philosophy.' During the Renaissance, their rediscovery sparked a revolution in Western thought.",
      color: "#1ABC9C"
    ),
  ]
  ...
  static let awakeningPathSamples: [AwakeningPathSample] = [
    AwakeningPathSample(
      ...
      universalConnection:
        "The same energy is called Qi in Taoism, Holy Spirit in Christianity, and Ki in Japanese traditions. Different names, same force."
    ),
    AwakeningPathSample(
      id: "buddhism",
      ...
      universalConnection:
        "The Buddhist concept of 'no-self' parallels the Christian mystical 'death of ego,' Sufi 'fana,' and Taoist 'emptiness.' All point to transcending limited identity."
    ),
    AwakeningPathSample(
      ...
      universalConnection:
        "'Christ in you, the hope of glory' parallels the Hindu Atman, Buddhist Buddha Nature, and Sufi divine spark. The divine is not separate but within."
    ),
    AwakeningPathSample(
      id: "taoism",
      name: "Qi Cultivation",
      ...
      universalConnection:
        "Qi is Prana in yoga, Ruach in Hebrew, Pneuma in Greek. Every culture recognized life force energy flowing through all things."
    ),
    AwakeningPathSample(
      id: "sufism",
      ...
      universalConnection:
        "Sufi fana (annihilation) is identical to Buddhist anatta (no-self) and Christian kenosis (self-emptying). Love dissolves the illusion of separation."
    ),
  ]
