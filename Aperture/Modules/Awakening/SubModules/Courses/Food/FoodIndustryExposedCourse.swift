...
struct FoodIndustryExposedCourse: View {
    ...
    private var shockingStats: some View {
        VStack(spacing: 16) {
            ...
            Text("Americans are sicker and dying younger than people in other wealthy nations. The food supply is a major reason.")
                .font(.system(size: 12))
    ...
    private var bannedElsewhereSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(spacing: 12) {
                bannedItem("Potassium Bromate", "In bread", "Banned in EU, UK, Canada, China", "Linked to cancer")
                bannedItem("Brominated Vegetable Oil (BVO)", "In sodas", "Banned in EU, Japan", "Affects thyroid, nervous system")
                bannedItem("Titanium Dioxide", "In candy, frosting", "Banned in EU (2022)", "DNA damage concerns")
                bannedItem("Red Dye 3", "In candy, frosting", "Banned in EU", "Thyroid tumors in animals")
                bannedItem("Azodicarbonamide", "In bread", "Banned in EU, Australia", "Respiratory issues, linked to cancer")
                bannedItem("rBGH/rBST", "In milk", "Banned in EU, Canada, Japan", "Increases IGF-1 (cancer link)")
                bannedItem("Ractopamine", "In pork, beef", "Banned in 160+ countries", "Heart problems")
                bannedItem("Chlorine-washed chicken", "Poultry", "Banned in EU", "Masks unsanitary conditions")
            }
            
            Text("The EU uses the 'precautionary principle': if evidence suggests harm, ban it until proven safe. The US does the opposite: allow until proven harmful.")
                .font(.system(size: 11))
                .foregroundColor(.orange)
        }
        .padding()
    ...
    private func bannedItem(_ name: String, _ found: String, _ banned: String, _ concern: String) -> some View {
        VStack(alignment: .leading, spacing: 4) {
            HStack {
                Text(name)
        ...
        [
            FoodLesson(
                ...
                **Coca-Cola alone spends $4 billion/year on marketing.**
                """,
                keyTakeaway: "The sugar industry paid scientists to blame fat for heart disease. This lie shaped 50 years of nutrition policy. Average American eats 19 teaspoons of sugar daily—3x the recommended amount. Obesity and diabetes followed."
            ),
            FoodLesson(
                ...
                **If your grandparents wouldn't recognize it as food, it's probably ultra-processed.**
                """,
                keyTakeaway: "60%+ of American calories come from ultra-processed foods. They're engineered with 'bliss points' to override satiety. Studies link them to obesity, cancer, depression, and early death. People eat 500 more calories when fed ultra-processed diets."
            ),
            FoodLesson(
                ...
                **The customer is the industry, not you.**
                """,
                keyTakeaway: "The FDA is captured by the industry it regulates. The GRAS loophole lets companies self-approve additives. 10,000+ additives with minimal review. 3,000+ are banned in Europe but legal in US. Revolving door between FDA and industry is normal."
            ),
            FoodLesson(
                ...
                **Only meaningful labels:**
                ...
                """,
                keyTakeaway: "99% of US meat comes from factory farms with horrific conditions. 80% of antibiotics go to livestock, creating resistant superbugs. Ag-gag laws make documenting conditions illegal. Most labels ('natural,' 'farm fresh') are meaningless."
            ),
            FoodLesson(
                ...
                **What You Can Do:**
                ...
                """,
                keyTakeaway: "The dairy industry spends $200M+/year on marketing. Countries with highest dairy consumption have highest osteoporosis rates. 65% of humans are lactose intolerant. rBGH is banned in most countries but legal in US. 'Got Milk?' was propaganda, not science."
            ),
            FoodLesson(
                ...
                **Poor communities eat more processed food because it's what they can afford.**
                ...
                """,
                keyTakeaway: "Modern American food is reorganized corn—it's in nearly everything. $5B+ in subsidies make corn artificially cheap. HFCS introduction timeline matches obesity epidemic. Corn-fed animals are less healthy than grass-fed. Policy makes junk food cheaper than vegetables."
            ),
            FoodLesson(
                ...
                **Practical approach:**
                ...
                """,
                keyTakeaway: "70% of non-organic produce has pesticide residues. Glyphosate found in 80%+ of Americans' urine. WHO says probably carcinogenic. Use the Dirty Dozen/Clean Fifteen to prioritize organic purchases. No one tests cumulative effects."
            ),
            FoodLesson(
                ...
                **None of these benefits are for you.**
                """,
                keyTakeaway: "10,000+ additives allowed in US food. BHA is 'reasonably anticipated to be carcinogenic' but legal. Food dyes require warning labels in EU, not US. WHO says aspartame is 'possibly carcinogenic.' 'Natural flavors' can mean 100+ mystery chemicals."
            ),
            FoodLesson(
                ...
                **Both are needed. Policy changes require political will.**
                """,
                keyTakeaway: "73% of Americans are overweight/obese—up from 13% in 1960. Portion sizes tripled. 23 million live in food deserts. $14 billion/year marketing junk to kids. The system profits from obesity. It's not personal failure—it's design."
            ),
            FoodLesson(
                ...
                **Your health is your wealth. Protect it.**
                """,
                keyTakeaway: "Use the 80/20 rule—whole foods 80% of the time. Shop perimeter, read ingredients, use apps like Yuka to scan products. Cooking at home is always healthier and cheaper. Support systemic change while making better individual choices. Your health is your wealth."
            )
        ]
    }
}
