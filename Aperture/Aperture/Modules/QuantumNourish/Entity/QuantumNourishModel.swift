...
enum FrequencyTier: String, CaseIterable, Codable {
    ...
    var description: String {
        switch self {
        case .destructive: return "Actively destroys cellular coherence. Calcifies the pineal gland. Disrupts the electromagnetic field."
        case .acidic: return "Creates acidic environment. Feeds inflammation. Lowers energy body resonance."
        case .low: return "Minimal life force. Heavily processed. Dead frequency — no biophotonic activity."
        case .neutral: return "Neither harmful nor elevating. Maintains baseline but doesn't raise vibration."
        case .mediumLow: return "Beginning to carry life force. Some biophotonic activity. Supports basic cellular function."
        case .mediumHigh: return "Strong life force. Active enzymes. Supports chakra alignment and mental clarity."
        case .high: return "Powerful vibrational food. Enhances intuition, pineal activation, and electromagnetic coherence."
        case .superHigh: return "Transcendent frequency. Essential oils, raw superfoods, and sacred plant medicines that activate dormant DNA."
        }
    }
...
enum QuantumPillar: String, CaseIterable {
    ...
    var description: String {
        switch self {
        case .gutBrain: return "The gut produces 90% of serotonin and 50% of dopamine. Heal your gut, heal your consciousness. Prebiotics, probiotics, and fermented foods rebuild the neural highway between belly and brain."
        case .pineal: return "Your pineal gland is the seat of the third eye — the antenna for higher consciousness. Fluoride, heavy metals, and processed foods calcify it. Specific foods decalcify and reactivate this sacred organ."
        case .pituitary: return "The master gland that orchestrates your entire endocrine system. Proper nutrition supports hormonal balance, growth hormone production, and the body's ability to regenerate at cellular level."
        case .mitochondrial: return "Your mitochondria are the power plants of consciousness. They convert food into ATP — the energy currency that powers every thought, every insight, every moment of awareness."
        case .emField: return "Your bioelectromagnetic field extends 3-5 feet from your body. High-frequency foods strengthen this field. Low-frequency foods create holes. Your aura is literally what you eat."
        case .quantumFeast: return "The synthesis of all pillars. Eating becomes ceremony. Food becomes medicine. Your plate becomes a portal for consciousness elevation."
        }
    }
    
    var topFoods: [String] {
        switch self {
        case .gutBrain: return ["Sauerkraut", "Kimchi", "Kefir", "Bone Broth", "Prebiotic Fiber", "Miso", "Apple Cider Vinegar"]
        case .pineal: return ["Raw Cacao", "Turmeric", "Chlorella", "Spirulina", "Oregano Oil", "Neem", "Tamarind"]
        case .pituitary: return ["Raw Coconut Oil", "Manganese-rich foods", "Vitamin E foods", "Pumpkin Seeds", "Brazil Nuts"]
        case .mitochondrial: return ["CoQ10 foods", "PQQ foods", "NAD+ precursors", "Wild-caught Salmon", "Grass-fed Liver"]
        case .emField: return ["Living Sprouts", "Raw Greens", "Spring Water", "Grounding Foods", "Rose Essential Oil"]
        case .quantumFeast: return ["Raw Organic Everything", "Blessed Water", "Conscious Preparation", "Sun-charged Foods"]
        }
    }
}
