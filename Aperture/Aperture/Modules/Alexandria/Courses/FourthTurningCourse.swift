...
enum FourthTurningCourse {
  static let course = AlexandriaCourse(
          ...
          ACLesson(
            ...
            content: """
              ...
              **And right now? We're in Winter.**
              ...
              """,
            keyInsight:
              "History moves in 80-year cycles with four seasons. We're currently in Winter (the Fourth Turning), a crisis phase predicted to climax 2025-2033. This has happened before — and every time, society was rebuilt stronger.",
            practice:
              "Count back 80 years from major crises: 2008 → 1929 (Depression), 1860 (Civil War), 1776 (Revolution). The pattern is real. What does that mean for what comes next?"
          ),
          ACLesson(
            id: "ft1_2",
            ...
            content: """
              ...
              **The question isn't IF this is happening. It's: what will YOU do during Winter?**
              """,
            keyInsight:
              "Every Fourth Turning ends with institutional destruction AND rebuilding, including a complete monetary reset. Continental dollars, Greenbacks, Bretton Woods — each crisis created a new financial system. The current system was built in 1944. It's 80 years old.",
            practice:
              "Open your Timeline in Aperture. Find: Federal Reserve (1913), Gold Standard End (1971), Reaganomics (1980). These aren't random events — they're the Unraveling that led to the current Winter.",
            interactiveElement: .timeline(events: [
              (
                year: "1773", event: "Tea Act sparks Revolution",
                significance: "Economic squeeze → political crisis → new nation"
              ),
              (
                year: "1860", event: "Lincoln elected, South secedes",
                significance: "Moral crisis → civil war → institutional rebirth"
              ),
              (
                year: "1929", event: "Stock market crash",
                significance: "Financial collapse → world war → Bretton Woods reset"
              ),
              (
                year: "2008", event: "Housing crash, bank bailouts",
                significance: "Financial collapse → ??? → monetary reset coming"
              ),
            ])
          ),
        ]
          ...
          ACLesson(
            ...
            content: """
              ...
              **You are not random. Your generation has a role. The question is whether you play it consciously or get swept along.**
              """,
            keyInsight:
              "Generational archetypes repeat every 80 years in the same order: Prophet → Nomad → Hero → Artist. Each has a specific role during crisis. Millennials are the current Hero generation — destined to rebuild, just like the GI Generation rebuilt after WWII.",
            practice:
              "Identify your archetype. Boomer? You're the Prophet — your role is wisdom, not culture wars. Gen X? You're the Nomad — lead with pragmatism. Millennial? You're the Hero — build. Gen Z? You're the Artist — observe, adapt, humanize.",
            interactiveElement: .comparison(
              left: "Last Cycle (1940s)",
              right: "This Cycle (2020s)",
              rows: [
                (
                  leftVal: "Missionary Gen (Prophets/elders)",
                  rightVal: "Baby Boomers (Prophets/elders)"
                ),
          ...
          ACLesson(
            ...
            content: """
              ...
              **Winter doesn't just break things. It burns away what was already dead.**
              """,
            keyInsight:
              "Calhoun's mouse utopia experiment shows that abundance without purpose leads to societal collapse — 'beautiful ones' who disengage entirely. Today's anxiety epidemic, birth rate decline, and social disconnection mirror this pattern exactly. The Fourth Turning crisis forces re-engagement.",
            practice:
              "Honest self-assessment: are you engaging with real community, or performing for algorithms? Are you building something, or just consuming? The behavioral sink is optional — but only if you choose to opt out."
          ),
        ]
      ),
          ...
          ACLesson(
            ...
            content: """
              ...
              **While you argue about left vs. right, the monetary system that governs your ENTIRE economic life is being restructured. The people restructuring it are not asking your opinion.**
              ...
              """,
            keyInsight:
              "Every Fourth Turning produces a monetary reset. The current dollar system (Bretton Woods, 1944) is 80 years old — one full cycle. Central banks are hoarding gold at record rates. BRICS nations are building dollar alternatives. The reset is not coming — it's already started.",
            practice:
              "Check: how much of your wealth is in 'paper promises' (dollars, stocks, bonds) vs. real assets (skills, land, precious metals, community)? You don't need to panic-sell anything. Just know where you stand."
          ),
          ACLesson(
            id: "ft3_2",
            ...
            content: """
              ...
              **None of this is partisan.** Both parties benefit from you being distracted by culture wars. Culture wars are FREE. Fixing the economy costs money that goes to donors.
              ...
              """,
            keyInsight:
              "While media keeps you focused on partisan theater, the actual economy is being restructured: unprecedented money printing, corporate consolidation, lobbying ROI of 200:1, housing financialization, and CBDC development. None of this is partisan — both parties benefit from your distraction.",
            practice:
              "This week, spend 30 minutes reading about ONE of these topics from a primary source (Fed statements, SEC filings, CBO reports) instead of from someone's reaction tweet. Primary sources change everything."
          ),
        ]
      ),
          ...
          ACLesson(
            ...
            content: """
              ...
              **6. HEDGE PRUDENTLY**
              ...
              """,
            keyInsight:
              "Six historically-informed actions: diversify into real assets, build community, develop skills, stay informed, plant seeds for renewal, and hedge across scenarios. These aren't doomsday prep — they're what worked in every previous Fourth Turning.",
            practice:
              "Rate yourself 1-5 on each of the six areas. Where are you weakest? That's your starting point. Pick ONE and take a concrete step this week."
          ),
          ACLesson(
            id: "ft4_2",
            ...
            content: """
              ...
              **6. DON'T APPLY ONE-SIZE-FITS-ALL**
              ...
              """,
            keyInsight:
              "Six critical mistakes to avoid: panicking, keeping all wealth in paper assets, isolating (becoming Calhoun's 'beautiful ones'), falling for fear-mongering salesmen, being passive, and applying generic advice without adapting to your situation.",
            practice:
              "Which of these six traps are you closest to falling into? Be brutally honest. That's your biggest vulnerability right now.",
          ...
          ACLesson(
            ...
            content: """
              ...
              **The people who plant seeds during Winter harvest in Spring.** What are you planting?
              ...
              """,
            keyInsight:
              "Every Fourth Turning produced extraordinary renewal: the Constitution, abolition, the middle class. The current crisis will destroy broken systems (healthcare, education, media, finance) and create space for something better. The question is who builds it — and whether you're one of the builders.",
            practice:
              "Write down three things about the current world you'd want to see rebuilt differently. Then ask: what can I do THIS WEEK — even something tiny — to plant a seed toward that future?"
          )
        ]
      ),
    ],
    ...
    dragonComment:
      "1776. 1860. 1929. 2008. Count the gaps. 84 years. 69 years. 79 years. The clock doesn't care about your politics. Winter is here. Plant seeds or freeze."
  )
}
