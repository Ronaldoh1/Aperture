...
enum SacredFrequencies {
  static let solfeggio: [SacredFrequency] = [
    SacredFrequency(
      hz: 174, name: "Foundation", nickname: "Foundation Frequency",
      effects: ["Grounding", "Pain reduction", "Security"], chakra: "Below Root"),
    SacredFrequency(
      hz: 285, name: "Healing", nickname: "Quantum Cognition",
      effects: ["Tissue regeneration", "Cellular repair"], chakra: "Root"),
    SacredFrequency(
      hz: 396, name: "Liberation", nickname: "Liberating Guilt & Fear",
      effects: ["Release guilt", "Transform grief"], chakra: "Root"),
    SacredFrequency(
      hz: 417, name: "Undoing", nickname: "Transmutation",
      effects: ["Clear trauma", "Break patterns"], chakra: "Sacral"),
    SacredFrequency(
      hz: 528, name: "Transformation", nickname: "Love Frequency",
      effects: ["DNA repair", "Miracles", "Transformation"], chakra: "Heart"),
    SacredFrequency(
      hz: 639, name: "Connection", nickname: "Connecting & Relationships",
      effects: ["Harmonize relationships", "Cell communication"], chakra: "Throat"),
    SacredFrequency(
      hz: 741, name: "Awakening Intuition", nickname: "Expression & Solutions",
      effects: ["Awakening", "Problem solving"], chakra: "Third Eye"),
    SacredFrequency(
      hz: 852, name: "Spiritual Order", nickname: "Returning to Spiritual Order",
      effects: ["See through illusions", "Inner strength"], chakra: "Crown"),
    SacredFrequency(
      hz: 963, name: "Divine Consciousness", nickname: "God Frequency",
      effects: ["Unity", "Enlightenment", "Cosmic connection"], chakra: "Above Crown"),
  ]

  static let other: [SacredFrequency] = [
    SacredFrequency(
      hz: 7.83, name: "Schumann Resonance", nickname: "Earth's Heartbeat",
      effects: ["Grounding", "Alpha state"], chakra: "Root"),
    SacredFrequency(
      hz: 111, name: "Temple Frequency", nickname: "Holy Frequency",
      effects: ["Right brain activation", "Mystical states"], chakra: "Third Eye"),
    SacredFrequency(
      hz: 136.1, name: "Om Frequency", nickname: "Earth Year",
      effects: ["Centeredness", "Meditation"], chakra: "Heart"),
    SacredFrequency(
      hz: 432, name: "Verdi Pitch", nickname: "Natural Tuning", effects: ["Harmony", "Relaxation"],
      chakra: "Heart"),
    SacredFrequency(
      hz: 440, name: "Concert Pitch", nickname: "Standard Tuning",
      effects: ["Modern standard", "Tension (disputed)"], chakra: "N/A"),
  ]
}
