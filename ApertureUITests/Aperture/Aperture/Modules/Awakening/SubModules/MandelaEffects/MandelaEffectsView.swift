      ...
      ZStack {
        ...
        VStack(spacing: 0) {
          ...
          VStack(spacing: 8) {
            ...
            Text(
              "When large groups of people remember events differently than they occurred. Named after many remembering Nelson Mandela dying in prison in the 1980s—he actually died in 2013."
            )
            .font(.caption)
              ...
              ForEach(MandelaCategory.allCases, id: \.self) { cat in
                Button(action: { selectedCategory = cat }) {
                  Text(cat.rawValue)
                    ...
                    .padding(.vertical, 8)
                    .background(
                      selectedCategory == cat ? Color(hex: "E74C3C") : Color.white.opacity(0.1)
                    )
                    .cornerRadius(20)
...
struct MandelaEffect: Identifiable {
  ...
  static let allEffects: [MandelaEffect] = [
    ...
    MandelaEffect(
      ...
      evidence:
        "Widely misquoted in media, parodies, and cultural references. The actual line has no 'Luke' in it.",
      theories: [
        "Misquoting in parodies spread the wrong version",
        "The context needed 'Luke' for clarity when quoted",
        "Human memory fills in contextual gaps",
      ]
    ),
    ...
    MandelaEffect(
      ...
      evidence:
        "The Queen says 'Magic mirror' in the 1937 Disney film. 'Mirror, mirror' is from the original Brothers Grimm tale.",
      theories: [
        "Grimm version replaced Disney in memory", "Alliterative version is more memorable",
        "Cultural bleed-over between versions",
      ]
    ),
    ...
    MandelaEffect(
      ...
      evidence:
        "Forrest says 'was' referring to what his mama told him. Present tense sounds more aphoristic.",
      theories: [
        "Present tense works better as life advice", "Memory converts narrative to maxim",
        "Subtle difference easily overlooked",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "'We' feels more dramatic/relatable", "Misremembering due to audience identification",
        "Slight difference, easy substitution",
      ]
    ),
    ...
    MandelaEffect(
      ...
      evidence:
        "Hannibal Lecter never says 'Hello, Clarice' in the film. He says 'Good morning' when they first meet.",
      theories: [
        "Anthony Hopkins later said the line in other media", "Parodies cemented the fake version",
        "Expectation of dramatic greeting",
      ]
    ),
    ...
    MandelaEffect(
      ...
      evidence:
        "Bond himself rarely says this exact line. Others often say it referring to his preference.",
      theories: [
        "Cultural shorthand simplified it", "Marketing emphasized catchphrase",
        "Iconic phrase transcended actual usage",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Generic version more applicable", "Motivational speakers changed it",
        "Plural makes better life advice",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Casual phrasing easier to remember", "Modern speech patterns update quotes",
        "The meaning overshadows exact words",
      ]
    ),
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 75,
      evidence:
        "The actual phrase was 'we've had' (past tense). The movie also uses present tense, compounding confusion.",
      theories: [
        "Present tense is more urgent/dramatic", "Movie influenced memory of real event",
        "Past tense seems grammatically odd",
      ]
    ),
    ...
    MandelaEffect(
      ...
      evidence:
        "E.T. actually says 'E.T. home phone' with alien syntax, though sometimes it varies in the film.",
      theories: [
        "Proper English grammar remembered instead", "Marketing used correct grammar",
        "Alien speech pattern corrected in memory",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "'-stein' is more common surname ending", "Memory regularizes unusual spellings",
        "Most famous Mandela Effect example",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Hyphens in similar brands cause confusion",
        "Grammatically seems like it should be hyphenated", "Visual memory fills in details",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Apostrophes often omitted casually", "Visual memory drops small details",
        "Pronunciation unchanged either way",
      ]
    ),
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 80,
      evidence:
        "It's Tunes (like music) not Toons (like cartoons). Named after Silly Symphonies competitor.",
      theories: [
        "Cartoons = Toons seems logical", "Brain autocorrects to expected",
        "Tiny Toon Adventures adds confusion",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Cornucopia associated with fruit imagery", "Thanksgiving imagery bleed-over",
        "One of strongest Mandela Effects",
      ]
    ),
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 70,
      evidence:
        "There has never been a Jiffy brand peanut butter. Jif and Skippy merged in memory.",
      theories: [
        "'Jiffy' is common word for quick", "Jif + Skippy = Jiffy", "Jiffy Pop popcorn confusion",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "We eat multiple, so plural seems right", "Box of crackers = plural",
        "Language naturally pluralizes",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Regional pronunciation differences", "Visual dyslexia in memory",
        "Less common Mandela Effect",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Fruit is correct spelling", "Brain autocorrects 'misspellings'",
        "Marketing spelling vs real word",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Meyer is more common spelling", "The jingle doesn't clarify spelling",
        "Visual memory approximates",
      ]
    ),
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 70,
      evidence:
        "Looking at a map, South America is much further east than expected. Brazil is east of New York.",
      theories: [
        "Mental model assumes vertical alignment", "Maps distort relative positions",
        "Continental drift memory error",
      ]
    ),
    ...
    MandelaEffect(
      ...
      evidence:
        "Many remember Australia being more isolated. It's actually quite close to Southeast Asia.",
      theories: [
        "Oceania isolation emphasized", "Map projections vary greatly",
        "Cultural isolation vs physical",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Maps often cut off New Zealand", "Mental geography simplified",
        "Direction confusion common",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Island nations seem more isolated", "Maps at different scales",
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 90,
      evidence:
        "The studio recording doesn't end with 'of the world' - just fades out. Live versions often do.",
      theories: [
        "Live versions end differently", "Brain expects musical resolution",
        "Memory completes the phrase",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Indefinite article sounds more natural", "Slight difference, easily missed",
        "Grammar smoothing in memory",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Plural sounds more grammatical", "Misheard lyrics common", "Memory averages to expected",
      ]
    ),
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 60,
      evidence:
        "There is no historical painting of Henry VIII holding a turkey leg, though many remember it.",
      theories: [
        "Renaissance fair imagery", "Conflation with feast scenes", "Pop culture inventions",
      ]
    ),
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 50,
      evidence:
        "The Statue of Liberty is on Liberty Island, not Ellis Island (immigration station).",
      theories: [
        "Both islands associated with immigration", "Close proximity conflated",
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 45,
      evidence:
        "Some remember the Mona Lisa with a neutral expression. The subtle smile has always been there.",
      theories: [
        "Subtlety leads to varied perception", "Psychological projection",
        "Famous 'smile' mystery paradox",
      ]
    ),
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 30,
      evidence:
        "Many people distinctly remember Nelson Mandela dying in prison. He was released in 1990, became president 1994-1999, died in 2013.",
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 40,
      evidence:
        "The famous 'Tank Man' was not run over. He blocked tanks, then was pulled away. His fate remains unknown.",
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 55,
      evidence:
        "Many don't realize eye sockets connect directly to the brain cavity. There's bone around, but openings exist.",
      theories: [
        "Anatomy isn't commonly studied", "Simplified mental models", "Not really a timeline shift",
      ]
    ),
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 65,
      evidence:
        "The heart is not on the left side—it's in the center, tilted slightly left. The apex points left, causing the misconception.",
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 50,
      evidence:
        "Some remember ribs as a complete cage. Lower ribs are 'floating'—not connected to sternum.",
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 85,
      evidence:
        "Curious George has never had a tail in any of the books. He's an ape, not a monkey.",
      theories: [
        "Monkeys have tails, apes don't", "Similar character confusion", "Expectation bias",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Mr. Peanut has monocle", "Rich stereotype includes monocle",
        "Visual memory combines icons",
      ]
    ),
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 70,
      evidence:
        "Pikachu's tail has never had a black tip. His ears have black tips, which may cause confusion.",
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 40,
      evidence:
        "There was never a movie called Shazaam with Sinbad. Kazaam with Shaq existed. Sinbad denies making any genie movie.",
      theories: [
        "Confusion with Kazaam", "Sinbad did other movies in costumes", "Collective false memory",
      ]
    ),
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 45,
      evidence:
        "Mr. Rogers wore many colored cardigans, not exclusively red. Blue and brown were common.",
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 60,
      evidence:
        "In the famous underwear dance scene, Tom Cruise doesn't wear sunglasses. Many posters/parodies add them.",
    ...
    MandelaEffect(
      ...
      percentRememberWrong: 65,
      evidence:
        "In Moonraker, many remember Dolly having braces, creating the joke with Jaws. She didn't.",
      theories: [
        "Narrative logic demands braces", "The scene 'needs' the joke",
        "Memory constructs missing punchline",
      ]
    ),
    ...
    MandelaEffect(
      ...
      theories: [
        "Indefinite article sounds more natural", "Conversational grammar", "Common misremembering",
      ]
    ),
  ]
}
      ...
      ScrollView {
        VStack(alignment: .leading, spacing: 24) {
            ...
            GeometryReader { geo in
              ZStack(alignment: .leading) {
                ...
                Rectangle()
                  ...
                  .frame(
                    width: geo.size.width * CGFloat(effect.percentRememberWrong) / 100, height: 8
                  )
                  .cornerRadius(4)
              }
            }
          ...
          VStack(spacing: 8) {
            ...
            Text(
              "The Mandela Effect is likely explained by the fallibility of human memory, confabulation, and social influence—not alternate timelines. However, exploring these phenomena helps us understand how memory works."
            )
            .font(.caption)
            .foregroundStyle(.white.opacity(0.6))
            .multilineTextAlignment(.center)
