...
struct PsyopDetectionCourseView: View {
  ...
  private var frameworkPreview: some View {
    VStack(spacing: 16) {
      ...
      HStack(spacing: 12) {
        FrameworkBadge(
          title: "F.A.T.E.", subtitle: "Focus • Authority\nTribe • Emotion", color: course.color)
        FrameworkBadge(
          title: "P.C.P.", subtitle: "Perception\nContext • Permission", color: course.color)
  ...
  private var warningSection: some View {
    VStack(alignment: .leading, spacing: 14) {
      ...
      Text(
        "\"Those who believe they're immune to manipulation are the MOST suggestible. They're the easiest to manipulate.\""
      )
      ...
      Text(
        "Technology has outpaced the human brain's ability to adapt. The same techniques that train dolphins control populations. This course teaches you to see the mechanisms."
      )
      ...
      VStack(alignment: .leading, spacing: 10) {
        PsyopKeyPoint(
          text: "Your mammalian brain is the target, not your logic", color: course.color)
        PsyopKeyPoint(
          text: "Suggestibility is FLUID — it can be increased or decreased", color: course.color)
