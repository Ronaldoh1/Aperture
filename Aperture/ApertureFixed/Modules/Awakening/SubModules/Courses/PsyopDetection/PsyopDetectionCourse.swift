...
""",
                    keyInsight: "Those who believe they're immune to manipulation are the MOST suggestible. Protection begins with admitting vulnerability.",
                    framework: "Suggestibility is FLUID, not fixed. It can be increased or decreased based on conditions."
                ),
...
""",
                    keyInsight: "Psyops target the mammalian brain (limbic system), not the logical neocortex. The same techniques that train animals control humans.",
                    framework: "Your emotional brain makes decisions FIRST. Logic comes after to justify what the mammal already chose."
                ),
...
""",
                    keyInsight: "Suggestibility is fluid, not fixed. The goal of mass manipulation is to make you easier to convince of ANYTHING.",
                    framework: "Protection comes from understanding the mechanisms and actively maintaining low suggestibility."
                )
            ]
        ),
...
""",
                    keyInsight: "F.A.T.E. (Focus, Authority, Tribe, Emotion) is the formula for mammalian control. All psyops use some combination.",
...
""",
                    keyInsight: "Focus controls what you think about. Authority controls who you believe. The Milgram experiment proved 100% of people will comply with perceived authority.",
                    framework: "Focus Question: 'What am I NOT being shown?' — Authority Question: 'Who benefits from my compliance?'"
                ),
...
""",
                    keyInsight: "Tribe triggers belonging instincts. Emotion bypasses logic. When both activate, facts become irrelevant—only identity matters.",
                    framework: "Tribe Question: 'Am I believing this because it's TRUE?' — Emotion Question: 'Is this feeling helping me think?'"
                )
            ]
        ),
...
""",
                    keyInsight: "PCP: Perception → Context → Permission. All manipulation works by shifting how you see reality until the desired action feels natural.",
                    framework: "P = Perception (how you see), C = Context (how you understand), P = Permission (what feels allowed)"
                ),
...
""",
                    keyInsight: "The most dangerous manipulation changes context, not facts. Same facts + different context = completely different response.",
                    framework: "Red flag phrases: 'This is really about...' 'The REAL reason...' — These signal context manipulation."
                ),
...
""",
                    keyInsight: "Permission follows context automatically. Psyops stack moral, social, survival, and identity permissions until action feels inevitable.",
                    framework: "Permission Question: 'What permission am I giving myself? Who created this permission structure?'"
                )
            ]
        ),
...
""",
                    keyInsight: "Fractionation: emotional up/down cycling that increases suggestibility with each cycle. It's a clinical hypnosis technique used on populations.",
                    framework: "Each emotional cycle → deeper suggestibility. Theta waves + GABA = maximum compliance."
                ),
...
""",
                    keyInsight: "Mass fractionation: society's emotional highs and lows are engineered. Each cycle makes the population more compliant.",
                    framework: "News pattern: Bad news → Joke → Commercial at the vulnerable point. Emotional cycling = suggestibility farming."
                ),
...
""",
                    keyInsight: "Claim → Joke → Audience reaction = critical factor bypass. You can't laugh and critically evaluate simultaneously.",
                    framework: "The joke prevents logical processing. The audience triggers tribal compliance. The claim lodges as fact."
                )
            ]
        ),
...
""",
                    keyInsight: "Psyop goal: destroy outrage through exhaustion, install apathy. A population that doesn't care can't resist.",
                    framework: "Endless outrage → Exhaustion → Apathy → Compliance. This is engineered, not accidental."
                ),
...
""",
                    keyInsight: "PDS Pipeline: Pacify (loneliness/anesthetics), Distract (timed spectacles), Sedate (information overload + fractionation).",
                    framework: "Always ask: What's the TIMING? What's on page 4? Who benefits from this distraction?"
                ),
...
""",
                    keyInsight: "If a product won't tell you the problem it solves, the problem is probably YOU—your loneliness, dissatisfaction, or autonomy.",
                    framework: "Product Test: What problem does this solve? If they won't say, what does it ACTUALLY solve? Who profits from my compliance?"
                )
            ]
        ),
...
""",
                    keyInsight: "Detection becomes automatic with practice. Run FATE, PCP, Fractionation, and PDS checks until they're reflexive.",
                    framework: "Checklists: FATE (Focus/Authority/Tribe/Emotion), PCP (Perception/Context/Permission), Fractionation, PDS"
                ),
...
""",
                    keyInsight: "Minimize exposure (hard limits, ruthless curation, timing awareness). Maximize recovery (movement, nature, human contact, sleep).",
                    framework: "60-second social media limit. Wait 48 hours before opinions. Don't shame yourself—identify the technique and move on."
                ),
...
""",
                    keyInsight: "The Left/Right division IS the psyop. If you can't see good in opponents or bad in your side, you've been captured.",
                    framework: "Hold beliefs as IDEAS, not IDENTITY. The exit from manipulation is intellectual humility."
                )
            ]
        ),
...
""",
                    keyInsight: "The critical factor is your brain's gatekeeper that evaluates information. All manipulation is designed to bypass, distract, or exhaust it.",
                    framework: "Critical Factor = the part asking 'Is this accurate? Is this good for me?' When it's bypassed, information lodges uncritically."
                ),
...
""",
                    keyInsight: "Claim → Joke → Tribal Reaction = Critical Factor Bypass. You cannot laugh and critically evaluate simultaneously.",
                    framework: "The joke PREVENTS processing. The audience triggers tribal compliance. The claim lodges as fact without examination."
                ),
...
""",
                    keyInsight: "Theta waves (4-7 Hz) + GABA flood = hypnotic compliance state. This is being induced at mass scale through media.",
                    framework: "Theta = dreamy/drowsy state. GABA = safety/calm chemical. Together = critical factor offline, suggestibility maximized."
                )
            ]
        ),
...
""",
                    keyInsight: "The true skill isn't hypnosis—it's target selection. Finding someone already angry, suggestible, and narratively useful.",
                    framework: "Perfect Target = pre-existing anger + fitting narrative + high suggestibility + isolation + plausible motive"
                ),
...
""",
                    keyInsight: "Ideas can be changed; identity cannot. Watch for the transition from 'I believe this' to 'I AM someone who believes this.'",
                    framework: "Selling Identity = 'People like YOU...' / 'Smart people know...' — bypasses logic, connects belief to self-worth."
                ),
...
""",
                    keyInsight: "When something real is happening, watch who suddenly goes QUIET. Silence from powerful people = something real.",
                    framework: "The loud ones get attention. The quiet ones have information. Sudden silence from usually-loud voices = detection signal."
                )
            ]
        ),
...
""",
                    keyInsight: "Baudrillard: We already live in simulation. Simulacra = copies with no original. Hyperreality = simulations better than reality.",
                    framework: "Simulation = copy of real. Simulacra = copy with no original. Hyperreality = simulation preferred to reality."
                ),
...
""",
                    keyInsight: "Five Exit Levels: 1) See beyond walls 2) Exit playable area 3) Exit map entirely 4) Jump to another game 5) Exit the console.",
                    framework: "Level 1 = awakening. Level 3 = pattern recognition. Level 5 = transcendence. Start by finding the boundaries."
                ),
...
""",
                    keyInsight: "Reality is findable: physicality, first-hand experience, ineffability, humility, and direct knowing are the compass points.",
                    framework: "Certainty = suspicious. Ineffability = authentic. Direct experience > told experience. The body is the anchor."
                )
            ]
        )
    ]
...
extension PsyopModule: Equatable {
    static func == (lhs: PsyopModule, rhs: PsyopModule) -> Bool { lhs.id == rhs.id }
}

extension PsyopLesson: Equatable {
    static func == (lhs: PsyopLesson, rhs: PsyopLesson) -> Bool { lhs.id == rhs.id }
}
