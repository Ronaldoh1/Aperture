...
struct SolarTheologyCourseView: View {
    ...
    private var attributionCard: some View {
        VStack(spacing: 12) {
            ...
            Text("\"Once you understand how this stuff works, you begin to see that the story goes back to India. Goes back to the Hindus. Goes back to Egypt.\"")
            ...
            if lesson.sections[currentSection].revealContent != nil && !showReveal {
                ...
                Button {
                    ...
                    HStack {
                        ...
                        Image(systemName: currentSection < lesson.sections.count - 1 ? "chevron.right" : "checkmark")
                    }
                    .foregroundColor(.white)
                }
            }
