...
struct IsraelPalestineHistoryCourse: View {
  ...
  private var contextNote: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      Text(
        "This course presents documented historical facts from scholarly sources, UN records, Israeli historians, and Palestinian accounts. We encourage verification of all claims through the sources provided."
      )
      .font(.system(size: 12))
      ...
      IPLesson(
        ...
        content: """
          ...
          *Source: Herzl's diaries; Benny Morris, "Righteous Victims" (1999)*
          """,
        keyTakeaway:
          "Pre-Zionist Palestine had ~500,000 people—85% Muslim, 10% Christian, 5% Jewish. It was inhabited land with cities, villages, and established communities. Early Zionist leaders knew this."
      ),
      IPLesson(
        ...
        content: """
          ...
          **Arab Responses:**
          ...
          """,
        keyTakeaway:
          "Zionism emerged from real European antisemitism. Early Jewish immigration (1882-1914) was ~70,000 people. Land purchases displaced Arab farmers. Both Jewish persecution in Europe and Palestinian displacement are documented facts."
      ),
      IPLesson(
        ...
        content: """
          ...
          *Source: Original document in British National Archives; Tom Segev, "One Palestine, Complete" (2000)*
          """,
        keyTakeaway:
          "Britain promised Palestine to Zionists (Balfour) while also promising Arab independence. Palestinians—90% of the population—were called 'non-Jewish communities' with no political rights mentioned. They were never consulted."
      ),
      IPLesson(
        ...
        content: """
          ...
          *Source: UN Archives; Benny Morris, "1948" (2008)*
          """,
        keyTakeaway:
          "Under British rule (1920-1948), Jewish population grew from 11% to 33%. The 1936 Arab Revolt was crushed. The UN proposed partition: 56% of land to 33% of population (Jews). Palestinians rejected giving away their majority's land."
      ),
      IPLesson(
        ...
        content: """
          ...
          *Source: UNRWA statistics*
          """,
        keyTakeaway:
          "750,000+ Palestinians became refugees in 1948. Israeli historians document forced expulsions alongside other factors. 400+ villages were destroyed. UN Resolution 194 called for return—never implemented."
      ),
      IPLesson(
        ...
        content: """
          ...
          **The occupation is now longer than most Israelis and Palestinians have been alive.**
          """,
        keyTakeaway:
          "Israel captured the West Bank and Gaza in 1967—57 years ago. UN Resolution 242 called for withdrawal. International law considers the occupation illegal. 5+ million Palestinians live under military rule."
      ),
      IPLesson(
        ...
        content: """
          ...
          **Every Israeli government since 1967 has expanded settlements**—left, right, and center.
          """,
        keyTakeaway:
          "720,000 Israeli settlers live in occupied territory—illegal under international law. Settlements control 40% of West Bank, fragment Palestinian territory, and make a two-state solution increasingly impossible."
      ),
      IPLesson(
        ...
        content: """
          ...
          **Breaking this cycle requires addressing root causes, not just symptoms.**
          """,
        keyTakeaway:
          "Gaza's 2.1 million people have lived under blockade since 2007. UN called it 'unlivable.' 97% of water is undrinkable. Both Hamas attacks on civilians and collective punishment of Gaza's population are documented realities."
      ),
      IPLesson(
        ...
        content: """
          ...
          *Source: Human Rights Watch, Amnesty International, B'Tselem reports*
          """,
        keyTakeaway:
          "Human Rights Watch, Amnesty International, B'Tselem, and UN rapporteurs have concluded Israel practices apartheid. Israel disputes this. The determination has major legal implications."
      ),
      IPLesson(
        ...
        content: """
          ...
          **The US is Israel's crucial shield from international pressure.**
          """,
        keyTakeaway:
          "$3.8 billion annually. 53 UN vetoes. US weapons used in military operations. The US provides unprecedented support—making it uniquely responsible for what that support enables."
      ),
      IPLesson(
        ...
        content: """
          ...
          **Understanding their perspective is not "taking sides"—it's seeing the full picture.**
          """,
        keyTakeaway:
          "Palestinians seek: end of occupation, right of return, viable state or equal rights. They accepted 22% of historic Palestine—Israel hasn't accepted even that. 14 million people asking for rights others take for granted."
      ),
      IPLesson(
        ...
        content: """
          ...
          **Understanding is the first step. What you do with that understanding is up to you.**
          """,
        keyTakeaway:
          "Two-state solution faces 720,000 settlers. One equal state challenges Zionism. Status quo is apartheid according to human rights groups. Peace requires security for Israelis and justice for Palestinians. All human life has equal value."
      ),
    ]
  }
}
