...
struct GnosticRevelationDatabase {
    ...
    static let all: [GnosticRevelation] = [
        ...
        GnosticRevelation(
            ...
            revelation: "In India, the highest priests were called BRAHMANS. Their supreme god was BRAHMA. Put an 'A' in front of Brahman... A-BRAHM. The Bible says Abraham's name was originally ABRAM.\n\nThe Brahman priests bathed in the sacred SARASWATI River.\n\nAbraham + Sarah = Brahman + Saraswati\n\nJudaism traces directly back to Hindu India.",
...
struct TimelineRevelationHelper {
