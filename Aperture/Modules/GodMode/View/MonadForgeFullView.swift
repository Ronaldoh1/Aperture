            ...
            SwiftUI.TimelineView(.animation) { timeline in
                Canvas { context, size in
                    ...
                    for i in 0..<40 {
                        ...
                        let yOffset = sin(time * 2 + seed) * 30 + (time * 50 + seed * 20).truncatingRemainder(dividingBy: size.height)
        ...
        VStack(spacing: 20) {
            ...
            ZStack {
                Circle()
                    .fill(
                        RadialGradient(
                            colors: [Color(red: 1, green: 0.5, blue: 0).opacity(sparkAnimation ? 0.3 : 0.1), Color.clear],
                            center: .center,
                            startRadius: 20,
...
struct CreateRealityShiftView: View {
    ...
    private var step1DesireInput: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            exampleBox("Examples: \"I am wealthy and financially free.\" \"I am in a loving relationship with my soulmate.\" \"I am healthy and full of energy.\"")
    ...
    private var step2SceneInput: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Describe a short scene (5-10 seconds) that IMPLIES the wish is already fulfilled. First person, present tense.")
                .font(.system(size: 14, weight: .medium))
                .foregroundColor(.white.opacity(0.6))
            ...
            exampleBox("Key: The scene must IMPLY the end. Don't visualize getting the thing—visualize HAVING it. Example: For a relationship, imagine lying next to them hearing \"I love you.\" For wealth, imagine checking your balance with calm satisfaction.")
    ...
    private var step3FeelingInput: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("What emotion/feeling anchors this reality? This is your trigger phrase when doubt arises.")
                .font(.system(size: 14, weight: .medium))
                .foregroundColor(.white.opacity(0.6))
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 8) {
                    ForEach(["Isn't it wonderful?", "Thank you!", "It is done.", "Of course."], id: \.self) { anchor in
                            ...
                            Text(anchor)
                                ...
                                .background(
                                    RoundedRectangle(cornerRadius: 8)
                                        .fill(feeling == anchor ? Color(red: 0.2, green: 0.8, blue: 0.4) : Color.white.opacity(0.1))
                                )
                        }
                    }
                }
    ...
    private var step4Review: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                Divider().background(Color.white.opacity(0.1))
                reviewItem("COMMITMENT", "\(targetNights) nights of SATS", Color(red: 1, green: 0.84, blue: 0))
            }
            .padding(20)
            .background(
            ...
            // Neville quote
            VStack(spacing: 8) {
                Text("\"Assume the feeling of the wish fulfilled and observe the route that your attention follows.\"")
...
struct RealityShiftDetailView: View {
    ...
    private var detailsSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            detailItem("FEELING ANCHOR", shift.feelingState, "heart.fill", Color(red: 0.2, green: 0.8, blue: 0.4))
        }
        .padding(20)
        .background(
            RoundedRectangle(cornerRadius: 16)
    ...
    private func detailItem(_ label: String, _ value: String, _ icon: String, _ color: Color) -> some View {
        VStack(alignment: .leading, spacing: 8) {
            HStack(spacing: 6) {
...
extension GodModeHubView {
    // Wire Monad Forge to full view
}
