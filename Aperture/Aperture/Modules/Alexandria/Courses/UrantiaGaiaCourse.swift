...
enum UrantiaGaiaCourse {
  static let course = AlexandriaCourse(
    id: "urantia_gaia", title: "Urantia & Gaia", subtitle: "Two Names, One Living Earth",
    icon: "globe.europe.africa.fill", colorHex: "#27AE60", tier: 3, isPremium: false,
    isUltraPremium: false,
    modules: [
      ACModule(
        id: "ug1", number: 1, title: "A Planet With Two Names",
        subtitle: "The cosmic record and the sacred spirit", icon: "leaf.fill",
        lessons: [
          ACLesson(
            id: "ug1_1", title: "More Than Rock and Water",
            content: """
              ...
              **Gaia = the sacred force.** The soul that inhabits the planet.
              ...
              """,
            keyInsight:
              "Urantia is Earth's cosmic name in a universal registry. Gaia is her living spirit. Together they reveal a planet that is both addressed in the cosmos and alive with consciousness.",
            practice:
              "Spend 10 minutes with bare feet on the ground. Not as exercise — as communion. Feel what the planet communicates through your body."
          )
        ])
    ],
    sources: [
      ...
      "Greek cosmogony — Hesiod's Theogony", "Lynn Margulis, symbiosis and Gaia theory",
      "Indigenous Earth-as-mother traditions worldwide",
    ],
    dragonComment:
      "Science says the Earth self-regulates like a living organism. Ancients said she IS a living organism. Maybe they weren't using metaphor. 🐉"
  )
}
