...
struct TriggerCategoryView: View {
    ...
    private func triggerCard(_ trigger: FlowTrigger) -> some View {
        ...
        VStack(alignment: .leading, spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                triggerSection(title: "HOW TO", content: trigger.howTo, icon: "hand.point.right.fill", color: Palette.accent.gold)

                triggerSection(title: "THE SCIENCE", content: trigger.scienceBehind, icon: "brain.head.profile", color: Palette.primary.cyan)
    ...
    private func triggerSection(title: String, content: String, icon: String, color: Color) -> some View {
