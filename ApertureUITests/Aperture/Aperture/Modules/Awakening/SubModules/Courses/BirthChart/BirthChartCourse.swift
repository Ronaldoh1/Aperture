        ...
        AstroLesson(
          ...
          content: """
            ...
            **Orbs**
            ...
            """,
          keyFact:
            "Aspects show how planets interact—trines flow, squares challenge, conjunctions merge."
        ),
...
// Main ZodiacSign enum is in Core/Astrology/ZodiacSign.swift
...
struct AstroProgress: Codable {
  ...
  static var `default`: AstroProgress {
    AstroProgress(completedLessons: [], savedBirthData: nil, savedChart: nil)
  }
}
