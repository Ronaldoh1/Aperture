...
enum AlchemyCourse {
  static let course = AlexandriaCourse(
    id: "alchemy_great_work", title: "The Great Work — Alchemy",
    ...
    modules: [
      ACModule(
        id: "al1", number: 1, title: "Not Lead Into Gold — You Into You",
        subtitle: "The real Magnum Opus", icon: "flame.fill",
        lessons: [
          ACLesson(
            id: "al1_1", title: "The Most Misunderstood Science in History",
            content: """
              ...
              **7. COAGULATION (☀️ Sun)** — The Philosopher's Stone achieved. The awakened self is STABLE. Not a peak experience, but a permanent state. The Great Work complete.
              ...
              """,
            keyInsight:
              "Alchemy was never about metal — it was a 7-stage system for transforming human consciousness from 'lead' (unconscious) to 'gold' (awakened). You're already in the process.",
            practice:
              "Which of the 7 stages are you currently in? Be honest. The stage you're in IS the work. Don't rush it — the gold needs time."
          )
        ])
    ],
    sources: [
      "Carl Jung, \"Psychology and Alchemy\"", "The Emerald Tablet of Hermes Trismegistus",
      "Paracelsus — alchemical medicine and transformation",
      "Isaac Newton's alchemical manuscripts (Keynes collection, Cambridge)",
      "Dennis William Hauck, \"The Emerald Tablet: Alchemy for Personal Transformation\"",
    ],
    dragonComment:
      "Newton spent more time on alchemy than physics. Jung called it the ancestor of psychology. They reduced it to 'guys trying to make gold' because the real secret — that YOU are the experiment — was too powerful to let loose. 🐉"
  )
}
