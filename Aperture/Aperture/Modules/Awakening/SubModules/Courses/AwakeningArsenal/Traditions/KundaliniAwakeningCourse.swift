...
struct KundaliniAwakeningCourse: View {
  ...
  private var courseHeader: some View {
    VStack(spacing: 16) {
      ...
      Text(
        "Awaken the dormant divine energy coiled at the base of your spine and guide it through the seven chakras to cosmic consciousness."
      )
      .font(.system(size: 13))
  ...
  private func chakraRow(
    _ num: Int, _ sanskrit: String, _ english: String, _ function: String, _ color: Color,
    _ mantra: String
  ) -> some View {
    HStack(spacing: 12) {
      ZStack {
      ...
      KundaliniLesson(
        ...
        content: """
          ...
          **3. Shaktipat (transmission):**
          ...
          """,
        keyTakeaway:
          "Kundalini is dormant spiritual energy at the spine's base. When awakened through practice, it rises through chakras to unite with cosmic consciousness. This is described across all traditions—same process, different names.",
        practiceGuide: """
      ...
      KundaliniLesson(
        ...
        content: """
          ...
          **Balancing ida and pingala:**
          ...
          """,
        keyTakeaway:
          "Preparation prevents problems. Clean the body through yoga and diet. Stabilize the mind through addressing unresolved issues. Create supportive lifestyle conditions. Balance the energy channels before attempting to raise Kundalini.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      KundaliniLesson(
        ...
        content: """
          ...
          **Effects:**
          ...
          """,
        keyTakeaway:
          "Pranayama is the key that unlocks energy. Nadi Shodhana balances the channels. Kapalabhati and Bhastrika generate heat and energy. Breath retention concentrates prana. Always build gradually—never force.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      KundaliniLesson(
        ...
        content: """
          ...
          **Subtle bandhas:** Energetic awareness without physical effort (develops with practice)
          ...
          """,
        keyTakeaway:
          "Bandhas are energy locks that seal and direct prana. Mula Bandha at root, Uddiyana at abdomen, Jalandhara at throat. Combined as Maha Bandha, they concentrate energy for Kundalini rising. Start with physical, evolve to energetic.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      KundaliniLesson(
        ...
        content: """
          ...
          **Complete practice (20-30 min):**
          ...
          """,
        keyTakeaway:
          "Each chakra governs specific aspects of life and consciousness. Meditation with visualization and mantra clears blockages and prepares for Kundalini. Work systematically from root to crown. Balance is key—neither too open nor too closed.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      KundaliniLesson(
        ...
        content: """
          ...
          **The goal isn't fireworks—it's transformation.**
          """,
        keyTakeaway:
          "Specific practices like Maha Mudra, kriyas, and conscious energy movement can activate Kundalini. Proceed gradually, never force, and prioritize integration over intensity. Signs of awakening include heat, energy movement, altered states, and emotional releases.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      KundaliniLesson(
        ...
        content: """
          ...
          **You're not alone. Many have navigated this.**
          """,
        keyTakeaway:
          "Kundalini syndrome occurs when awakening overwhelms unprepared systems. Symptoms include physical, mental, and perceptual disturbances. Treatment involves grounding, stopping intense practices, and getting support. Prevention through proper preparation is best.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      KundaliniLesson(
        ...
        content: """
          ...
          **Same energy. Same process. Same destination.**
          ...
          """,
        keyTakeaway:
          "Integration matters more than peak experiences. Living awakened means staying grounded while perceiving deeper. Service, humility, and ordinary life become the practice. The path never ends—there's always more depth. And ultimately, all paths reveal the same truth.",
        practiceGuide: """
          **This Week's Practice:**
