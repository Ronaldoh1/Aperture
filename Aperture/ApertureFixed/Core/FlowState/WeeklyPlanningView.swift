...
struct WeeklyPlanningView: View {
    ...
    private func suggestedBlocks(for type: CircadianType) -> [FocusBlock] {
        ...
        case .earlyBird:
            return [
                FocusBlock(id: UUID(), title: "Deep Work AM", startHour: 6, endHour: 10, type: .deepWork, date: today),
                FocusBlock(id: UUID(), title: "Admin & Email", startHour: 10, endHour: 11, type: .shallowWork, date: today),
                FocusBlock(id: UUID(), title: "Mindful Lunch", startHour: 12, endHour: 13, type: .break, date: today)
            ]
        case .nightOwl:
            return [
                FocusBlock(id: UUID(), title: "Warm Up", startHour: 10, endHour: 12, type: .shallowWork, date: today),
                FocusBlock(id: UUID(), title: "Deep Work PM", startHour: 14, endHour: 18, type: .deepWork, date: today),
                FocusBlock(id: UUID(), title: "Night Flow", startHour: 21, endHour: 24, type: .deepWork, date: today)
            ]
        case .balanced:
            return [
                FocusBlock(id: UUID(), title: "Morning Focus", startHour: 9, endHour: 12, type: .deepWork, date: today),
                FocusBlock(id: UUID(), title: "Lunch Break", startHour: 12, endHour: 13, type: .break, date: today),
                FocusBlock(id: UUID(), title: "Afternoon Focus", startHour: 14, endHour: 17, type: .deepWork, date: today)
            ]
        }
    }
    ...
    private func loadCurrentPlan() {
        if let plan = orchestrator.weeklyPlan, plan.isCurrentWeek {
            topPriorities = plan.topThreePriorities + Array(repeating: "", count: max(0, 3 - plan.topThreePriorities.count))
    ...
    private func savePlan() {
        let plan = WeeklyFlowPlan(
            id: UUID(),
            weekStarting: Calendar.current.date(from: Calendar.current.dateComponents([.yearForWeekOfYear, .weekOfYear], from: Date()))!,
