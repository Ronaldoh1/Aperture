...
enum UjatCodeCourse {
  ...
  static let modules: [UjatModule] = [
    ...
    UjatModule(
      ...
      colorHex: "#FFD700",
      description:
        "That split second when you walk into a room and something feels off—before anyone says a word. That's not imagination. That's your nervous system processing data faster than your conscious mind.",
      lessons: [
        UjatLesson(
          id: "uj-1-1",
          ...
          keyInsight:
            "Your nervous system processes environmental data at speeds that make conscious thought look sluggish. This capacity didn't disappear—it just atrophied from neglect.",
          dragonComment:
            "You were born with these abilities. Society just trained you to ignore them."
        ),
        ...
        UjatLesson(
          ...
          practice: nil,
          keyInsight:
            "The Eye of Horus isn't mystical decoration—it's an anatomically precise training manual for developing enhanced sensory processing.",
          dragonComment:
            "The ancients hid their greatest technology in plain sight. Anyone looking could see it. Few knew how to read it."
        ),
        ...
        UjatLesson(
          ...
          practice: nil,
          keyInsight:
            "The techniques were encoded not to exclude people, but because enhanced perception without preparation creates more problems than it solves.",
          dragonComment:
            "The secret was never the information. It was knowing you had to earn it through practice."
        ),
      ]
    ),
    ...
    UjatModule(
      ...
      colorHex: "#FF9800",
      description:
        "Your brain operates two completely different information processing systems. One of them just assessed my credibility 200 milliseconds before your analytical mind could form a complete thought.",
      lessons: [
        UjatLesson(
          id: "uj-2-1",
          ...
          practice: nil,
          keyInsight:
            "Your fast processing system assesses situations 200 milliseconds before your conscious mind can form a complete thought—and it's often more accurate.",
          dragonComment:
            "You've been taught to trust the slow mind and ignore the fast one. That's backwards."
        ),
        ...
        UjatLesson(
          ...
          keyInsight:
            "The problem is that modern culture trains us to dismiss System 1 signals as unreliable, pushing us to over-rely on conscious analysis while ignoring our most sophisticated intelligence.",
        ...
        UjatLesson(
          ...
          practice: nil,
          keyInsight:
            "Expert intuition isn't magic—it's sophisticated pattern recognition developed through thousands of hours of exposure to relevant patterns.",
          dragonComment:
            "Your intuition can be trained like any skill. The more patterns you expose it to, the smarter it gets."
        ),
      ]
    ),
    ...
    UjatModule(
      ...
      colorHex: "#4CAF50",
      description:
        "Your digestive system contains over 500 million neurons. Your heart has its own neural network. Your body has been trying to tell you something your entire life.",
      lessons: [
        UjatLesson(
          id: "uj-3-1",
          ...
          keyInsight:
            "Your gut contains 500 million neurons that process information independently—and 80% of vagus nerve signals travel from gut to brain, not the other way around.",
          dragonComment:
            "Your gut has been giving you advice your whole life. Time to start listening."
        ),
        ...
        UjatLesson(
          ...
          keyInsight:
            "Your heart has its own neural network that responds to emotional stimuli before your brain—and when it's coherent, it enhances your cognitive clarity.",
        ...
        UjatLesson(
          ...
          practice: nil,
          keyInsight:
            "The insula integrates information from gut, heart, and skin into unified body awareness. Strengthening it improves emotional regulation, social accuracy, and decision-making.",
          dragonComment:
            "Your whole body is a perception organ. The brain is just where the signals get processed."
        ),
      ]
    ),
    ...
    UjatModule(
      ...
      colorHex: "#9C27B0",
      description:
        "When ancient Egyptian priests placed attention behind the forehead during sacred rituals, they weren't working from superstition. They had discovered that focusing here produces consistent, measurable changes in perception.",
      lessons: [
        UjatLesson(
          id: "uj-4-1",
          ...
          practice: nil,
          keyInsight:
            "The 'third eye' location sits above the prefrontal cortex and near the bridge between cognitive and emotional processing—focusing here produces measurable neurological changes.",
          dragonComment:
            "The Egyptians found the right location through observation. Neuroscience found it through brain scans. Same spot."
        ),
        ...
        UjatLesson(
          ...
          keyInsight:
            "Hard focus activates analytical networks but blocks subtle perception. Soft focus activates the salience network—allowing you to detect what's important without forcing.",
          dragonComment:
            "Don't squeeze your awareness into a point. Let it rest there like a cat watching a mouse hole—alert but relaxed."
        ),
        ...
        UjatLesson(
          ...
          practice: nil,
          keyInsight:
            "Regular focal point practice creates measurable brain changes—increased gray matter, enhanced connectivity, and improved sensory processing. It's upgrading your neural operating system.",
    ...
    UjatModule(
      ...
      colorHex: "#00BCD4",
      description:
        "When you combine breath, attention, and silence in specific ways, you create nervous system coherence that fundamentally changes how your brain processes information.",
      lessons: [
        UjatLesson(
          id: "uj-5-1",
          ...
          keyInsight:
            "Breathing at 5-6 breaths per minute creates heart-brain coherence—shifting you from stress response into the optimal state for pattern recognition and subtle perception.",
          dragonComment:
            "Your breath is the one autonomic function you can consciously control. It's your backdoor into the nervous system."
        ),
        ...
        UjatLesson(
          ...
          practice: nil,
          keyInsight:
            "Sustained but relaxed attention strengthens cognitive control while quieting mental chatter—creating the focused-but-open state athletes call 'the zone.'",
          dragonComment:
            "Attention is like water. Force it and it splashes everywhere. Channel it gently and it becomes powerful."
        ),
        ...
        UjatLesson(
          ...
          keyInsight:
            "Silence isn't the absence of sound—it's the absence of internal commentary. When you stop labeling every experience, your brain can process subtler information.",
    ...
    UjatModule(
      ...
      colorHex: "#E91E63",
      description:
        "Seven conscious breaths hits what researchers call the 'neuroplasticity sweet spot.' It's long enough to trigger brain wave shifts, short enough that your prefrontal cortex doesn't fatigue.",
      lessons: [
        UjatLesson(
          id: "uj-6-1",
          ...
          practice: nil,
          keyInsight:
            "Seven breaths (2-3 minutes) is the sweet spot—long enough to shift brain waves, short enough to maintain quality attention.",
        ...
        UjatLesson(
          ...
          practice: nil,
          keyInsight:
            "Each breath serves a specific neurological function—shifting nervous system state, activating attention networks, and expanding body awareness.",
        ...
        UjatLesson(
          ...
          keyInsight:
            "The 7-breath protocol takes 70 seconds but creates measurable nervous system shifts. Consistency matters more than duration.",
    ...
    UjatModule(
      ...
      colorHex: "#FF5722",
      description:
        "After the third or fourth breath, a voice in your head will say 'This is ridiculous.' Welcome to your internal opposition committee. Understanding how it operates is crucial.",
      lessons: [
        UjatLesson(
          id: "uj-7-1",
          ...
          practice: nil,
          keyInsight:
            "Your brain is wired to resist unfamiliar states of consciousness—not because the experiences are fake, but because your survival systems flag anything unknown as potentially dangerous.",
          dragonComment:
            "The voice saying 'this is stupid' isn't wisdom. It's the bouncer trying to keep the unfamiliar out."
        ),
        ...
        UjatLesson(
          ...
          keyInsight:
            "Resistance takes four main forms: cognitive dissonance, fear, impatience, and spiritual ego. Knowing which one you're dealing with helps you respond appropriately.",
          dragonComment:
            "Your resistance isn't your enemy. It's just an old security system that doesn't know the war is over."
        ),
        ...
        UjatLesson(
          ...
          practice: nil,
          keyInsight:
            "The goal isn't to silence resistance, but to understand it—listening when it offers genuine caution, proceeding when it's just protecting you from the unfamiliar.",
          dragonComment:
            "Resistance intensifies just before breakthrough. If it's getting louder, you're probably getting closer."
        ),
      ]
    ),
    ...
    UjatModule(
      ...
      colorHex: "#795548",
      description:
        "Your brain needs approximately 66 days to automate a new behavior. But the critical window happens in the first 7 days—when your neural pathways are most plastic.",
      lessons: [
        UjatLesson(
          id: "uj-8-1",
          ...
          practice: nil,
          keyInsight:
            "The first 7 days are the critical window when neural pathways are most plastic. Consistency during this period determines whether the practice becomes permanent.",
        ...
        UjatLesson(
          ...
          keyInsight:
            "Morning practice leverages peak neuroplasticity, midday practice interrupts stress accumulation, and evening practice optimizes memory consolidation. Timing matters.",
        ...
        UjatLesson(
          ...
          practice: nil,
          keyInsight:
            "Track objective measures (HRV, sleep, decision clarity, emotional reactivity) rather than subjective impressions—your mind will try to dismiss real changes as coincidence.",
    ...
    UjatModule(
      ...
      lessons: [
        UjatLesson(
          ...
          practice: nil,
          keyInsight:
            "Integration means enhanced perception becomes your baseline—not something you do, but something you are.",
          dragonComment:
            "The goal isn't to feel special during practice. It's to become more fully present in ordinary life."
        ),
        ...
        UjatLesson(
          ...
          practice: nil,
          keyInsight:
            "Enhanced perception improves everything—relationships, decisions, professional performance—not through supernatural abilities but through optimized natural intelligence.",
        ...
        UjatLesson(
          ...
          keyInsight:
            "Enhanced perception isn't about seeing other worlds—it's about seeing this world clearly. The inner eye opens to reveal what was always there.",
