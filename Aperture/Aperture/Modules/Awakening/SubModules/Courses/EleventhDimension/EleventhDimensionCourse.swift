...
enum EleventhDimensionCourse {
  ...
  static let modules: [DimensionModule] = [
    ...
    DimensionModule(
      ...
      colorHex: "#7C4DFF",
      description:
        "Right now as you read this, you might not be completely here. Modern physics suggests our universe operates across 11 dimensions—yet you only experience four.",
      lessons: [
        DimensionLesson(
          id: "11d-1-1",
          ...
          keyInsight:
            "If consciousness emerges from fundamentally 11-dimensional processes, asking whether your awareness touches those hidden dimensions isn't mysticism—it's a legitimate scientific question.",
          dragonComment:
            "You've always sensed you're more than this body. Physics is finally catching up to what you already knew."
        ),
        ...
        DimensionLesson(
          ...
          practice: nil,
          keyInsight:
            "11 dimensions aren't an option in M-theory—they're a requirement. The math simply doesn't work with fewer dimensions.",
          dragonComment:
            "When the equations demand 11 dimensions, maybe it's time to update our understanding of what 'reality' means."
        ),
        ...
        DimensionLesson(
          ...
          keyInsight:
            "The part of you that feels incomplete, that senses there's more to existence than what you can directly experience, might be a dim recognition that your consciousness is somehow aware of its own dimensional confinement.",
          dragonComment:
            "Your body is 11-dimensional. Your mind emerged from 11-dimensional processes. Why would consciousness be limited to 4?"
        ),
      ]
    ),
    ...
    DimensionModule(
      ...
      colorHex: "#536DFE",
      description:
        "You're not sitting in empty space. You're embedded in a three-dimensional membrane floating through higher dimensional space. And you're not alone.",
      lessons: [
        DimensionLesson(
          id: "11d-2-1",
          ...
          practice: nil,
          keyInsight:
            "Our entire universe might be the surface of a membrane floating in higher dimensional space—and we're permanently confined to that surface.",
          dragonComment:
            "The universe isn't everything. It's just our neighborhood in a much bigger reality."
        ),
        ...
        DimensionLesson(
          ...
          keyInsight:
            "Other universes could be micrometers away from you right now—separated only by directions your senses cannot detect.",
          dragonComment:
            "The multiverse isn't science fiction. It's what happens when you take the math seriously."
        ),
        ...
        DimensionLesson(
          ...
          practice: nil,
          keyInsight:
            "The mathematics of M-theory forces us to confront the possibility that what you call 'you' might be like the tip of an iceberg—with vast portions of your existence extending into dimensions you cannot perceive.",
          dragonComment:
            "Evolution built you to survive on this brane. It didn't build you to perceive reality. Those are different problems."
        ),
      ]
    ),
    ...
    DimensionModule(
      ...
      colorHex: "#448AFF",
      description:
        "What you call 'you'—that voice in your head, your personality, your memories—might be just the tip of an iceberg so vast that most of it exists completely outside your awareness.",
      lessons: [
        DimensionLesson(
          id: "11d-3-1",
          ...
          keyInsight:
            "What you think of as your 'self' is just a small fraction of who you really are—the tip of an iceberg that extends far beyond your conscious awareness.",
        ...
        DimensionLesson(
          ...
          practice: nil,
          keyInsight:
            "Ancient wisdom traditions and cutting-edge theoretical physics keep arriving at strikingly similar conclusions about consciousness transcending our perceived limitations.",
          dragonComment:
            "The mystics mapped this territory thousands of years ago. Physics is just drawing better maps of the same landscape."
        ),
        ...
        DimensionLesson(
          ...
          keyInsight:
            "If consciousness exists as a field—like an electromagnetic field—then your individual awareness might be just one receiver among many. Other aspects of yourself could be tuned to completely different frequencies.",
          dragonComment:
            "Your brain might be less like a computer and more like a radio. The signal exists whether the radio is on or not."
        ),
      ]
    ),
    ...
    DimensionModule(
      ...
      colorHex: "#40C4FF",
      description:
        "What if your brain isn't creating your consciousness at all? What if it's simply receiving it—like a radio tuning into a signal that was already there?",
      lessons: [
        DimensionLesson(
          id: "11d-4-1",
          ...
          practice: nil,
          keyInsight:
            "The brain might not generate consciousness but rather receive and focus it—like an instrument through which something deeper expresses itself.",
          dragonComment:
            "What if consciousness is the default state of reality, and matter is the exception?"
        ),
        ...
        DimensionLesson(
          ...
          keyInsight:
            "Consciousness might be fundamental to reality—not something that emerges from complexity but something that complexity allows to express itself.",
        ...
        DimensionLesson(
          ...
          practice: nil,
          keyInsight:
            "If awareness can exist when the brain shows no measurable activity, consciousness must operate by different rules than neuroscience assumes.",
          dragonComment:
            "Thousands of people have seen their surgeries from the ceiling. At some point, we have to take this seriously."
        ),
      ]
    ),
    ...
    DimensionModule(
      ...
      colorHex: "#00BCD4",
      description:
        "Have you ever woken from a dream feeling like you lived an entire lifetime? Those experiences might be glimpses of the greater self that never fragmented.",
      lessons: [
        DimensionLesson(
          id: "11d-5-1",
          ...
          keyInsight:
            "Profound dreams might not be imagination—they might be moments when your consciousness accesses experiences from parallel streams of reality.",
        ...
        DimensionLesson(
          ...
          practice: nil,
          keyInsight:
            "Children's 'past life' memories might not be about previous incarnations—they might be dimensional bleeding from parallel selves existing simultaneously.",
          dragonComment:
            "Children haven't learned yet that reality is supposed to be limited. They still receive all the channels."
        ),
        ...
        DimensionLesson(
          ...
          keyInsight:
            "Strange experiences like déjà vu, precognition, and instant recognition might be moments when your higher-dimensional self bleeds through into ordinary awareness.",
          dragonComment:
            "Those 'weird' experiences aren't errors in consciousness. They're features."
        ),
      ]
    ),
    ...
    DimensionModule(
      ...
      colorHex: "#009688",
      description:
        "In 1994, a psychology professor conducted experiments that should have been impossible. Participants responded to stimuli that hadn't been chosen yet.",
      lessons: [
        DimensionLesson(
          id: "11d-6-1",
          ...
          practice: nil,
          keyInsight:
            "Rigorous laboratory experiments show people responding to stimuli before those stimuli are even selected—suggesting consciousness operates outside linear time.",
          dragonComment:
            "74 billion to one against chance. At some point, the universe is trying to tell us something."
        ),
        ...
        DimensionLesson(
          ...
          keyInsight:
            "Decades of rigorous research shows people can perceive distant locations with accuracy that defies conventional explanation.",
          dragonComment:
            "The CIA spent 20 years researching this. They weren't wasting money on fantasy."
        ),
        ...
        DimensionLesson(
          ...
          practice: nil,
          keyInsight:
            "Random number generators worldwide show measurable patterns during major global events—suggesting consciousness creates physical effects across the planet.",
          dragonComment:
            "The universe isn't random. It's responsive. We just forgot how to read it."
        ),
      ]
    ),
    ...
    DimensionModule(
      ...
      colorHex: "#4CAF50",
      description:
        "There's something extraordinary happening inside your awareness right now. Part of you is simultaneously watching yourself think. This observer might be your actual self—existing in higher dimensional space.",
      lessons: [
        DimensionLesson(
          id: "11d-7-1",
          title: "The Observer",
          ...
          keyInsight:
            "The witnessing consciousness—the part of you that can observe your own thoughts—might be your actual self existing in higher dimensional space.",
        ...
        DimensionLesson(
          ...
          practice: nil,
          keyInsight:
            "The witness within provides guidance that seems to operate outside normal time—sensing patterns before they manifest and knowing things your conscious mind can't explain.",
          dragonComment:
            "That 'still small voice' isn't random intuition. It's the part of you that can see around corners."
        ),
        ...
        DimensionLesson(
          ...
          keyInsight:
            "Your higher dimensional presence isn't distant—it's the part of you that's already looking through your eyes, quietly guiding and creating from beyond linear awareness.",
          dragonComment:
            "The best decisions you've ever made weren't really 'yours.' They came through you from something bigger."
        ),
      ]
    ),
    ...
    DimensionModule(
      ...
      colorHex: "#8BC34A",
      description:
        "Have you ever walked into a place you'd never been and felt like you were coming home? You might be accessing memory—just not the kind stored in your brain.",
      lessons: [
        DimensionLesson(
          id: "11d-8-1",
          ...
          practice: nil,
          keyInsight:
            "Memory might not be stored in your brain at all—it might be accessed through it, like a radio receiver tuning into information that exists in fields of consciousness.",
          dragonComment:
            "Your brain isn't a hard drive. It's more like a search engine accessing a cloud that extends beyond your body."
        ),
        ...
        DimensionLesson(
          ...
          keyInsight:
            "The collective unconscious isn't metaphor—it's a shared field of human experience that you can access through attention and intention.",
        ...
        DimensionLesson(
          ...
          practice: nil,
          keyInsight:
            "Your consciousness is connected to the infinite library of human experience. What feels like intuition might be memory from dimensions beyond your individual biography.",
          dragonComment:
            "You're not just inheriting genes. You're inheriting experiences, knowledge, and wisdom from everyone who came before."
        ),
      ]
    ),
    ...
    DimensionModule(
      ...
      lessons: [
        DimensionLesson(
          ...
          practice: nil,
          keyInsight:
            "The goal isn't to escape into higher dimensions—it's to become a bridge between expanded awareness and practical effectiveness.",
          dragonComment:
            "Awakening isn't about leaving. It's about being here more fully with access to everything you are."
        ),
        ...
        DimensionLesson(
          ...
          keyInsight:
            "Your body's responses to decisions might come from dimensions that can perceive fuller implications than your analytical mind can access.",
          dragonComment:
            "Your body has been giving you the answers all along. You just weren't listening."
        ),
        ...
        DimensionLesson(
          ...
          practice: nil,
          keyInsight:
            "Recognizing the multi-dimensional nature of others allows you to relate to their deeper essence—often shifting dynamics that surface-level interactions couldn't change.",
          dragonComment:
            "That annoying person? They're also a vast multi-dimensional being having a difficult moment. So are you."
        ),
      ]
    ),
    ...
    DimensionModule(
      ...
      colorHex: "#FF9800",
      description:
        "What if the 11th dimension—like all the others—is just another playground for the awareness that you fundamentally are?",
      lessons: [
        DimensionLesson(
          id: "11d-10-1",
          ...
          practice: nil,
          keyInsight:
            "Consciousness isn't something existing in dimensions—it might be the capacity that allows dimensions to exist in the first place.",
        ...
        DimensionLesson(
          ...
          keyInsight:
            "The awareness reading these words isn't broken or incomplete—it's already the deepest truth, expressing itself through your particular form.",
        ...
        DimensionLesson(
          ...
          practice: nil,
          keyInsight:
            "You don't need to choose between infinite awareness and multi-dimensional existence. The deeper the recognition, the more freely you can dance through all dimensions.",
          dragonComment:
            "What if the 11th dimension is just another playground for the awareness that you fundamentally are?"
        ),
      ]
    ),
  ]
