...
struct PresetAvatar: Identifiable, Equatable {
  ...
  static let all: [PresetAvatar] = [
    PresetAvatar(
      id: "sun_warrior", emoji: "☀️", name: "Sun Warrior",
      gradientColors: [Color(hex: "#FFD700"), Color(hex: "#FF8C00")]),
    PresetAvatar(
      id: "third_eye", emoji: "👁️", name: "Third Eye",
      gradientColors: [Color(hex: "#9B59B6"), Color(hex: "#3498DB")]),
    PresetAvatar(
      id: "phoenix", emoji: "🔥", name: "Phoenix Rising",
      gradientColors: [Color(hex: "#E74C3C"), Color(hex: "#F39C12")]),
    PresetAvatar(
      id: "lotus", emoji: "🪷", name: "Lotus Bloom",
      gradientColors: [Color(hex: "#E91E63"), Color(hex: "#9C27B0")]),
    PresetAvatar(
      id: "dragon", emoji: "🐉", name: "Dragon Spirit",
      gradientColors: [Color(hex: "#2ECC71"), Color(hex: "#1ABC9C")]),
    PresetAvatar(
      id: "star", emoji: "⭐", name: "Star Seed",
      gradientColors: [Color(hex: "#FFD700"), Color(hex: "#FFFFFF")]),
    PresetAvatar(
      id: "moon", emoji: "🌙", name: "Moon Child",
      gradientColors: [Color(hex: "#2C3E50"), Color(hex: "#3498DB")]),
    PresetAvatar(
      id: "crystal", emoji: "💎", name: "Crystal Clear",
      gradientColors: [Color(hex: "#00BCD4"), Color(hex: "#E0F7FA")]),
    PresetAvatar(
      id: "serpent", emoji: "🐍", name: "Kundalini",
      gradientColors: [Color(hex: "#FF5722"), Color(hex: "#FFD700")]),
    PresetAvatar(
      id: "eye_of_ra", emoji: "𓂀", name: "Eye of Ra",
      gradientColors: [Color(hex: "#FFD700"), Color(hex: "#1ABC9C")]),
  ]
}
...
class TimelineAvatarManager: ObservableObject {
  ...
  private init() {
    hasCompletedSetup = UserDefaults.standard.bool(forKey: "timeline_avatar_setup_done")
    selectedPresetId = UserDefaults.standard.string(forKey: "timeline_avatar_preset_id")
    avatarImageData = Self.loadImageData()
  }
...
struct TimelineAvatarSetupView: View {
  ...
  private var explanationSection: some View {
    VStack(spacing: 8) {
      ...
      Text(
        "As you scroll through centuries of hidden history, your avatar marks where you are in the journey. Pick a photo or choose a spirit symbol below."
      )
  ...
  private var privacyNote: some View {
    HStack(spacing: 8) {
      ...
      Text(
        "Your avatar is stored locally on this device only. It never leaves your phone and is never uploaded anywhere."
      )
      ...
      RoundedRectangle(cornerRadius: 10)
        ...
        .overlay(
          RoundedRectangle(cornerRadius: 10).stroke(
            Palette.primary.cyan.opacity(0.1), lineWidth: 0.5))
    )
  }
