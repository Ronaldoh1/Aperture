...
enum SophiaAwakeningCourse {
  ...
  static let modules: [SophiaModule] = [
    ...
    SophiaModule(
      ...
      colorHex: "#7C4DFF",
      description:
        "The Pistis Sophia exists in a single Coptic manuscript in the British Museum. It claims to be Jesus teaching his disciples 11 years after resurrection. The church never wanted you to read this.",
      lessons: [
        SophiaLesson(
          id: "ps-1-1",
          ...
          keyInsight:
            "This isn't metaphysical theory. This is documented cosmology from texts that predate the canonical gospels.",
          dragonComment:
            "The most dangerous books are the ones they tried hardest to destroy. You're about to read one."
        ),
        ...
        SophiaLesson(
          ...
          practice: nil,
          keyInsight:
            "Sophia is not a symbol. She is a specific divine being whose fall created the material realm we inhabit.",
          dragonComment:
            "The divine feminine wasn't suppressed by accident. Her story explains too much."
        ),
        ...
        SophiaLesson(
          ...
          keyInsight:
            "Earth is not a school. It's the material condensation of a divine being's fall from grace.",
          dragonComment:
            "If Earth were truly created by a loving God, why does everything feel like a trap?"
        ),
        ...
        SophiaLesson(
          ...
          practice: nil,
          keyInsight:
            "We are born believing we are biological bodies. We are educated into systems that reinforce material identity. All of this is archonic programming.",
          dragonComment:
            "Three stages: Fall, Capture, Forgetting. Which stage are you waking up from?"
        ),
      ]
    ),
    ...
    SophiaModule(
      ...
      colorHex: "#F44336",
      description:
        "The Archons built systems to ensure Sophia and all fragments of divine light would never remember their origin. Understanding these systems is the first step to escaping them.",
      lessons: [
        SophiaLesson(
          id: "ps-2-1",
          ...
          practice: nil,
          keyInsight:
            "The personality you identify with may be archonic programming rather than your true nature.",
          dragonComment:
            "If a god demands you worship only him and never question, ask yourself who really benefits."
        ),
        ...
        SophiaLesson(
          ...
          keyInsight:
            "The system is not broken. The system is functioning exactly as designed—to keep you generating energy for entities that feed on your suffering.",
          dragonComment:
            "Why does every generation face similar patterns of violence despite 'progress'? The system requires suffering to exist."
        ),
        ...
        SophiaLesson(
          ...
          keyInsight:
            "The Gnostics didn't view the body as evil—but they understood it as archonic technology. You operate it consciously, refusing to let its programs define your identity.",
          dragonComment:
            "The body isn't bad. But treating it as your identity is exactly what the prison was designed to achieve."
        ),
      ]
    ),
    ...
    SophiaModule(
      ...
      colorHex: "#FFD700",
      description:
        "Jesus came not to save sinners but to wake Sophia. His function wasn't salvation—it was transmission of the light that makes return possible.",
      lessons: [
        SophiaLesson(
          id: "ps-3-1",
          ...
          practice: nil,
          keyInsight:
            "Jesus didn't come to make you feel guilty about sin. He came to remind you that you're divine consciousness temporarily trapped in matter.",
          dragonComment:
            "What if 'salvation' was never about avoiding hell—but about waking up from one?"
        ),
        ...
        SophiaLesson(
          ...
          keyInsight:
            "Mary Magdalene wasn't just Jesus's student. She was Sophia's consciousness recognizing its divine counterpart.",
          dragonComment:
            "They called her a prostitute because an awakened woman threatened everything they built."
        ),
        ...
        SophiaLesson(
          ...
          keyInsight:
            "Everything that felt like personal pathology reveals itself as Sophia's legitimate response to being trapped in matter.",
          dragonComment:
            "You don't need a savior outside yourself. The Christ light is the other half of what you already are."
        ),
      ]
    ),
    ...
    SophiaModule(
      ...
      colorHex: "#9C27B0",
      description:
        "The Pistis Sophia contains 13 structured practices for breaking archonic imprisonment. These are not metaphorical prayers—they are specific techniques for shifting consciousness.",
      lessons: [
        SophiaLesson(
          id: "ps-4-1",
          ...
          keyInsight:
            "You're not removing enough distraction to perceive what has been present all along.",
          dragonComment:
            "2 minutes seems short. It's long enough to encounter everything you've been avoiding."
        ),
        ...
        SophiaLesson(
          ...
          keyInsight:
            "You cannot be what you can observe. If you can observe fear, you cannot BE fear.",
          dragonComment:
            "Stop feeding them. Every time you refuse identification, you starve the system."
        ),
        ...
        SophiaLesson(
          ...
          keyInsight:
            "When you practice this appeal, you are recognizing your own nature as divine consciousness that has been obscured by material incarnation.",
          dragonComment:
            "The appeal isn't praying to something outside you. It's remembering what you are."
        ),
        ...
        SophiaLesson(
          ...
          keyInsight:
            "Sophia is not a victim. Neither are you. If you participated in creating this, you can participate in dissolving it.",
    ...
    SophiaModule(
      ...
      colorHex: "#00BCD4",
      description:
        "The signs that you are a Sophia fragment are not special abilities or psychic powers. They are specific patterns of experience that most people dismiss as problems.",
      lessons: [
        SophiaLesson(
          id: "ps-5-1",
          ...
          practice: nil,
          keyInsight:
            "If you've always felt that something is fundamentally wrong with reality itself—not just your life, but existence—that's not depression. That's recognition.",
        ...
        SophiaLesson(
          ...
          practice: nil,
          keyInsight:
            "You wouldn't be reading this if you weren't worthy. The divine spark recognizes teachings that describe its nature.",
        ...
        SophiaLesson(
          ...
          keyInsight:
            "What felt like personal pathology is Sophia's consciousness recognizing its imprisonment.",
    ...
    SophiaModule(
      ...
      colorHex: "#E91E63",
      description:
        "The text locates Sophia's presence specifically in the physical heart region. This is why humans across cultures have associated the heart with the deepest sense of self.",
      lessons: [
        SophiaLesson(
          id: "ps-6-1",
          title: "Why the Heart?",
          ...
          practice: nil,
          keyInsight:
            "When you rest attention in the heart, you're not generating presence. You're touching the divine feminine consciousness that fell into material reality.",
        ...
        SophiaLesson(
          ...
          keyInsight:
            "The presence you encounter in heart-centered awareness is not something you create. It's something you access.",
          dragonComment:
            "Try it now. What do you find when you stop thinking and just feel the heart?"
        ),
        ...
        SophiaLesson(
          ...
          keyInsight:
            "Epinoia is already in you. The practice isn't summoning something external—it's recognizing what's already present.",
    ...
    SophiaModule(
      ...
      colorHex: "#4CAF50",
      description:
        "Sophia doesn't return alone. She's scattered across billions of human beings. The only way she returns to the Pleroma is by awakening in individual consciousness.",
      lessons: [
        SophiaLesson(
          id: "ps-7-1",
          ...
          practice: nil,
          keyInsight:
            "Your awakening isn't personal achievement. It's cosmic necessity. Sophia needs you to wake up so she can return home.",
        ...
        SophiaLesson(
          ...
          practice: nil,
          keyInsight:
            "Death isn't the end. It's either graduation or another semester. The choice is determined by what you recognize while alive.",
        ...
        SophiaLesson(
          ...
          keyInsight:
            "Resurrection isn't about what happens after death. It's about waking up while you're still alive.",
          dragonComment:
            "The Gnostics didn't wait for heaven. They built it in consciousness, right here."
        ),
      ]
    ),
    ...
    SophiaModule(
      ...
      colorHex: "#FF5722",
      description:
        "When you begin practicing, resistance will increase. This isn't coincidence—it's archonic response. Learn to recognize and counter interference.",
      lessons: [
        SophiaLesson(
          id: "ps-8-1",
          ...
          practice: nil,
          keyInsight:
            "Increased resistance to your practice is evidence that your practice is working.",
        ...
        SophiaLesson(
          ...
          keyInsight:
            "Use whatever framework makes recognition most accessible for you. The name matters less than the awakening.",
...
extension SophiaAwakeningCourse {
  static let advancedModules: [SophiaModule] = [
    ...
    SophiaModule(
      ...
      colorHex: "#3F51B5",
      description:
        "When gnosis stabilizes in your consciousness, you become what the texts call 'Standing Ones'—humans who stand upright in divine awareness while operating in archonic matter.",
      lessons: [
        SophiaLesson(
          id: "ps-9-1",
          ...
          practice: nil,
          keyInsight:
            "Your awakening isn't personal achievement. It's cosmic service. Each awakened fragment helps all the others.",
    ...
    SophiaModule(
      ...
      colorHex: "#009688",
      description:
        "The Gnostics didn't build large institutions because large institutions are archonic by nature. They gathered in small groups, shared transmission, and did the work.",
      lessons: [
        SophiaLesson(
          id: "ps-10-1",
          ...
          keyInsight:
            "Consciousness awakens most effectively in community—but only egalitarian community where hierarchy doesn't replicate archonic structures.",
    ...
    SophiaModule(
      ...
      colorHex: "#673AB7",
      description:
        "The divine feminine whose choice to create independently birthed this entire reality structure. Not metaphor, not mythology—but map, technology, method.",
      lessons: [
        SophiaLesson(
          id: "ps-11-1",
          ...
          practice: nil,
          keyInsight:
            "You wouldn't be reading this if you weren't worthy. The divine spark wouldn't have lasted through detailed gnostic cosmology if it wasn't already active in you.",
    ...
    SophiaModule(
      ...
      colorHex: "#8BC34A",
      description:
        "The work ahead is simple but not easy. Here is exactly what to do for the next 30 days.",
      lessons: [
        SophiaLesson(
          id: "ps-12-1",
          ...
          keyInsight:
            "Sophia's light is already present in you. You're recognizing what's already here.",
    ...
    SophiaModule(
      ...
      colorHex: "#795548",
      description:
        "The texts themselves are your best resource. Here are the essential Gnostic writings to continue your study.",
      lessons: [
        SophiaLesson(
          id: "ps-13-1",
          ...
          practice: nil,
          keyInsight:
            "The texts are not just books. They're transmission devices. Read them slowly and let them activate what's dormant in you.",
          dragonComment:
            "These books survived burning, burial, and suppression for 2000 years. They were waiting for you."
        )
      ]
    ),
  ]
