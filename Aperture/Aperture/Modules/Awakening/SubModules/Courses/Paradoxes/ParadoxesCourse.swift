...
struct ParadoxesCourse {
  ...
  let paradoxes: [CourseParadox] = [
    ...
    CourseParadox(
      ...
      description:
        "If you travel back in time and kill your grandfather before your parent was born, you would never exist to go back in time.",
      explanation: """
        **The Problem**
    ...
    CourseParadox(
      ...
      description:
        "An object or information exists without ever being created because it was sent back in time.",
      explanation: """
        **The Setup**
    ...
    CourseParadox(
      ...
      explanation: """
        ...
        **This Is Real**
        ...
        """,
      mindBender:
        "If you traveled fast enough for long enough, you could return to find everyone you knew dead—while you barely aged."
    ),
    ...
    CourseParadox(
      ...
      explanation: """
        ...
        **Gödel's Incompleteness**
        ...
        """,
      mindBender:
        "If a system is complex enough to talk about itself, it contains paradoxes. Does this apply to consciousness examining itself?"
    ),
    ...
    CourseParadox(
      ...
      explanation: """
        ...
        **Possible Answers**
        ...
        """,
      mindBender:
        "If every cell in your body is replaced, at what point did 'you' die and someone else take over?"
    ),
    ...
    CourseParadox(
      ...
      explanation: """
        ...
        **Deeper Question**
        ...
        """,
      mindBender:
        "If unlimited power is self-contradictory, are there necessary limits built into existence?"
    ),
    ...
    CourseParadox(
      ...
      explanation: """
        ...
        **Why It Matters**
        ...
        """,
      mindBender:
        "If this is a simulation, what would you do differently? If nothing, does it matter?"
    ),
    ...
    CourseParadox(
      ...
      explanation: """
        ...
        **Possible Resolutions**
        ...
        """,
      mindBender:
        "Did you choose to read this sentence, or was that 'choice' made billions of years ago at the Big Bang?"
    ),
  ]
}
...
struct ParadoxProgress: Codable {
  ...
  static var `default`: ParadoxProgress {
    ParadoxProgress(completedParadoxes: [], lastAccessed: nil)
  }
}
