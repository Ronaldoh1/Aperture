...
struct MasterLiesCourseView: View {
    ...
    var allModules: [LiesModule] {
        course.modules + MasterLiesCourse.additionalModules + MasterLiesCourse.moreModules + MasterLiesCourse.darkestSecrets
    }
    ...
    private var awakeningMeter: some View {
        ...
        VStack(spacing: 12) {
            ...
            HStack {
                ...
                Spacer()
                StageLabel(name: "Questioning", isActive: progressPercentage >= 0.25 && progressPercentage < 0.5)
                Spacer()
                StageLabel(name: "Awakening", isActive: progressPercentage >= 0.5 && progressPercentage < 0.75)
                Spacer()
