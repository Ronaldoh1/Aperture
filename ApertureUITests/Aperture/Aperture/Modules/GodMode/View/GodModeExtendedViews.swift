...
struct EsotericArchivesView: View {
  ...
  private var dragonWisdom: some View {
    VStack(spacing: 12) {
      ...
      Text(
        "\"Ancient civilizations didn't vanish—their wisdom went underground, encoded in symbols, waiting for this moment.\""
      )
      .font(.caption)
      .italic()
      .foregroundStyle(.white.opacity(0.7))
        ...
        ScrollView {
          VStack(spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 16) {
              ...
              TrainingCard(
                icon: "🎯", title: "Daily Mission", subtitle: "Today's actionable task",
                color: .orange
              ) {
                showDailyMission = true
              }
              TrainingCard(
                icon: "✅", title: "Practice Tracker", subtitle: "Log your daily work", color: .green
              ) {}
              TrainingCard(
                icon: "🧠", title: "Active Recall Quiz", subtitle: "Spaced repetition system",
                color: .blue
              ) {}
              TrainingCard(
                icon: "📝", title: "Integration Journal", subtitle: "Real-life application",
                color: .purple
              ) {}
              TrainingCard(
                icon: "📈", title: "Mastery Path", subtitle: "Track your progress", color: .cyan
              ) {}
            }
...
struct ForbiddenSectionView: View {
  ...
  private var warningView: some View {
    VStack(spacing: 24) {
      ...
      Text(
        "This section contains teachings that challenge fundamental beliefs about reality, religion, and consciousness.\n\nProceed with discernment. Question everything—including this."
      )
      .font(.body)
      ...
      ZStack {
        ...
        ScrollView {
          VStack(spacing: 24) {
            ...
            // Disclaimer
            Text(
              "⚠️ Astral projection is an advanced practice. Ensure you are grounded and mentally prepared."
            )
            .font(.caption)
            .foregroundStyle(.white.opacity(0.5))
            .multilineTextAlignment(.center)
