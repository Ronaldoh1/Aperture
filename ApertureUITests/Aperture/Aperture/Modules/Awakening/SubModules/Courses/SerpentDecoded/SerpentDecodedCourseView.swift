...
struct SerpentDecodedCourseView: View {
  ...
  private var introSection: some View {
    VStack(alignment: .leading, spacing: 14) {
      ...
      Text(
        "What if the serpent in Genesis was never God's enemy? What if everything the church taught you about the fall was inverted?"
      )
      ...
      Text(
        "And what if Jesus himself pointed to the serpent as a symbol of salvation—and they've been hiding it from you for 2,000 years?"
      )
      ...
      VStack(alignment: .leading, spacing: 10) {
        KeyPoint(
          text: "The serpent was sacred in every ancient culture before Genesis",
          color: course.color)
        KeyPoint(
          text: "The Hebrew word 'Nachash' means 'to shine, to illuminate'", color: course.color)
        KeyPoint(
          text: "Jesus explicitly compared himself to the bronze serpent", color: course.color)
...
extension SerpentModule: Equatable {
  static func == (lhs: SerpentModule, rhs: SerpentModule) -> Bool {
    lhs.id == rhs.id
  }
}

extension SerpentLesson: Equatable {
  static func == (lhs: SerpentLesson, rhs: SerpentLesson) -> Bool {
    lhs.id == rhs.id
  }
}
