    ...
    ZStack {
      ...
      ScrollView {
        VStack(spacing: 16) {
          ...
          HStack(spacing: 16) {
            FoodStatBox(
              title: "Obesity", value: "\(String(format: "%.1f", state.obesityRate))%", color: .red)
            FoodStatBox(
              title: "Diabetes", value: "\(String(format: "%.1f", state.diabetesRate))%",
              color: .orange)
          }
      ...
      ScrollView {
        VStack(spacing: 20) {
          ...
          VStack(alignment: .leading, spacing: 12) {
            ...
            ForEach(
              [
                "Autophagy - cellular cleanup", "Improved insulin sensitivity", "Mental clarity",
      ...
      ScrollView {
        VStack(spacing: 20) {
          ...
          VStack(alignment: .leading, spacing: 12) {
            ...
            ForEach(
              [
                "Organic fruits and vegetables", "Grass-fed/pasture-raised meats",
                "Wild-caught fish", "Nuts and seeds", "Whole grains (if tolerated)",
                "Filtered water",
              ], id: \.self
            ) { food in
              HStack {
          ...
          VStack(alignment: .leading, spacing: 12) {
            ...
            ForEach(
              [
                "Processed foods", "Fast food", "Sugary drinks", "Artificial sweeteners",
                "Trans fats", "Foods with ingredients you can't pronounce",
              ], id: \.self
            ) { food in
              HStack {
                Image(systemName: "xmark.circle.fill")
