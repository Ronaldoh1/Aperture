      ...
      lessons: [
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "The Hyperbolic Time Chamber is a nested simulation—a year inside = a day outside. Goku trained in what's essentially a different process thread."
        ),
        ...
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "When Goku dies, his consciousness continues in Other World. The 'process' moved to different 'hardware'—suggesting consciousness isn't tied to the body."
        ),
        ...
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "Ultra Instinct: Goku's body moves without thought. The 'mind.generateThought()' function is bypassed. Pure response without the overhead of thinking."
        ),
      ]
    ),
      ...
      lessons: [
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "Goku never guarantees victory. 'I don't know if I can win, but I'll try!' He's comfortable with Optional<Victory>."
        ),
        ...
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "Saiyans, Namekians, Androids, Gods—all have Ki. Ki is the protocol they all conform to, regardless of their species implementation."
        ),
        ...
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "When Goku fuses with Vegeta, they become Gogeta—a new instance, not a modified Goku or Vegeta. Fusion shows that identity is mutable and composite."
        ),
        ...
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "Vegeta's pride was a captured variable from his royal Saiyan past. It influenced every action until he learned to weaken that capture."
        ),
      ]
    ),
      ...
      lessons: [
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "Ultra Instinct is flow state for fighting. Goku doesn't think about moves—he IS the movement. Same absorption, different domain."
        ),
        ...
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "Vegeta spent years debugging his 'I must surpass Kakarot' bug. The root cause was his pride belief. Once he saw it, he could finally let go and achieve Ultra Ego."
        ),
        ...
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "Gohan's character arc is refactoring—from scared kid to confident warrior, but the 'gentle scholar' core remained. Good refactoring preserves the essential while fixing the bugs."
        ),
        ...
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "Goku doesn't hoard techniques. He shares them freely—teaching Krillin, Gohan, even enemies. Open source martial arts. That's why he keeps growing—giving multiplies."
        ),
      ]
    ),
      ...
      lessons: [
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "When Goku was triggered by Frieza killing Krillin, he had a choice: rage blindly or transform consciously. His grief became fuel for Super Saiyan—emotional alchemy through processing, not suppression."
        ),
        ...
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "Ultra Instinct IS this algorithm running automatically. Whis kept asking Goku 'Who is fighting?' until Goku couldn't find a fighter—just fighting happening. That's the base case."
        ),
        ...
        CodeLesson(
          ...
          swiftCode: """
            ...
            """,
          dragonBallConnection:
            "After mastering Ultra Instinct, Goku doesn't stop being Goku. He still loves food, trains hard, protects friends. But he's no longer identified with being 'the strongest.' He just IS—and fights from that."
        ),
      ]
    ),
  ]
...
struct CodeProgress: Codable {
  ...
  static var `default`: CodeProgress {
    CodeProgress(completedLessons: [], lastAccessed: nil)
  }
}
