...
class FeaturePreferencesManager: ObservableObject {
    ...
    @Published var foodConsciousnessEnabled: Bool {
        didSet { UserDefaults.standard.set(foodConsciousnessEnabled, forKey: Keys.foodConsciousnessEnabled) }
    }
    
    @Published var hydrationRemindersEnabled: Bool {
        didSet { UserDefaults.standard.set(hydrationRemindersEnabled, forKey: Keys.hydrationRemindersEnabled) }
    }
    ...
    @Published var sacredGeometryBadgesEnabled: Bool {
        didSet { UserDefaults.standard.set(sacredGeometryBadgesEnabled, forKey: Keys.sacredGeometryBadgesEnabled) }
    }
    ...
    @Published var hasSetFeaturePreferences: Bool {
        didSet { UserDefaults.standard.set(hasSetFeaturePreferences, forKey: Keys.hasSetFeaturePreferences) }
    }
    ...
    private init() {
        ...
        if hasSetPrefs {
            ...
            self.foodConsciousnessEnabled = UserDefaults.standard.bool(forKey: Keys.foodConsciousnessEnabled)
            self.hydrationRemindersEnabled = UserDefaults.standard.bool(forKey: Keys.hydrationRemindersEnabled)
            self.fastingCoachEnabled = UserDefaults.standard.bool(forKey: Keys.fastingCoachEnabled)
            self.psyopScannerEnabled = UserDefaults.standard.bool(forKey: Keys.psyopScannerEnabled)
            self.flowStateEnabled = UserDefaults.standard.bool(forKey: Keys.flowStateEnabled)
            self.sacredGeometryBadgesEnabled = UserDefaults.standard.bool(forKey: Keys.sacredGeometryBadgesEnabled)
        } else {
            // Apply defaults - all features enabled
            self.foodConsciousnessEnabled = true
            self.hydrationRemindersEnabled = true
            self.fastingCoachEnabled = true
            self.psyopScannerEnabled = true
            self.flowStateEnabled = true
            self.sacredGeometryBadgesEnabled = true
        }
        
        self.hasCompletedOnboarding = UserDefaults.standard.bool(forKey: Keys.hasCompletedOnboarding)
        self.hasSetFeaturePreferences = hasSetPrefs
    }
        ...
        ZStack {
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    // Mind Consciousness
                    VStack(alignment: .leading, spacing: 12) {
                        FeatureSectionHeader(icon: "brain.head.profile", title: "Mind Consciousness", color: .purple)
