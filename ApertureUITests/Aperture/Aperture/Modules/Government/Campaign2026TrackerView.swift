...
struct Campaign2026TrackerView: View {
  ...
  private var keyRacesSection: some View {
    VStack(alignment: .leading, spacing: 16) {
      ...
      // Note about data
      Text(
        "Note: Candidate information updates as primaries conclude. Check resources below for current data."
      )
      .font(.system(size: 11))
      .foregroundColor(.gray)
      .italic()
  ...
  private var researchSection: some View {
    VStack(alignment: .leading, spacing: 16) {
      ...
      VStack(spacing: 12) {
        ...
        researchRow(
          "How do they vote?", "Check VoteSmart.org for voting records", "checkmark.square")
        researchRow(
          "What do they actually say?", "Watch full interviews, not clips", "play.rectangle")
  ...
  private var resourcesSection: some View {
    VStack(alignment: .leading, spacing: 16) {
      ...
      VStack(spacing: 12) {
        resourceLink(
          "OpenSecrets.org", "Follow the money—campaign finance data", "https://opensecrets.org")
