...
struct LessonView: View {
  ...
  private var lessonHeader: some View {
    HStack {
      ...
      Spacer()
      Text("Lesson \(lesson.number)").font(.system(size: 14, weight: .bold, design: .rounded))
    ...
    case .warning(let text):
      ...
      .background(
        RoundedRectangle(cornerRadius: 12, style: .continuous)
          ...
          .overlay(
            RoundedRectangle(cornerRadius: 12, style: .continuous).stroke(
              Palette.primary.orange.opacity(0.3), lineWidth: 1))
      )
  ...
  private var keyTakeaways: some View {
    VStack(alignment: .leading, spacing: 12) {
      HStack(spacing: 8) {
        ...
        Text("KEY TAKEAWAYS").font(.system(size: 11, weight: .bold, design: .rounded)).tracking(1)
          .foregroundColor(module.color)
      }
      ...
      RoundedRectangle(cornerRadius: 14, style: .continuous)
        ...
        .overlay(
          RoundedRectangle(cornerRadius: 14, style: .continuous).stroke(
            module.color.opacity(0.3), lineWidth: 1))
    )
  }
      ...
      Button {
        ...
        HStack {
          HStack(spacing: 8) {
            ...
            Text("REFLECTION PROMPTS").font(.system(size: 11, weight: .bold, design: .rounded))
              .tracking(1).foregroundColor(Palette.primary.violet)
          }
          Spacer()
        ...
        ForEach(lesson.reflectionPrompts, id: \.self) { prompt in
          ...
          .background(
            RoundedRectangle(cornerRadius: 10, style: .continuous).fill(
              Palette.primary.violet.opacity(0.1)))
        }
      }
    }
    .padding(16)
  ...
  private var furtherReadingSection: some View {
    VStack(alignment: .leading, spacing: 12) {
      Button {
        ...
        HStack {
          HStack(spacing: 8) {
            Image(systemName: "book.fill").font(.system(size: 14)).foregroundColor(
              Palette.text.secondary)
            Text("FURTHER READING").font(.system(size: 11, weight: .bold, design: .rounded))
  ...
  private var notesSection: some View {
    VStack(alignment: .leading, spacing: 10) {
      HStack(spacing: 8) {
        Image(systemName: "pencil.circle.fill").font(.system(size: 14)).foregroundColor(
          Palette.accent.gold)
        Text("YOUR NOTES").font(.system(size: 11, weight: .bold, design: .rounded)).tracking(1)
          .foregroundColor(Palette.accent.gold)
      }
