    ...
    VStack(alignment: .leading, spacing: 10) {
      ...
      if selectedTier == tier {
        VStack(spacing: 8) {
          // Chakra connection
          HStack(spacing: 6) {
            Image(systemName: "circle.hexagongrid").font(.system(size: 10)).foregroundColor(
              tier.color)
  ...
  private func pillarDetail(_ pillar: QuantumPillar) -> some View {
    VStack(alignment: .leading, spacing: 14) {
      ...
      VStack(alignment: .leading, spacing: 8) {
        Text("TOP FOODS").font(.system(size: 9, weight: .bold)).tracking(1).foregroundColor(
          pillar.color)
    ...
    .background(
      RoundedRectangle(cornerRadius: 14)
        ...
        .overlay(
          RoundedRectangle(cornerRadius: 14).stroke(pillar.color.opacity(0.15), lineWidth: 1))
    )
  }
}
...
struct FlowLayout: Layout {
  ...
  func placeSubviews(
    ...
    let result = arrangeSubviews(
      proposal: ProposedViewSize(width: bounds.width, height: bounds.height), subviews: subviews)
          ...
          VStack(spacing: 20) {
            ...
            VStack(spacing: 12) {
              ZStack {
                ...
                Image(systemName: "eye.fill").font(.system(size: 36)).foregroundColor(
                  Color(hex: "#9B59B6"))
              }
              ...
              Text(
                "Your pineal gland is the seat of intuition. These foods either activate it or calcify it."
              )
            ...
            VStack(alignment: .leading, spacing: 12) {
              HStack(spacing: 6) {
                ...
                Text("DECALCIFIERS & ACTIVATORS").font(.system(size: 10, weight: .bold)).tracking(1)
            ...
            VStack(alignment: .leading, spacing: 12) {
              HStack(spacing: 6) {
                ...
                Text("CALCIFIERS — AVOID THESE").font(.system(size: 10, weight: .bold)).tracking(1)
                  .foregroundColor(.red)
              }
...
struct ConsciousnessKillersView: View {
  ...
  var body: some View {
    NavigationStack {
      ZStack {
        LinearGradient(
          colors: [Color.black, Color(hex: "#1a0000"), Color.black], startPoint: .top,
          endPoint: .bottom
        ).ignoresSafeArea()
        ...
        ScrollView(showsIndicators: false) {
          VStack(spacing: 20) {
            VStack(spacing: 12) {
              ...
              Text("CONSCIOUSNESS KILLERS").font(.system(size: 10, weight: .bold)).tracking(4)
                .foregroundColor(.red)
              Text("The Kill List").font(.system(size: 24, weight: .bold, design: .rounded))
                .foregroundColor(Palette.text.primary)
            ...
            VStack(spacing: 8) {
              ...
              Text(
                "\"Every item on this list was put in your food supply by people who understand frequency. They know exactly what these substances do to your pineal gland, your gut, and your electromagnetic field. This isn't negligence. It's engineering.\""
              )
