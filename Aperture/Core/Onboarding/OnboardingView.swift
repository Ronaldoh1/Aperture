...
// 1. Logo Awe → 2. Motivation Quiz → 3. Path Reveal → 4. Meet Dragon → 5. First Micro Win
...
struct OnboardingView: View {
    ...
    private var logoAwePage: some View {
        VStack(spacing: 30) {
            ...
            Text("A unified path through awakening traditions,\nhidden history, and practical transformation.")
                .font(.system(size: 15))
                .foregroundColor(.white.opacity(0.6))
    ...
    private var meetDragonPage: some View {
        VStack(spacing: 24) {
            ...
            Text("I'm your companion on this journey.")
                .font(.system(size: 22, weight: .bold))
                .foregroundColor(.white)
            
            VStack(spacing: 12) {
                Text("I'll be here whenever you need guidance.")
                    .foregroundColor(.white.opacity(0.7))
                
                Text("Long press anywhere to summon me.")
                    .foregroundColor(Palette.accent.gold)
                    .fontWeight(.medium)
                
                Text("I grow as you grow.")
                    .foregroundColor(.white.opacity(0.7))
            }
            .font(.system(size: 15))
            .multilineTextAlignment(.center)
            ...
            VStack(spacing: 8) {
                ...
                TextField("Dragon", text: $dragonName)
    ...
    private func firstInsight(for journey: UserJourneyType) -> String {
        switch journey {
        case .groundMe:
            return "Awakening can feel destabilizing—that's normal. The practices here are designed to help you find your center. Start with breathing. Start with presence. Everything else builds from there."
        case .showPatterns:
            return "History isn't what they taught you. The patterns repeat across centuries—the same control mechanisms, the same distractions, the same suppressed truths. Once you see them, you can't unsee them."
        case .teachPractice:
            return "Every culture discovered the same inner technology. Kundalini, Qi, Holy Spirit, Bodhi—different names for the same awakening mechanism. You're about to learn what they all point to."
        case .giveSources:
            return "The Nag Hammadi library, the Dead Sea Scrolls, the Corpus Hermeticum—these texts were hidden or suppressed for centuries. Now they're in your pocket. Question everything, including us."
        }
    }
    ...
    private func completeOnboarding() {
        ...
        journeyStore.completeOnboarding(
            journeyType: journey,
            dragonName: dragonName.isEmpty ? nil : dragonName
        )
