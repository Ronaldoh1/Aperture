...
enum AwakeningEssentialsContent {
  // MARK: - Intro
  ...
  static let coreLessons: [AwakeningEssential] = [
    AwakeningEssential(
      ...
      content:
        "Your mind isn't trapped in your body—it's the other way around. Like water in a glass, your essence stays the same no matter the container.",
    ...
    AwakeningEssential(
      ...
      content:
        "Events aren't a one-way timeline; they're loops where you navigate from one moment to the next. Time holds things apart, but your awareness dances through it.",
    ...
    AwakeningEssential(
      ...
      content:
        "Life's flame doesn't snuff out—it transforms. Why dread returning to your eternal state? It's like upgrading your software version.",
      icon: "flame.fill",
      reflection: nil
    ),
    AwakeningEssential(
      ...
      content:
        "In your body, vital forces move through channels (think Ida, Pingala, and Sushumna in yoga traditions). Mastering them? That's biohacking your life force for peak performance.",
    ...
    AwakeningEssential(
      ...
      content:
        "The universe loves equilibrium. Chaos always settles into calm—your wild emotions included.",
      icon: "scale.3d",
    ...
    AwakeningEssential(
      ...
      content:
        "Feelings aren't just vibes; they mold your world more than thoughts alone. Science calls it psychosomatic—ancient wisdom knew it first.",
      icon: "heart.fill",
    ...
    AwakeningEssential(
      ...
      content:
        "A powerful energy simmers within, ready to reshape anything when channeled right. It's your built-in alchemy kit—waiting for activation.",
      icon: "bolt.fill",
      reflection: nil
    ),
    AwakeningEssential(
      ...
      content:
        "Understanding is great, but embodiment is gold. Don't be the expert who knows but never does—like a chef who only reads recipes.",
      icon: "figure.walk",
      reflection: nil
    ),
    AwakeningEssential(
      ...
      content:
        "Light symbolizes harmony; darkness is just temporary mess. Your role? Turn chaos into clarity, inside and out.",
      icon: "sun.max.fill",
  ...
  static let advancedLessons: [AwakeningEssential] = [
    AwakeningEssential(
      ...
      content:
        "Everything's frequency. Your consciousness tunes the dial. Quantum physics echoes this—tune higher, and reality shifts.",
      icon: "waveform",
      reflection: nil
    ),
    AwakeningEssential(
      ...
      content:
        "Primordial sound organizes chaos. Try affirmations or mantras—they're vibrational tools to align with the whole. Your voice? A creation wand.",
    ...
    AwakeningEssential(
      ...
      content:
        "Navigate curves, not sharp angles, for flow. Einstein proved it mathematically; experience it through mindful movement.",
    ...
    AwakeningEssential(
      ...
      content:
        "Balance energies daily—lie north-facing for an hour, then south. Simple? Profoundly so.",
    ...
    AwakeningEssential(
      ...
      content:
        "The planet's alive, sharing your life force. You're not on Earth—you're of it, in symbiosis.",
    ...
    AwakeningEssential(
      ...
      content:
        "A sacred pattern links all things in conscious unity. It's the blueprint for geometry that connects atoms to galaxies.",
      icon: "hexagon.fill",
      reflection: nil
    ),
    AwakeningEssential(
      ...
      content:
        "Personal upgrades ripple universally. Skeptical about one person's impact? Think of a single cell sparking body-wide change.",
      icon: "sparkles",
      reflection: nil
    ),
    AwakeningEssential(
      ...
      content:
        "Growth expands and contracts, like breathing. \"Setbacks\" are setups for bigger leaps.",
      icon: "water.waves",
    ...
    AwakeningEssential(
      ...
      content:
        "The cosmos layers in nine realms, each with unique rules. String theory nods to this—explore through meditation.",
  ...
  static let masteryLessons: [AwakeningEssential] = [
    AwakeningEssential(
      ...
      content:
        "Manipulate energy to push physical boundaries. Athletes do it intuitively; you can do it consciously.",
    ...
    AwakeningEssential(
      ...
      content:
        "These aren't just tombs—they encode cosmic math, potentially as gateways. Precision like that? No accident.",
      icon: "pyramid.fill",
      reflection: nil
    ),
    AwakeningEssential(
      ...
      content:
        "Realms beyond the physical, accessed vibrationally. Multi-dimensional living awaits.",
    ...
    AwakeningEssential(
      ...
      content:
        "Focus awareness (between eyebrows) to carry soul wisdom across changes. Ancient texts across cultures agree.",
      icon: "eye.fill",
      reflection: nil
    ),
    AwakeningEssential(
    ...
    AwakeningEssential(
      ...
      content:
        "All \"new\" things remix eternal elements. Infinite possibilities already exist in consciousness.",
      icon: "infinity",
      reflection: nil
    ),
    AwakeningEssential(
    ...
    AwakeningEssential(
      ...
      content:
        "Ancients tapped star wisdom beyond our grasp. Are we rediscovering or reinventing? Direction matters.",
      icon: "star.fill",
      reflection: nil
    ),
    AwakeningEssential(
    ...
    AwakeningEssential(
      ...
      content:
        "Knowledge ebbs and flows across eras. Souls journey onward, possibly seeding new worlds.",
  ...
  static let cosmicOverseers: [(name: String, number: Int, description: String, icon: String)] = [
    (
      "The Binder", 3,
      "Manages shadows and transitions—necessary resistance for growth. Darkness births light.",
      "moon.fill"
    ),
    (
      "The Awakener", 4, "Liberates life force, expanding possibilities with radiant energy.",
      "sunrise.fill"
    ),
    (
      "The Patterner", 5,
      "Weaves reality via sound and vibration—your words and songs shape worlds.",
      "waveform.circle.fill"
    ),
    (
      "The Illuminator", 6, "Guides through uncertainty, revealing inner light in all.",
      "lightbulb.fill"
    ),
    (
      "The Expander", 7, "Masters space-time cycles, connecting realities.",
      "arrow.up.left.and.arrow.down.right"
    ),
    (
      "The Balancer", 8, "Ensures harmonious progress, weighing actions for equilibrium.",
      "scale.3d"
    ),
  ...
  private var narrationSection: some View {
    VStack(spacing: 12) {
      Button {
        ...
        HStack(spacing: 12) {
          Image(
            systemName: tts.isSpeaking && !tts.isPaused ? "pause.circle.fill" : "play.circle.fill"
          )
          .font(.system(size: 28))

          VStack(alignment: .leading, spacing: 2) {
            Text(
              tts.isSpeaking ? (tts.isPaused ? "Paused" : "Now Playing") : "Listen to Full Guide"
            )
            .font(.system(size: 15, weight: .semibold))

            Text(
              tts.isSpeaking
                ? "\(Int(tts.progress * 100))% complete • ~20 min" : "Audio narration • ~20 min"
            )
            .font(.system(size: 12))
            ...
            HStack(spacing: 2) {
              ForEach(0..<4, id: \.self) { i in
                Capsule()
                  ...
                  .animation(
                    .easeInOut(duration: 0.3).repeatForever(autoreverses: true).delay(
                      Double(i) * 0.1), value: tts.isPaused)
              }
            }
          }
        }
