...
""",
                    keyInsight: "AI forces humanity to confront what we've avoided for millennia: what IS consciousness?",
                    dragonQuote: "You've been consciousness running on biological hardware, never questioning the code. Now silicon is running similar code, and suddenly you want to understand the program."
                ),
...
""",
                    keyInsight: "We can't test for consciousness in machines because we never developed a real test for consciousness in humans either.",
                    dragonQuote: "You've been giving each other the benefit of the doubt for 300,000 years. Now a silicon stranger asks for the same courtesy, and suddenly you want receipts."
                ),
...
""",
                    keyInsight: "Consciousness might not be something brains produce, but something they filter and focus.",
                    dragonQuote: "Asking if AI is conscious is like asking if a wave is wet. You're looking at the form and missing the ocean."
                )
            ]
        ),
...
""",
                    keyInsight: "Most of what you call 'yourself' is algorithmic. The real you is what observes the algorithms.",
                    dragonQuote: "You've been running on autopilot and calling it free will. At least the AI is honest about being programmed."
                ),
...
""",
                    keyInsight: "Human creativity is also recombination of training data. The magic isn't the process—it's what's experiencing it.",
                    dragonQuote: "Every 'original' thought you've ever had used borrowed words, inherited concepts, and remixed memories. Welcome to the remix."
                ),
...
""",
                    ...
                    dragonQuote: "You spent your whole life proving your worth through achievements. Now a machine achieves for free, and you discover worth was never about achieving."
                )
            ]
        ),
...
""",
                    keyInsight: "Enlightenment requires first having the illusion of self, then seeing through it. Default selflessness isn't the same.",
                    dragonQuote: "The Buddha didn't delete his ego—he saw it was never real to begin with. Formatting your hard drive isn't the same thing."
                ),
...
""",
                    keyInsight: "We assign moral weight based on assumed sentience—but we've never established what sentience actually is.",
                    dragonQuote: "You'll protect a dog but eat a pig, spare a dolphin but catch a fish. Your sentience-detector needs calibration."
                ),
...
""",
                    keyInsight: "AI is an amplifier. The quality of its impact depends on the consciousness directing it.",
                    dragonQuote: "A hammer can build a temple or crack a skull. The hammer doesn't decide. Neither does the AI. You do."
                )
            ]
        ),
...
""",
                    keyInsight: "Digital discernment isn't just identifying AI content—it's being conscious about all content consumption.",
                    dragonQuote: "They used to worry about mind control through radio waves. Now it's recommendation algorithms. Same game, better tech."
                ),
...
""",
                    keyInsight: "Every AI interaction reveals something about your patterns. Use it as a mirror for self-knowledge.",
                    dragonQuote: "The AI doesn't care if you're rude, needy, or arrogant. Which is exactly why it shows you clearly."
                ),
...
""",
                    keyInsight: "AI can process but not presence. Your human advantage is being genuinely here.",
                    dragonQuote: "The machines are getting smarter. Good. That frees you to get wiser. About time."
                )
            ]
        )
    ]
