        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    Text("Human civilization is built on pyramids—not just stone ones, but invisible hierarchies of thought, layers of meaning, and levels of thinking that range from basic impulses to true revelation.")
                        .font(.body)
                        .foregroundStyle(.white.opacity(0.9))
                    
                    Text("Yet despite the astonishing tools available today, most people never climb past the first steps. Society operates at the LOWEST layers—remembering, or more accurately, simply regurgitating everything they've been told.")
                        .font(.body)
                        .foregroundStyle(.white.opacity(0.9))
                }
                .padding()
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Text("Most people don't even realize there ARE higher levels of thinking that they can ascend to.")
                        .font(.body)
                        .fontWeight(.semibold)
                        .foregroundStyle(Color(hex: "9B59B6"))
                    
                    Text("They believe they're thinking simply because information is passing through their minds. It's like riding shotgun and convincing yourself you're the one steering.")
                        .font(.caption)
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Text("Educational psychologist Benjamin Bloom created a taxonomy of thinking—originally for teachers, but actually a blueprint for human cognition itself.")
                        .font(.body)
                        .foregroundStyle(.white.opacity(0.9))
                    
                    Text("It reveals why some people develop clarity, perspective, and wisdom—while others remain stuck, repeating what they've been told without any deeper understanding.")
                        .font(.caption)
                        .foregroundStyle(.white.opacity(0.7))
                }
                .padding()
                ...
                statCard(
                    title: "THE PARADOX",
                    stat: "∞",
                    desc: "We have unprecedented access to information, yet understand LESS than ever. We confuse awareness with comprehension, memory with intelligence, noise with depth."
                )
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    Text("Metacognition is the ability to watch your own mind the way you watch a movie. You're observing the observer.")
                        .font(.body)
                        .foregroundStyle(.white.opacity(0.9))
                    ...
                    Text("It's like unlocking the ability to DEBUG your own mind—identifying cognitive biases, emotional triggers, and blind spots in real-time.")
                        .font(.caption)
                        .foregroundStyle(Color(hex: "FFD700"))
                }
                .padding()
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Text("The top is not a PLACE—it's a PRACTICE. Nobody reaches it and stays permanently. You rise, fall, and rise again.")
                        .font(.body)
                        .foregroundStyle(.white.opacity(0.9))
                    
                    Text("Every moment you choose depth over speed, curiosity over certainty, reflection over reaction—you ASCEND.")
                        .font(.caption)
                        .fontWeight(.semibold)
                        .foregroundStyle(Color(hex: "27AE60"))
                }
                ...
                ascendStep(
                    ...
                    desc: "Creation is not just artistic—it's cognitive. Transform thinking into something original.",
                    practices: [
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Text("When one mind climbs, it changes more than just that mind. It changes everyone connected to it.")
                        .font(.body)
                        .foregroundStyle(.white.opacity(0.9))
                    
                    Text("Your clarity becomes a light guiding others to the top. In a world trapped at the bottom, climbing is a REVOLUTIONARY ACT.")
                        .font(.caption)
                        .fontWeight(.semibold)
                        .foregroundStyle(Color(hex: "FFD700"))
                }
...
extension ThinkingLevel {
    static let allLevels: [ThinkingLevel] = [
        ThinkingLevel(
            number: 1,
            name: "REMEMBER",
            description: "Simply repeating information verbatim. The cognitive equivalent of fast food—pre-cooked, pre-chewed, pre-digested.",
            characteristics: [
        ...
        ThinkingLevel(
            number: 2,
            name: "UNDERSTAND",
            description: "Explaining ideas in your own words. A fragile understanding that collapses when life gets complicated.",
            characteristics: [
        ...
        ThinkingLevel(
            number: 3,
            name: "APPLY",
            description: "Using information to solve simple problems. Taking knowledge and putting it into action.",
            characteristics: [
        ...
        ThinkingLevel(
            number: 4,
            name: "ANALYZE",
            description: "Compare, contrast, break things apart, see hidden structures. Thinking becomes STRUCTURAL.",
            characteristics: [
        ...
        ThinkingLevel(
            number: 5,
            name: "EVALUATE",
            description: "Form judgments, determine priorities, take stances. Evaluation means PRIORITIZATION.",
            characteristics: [
        ...
        ThinkingLevel(
            number: 6,
            name: "CREATE",
            description: "Produce something that did not exist before—new solutions, models, explanations, perspectives.",
            characteristics: [
            ...
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        ...
                        // Characteristics
                        detailSection(title: "Characteristics", items: level.characteristics, color: level.color)
                        
                        // Examples
                        detailSection(title: "Examples", items: level.examples, color: Color(hex: "3498DB"))
                        
                        // How to Ascend
                        detailSection(title: "How to Ascend", items: level.howToAscend, color: Color(hex: "27AE60"))
