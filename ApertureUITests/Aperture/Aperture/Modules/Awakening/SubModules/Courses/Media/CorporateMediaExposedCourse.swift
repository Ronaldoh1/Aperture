...
struct CorporateMediaExposedCourse: View {
  ...
  private var warningCard: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      Text(
        "This course examines how corporate media operates. Understanding media ownership, business models, and documented failures helps you become a more discerning news consumer."
      )
      .font(.system(size: 12))
      ...
      MediaLesson(
        ...
        content: """
          ...
          **More time doesn't mean more news. It means more filler.**
          """,
        keyTakeaway:
          "TV news is a business optimized for attention, not truth. Conflict, fear, and outrage get viewers. Nuance and context don't. The business model shapes the content."
      ),
      MediaLesson(
        ...
        content: """
          ...
          **After:** Media empires consolidated
          ...
          """,
        keyTakeaway:
          "6 corporations control 90% of American media. Sinclair forces 185+ local stations to air the same scripts. Media consolidation means fewer perspectives and protected corporate interests."
      ),
      MediaLesson(
        ...
        content: """
          ...
          **Laura Ingraham:**
          ...
          """,
        keyTakeaway:
          "Fox News legally argued in court that Tucker Carlson isn't presenting facts. Internal documents show hosts knew election claims were false. They paid $787M in defamation settlement. It's entertainment designed for political influence."
      ),
      MediaLesson(
        ...
        content: """
          ...
          **But both are corporate media with corporate interests.**
          """,
        keyTakeaway:
          "MSNBC is opinion programming owned by Comcast. Fired Phil Donahue for anti-war views despite high ratings. Russiagate coverage was often overhyped. Less misinformation than Fox, but still corporate media with corporate interests."
      ),
      MediaLesson(
        ...
        content: """
          ...
          **The truth is more boring than they can afford.**
          """,
        keyTakeaway:
          "CNN pioneered 24-hour news and 'both sides' journalism that treats lies as valid perspectives. Gave Trump billions in free airtime. Drama over substance. Not fake, but optimized for conflict over truth."
      ),
      MediaLesson(
        ...
        content: """
          ...
          **It's in what they don't cover at all.**
          """,
        keyTakeaway:
          "Chomsky's 'Manufacturing Consent': Media is filtered through ownership, advertising, sources, flak, and common enemies. Not conspiracy—structural incentives. Iraq War showed how 'free' media can enable catastrophic lies."
      ),
      MediaLesson(
        ...
        content: """
          ...
          **This requires recognizing local news as public infrastructure, not just business.**
          """,
        keyTakeaway:
          "2,500+ newspapers closed since 2005. 70 million Americans live in 'news deserts.' Local corruption increases without local news. Sinclair forces identical propaganda across 185+ 'local' stations. Local news is dying—democracy suffers."
      ),
      MediaLesson(
        ...
        content: """
          ...
          **Social media can alert you to stories. Then go find real reporting.**
          """,
        keyTakeaway:
          "Algorithms optimize for engagement, not truth. False news spreads 6x faster than true news. Filter bubbles create echo chambers. Social media is designed to manipulate your emotions, not inform you."
      ),
      MediaLesson(
        ...
        content: """
          ...
          **Media literacy is a skill. It takes practice.**
          """,
        keyTakeaway:
          "Use the SIFT method: Stop, Investigate source, Find other coverage, Trace claims. Watch for selection, framing, and omission bias. Prioritize depth over speed, reporting over opinion. Media literacy is a skill that takes practice."
      ),
      MediaLesson(
        ...
        content: """
          ...
          **You are what you consume. Choose wisely.**
          """,
        keyTakeaway:
          "Build a healthy news diet: Wire services (AP, Reuters) for facts, investigative outlets (ProPublica) for depth, international sources for perspective, fact-checkers for verification. 15-20 minutes of quality beats hours of cable noise."
      ),
    ]
  }
}
