...
struct AmericanDreamExposedCourse: View {
  ...
  private func lessonRow(_ lesson: DreamLesson, index _: Int) -> some View {
    HStack(spacing: 16) {
      ZStack {
        Circle()
      ...
      DreamLesson(
        ...
        content: """
          ...
          **The Original Sin:**
          ...
          """,
        keyTakeaway:
          "The 'American Dream' started as a vision of equal opportunity and was corrupted into a consumer fantasy that blames individuals for systemic failures."
      ),
      DreamLesson(
        ...
        content: """
          ...
          **Why This Matters:**
          ...
          """,
        keyTakeaway:
          "Only 50% of people born in 1980 will earn more than their parents. America ranks 27th in social mobility. The 'land of opportunity' is a statistical lie."
      ),
      DreamLesson(
        ...
        content: """
          ...
          **Who Suffers:**
          ...
          """,
        keyTakeaway:
          "Homes cost 8x median income today vs. 2x in 1950. This isn't market forces—it's policy choices that benefit property owners and lock everyone else out."
      ),
      DreamLesson(
        ...
        content: """
          ...
          **Other Countries:**
          ...
          """,
        keyTakeaway:
          "$1.77 trillion in student debt. Can't be discharged in bankruptcy. Other developed nations offer free or cheap college. America chose to trap its young people in debt."
      ),
      DreamLesson(
        ...
        content: """
          ...
          **Who Suffers:**
          ...
          """,
        keyTakeaway:
          "66.5% of bankruptcies involve medical debt. America spends the most on healthcare and has worse outcomes than every other developed nation. This is policy, not nature."
      ),
      DreamLesson(
        ...
        content: """
          ...
          **Who Suffers:**
          ...
          """,
        keyTakeaway:
          "Productivity rose 64% since 1973, but workers only got 17% of those gains. The rest went to executives and shareholders. This is wage theft on a civilizational scale."
      ),
      DreamLesson(
        ...
        content: """
          ...
          **The Coming Crisis:**
          ...
          """,
        keyTakeaway:
          "50% of Americans have zero retirement savings. The 401(k) shifted all risk from employers to workers. Even its creator calls it a 'monster.'"
      ),
      DreamLesson(
        ...
        content: """
          ...
          **The Real Question:**
          ...
          """,
        keyTakeaway:
          "Your parents' income is the best predictor of your income—not hard work. Meritocracy is a myth that blames individuals for systemic failures."
      ),
      DreamLesson(
        ...
        content: """
          ...
          **Breaking Free:**
          ...
          """,
        keyTakeaway:
          "The American Dream became 'buy more stuff.' $300 billion/year in advertising exists to make you feel inadequate. Consumption doesn't create happiness—it creates debt."
      ),
      DreamLesson(
        ...
        content: """
          ...
          **The Real American Dream:**
          ...
          """,
        keyTakeaway:
          "The dream isn't dead—it was stolen. Other countries prove a different system is possible. It requires collective action to take it back."
      ),
    ]
  }
}
