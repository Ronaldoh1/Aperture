        ...
        CalendarLesson(
          ...
          content: """
            ...
            **What Happened?**
            ...
            """,
          keyFact:
            "September literally means 'seventh month' in Latin—proof the calendar was shifted."
        ),
        ...
        CalendarLesson(
          ...
          content: """
            ...
            **The Power Play**
            ...
            """,
          keyFact:
            "New Year was moved from March to January for political convenience, not cosmic truth."
        ),
        ...
        CalendarLesson(
          ...
          content: """
            ...
            **The Catholic Church Connection**
            ...
            """,
          keyFact:
            "January resolutions fail because you're planting seeds in winter. Start at spring equinox."
        ),
      ]
    ),
        ...
        CalendarLesson(
          ...
          content: """
            ...
            **Why 13 Moons?**
            ...
            """,
          keyFact:
            "New moons are for beginnings, full moons for completion—align your actions accordingly."
        ),
        ...
        CalendarLesson(
          ...
          content: """
            ...
            **The Nine-Year Cycle**
            ...
            """,
          keyFact:
            "Your birthday is your personal New Year. That's when your annual cycle truly begins."
        ),
      ]
    ),
        ...
        CalendarLesson(
          ...
          content: """
            ...
            **The Pattern**
            ...
            """,
          keyFact:
            "Multiple valid calendar systems exist—the Gregorian is not 'the' calendar, just 'a' calendar."
        ),
      ]
    ),
  ]
...
struct CalendarProgress: Codable {
  ...
  static var `default`: CalendarProgress {
    CalendarProgress(completedLessons: [], lastAccessed: nil)
  }
}
