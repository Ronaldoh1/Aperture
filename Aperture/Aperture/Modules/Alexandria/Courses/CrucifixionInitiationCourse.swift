...
enum CrucifixionInitiationCourse {
  static let course = AlexandriaCourse(
    ...
    modules: [
      ACModule(
        id: "ci1", number: 1, title: "The Initiation Pattern",
        subtitle: "The universal death-rebirth mystery", icon: "arrow.triangle.2.circlepath",
        lessons: [
          ACLesson(
            id: "ci1_1", title: "Not Execution — Graduation",
            content: """
              ...
              **This is not a Christian invention.** This is the oldest ritual pattern in human consciousness:
              ...
              """,
            keyInsight:
              "The crucifixion follows the universal initiation pattern (death → descent → rebirth) found in Egypt, Greece, and Mesoamerica. It's not unique — it's archetypal.",
            practice:
              "Identify a 'death' you've already experienced — a breakup, a job loss, a crisis. Can you see the initiation pattern in your own life?"
          )
        ])
    ],
    sources: [
    ...
    dragonComment:
      "Every ancient tradition knew: the ego must die for the spirit to live. They just called it different names. The cross is the same door everyone walks through. 🐉"
  )
}
