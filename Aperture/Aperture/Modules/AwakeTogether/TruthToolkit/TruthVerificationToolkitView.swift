// TruthVerificationToolkitView.swift
...
enum PropagandaDatabase {
  static let allTechniques: [PropagandaTechnique] = [
    PropagandaTechnique(
      ...
      keywords: [
        "crisis", "emergency", "disaster", "threat", "danger", "warning", "urgent", "breaking",
        "panic", "fear",
      ],
      defense: "Pause. Ask: What do they want me to feel? Fear rarely leads to good decisions.",
      gnosticLink:
        "The Archons feed on fear energy. Fear keeps you in the material illusion, disconnected from your divine spark."
    ),
    ...
    PropagandaTechnique(
      ...
      keywords: [
        "they", "them", "those people", "liberals", "conservatives", "enemies", "traitors", "real",
        "true", "us",
      ],
      defense: "Ask: Who benefits from this division? Most people want the same things.",
      gnosticLink:
        "The Demiurge's primary tool is separation. Division prevents collective awakening and maintains the prison of duality."
    ),
    ...
    PropagandaTechnique(
      ...
      keywords: [
        "experts", "scientists", "officials", "authorities", "studies show", "research proves",
        "consensus",
      ],
      defense:
        "Ask: Who funded the study? What do dissenting experts say? Appeal to authority ≠ truth.",
      gnosticLink:
        "The Archons create false hierarchies. True gnosis comes from direct experience, not external authority."
    ),
    ...
    PropagandaTechnique(
      ...
      keywords: [
        "everyone", "most people", "trending", "viral", "popular", "majority", "consensus", "join",
      ],
      defense: "Remember: Truth isn't determined by popularity. Mass delusion is historical fact.",
      gnosticLink:
        "The sleeping masses (hylics) follow the crowd. Pneumatics (awakened souls) follow inner knowing."
    ),
    ...
    PropagandaTechnique(
      ...
      keywords: [
        "children", "innocent", "victims", "monsters", "heartless", "cruel", "care", "compassion",
      ],
      defense: "Strong emotions = critical thinking bypassed. Pause before reacting.",
      gnosticLink:
        "Emotions are the Archons' playground. They manipulate your astral body through triggered feelings."
    ),
    ...
    PropagandaTechnique(
      ...
      keywords: [
        "now", "urgent", "immediately", "limited", "last chance", "before it's too late",
        "act fast",
      ],
      defense: "Real emergencies rarely come through your feed. Sleep on important decisions.",
      gnosticLink:
        "Time pressure traps you in the material realm. Eternity is your true home; nothing is truly urgent."
    ),
    ...
    PropagandaTechnique(
      ...
      gnosticLink:
        "The Demiurge presents a partial reality as the whole truth. True gnosis sees beyond the veil."
    ),
    ...
    PropagandaTechnique(
      ...
      keywords: [
        "conspiracy", "extremist", "radical", "dangerous", "misinformation", "denier", "anti-",
      ],
      defense: "Labels are designed to prevent thinking. Judge ideas on merit, not labels.",
      gnosticLink:
        "Labels are spells that bind perception. The Archons use language to limit consciousness."
    ),
    ...
    PropagandaTechnique(
      ...
      keywords: [
        "debunked", "imagining", "never happened", "misremember", "false memory", "you're wrong",
      ],
      defense:
        "Trust your direct experience. Document what you observe. Connect with others who remember.",
      gnosticLink:
        "The Demiurge's greatest trick is making you forget your divine origin. Trust your inner knowing."
    ),
    ...
    PropagandaTechnique(
      ...
      defense:
        "Repetition doesn't create truth. The illusory truth effect is a documented psychological phenomenon.",
      gnosticLink:
        "The Matrix repeats its programming endlessly. Break the loop through direct awareness."
    ),
    ...
    PropagandaTechnique(
      ...
      keywords: [
        "they want", "they believe", "their position", "so you're saying", "in other words",
      ],
      defense: "Ask: Is this an accurate representation of what they actually said?",
      gnosticLink:
        "The Archons distort truth into caricatures. Seek the original source, not the interpretation."
    ),
    ...
    PropagandaTechnique(
      ...
      keywords: [
        "tradition", "always", "heritage", "values", "customs", "ancestors", "historical",
      ],
      defense: "Longevity doesn't equal truth. Many long-standing beliefs have been wrong.",
      gnosticLink:
        "The Demiurge perpetuates cycles. True gnosis breaks free from inherited conditioning."
    ),
  ]
}
...
class TruthAnalysisService: ObservableObject {
  ...
  private func detectPropagandaTechniques(in text: String) -> [DetectedTechnique] {
    ...
    tagger.string = text
    let sentiment =
      tagger.tag(at: text.startIndex, unit: .paragraph, scheme: .sentimentScore).0?.rawValue ?? "0"
  ...
  private func generateGnosticAnalysis(headline _: String, techniques: [DetectedTechnique])
    -> GnosticLens
  {
    ...
    if demiurgeAlignment > 70 {
      pleromaTruth =
        "This narrative strongly serves the illusion-maintenance system. The truth it obscures: You are a divine spark experiencing temporary limitation. Don't let manufactured reality distort your eternal nature."
    } else if demiurgeAlignment > 40 {
      pleromaTruth =
        "Partial truth mixed with distortion. Discern what resonates with your inner knowing from what triggers your programming. The Pleroma (fullness) contains all perspectives in unity."
    } else {
      pleromaTruth =
        "This content has relatively low Archonic manipulation. Still apply discernment - even truth can be weaponized. Ask: Does this expand or contract my consciousness?"
    }
    ...
    if demiurgeAlignment > 60 {
      pneumaticResponse =
        "Center in your divine spark before engaging. This content is designed to pull you into the material illusion. Observe without attachment. Ask: 'Who benefits if I react?' Respond from awareness, not programming."
    } else {
      pneumaticResponse =
        "Engage with discernment. Hold space for multiple perspectives. Remember: the map is not the territory. Your inner gnosis is the ultimate truth-detector."
    }
  ...
  private func calculateDemiurgeScore(techniques _: [DetectedTechnique], gnostic: GnosticLens)
    -> Int
  {
    return gnostic.demiurgeAlignment
  }

  private func generateCounterpoints(headline _: String) -> [String] {
  ...
  private func identifyBeneficiaries(headline _: String, techniques: [DetectedTechnique])
    -> [String]
  {
    ...
    if techniques.contains(where: { $0.name == "Us vs. Them" }) {
      beneficiaries.append(
        "Those who benefit from divided populations (political parties, oligarchs)")
    }
  ...
  private func generateAwakeningSuggestion(manipLevel: ManipulationLevel, gnostic _: GnosticLens)
    -> String
  {
    switch manipLevel {
    case .none:
      return
        "This content appears relatively clean. Still apply your inner discernment. Truth isn't about the source - it's about resonance with your highest knowing."
    case .light:
      return
        "Minor spin detected. Take a breath before sharing. Ask: 'Does this expand consciousness or create reaction?' The awakened response is always from center."
    case .moderate:
      return
        "Significant manipulation patterns present. Before engaging: Ground yourself, remember your divine nature, and observe the emotional hooks. Don't feed the narrative machine."
    case .heavy:
      return
        "Heavy manipulation detected. This content is engineered to trigger you. Practice radical non-reactivity. Your attention is energy - don't give it to the Demiurge's agenda."
    case .extreme:
      return
        "Full matrix programming detected. This is designed to keep you asleep. Step back completely. Meditate, connect with nature, or talk to someone grounded before engaging."
    }
  }
            ...
            Circle()
              ...
              .stroke(
                analysis.overallScore > 60
                  ? Color.green : analysis.overallScore > 30 ? Color.yellow : Color.red,
