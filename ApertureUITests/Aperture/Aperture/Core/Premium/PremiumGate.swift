...
struct UpgradeSheet: View {
      ...
      .background(
        RoundedRectangle(cornerRadius: 14)
          ...
          .overlay(
            RoundedRectangle(cornerRadius: 14)
              .stroke(
                isSelected ? Palette.accent.gold : Color.white.opacity(0.1),
  ...
  private var legalText: some View {
    Text(
      "After your free trial, \(selectedPlan.price) will be charged to your Apple ID. Subscription automatically renews unless cancelled at least 24 hours before the end of the current period."
    )
