...
struct WealthConsciousnessView: View {
      ...
      VStack(spacing: 24) {
        ...
        VStack(alignment: .leading, spacing: 16) {
          ...
          VStack(alignment: .leading, spacing: 12) {
            ...
            Text(
              "When you see people driving nice cars, living in beautiful homes, flying first class—most people ask about their JOB. This is scarcity thinking."
            )
            .font(.caption)
        ...
        VStack(alignment: .leading, spacing: 16) {
          ...
          VStack(alignment: .leading, spacing: 12) {
            ...
            Text(
              "Ask: How do they show up with their finances? What do they believe about money? What is their internal relationship with wealth?"
            )
            .font(.caption)
            .foregroundStyle(.white.opacity(0.8))
          }
        ...
        VStack(alignment: .leading, spacing: 16) {
          ...
          Text(
            "These created—usually SUBCONSCIOUSLY—your beliefs about money that are now reflected in your financial reality."
          )
          .font(.caption)
          .italic()
          .foregroundStyle(Color(hex: "FFD700"))
        ...
        keyInsight(
          ...
          subtext:
            "As you begin to think DIFFERENTLY about money, you rewire your brain, create new neural pathways, new beliefs, new actions—and therefore new results."
        )
    ...
    ScrollView {
      VStack(spacing: 24) {
        ...
        scarcityTrap(
          ...
          description:
            "This looks like: 'I can't afford it', 'I don't have enough money', constantly feeling paycheck to paycheck, wondering how you'll pay bills.",
          symptom: "You're constantly paycheque to paycheque, wondering how to afford anything",
          truth:
            "As long as your thinking is 'there's not enough', that will continue to be your experience",
        ...
        scarcityTrap(
          ...
          description:
            "Believing if you build wealth, it comes out of a limited pie. Someone else must suffer for you to succeed.",
          symptom:
            "You feel guilty about success, think wealthy people are greedy, fear 'taking too much'",
          truth:
            "Wealth is not a fixed pie. Your abundance doesn't diminish someone else's potential",
        ...
        scarcityTrap(
          ...
          description:
            "Believing the ONLY way to build wealth is to work longer, harder, faster. Reinforced by hustle culture.",
        ...
        scarcityTrap(
          ...
          description:
            "A false belief that you don't DESERVE to be wealthy. Limiting self-identity around what you're capable of.",
          symptom:
            "You sabotage success, feel 'undeserving', have ceiling on what you allow yourself",
        ...
        scarcityTrap(
          ...
          description:
            "Scared to spend or invest. Feeling like you're risking security. Must hoard to protect family.",
          symptom:
            "You hang onto everything, afraid to take risks, feel constant financial anxiety",
        ...
        VStack(alignment: .leading, spacing: 12) {
          ...
          Text(
            "Which of these resonate with you? Chances are you have 1, 2, 3 or maybe ALL 5 operating in your life."
          )
          .font(.body)
          .foregroundStyle(.white.opacity(0.9))

          Text(
            "Just because you have these patterns doesn't mean you're stuck. Awareness is the first step to transformation."
          )
          .font(.caption)
          .foregroundStyle(Color(hex: "FFD700"))
        }
    ...
    ScrollView {
      VStack(spacing: 24) {
        ...
        VStack(alignment: .leading, spacing: 16) {
          ...
          Text(
            "Client after client doubles their income, attracts dream homes, cars, vacations—flying first class—because they changed their THINKING about money first."
          )
          .font(.caption)
          .foregroundStyle(.white.opacity(0.7))
        }
    ...
    ScrollView {
      VStack(spacing: 24) {
        ...
        keyInsight(
          ...
          subtext:
            "If not, start changing the thinking you have around money—and watch new results appear."
        )
  ...
  private func scarcityTrap(
    number: Int, title: String, subtitle: String, description: String, symptom: String,
    truth: String, color: Color
  ) -> some View {
    VStack(alignment: .leading, spacing: 12) {
      HStack {
        Text("\(number)")
