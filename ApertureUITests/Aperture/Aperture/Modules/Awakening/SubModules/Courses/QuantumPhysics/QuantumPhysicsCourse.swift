        ...
        QuantumLesson(
          ...
          content: """
            ...
            **Three Experiments That Broke Physics**
            ...
            """,
          keyInsight:
            "At the fundamental level, reality is quantized, probabilistic, and non-local."
        ),
        ...
        QuantumLesson(
          ...
          content: """
            ...
            **Implications**
            ...
            """,
          keyInsight:
            "Uncertainty is fundamental—the universe is inherently unknowable in principle."
        ),
      ]
    ),
        ...
        QuantumLesson(
          ...
          content: """
            ...
            **Why It Matters**
            ...
            """,
          keyInsight:
            "Quantum physics creates space for consciousness to be fundamental, not emergent."
        ),
      ]
    ),
  ]
...
struct QuantumProgress: Codable {
  ...
  static var `default`: QuantumProgress {
    QuantumProgress(completedLessons: [], lastAccessed: nil)
  }
}
