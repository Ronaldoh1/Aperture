...
final class AwakeningStorage: AwakeningStorageType {
  ...
  func loadProfile() -> AwakeningProfile {
    ...
    do {
      ...
      return try decoder.decode(AwakeningProfile.self, from: data)
    } catch {
...
enum LevelProgressionEngine {
  ...
  static func checkForLevelUp(oldProfile: AwakeningProfile, newProfile: AwakeningProfile)
    -> AwakeningLevel?
  {
