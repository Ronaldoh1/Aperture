...
protocol AwakeningArsenalServiceProtocol {
  ...
  func getPracticeLogs(userId: String, methodId: String?, dateRange: DateInterval?) async throws
    -> [PracticeLog]
...
class FirebaseAwakeningService: AwakeningArsenalServiceProtocol {
  ...
  func logPractice(_ practice: PracticeLog) async throws {
    ...
    var methodProgress = try await getMethodProgress(
      userId: practice.userId, methodId: practice.methodId)
    methodProgress.practiceCount += 1
    methodProgress.totalMinutes += practice.duration
    try await updateMethodProgress(
      userId: practice.userId, methodId: practice.methodId, progress: methodProgress)
    ...
    -> [PracticeLog]
  {
    ...
    guard let data = defaults.data(forKey: key),
      var logs = try? decoder.decode([PracticeLog].self, from: data)
    else {
      return []
    }
...
class APIAwakeningService: AwakeningArsenalServiceProtocol {
  ...
  func getMethodProgress(userId _: String, methodId _: String) async throws -> MethodProgress {
    // API implementation
    fatalError("Implement for your API")
  }

  func updateMethodProgress(userId _: String, methodId _: String, progress _: MethodProgress)
    async throws
  {
    fatalError("Implement for your API")
  }

  func completeStep(userId _: String, methodId _: String, stepId _: String) async throws {
    fatalError("Implement for your API")
  }

  func logPractice(_: PracticeLog) async throws {
    fatalError("Implement for your API")
  }

  func getPracticeLogs(userId _: String, methodId _: String?, dateRange _: DateInterval?)
    async throws -> [PracticeLog]
  {
    fatalError("Implement for your API")
  }

  func getPracticeStats(userId _: String) async throws -> PracticeStats {
    fatalError("Implement for your API")
  }

  func bookmarkMethod(userId _: String, methodId _: String) async throws {
    fatalError("Implement for your API")
  }

  func removeBookmark(userId _: String, methodId _: String) async throws {
    fatalError("Implement for your API")
  }

  func getBookmarks(userId _: String) async throws -> [String] {
    fatalError("Implement for your API")
  }
  ...
  func downloadForOffline(methodId _: String) async throws {
    fatalError("Implement for your API")
  }
}
...
class MockAwakeningService: AwakeningArsenalServiceProtocol {
  ...
  func getUserProgress(userId _: String) async throws -> UserAwakeningProgress {
    return mockProgress
  }
  ...
  func getMethodProgress(userId _: String, methodId: String) async throws -> MethodProgress {
    return mockMethodProgress[methodId]
      ?? MethodProgress(
        methodId: methodId,
        startedAt: nil,
        completedAt: nil,
  ...
  func updateMethodProgress(userId _: String, methodId: String, progress: MethodProgress)
    async throws
  {
    mockMethodProgress[methodId] = progress
  }

  func completeStep(userId _: String, methodId: String, stepId: String) async throws {
    var progress =
      mockMethodProgress[methodId]
      ?? MethodProgress(
        methodId: methodId,
        startedAt: Date(),
        completedAt: nil,
  ...
  func bookmarkMethod(userId _: String, methodId: String) async throws {
    mockBookmarks.append(methodId)
  }

  func removeBookmark(userId _: String, methodId: String) async throws {
