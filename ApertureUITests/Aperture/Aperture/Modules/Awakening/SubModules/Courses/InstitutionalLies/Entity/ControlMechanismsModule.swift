...
extension ControlMechanism {
  static let all: [ControlMechanism] = [
    ControlMechanism(
      ...
      icon: "repeat",
      description:
        "The illusory truth effect: repeated claims feel truer, regardless of accuracy. Say something enough times and it becomes 'common knowledge.'",
      examples: [
    ...
    ControlMechanism(
      ...
      icon: "shield.fill",
      description:
        "People accept claims that match their tribe and self-story, and reject claims that threaten it - regardless of evidence.",
      examples: [
      ...
      defense:
        "Notice when you're defending a belief because it's YOURS rather than because it's TRUE."
    ),
    ...
    ControlMechanism(
      ...
      description:
        "Outrage and fear spread faster than nuance. Systems optimize for emotional stickiness, not truth.",
      examples: [
      ...
      defense:
        "If content makes you immediately angry or afraid, pause. Strong emotion often means manipulation."
    ),
    ...
    ControlMechanism(
      ...
      description:
        "False details get integrated into recall. Then people defend the memory as if it were a file on disk.",
      examples: [
      ...
      defense:
        "Hold memories loosely. Your confidence in a memory doesn't correlate with its accuracy."
    ),
    ...
    ControlMechanism(
      ...
      description:
        "Hire PR, fund friendly experts, bury bad results, or reframe harm as 'misuse.' Control the story, control reality.",
      examples: [
    ...
    ControlMechanism(
      ...
      description:
        "When industries control their own regulators through lobbying, revolving door careers, and underfunded enforcement.",
      examples: [
    ...
    ControlMechanism(
      ...
      description:
        "Contractors, subsidiaries, 'we followed guidance,' 'we relied on consultants.' Diffuse blame until no one is responsible.",
      examples: [
    ...
    ControlMechanism(
      ...
      icon: "clock.fill",
      description:
        "Lawsuits, nondisclosure, procedural fog until the public's attention span dies. Justice delayed is justice denied.",
      examples: [
      ...
      defense:
        "Time-based arguments ('let's wait for more data') often serve those who benefit from the status quo."
    ),
  ]
}
