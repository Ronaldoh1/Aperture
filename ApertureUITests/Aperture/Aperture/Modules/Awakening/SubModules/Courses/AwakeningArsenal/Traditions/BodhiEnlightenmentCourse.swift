...
struct BodhiEnlightenmentCourse: View {
  ...
  private var courseHeader: some View {
    VStack(spacing: 16) {
      ...
      Text(
        "2,500 years of refined wisdom on ending suffering, seeing reality clearly, and awakening to your true nature."
      )
      .font(.system(size: 13))
  ...
  private var fourNobleTruths: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      Text(
        "Buddha's core teaching: suffering is real, has a cause, can end, and there's a path to end it."
      )
      .font(.system(size: 11))
      .foregroundColor(.gray)
      .italic()
  ...
  private func pathSection(_ title: String, _ items: [(String, String)], _ color: Color)
    -> some View
  {
      ...
      BodhiLesson(
        ...
        content: """
          ...
          **What it IS:**
          ...
          """,
        keyTakeaway:
          "Buddhist enlightenment (Bodhi) is awakening to the nature of reality: impermanence, suffering, and non-self. It's not supernatural but a clear seeing that ends craving and brings peace. The Buddha was a human who achieved this—and taught that you can too.",
        practiceGuide: """
      ...
      BodhiLesson(
        ...
        content: """
          ...
          **5. "I'm not doing it right"**
          ...
          """,
        keyTakeaway:
          "Mindfulness is present-moment awareness without judgment. The breath is the classic anchor. When mind wanders (it will), notice and return—this IS the practice. Extend mindfulness to daily activities. Consistency matters more than duration.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      BodhiLesson(
        ...
        content: """
          ...
          **How to work with it:**
          ...
          """,
        keyTakeaway:
          "Vipassana uses stable attention to directly see impermanence, suffering, and non-self. Body scanning and noting are classic techniques. The progress of insight includes both beautiful and difficult stages. Teacher support matters for deep practice.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      BodhiLesson(
        ...
        content: """
          ...
          *"You are the owner of your actions. May you find peace."*
          ...
          """,
        keyTakeaway:
          "Metta (loving-kindness) meditation cultivates unconditional friendliness toward self and others. It balances insight practice with heart opening. Start with self, expand outward to all beings. Intention matters more than emotion—keep practicing.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      BodhiLesson(
        ...
        content: """
          ...
          **First step on the path:**
          ...
          """,
        keyTakeaway:
          "The Five Precepts (no killing, stealing, sexual misconduct, lying, intoxicants) are training rules that create conditions for meditation to work. They're not commandments but voluntary commitments to non-harm. Generosity is the foundation. Ethics and meditation support each other.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      BodhiLesson(
        ...
        content: """
          ...
          **The paradox:** Fully accepting impermanence allows you to live more fully.
          ...
          """,
        keyTakeaway:
          "Impermanence is not philosophy but observable fact. Contemplating it (especially death) reduces clinging and fear. Everything changes—body, thoughts, self. Accepting this fully allows more presence and less suffering.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      BodhiLesson(
        ...
        content: """
          ...
          **Answer:** Practice happens. Enlightenment happens. There was never a separate self doing it—just the process assuming it was a self.
          ...
          """,
        keyTakeaway:
          "Anatta (non-self) means no fixed, unchanging self can be found—just five aggregates constantly changing. This isn't nihilism but freedom from over-identification. Direct investigation in meditation reveals this. Both conventional self and ultimate non-self are valid in their domains.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      BodhiLesson(
        ...
        content: """
          ...
          **Counter to hindrances:**
          ...
          """,
        keyTakeaway:
          "The five hindrances (desire, aversion, sloth, restlessness, doubt) are universal obstacles. Don't fight them—recognize, accept, investigate, and let them pass. RAIN technique works well. Cultivate the seven factors of awakening as antidotes.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      BodhiLesson(
        ...
        content: """
          ...
          **Alternatives:**
          ...
          """,
        keyTakeaway:
          "Retreat accelerates practice through continuity and reduced distraction. Expect phases—initial excitement, mid-retreat difficulty, then deepening. Choose retreats carefully (tradition, teacher, reviews). Integration after retreat matters as much as the retreat itself.",
        practiceGuide: """
          **This Week's Practice:**
      ...
      BodhiLesson(
        ...
        content: """
          ...
          **The path continues. The practice is the reward. ☸️**
          """,
        keyTakeaway:
          "Real practice is lived off the cushion—in relationships, work, and social engagement. Sangha supports the path. Study and practice together. The awakened life isn't escape but fuller engagement. The path never ends—practice continues forever.",
        practiceGuide: """
          **This Week's Practice:**
