...
struct EducationExposedCourse: View {
  ...
  private func lessonRow(_ lesson: EducationLesson, index _: Int) -> some View {
    HStack(spacing: 16) {
      ZStack {
        Circle()
      ...
      EducationLesson(
        ...
        content: """
          ...
          **WHY THIS MATTERS:**
          ...
          """,
        keyTakeaway:
          "America has two education systems: elite private schools that create connections and opportunities, and underfunded public schools that prepare students for debt and compliance."
      ),
      EducationLesson(
        ...
        content: """
          ...
          **Other Countries:**
          ...
          """,
        keyTakeaway:
          "School funding through property taxes guarantees that poor areas have poor schools. This isn't an accident—it's the system that replaced explicit segregation."
      ),
      EducationLesson(
        ...
        content: """
          ...
          **Other Countries:**
          ...
          """,
        keyTakeaway:
          "Student loans can't be discharged in bankruptcy, unlike almost any other debt. This was lobbied for by the loan industry. $1.77 trillion in debt traps 45 million Americans."
      ),
      EducationLesson(
        ...
        content: """
          ...
          **What's Actually Valuable:**
          ...
          """,
        keyTakeaway:
          "Jobs that never needed degrees now 'require' them—not because they're harder, but because employers can demand it and shift training costs to workers via debt."
      ),
      EducationLesson(
        ...
        content: """
          ...
          **Other Countries:**
          ...
          """,
        keyTakeaway:
          "Legacy admissions give a 6x advantage to children of alumni at elite schools. It's affirmative action for the wealthy, perpetuating class across generations."
      ),
      EducationLesson(
        ...
        content: """
          ...
          **Breaking the Conditioning:**
          ...
          """,
        keyTakeaway:
          "Schools teach compliance as much as content. Financial literacy, rights, and critical thinking are deliberately NOT taught. The hidden curriculum creates workers, not citizens."
      ),
      EducationLesson(
        ...
        content: """
          ...
          **Better options:**
          ...
          """,
        keyTakeaway:
          "For-profit colleges take 25% of federal aid but cause 50% of defaults. They target veterans and the poor with predatory recruiting, extract loan money, and leave students with debt and worthless credentials."
      ),
      EducationLesson(
        ...
        content: """
          ...
          **New reality:**
          ...
          """,
        keyTakeaway:
          "Trades, tech bootcamps, community college, and self-education are all viable paths. The question isn't 'what degree?' but 'what skills create value, and what's the cheapest way to learn them?'"
      ),
      EducationLesson(
        ...
        content: """
          ...
          **That's what this app is for.**
          ...
          """,
        keyTakeaway:
          "Schooling was done to you. Education is what you do for yourself. Learn financial literacy, your rights, critical thinking, and how systems actually work. Take control of your own education."
      ),
    ]
  }
}
