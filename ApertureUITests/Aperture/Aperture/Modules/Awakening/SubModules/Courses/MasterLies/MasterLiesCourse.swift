    ...
    LiesModule(
      ...
      lies: [
        ExposedLie(
          ...
          whobenefits:
            "Corporations get compliant workers. Government gets obedient citizens. The elite maintain their position."
        ),
        ...
        ExposedLie(
          ...
          whobenefits:
            "Ruling families maintain multi-generational power. Class mobility is minimized."
        ),
    ...
    LiesModule(
      ...
      lies: [
        ExposedLie(
          ...
          whobenefits:
            "Textbook companies sell editions without updating content. Teachers teach what they were taught."
        ),
        ...
        ExposedLie(
          ...
          whobenefits:
            "Nobody specifically--this shows how false information persists through repetition and authority."
        ),
        ...
        ExposedLie(
          ...
          whobenefits:
            "Simple models are easier to teach and test. Truth is complicated; tests need simple answers."
        ),
    ...
    LiesModule(
      ...
      lies: [
        ExposedLie(
          ...
          whobenefits:
            "Sugar industry ($100B+), processed food companies, pharmaceutical companies selling cholesterol drugs."
        ),
...
struct MasterLiesProgress: Codable {
  ...
  static var `default`: MasterLiesProgress {
    MasterLiesProgress(completedLies: [], lastAccessed: nil)
  }
}
