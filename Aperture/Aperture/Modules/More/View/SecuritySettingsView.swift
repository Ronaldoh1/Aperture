...
struct SecuritySettingsView: View {
  ...
  var body: some View {
    ...
    .alert(
      "Enable \(authManager.biometricType.displayName)", isPresented: $showBiometricConfirmation
    ) {
      Button("Enable") {
        Task {
  ...
  private var biometricSection: some View {
    Section(
      header: Text("Biometric Security"),
      footer: Text(
        "\(authManager.biometricType.displayName) provides fast, secure access without typing passwords."
      )
    ) {
      // Biometric toggle
  ...
  private var autoLockSection: some View {
    Section(
      ...
      footer: Text("Automatically lock the app after being in the background.")
    ) {
