...
enum PodcastLibrary {
  static let allPodcasts: [AwakeningPodcast] = [
    ...
    AwakeningPodcast(
      ...
      keyTopics: [
        "Shadow Work", "Healing Patterns", "Awakening Milestones", "Psychospiritual Development",
        "Inner Child", "Trauma Integration",
      ],
      bestFor: [
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "The Architecture of Your Inner World",
          description: "Map your psyche like a system architect maps code", duration: "45 min"),
        SampleEpisode(
          title: "Shadow Work 101: Meeting Your Hidden Self",
          description: "Practical intro to integrating disowned parts", duration: "38 min"),
        SampleEpisode(
          title: "When Awakening Gets Messy",
          description: "What to do when spiritual growth disrupts your life", duration: "52 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      longDescription:
        "Sahara Rose's powerhouse frames Dharma and purpose as 'spiritual entrepreneurship.' It's like a growth-hacker's manifesto for the soul—episodes mash Ayurveda, manifestation, and awakening journeys. Recent seasons tackle AI ethics meets mysticism. Her energy's contagious for spotting ideological overlaps between ancient wisdom and modern life. Perfect for those who want awakening AND success.",
      ...
      keyTopics: [
        "Dharma", "Ayurveda", "Manifestation", "Purpose", "Feminine Energy", "Spiritual Business",
      ],
      bestFor: [
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "Discovering Your Dharma",
          description: "Find your soul's purpose using ancient Ayurvedic wisdom", duration: "55 min"
        ),
        SampleEpisode(
          title: "Spiritual Entrepreneurship",
          description: "Building a business aligned with your highest self", duration: "48 min"),
        SampleEpisode(
          title: "AI and the Future of Consciousness",
          description: "Where technology meets mysticism", duration: "62 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      keyTopics: [
        "Wisdom", "Unity", "Poetry", "Science & Spirit", "Social Healing", "Contemplative Life",
      ],
      bestFor: [
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "The Inner Landscape of Beauty",
          description: "With poet John O'Donohue on beauty as a human need", duration: "51 min"),
        SampleEpisode(
          title: "The Bias Inside Us",
          description: "Exploring unconscious patterns with compassion", duration: "48 min"),
        SampleEpisode(
          title: "Einstein's God", description: "The spirituality behind scientific genius",
          duration: "55 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      keyTopics: [
        "Self-Compassion", "RAIN Meditation", "Mindfulness", "Buddhism", "Radical Acceptance",
        "Loving Awareness",
      ],
      bestFor: [
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "Radical Compassion: The RAIN Practice",
          description: "Her signature technique for emotional freedom", duration: "42 min"),
        SampleEpisode(
          title: "Receiving Life in Open Awareness", description: "Expand beyond the small self",
          duration: "38 min"),
        SampleEpisode(
          title: "Freedom from the Trance of Unworthiness",
          description: "Breaking free from not-enoughness", duration: "45 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      websiteURL: nil,
      keyTopics: [
        "Third Eye", "Chakras", "Energy Work", "Collective Awakening", "Psychic Development",
        "Ascension",
      ],
      bestFor: [
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "Opening Your Third Eye Safely",
          description: "Practical steps without the overwhelm", duration: "35 min"),
        SampleEpisode(
          title: "The 2026 Collective Shift",
          description: "What's happening energetically on the planet", duration: "42 min"),
        SampleEpisode(
          title: "Protecting Your Energy Field",
          description: "Boundaries for empaths and sensitives", duration: "38 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      keyTopics: [
        "Neuroscience", "Consciousness", "Healing Stories", "Breaking Illusions",
        "Mind-Body Connection", "Transformation",
      ],
      bestFor: [
      ...
      sampleEpisodes: [
        SampleEpisode(
          ...
          description: "What happens in your brain during spiritual experiences", duration: "48 min"
        ),
        SampleEpisode(
          title: "Breaking Free from the Matrix",
          description: "Stories of people who woke up from conditioning", duration: "52 min"),
        SampleEpisode(
          title: "Questioning Reality", description: "What if everything you believed was wrong?",
          duration: "45 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      keyTopics: [
        "Awakening Stories", "Non-Duality", "Kundalini", "Ordinary Awakening",
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "The Engineer Who Woke Up",
          description: "A software developer's spontaneous awakening", duration: "95 min"),
        SampleEpisode(
          title: "Kundalini Rising: A Nurse's Story",
          description: "Medical professional navigates energy awakening", duration: "88 min"),
        SampleEpisode(
          title: "After the Awakening: What Now?",
          description: "The integration process nobody talks about", duration: "102 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      keyTopics: [
        "Physics", "Consciousness", "Mathematics", "Reality", "Philosophy of Mind",
        "Quantum Mechanics",
      ],
      bestFor: [
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "Is Consciousness Fundamental?", description: "Physicists debate the hard problem",
          duration: "120 min"),
        SampleEpisode(
          title: "The Simulation Hypothesis", description: "Are we living in a computed reality?",
          duration: "95 min"),
        SampleEpisode(
          title: "Panpsychism and Physics", description: "Does consciousness pervade all matter?",
          duration: "108 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "Be Here Now", description: "The essence of Ram Dass's teaching",
          duration: "45 min"),
        SampleEpisode(
          title: "Becoming Nobody", description: "Dissolving the ego with love", duration: "52 min"),
        SampleEpisode(
          title: "Loving Awareness", description: "His ultimate teaching on consciousness",
          duration: "48 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      keyTopics: [
        "Zen Buddhism", "Taoism", "Western Philosophy", "The Self", "Play", "Nature of Reality",
      ],
      bestFor: [
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "The Real You", description: "Who are you really? A mind-bending exploration",
          duration: "55 min"),
        SampleEpisode(
          title: "The Tao of Philosophy", description: "Effortless action and going with the flow",
          duration: "48 min"),
        SampleEpisode(
          title: "This Is It", description: "The present moment is all there is", duration: "42 min"
        ),
      ],
    ...
    AwakeningPodcast(
      ...
      keyTopics: [
        "Non-Duality", "Awareness", "True Nature", "Self-Inquiry", "Consciousness", "Peace",
      ],
      bestFor: [
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "The Nature of Awareness", description: "What is the 'I' that is aware?",
          duration: "45 min"),
        SampleEpisode(
          title: "You Are the Space", description: "Recognizing yourself as boundless awareness",
          duration: "38 min"),
        SampleEpisode(
          title: "Beyond the Mind", description: "What remains when thinking stops?",
          duration: "42 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      longDescription:
        "While not explicitly spiritual, Shawn's show recognizes that physical health is the foundation for awakening. Sleep, nutrition, movement—all covered with deep research. A healthy body is a clear vessel. The systems-thinking approach will appeal to engineers. Your body is hardware; optimize it.",
      category: .practicalAwakening,
      coverColor: .green,
      icon: "💪",
      ...
      sampleEpisodes: [
        SampleEpisode(
          ...
          description: "How sleep affects your spiritual capacity", duration: "62 min"),
        SampleEpisode(
          title: "Brain Food", description: "Nutrition for cognitive clarity", duration: "55 min"),
        SampleEpisode(
          title: "The Gut-Brain Connection", description: "Your second brain and intuition",
          duration: "58 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      keyTopics: [
        "Human Optimization", "Relationships", "Psychedelics", "Masculinity", "Purpose",
        "Shadow Work",
      ],
      bestFor: [
        "Men on the path",
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "Own the Day", description: "A morning-to-night optimization protocol",
          duration: "68 min"),
        SampleEpisode(
          title: "The Dark Night of the Soul", description: "Navigating spiritual crisis",
          duration: "75 min"),
        SampleEpisode(
          title: "Sacred Relationships", description: "Love as a path to awakening",
          duration: "82 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      keyTopics: [
        "Meditation", "Skepticism", "Anxiety", "Practical Buddhism", "Mindfulness", "Mental Health",
      ],
      bestFor: [
        "Skeptics and cynics",
        "Anxiety sufferers",
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "Meditation for Skeptics", description: "Dan's journey from doubt to practice",
          duration: "45 min"),
        SampleEpisode(
          title: "Dealing with Anxiety", description: "Practical techniques for worry",
          duration: "52 min"),
        SampleEpisode(
          title: "Is Enlightenment Real?", description: "Investigating the ultimate claim",
          duration: "58 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      longDescription:
        "Tami Simon founded Sounds True, one of the largest spiritual publishers. Her interviews tap into their vast network of teachers—from Eckhart Tolle to Pema Chödrön. Deep, thoughtful conversations with the biggest names in spirituality. Like having backstage passes to the awakening movement.",
      category: .consciousness,
      coverColor: .purple,
      icon: "🎙️",
      ...
      keyTopics: [
        "All Traditions", "Top Teachers", "Publishing Insights", "New Releases", "Spiritual Trends",
      ],
      bestFor: [
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "Eckhart Tolle on Presence", description: "The Power of Now author on awakening",
          duration: "55 min"),
        SampleEpisode(
          title: "Pema Chödrön on Groundlessness", description: "Buddhist nun on uncertainty",
          duration: "48 min"),
        SampleEpisode(
          title: "Adyashanti: True Nature", description: "Non-dual teacher on awakening",
          duration: "52 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      websiteURL: nil,
      keyTopics: [
        "Manifestation", "Reality Creation", "Consciousness", "Success", "Universe",
        "Entrepreneurship",
      ],
      bestFor: [
        "Spiritual entrepreneurs",
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "Creating Your Reality", description: "The mechanics of manifestation",
          duration: "58 min"),
        SampleEpisode(
          title: "Consciousness and Business", description: "Building an awakened company",
          duration: "52 min"),
        SampleEpisode(
          title: "The Simulation Theory", description: "Are we in a cosmic video game?",
          duration: "65 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      keyTopics: [
        "Human Design", "Energy Types", "Decision Making", "Alignment", "Relationships", "Career",
      ],
      bestFor: [
        "System lovers",
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "Intro to Human Design", description: "The basics of your energetic blueprint",
          duration: "45 min"),
        SampleEpisode(
          title: "The 5 Energy Types",
          description: "Generators, Projectors, Manifestors, Reflectors, MG", duration: "52 min"),
        SampleEpisode(
          title: "Making Aligned Decisions", description: "Using your authority for clarity",
          duration: "48 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      sampleEpisodes: [
        SampleEpisode(
          ...
          description: "What neuroscience reveals about awareness", duration: "85 min"),
        SampleEpisode(
          title: "Free Will and the Self", description: "Do you really make choices?",
          duration: "78 min"),
        SampleEpisode(
          title: "Meditation and the Ego", description: "What happens when you look for the self",
          duration: "92 min"),
      ],
    ...
    AwakeningPodcast(
      ...
      longDescription:
        "Stephen West breaks down the history of philosophy in engaging, story-like episodes. From ancient Greeks to modern consciousness philosophers. Understanding how humans have grappled with big questions provides context for your own inquiry. The foundation that makes spiritual teachings make sense.",
      category: .philosophy,
      coverColor: .brown,
      icon: "📚",
      ...
      keyTopics: [
        "Philosophy History", "Big Questions", "Ethics", "Existentialism", "Eastern Philosophy",
        "Modern Thought",
      ],
      bestFor: [
      ...
      sampleEpisodes: [
        SampleEpisode(
          title: "Buddha and the Origins of Buddhism",
          description: "Philosophy behind the religion", duration: "35 min"),
        SampleEpisode(
          title: "Alan Watts and Eastern Philosophy", description: "The bridge builder",
          duration: "42 min"),
        SampleEpisode(
          title: "The Meaning of Life", description: "How philosophers have answered the big one",
          duration: "38 min"),
      ],
