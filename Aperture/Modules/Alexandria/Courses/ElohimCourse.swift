...
struct ElohimCourse {
    static let course = AlexandriaCourse(
        ...
        modules: [
            ACModule(id: "el1", number: 1, title: "Let US Make Man", subtitle: "The plural they couldn't erase", icon: "text.magnifyingglass", lessons: [
                ACLesson(id: "el1_1", title: "The Word That Breaks Monotheism",
                    content: """
...
""",
                    keyInsight: "Elohim (אֱלֹהִים) is grammatically plural — 'gods,' not 'God.' Genesis 1:26 ('Let US make man in OUR image') preserves the original understanding of creation by a council, not a single deity.",
                    practice: "Read Genesis 1 in any translation. Circle every instance of 'us,' 'our,' and 'Elohim.' Notice how the singular interpretation requires ignoring the actual text."
                )
            ])
        ],
        sources: ["Genesis 1:26 — Hebrew grammatical analysis", "Michael Heiser, \"The Unseen Realm\" (Divine Council)", "Mark S. Smith, \"The Origins of Biblical Monotheism\"", "Mesopotamian divine council parallels", "Psalm 82 — 'God stands in the divine assembly'"],
        dragonComment: "The very first page of the Bible says 'Let US make man in OUR image.' Plural. They built an entire monotheistic religion on a text that opens with a committee meeting. 🐉"
    )
}
