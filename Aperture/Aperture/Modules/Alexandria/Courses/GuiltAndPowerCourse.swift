...
enum GuiltAndPowerCourse {
  static let course = AlexandriaCourse(
          ...
          ACLesson(
            ...
            content: """
              ...
              **The Confiteor** — the Catholic prayer of confession — wasn't born as an act of spiritual liberation. It was born as an **instrument of control.**
              ...
              """,
            keyInsight:
              "The Confiteor prayer functions as psychological conditioning — programming guilt to produce obedience and dependency.",
            practice:
              "If you grew up Catholic, recall the first time you said this prayer. How old were you? Did anyone explain what you were confessing to?",
            interactiveElement: .bilingualText(
              spanish:
                "Por mi culpa, por mi culpa, por mi gran culpa. Yo confieso ante Dios todopoderoso, y ante ustedes hermanos, que he pecado mucho de pensamiento, palabra, obra y omisión.",
              english:
                "Through my fault, through my fault, through my most grievous fault. I confess to almighty God, and to you my brothers and sisters, that I have greatly sinned in my thoughts and in my words, in what I have done and what I have failed to do."
            )
          ),
          ACLesson(
            id: "gp1_2",
            ...
            content: """
              ...
              **The truth?** The divine spark that dwells in you never asked for sacrifices, shame, or chains of guilt. Divinity does not condemn your existence — it celebrates it.
              ...
              """,
            keyInsight:
              "The Church created a closed loop: manufacture guilt through Original Sin, then sell the cure through sacraments. The disease and the remedy — same institution.",
            practice:
              "The path of awakening doesn't begin with guilt — it begins with consciousness. Not with kneeling, but with rising up. What would your spirituality look like without guilt?"
          ),
        ]
      )
    ],
    ...
    dragonComment:
      "They made you apologize for being born. Let that sink in. A prayer that begins with 'my fault' before you've done anything is not worship — it's programming. 🐉"
  )
}
