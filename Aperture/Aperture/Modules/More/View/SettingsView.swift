...
extension SettingsView {
  fileprivate var feedbackSection: some View {
    VStack(alignment: .leading, spacing: 12) {
      Text("FEEDBACK").font(.system(size: 10, weight: .bold)).tracking(2).foregroundColor(
        .white.opacity(0.3))

      SettingsButton(
        icon: "bubble.left.and.bubble.right.fill",
        title: "Send Feedback",
        subtitle: "Bug reports, feature requests, love notes",
        color: .cyan
      ) {
      ...
      HStack(spacing: 8) {
        ...
        Text("Tip: Shake your phone anywhere to send feedback instantly")
...
// MARK: - Settings Toggle Component (Original)
