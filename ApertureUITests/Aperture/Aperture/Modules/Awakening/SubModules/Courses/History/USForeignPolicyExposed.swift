      ...
      ForeignPolicyLesson(
        ...
        content: """
          ...
          **The Information War:**
          ...
          """,
        keyTakeaway:
          "The U.S. has intervened in 70+ countries since 1945, usually to protect corporate interests. Coups, invasions, and proxy wars follow a consistent pattern. 20-30 million deaths are linked to these interventions."
      ),
      ForeignPolicyLesson(
        ...
        content: """
          ...
          **The Legacy:**
          ...
          """,
        keyTakeaway:
          "The CIA overthrew Iran's democracy in 1953 to control oil. The dictator they installed ruled for 26 years. This directly led to the 1979 revolution and current tensions. Most Americans don't know this history."
      ),
      ForeignPolicyLesson(
        ...
        content: """
          ...
          **The Results:**
          ...
          """,
        keyTakeaway:
          "The U.S. overthrew democracies, backed dictators, and funded death squads across Latin America. 200,000 killed in Guatemala, 75,000 in El Salvador. Today's migration crisis is direct blowback from these interventions."
      ),
      ForeignPolicyLesson(
        ...
        content: """
          ...
          **The Lessons Ignored:**
          ...
          """,
        keyTakeaway:
          "Vietnam was built on lies (Gulf of Tonkin). 3-4 million died. Agent Orange still causes birth defects. My Lai massacre covered up. Pentagon Papers proved government knew war was unwinnable. Same pattern repeated in Iraq."
      ),
      ForeignPolicyLesson(
        ...
        content: """
          ...
          **No Accountability:**
          ...
          """,
        keyTakeaway:
          "The Iraq War was based on known lies about WMD. 150,000-1,000,000+ Iraqi civilians died. No accountability for those who lied. Cost: $2+ trillion, regional destabilization, and ISIS."
      ),
      ForeignPolicyLesson(
        title: "Drone Warfare",
        region: "Global",
        ...
        content: """
          ...
          **No Accountability:**
          ...
          """,
        keyTakeaway:
          "Drones have killed 8,500-12,000 people including U.S. citizens without trial. 'Signature strikes' target behavior patterns, not known individuals. This creates more terrorists while traumatizing entire populations."
      ),
      ForeignPolicyLesson(
        ...
        content: """
          ...
          **Who pays:**
          ...
          """,
        keyTakeaway:
          "Sanctions kill civilians while rarely changing regime behavior. 500,000 Iraqi children died under sanctions. Albright said it was 'worth it.' The UN votes 187-2 against Cuba embargo yearly. This is economic warfare on populations."
      ),
      ForeignPolicyLesson(
        ...
        content: """
          ...
          **Empire by Another Name:**
          ...
          """,
        keyTakeaway:
          "The U.S. has 750+ military bases in 80+ countries—more than any empire in history. Cost: $150+ billion/year. Host communities suffer assault, environmental damage, and displacement. This is empire by another name."
      ),
      ForeignPolicyLesson(
        ...
        content: """
          ...
          **What You Can Do:**
          ...
          """,
        keyTakeaway:
          "Media manufactures consent for war through biased sourcing, sanitized language, and excluding anti-war voices. Only 3 of 393 Iraq War interviews featured anti-war leaders. Pentagon secretly briefed TV analysts."
      ),
      ForeignPolicyLesson(
        ...
        content: """
          ...
          **Final Thought:**
          ...
          """,
        keyTakeaway:
          "Change requires education, speaking up, organizing, and policy change. Anti-war movements have succeeded before. The pattern continues because people don't see it. Now you see it—what will you do?"
      ),
    ]
  }
}
