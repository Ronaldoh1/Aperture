...
struct Constitution101View: View {
  ...
  private var quoteBanner: some View {
    VStack(spacing: 8) {
      Text(
        "\"The Constitution doesn't GIVE you rights. You are BORN with natural rights. The Constitution PROTECTS those rights from government interference.\""
      )
      ...
      .background(
        RoundedRectangle(cornerRadius: 14)
          ...
          .overlay(
            RoundedRectangle(cornerRadius: 14)
              .stroke(
                isCompleted ? Constitution101Course.color.opacity(0.3) : Color.clear, lineWidth: 1)
          )
      )
    }
  }
