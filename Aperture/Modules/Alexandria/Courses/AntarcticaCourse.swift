...
struct AntarcticaCourse {
    static let course = AlexandriaCourse(
        ...
        modules: [
            ACModule(id: "ant1", number: 1, title: "Why 58 Nations Agreed to Keep You Out", subtitle: "The Antarctic Treaty decoded", icon: "lock.shield.fill", lessons: [
...
""",
                    keyInsight: "58 nations — including enemies — agreed to restrict access to Antarctica. In all of human history, this level of cooperation on limiting access to 'nothing' has never happened.",
                    practice: "Read the Antarctic Treaty (freely available). Note what it restricts and what it doesn't explain. Then ask: what would make 58 countries cooperate on keeping a secret?",
                    interactiveElement: .timeline(events: [
                        (year: "1513", event: "Piri Reis Map created", significance: "Shows ice-free Antarctic coast — impossible knowledge for the era"),
                        (year: "1938-39", event: "German Antarctic Expedition", significance: "Nazi regime claims territory — evil regime, but why Antarctica specifically?"),
                        (year: "1946-47", event: "Operation Highjump", significance: "4,700 military personnel for 'scientific' research"),
                        (year: "1947", event: "Admiral Byrd's testimony", significance: "'Lands beyond the pole' and high-speed craft referenced"),
                        (year: "1959", event: "Antarctic Treaty signed", significance: "58 nations restrict ALL access — unprecedented"),
                        (year: "1996", event: "Lake Vostok discovered", significance: "Liquid lake sealed for 15-20 million years under 4km of ice"),
                        (year: "2016", event: "Pyramid anomalies spotted", significance: "Satellite imagery reveals geometric structures in Ellsworth Mountains")
                    ])
                )
            ]),
            ACModule(id: "ant2", number: 2, title: "Agartha — The Inner World", subtitle: "What ancient traditions say lies beneath", icon: "globe.central.south.asia.fill", lessons: [
                ACLesson(id: "ant2_1", title: "The Subterranean Kingdom",
                    content: """
...
""",
                    keyInsight: "Multiple ancient traditions describe subterranean kingdoms beneath the earth. The Antarctic Treaty restricts access to the one place on Earth where such entrances might exist.",
                    practice: "This module doesn't end with answers. It ends with mystery. Sit with the not-knowing. The most powerful spiritual state is the one that stays curious without needing to resolve."
                )
            ])
        ],
        sources: ["The Antarctic Treaty (1959) — full text", "Piri Reis Map (Topkapi Palace Museum, Istanbul)", "Charles Hapgood, \"Maps of the Ancient Sea Kings\"", "Admiral Byrd's expedition records and interviews", "Lake Vostok research (Nature, 2012)", "Graham Hancock, \"Magicians of the Gods\"", "Kalachakra Tantra — Shambhala references"],
        dragonComment: "The most protected, most restricted, most cooperated-on place on Earth is supposedly empty. In the history of power, nobody locks a door to an empty room. 🐉"
    )
}
