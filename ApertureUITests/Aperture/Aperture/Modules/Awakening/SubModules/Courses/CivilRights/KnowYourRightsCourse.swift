...
struct KnowYourRightsCourse: View {
  ...
  private func lessonRow(_ lesson: RightsLesson, index _: Int) -> some View {
    HStack(spacing: 16) {
      ZStack {
        Circle()
      ...
      RightsLesson(
        ...
        content: """
          ...
          **Your job is to:**
          ...
          """,
        keyTakeaway:
          "The Constitution guarantees rights, but they only protect you if you know them and assert them. Knowledge is your first defense."
      ),
      RightsLesson(
        ...
        content: """
          ...
          **After the Encounter:**
          ...
          """,
        keyTakeaway:
          "Know the three types of encounters. Use the magic words. Stay calm. Don't consent to searches. Assert your rights, then comply physically while fighting legally."
      ),
      RightsLesson(
        title: "Traffic Stops",
        ...
        content: """
          ...
          **After the Stop:**
          ...
          """,
        keyTakeaway:
          "Provide license, registration, insurance. Keep hands visible. Don't consent to searches. Don't answer questions. Fight tickets in court, not on the roadside."
      ),
      RightsLesson(
        ...
        content: """
          ...
          **Resources:**
          ...
          """,
        keyTakeaway:
          "Everyone has constitutional rights regardless of status. Don't open the door without a judge-signed warrant. Remain silent. Don't sign anything. Have an emergency plan ready."
      ),
      RightsLesson(
        ...
        content: """
          ...
          **If They Search Anyway:**
          ...
          """,
        keyTakeaway:
          "Never consent to searches. Say 'I do not consent' clearly, even if they search anyway. This preserves your rights for court."
      ),
      RightsLesson(
        ...
        content: """
          ...
          **Silence protects the innocent as much as the guilty.**
          """,
        keyTakeaway:
          "Invoke your right to silence clearly: 'I am invoking my right to remain silent. I want a lawyer.' Then actually remain silent. This is not suspicious—it's smart."
      ),
      RightsLesson(
        ...
        content: """
          ...
          **The Takeaway:**
          ...
          """,
        keyTakeaway:
          "Say 'I want a lawyer' clearly and then stop talking. This is your right. Never talk to police about anything serious without an attorney present."
      ),
      RightsLesson(
        ...
        content: """
          ...
          **Legal Observer Programs:**
          ...
          """,
        keyTakeaway:
          "You have the right to record police in public. Livestream to protect footage. Know your protest rights. Prepare before you go. Document everything."
      ),
      RightsLesson(
        ...
        content: """
          ...
          **If Your Rights Are Violated:**
          ...
          """,
        keyTakeaway:
          "Students have constitutional rights, though somewhat limited. Police in schools must follow police rules. Know the difference between school officials and SROs."
      ),
      RightsLesson(
        ...
        content: """
          ...
          **Resources:**
          ...
          """,
        keyTakeaway:
          "The Constitution doesn't fully apply to private employers, but laws protect against discrimination, wage theft, unsafe conditions, and retaliation. Know your rights and document everything."
      ),
      RightsLesson(
        ...
        content: """
          ...
          **Protest-Specific Digital Safety:**
          ...
          """,
        keyTakeaway:
          "Police need a warrant to search your phone, but border is different. Passwords may be more protected than biometrics. Use encrypted messaging. Assume digital data can be obtained."
      ),
      RightsLesson(
        ...
        content: """
          ...
          **Resources:**
          ...
          """,
        keyTakeaway:
          "If rights are violated: stay calm, don't resist, document everything, file complaints, consult a lawyer. Fighting misconduct is hard but important. Collective action creates change."
      ),
    ]
  }
}
