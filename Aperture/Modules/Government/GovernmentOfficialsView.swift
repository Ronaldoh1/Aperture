...
struct GovernmentOfficialsView: View {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    HStack(spacing: 8) {
                        ...
                        Text(justice.ideology)
                            ...
                            .padding(.vertical, 2)
                            .background((justice.ideology == "Conservative" ? Color.red : Color.blue).opacity(0.2))
                            .cornerRadius(4)
                    }
                }
    ...
    private var stateOfficials: some View {
        VStack(spacing: 16) {
            ...
            VStack(spacing: 12) {
                linkButton("Find Your State Legislators", "https://openstates.org/find_your_legislator/", .green)
    ...
    private var supremeCourtJustices: [Justice] {
        [
            Justice(name: "John Roberts", appointedBy: "Bush (2005)", yearAppointed: "2005", ideology: "Conservative", flag: nil),
            Justice(name: "Clarence Thomas", appointedBy: "H.W. Bush (1991)", yearAppointed: "1991", ideology: "Conservative", flag: "Ethics concerns: undisclosed gifts from billionaire Harlan Crow"),
            Justice(name: "Samuel Alito", appointedBy: "Bush (2006)", yearAppointed: "2006", ideology: "Conservative", flag: "Ethics concerns: undisclosed luxury travel"),
            Justice(name: "Sonia Sotomayor", appointedBy: "Obama (2009)", yearAppointed: "2009", ideology: "Liberal", flag: nil),
            Justice(name: "Elena Kagan", appointedBy: "Obama (2010)", yearAppointed: "2010", ideology: "Liberal", flag: nil),
            Justice(name: "Neil Gorsuch", appointedBy: "Trump (2017)", yearAppointed: "2017", ideology: "Conservative", flag: "Seat held open by McConnell blocking Garland"),
            Justice(name: "Brett Kavanaugh", appointedBy: "Trump (2018)", yearAppointed: "2018", ideology: "Conservative", flag: "Contentious confirmation, credible assault allegations"),
            Justice(name: "Amy Coney Barrett", appointedBy: "Trump (2020)", yearAppointed: "2020", ideology: "Conservative", flag: "Rushed confirmation 8 days before election"),
            Justice(name: "Ketanji Brown Jackson", appointedBy: "Biden (2022)", yearAppointed: "2022", ideology: "Liberal", flag: nil)
        ]
    }
...
struct MajorCourtCasesView: View {
    ...
    private var majorCases: [CourtCase] {
        [
            CourtCase(name: "Citizens United v. FEC", year: "2010", summary: "Ruled corporations have free speech rights, opening unlimited money in politics.", impact: "Super PACs, dark money, corporate political power"),
            CourtCase(name: "Shelby County v. Holder", year: "2013", summary: "Gutted the Voting Rights Act, removing federal oversight of discriminatory voting laws.", impact: "Wave of voter suppression laws in formerly covered states"),
            CourtCase(name: "Dobbs v. Jackson", year: "2022", summary: "Overturned Roe v. Wade, eliminating federal abortion rights.", impact: "Abortion banned or restricted in 20+ states"),
            CourtCase(name: "Rucho v. Common Cause", year: "2019", summary: "Ruled federal courts cannot review partisan gerrymandering.", impact: "No federal check on extreme gerrymandering"),
            CourtCase(name: "Students for Fair Admissions v. Harvard", year: "2023", summary: "Banned race-conscious college admissions.", impact: "Affirmative action ended, legacy admissions continue"),
            CourtCase(name: "Janus v. AFSCME", year: "2018", summary: "Ruled public sector workers can't be required to pay union fees.", impact: "Weakened public sector unions"),
            CourtCase(name: "Bush v. Gore", year: "2000", summary: "Stopped Florida recount, effectively deciding the 2000 election.", impact: "5-4 decision handed presidency to Bush"),
            CourtCase(name: "Dred Scott v. Sandford", year: "1857", summary: "Ruled Black people could not be citizens and had no rights.", impact: "Helped trigger Civil War, worst decision in Court history"),
            CourtCase(name: "Plessy v. Ferguson", year: "1896", summary: "Established 'separate but equal' doctrine.", impact: "Legalized segregation for 58 years"),
            CourtCase(name: "Brown v. Board of Education", year: "1954", summary: "Ruled school segregation unconstitutional.", impact: "Began dismantling legal segregation"),
            CourtCase(name: "Miranda v. Arizona", year: "1966", summary: "Required police to inform suspects of their rights.", impact: "'You have the right to remain silent...'"),
            CourtCase(name: "Roe v. Wade", year: "1973", summary: "Established federal right to abortion.", impact: "Protected abortion access for 49 years until overturned")
        ]
    }
}
