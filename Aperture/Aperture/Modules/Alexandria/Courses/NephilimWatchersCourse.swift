...
enum NephilimWatchersCourse {
  static let course = AlexandriaCourse(
    id: "nephilim_watchers", title: "Nephilim & The Watchers",
    subtitle: "The Forbidden Union That Changed Everything",
    icon: "figure.stand.line.dotted.figure.stand", colorHex: "#4ECDC4", tier: 3, isPremium: false,
    isUltraPremium: false,
    modules: [
      ACModule(
        id: "nw1", number: 1, title: "Those Who Descended",
        subtitle: "The Book of Enoch's dangerous truth", icon: "arrow.down.to.line",
        lessons: [
          ACLesson(
            id: "nw1_1", title: "The Teachers They Called Fallen",
            content: """
              ...
              **The uncomfortable question:** Was this really a "fall"? Or was it a deliberate knowledge transfer? Were the Watchers rebels — or teachers who believed every being deserves access to wisdom?
              ...
              """,
            keyInsight:
              "The Watchers brought specific, catalogued knowledge to humanity (metallurgy, medicine, astronomy). This isn't a myth about 'falling' — it's a record of technology transfer.",
            practice:
              "Read 1 Enoch chapters 6-8 (freely available online). Note how specific the knowledge transfer is — names, subjects, technologies. Does this read like mythology or a report?"
          )
        ])
    ],
    sources: [
      "1 Enoch (Book of the Watchers) chapters 6-36", "Genesis 6:1-4 — the Nephilim reference",
      "Council of Laodicea (~363 CE) — removal of 1 Enoch from canon",
      "Michael Heiser, \"Reversing Hermon\"",
      "Dead Sea Scrolls — Enoch fragments (oldest copies found)",
    ],
    dragonComment:
      "They removed the Book of Enoch from the Bible because it names specific beings who taught humanity specific skills. A mythology doesn't come with a curriculum. A record does. 🐉"
  )
}
