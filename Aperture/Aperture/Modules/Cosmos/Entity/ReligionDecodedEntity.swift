  ...
  static let christianity = ReligionDecodedData(
    ...
    characters: [
      DecodedCharacter(
        ...
        explanation:
          "The 'Son' is the 'Sun'. Born December 25th (winter solstice), dies for 3 days, rises again. It's the sun's annual journey through the zodiac."
      ),
      DecodedCharacter(
        name: "Virgin Mary",
        ...
        explanation:
          "The sun is 'born from the virgin' because it passes through the constellation Virgo. Virgin = Virgo. Same word."
      ),
      DecodedCharacter(
        name: "12 Disciples",
        ...
        explanation:
          "The sun travels through 12 houses (zodiac signs) each year. The disciples 'follow' the sun — they ARE the path."
      ),
      DecodedCharacter(
        name: "Judas",
        ...
        explanation:
          "Pisces ends the zodiac cycle. The sun 'dies' after Pisces before being 'reborn' in Aries. Judas = the end of the cycle."
      ),
      DecodedCharacter(
        name: "Satan",
        ...
        explanation:
          "Satan = Saturn. Both represent darkness, limitation, time, and death. The adversary of the light (sun)."
      ),
      DecodedCharacter(
        name: "Mary Magdalene",
        ...
        explanation:
          "The sacred feminine, suppressed by the Church. Two Marys = celestial and earthly Virgo. She was never a prostitute — that was a smear campaign."
      ),
    ],
    symbols: [
      DecodedSymbol(
        ...
        explanation:
          "The sun 'dies' at the Southern Cross during winter solstice. Also represents the intersection of the ecliptic and celestial equator.",
        icon: "cross"
      ),
      DecodedSymbol(
        ...
        explanation:
          "Christianity began during the Age of Pisces (the fish). 'I will make you fishers of men.' We're now transitioning to Aquarius.",
        icon: "fish"
      ),
      DecodedSymbol(
        name: "The Halo",
        ...
        explanation:
          "Halos in religious art are literally the sun disc placed behind heads — borrowed directly from Egyptian sun god imagery.",
        icon: "sun.max"
      ),
      DecodedSymbol(
        name: "Christmas Tree",
        ...
        explanation:
          "The evergreen survives winter (when the sun 'dies'). Decorated with lights = stars. Star on top = the sun/morning star.",
        icon: "tree"
      ),
    ],
    holidays: [
      DecodedHoliday(
        ...
        astronomicalMeaning:
          "Winter Solstice — the sun is 'reborn' after being at its lowest point for 3 days (Dec 22-25)",
        date: "December 25"
      ),
      DecodedHoliday(
        name: "Easter",
        ...
        astronomicalMeaning:
          "Spring Equinox — the sun 'rises' as days become longer than nights. Named after Ishtar/Eostre (fertility goddess).",
      ...
      DecodedHoliday(
        ...
        astronomicalMeaning:
          "The sun at its lowest before rising again. 'Good' from 'God' — God's Friday.",
      ...
      DecodedHoliday(
        ...
        astronomicalMeaning:
          "Sun enters the 'dead zone' — the dark half of the year. Veil between worlds thins.",
        date: "October 31"
      ),
    ],
    controlMechanisms: [
    ...
    etymologies: [
      EtymologyReveal(
        word: "SUNDAY", commonMeaning: "First day of the week",
        actualOrigin: "SUN-DAY — the Lord's day = worship the sun"),
      EtymologyReveal(
        word: "AMEN", commonMeaning: "'So be it'",
        actualOrigin: "AMEN-RA — Egyptian sun god. You're invoking Ra."),
      EtymologyReveal(
        word: "CHURCH", commonMeaning: "House of God",
        actualOrigin: "CIRCE (Greek) — circle. The solar cycle ⭕"),
      EtymologyReveal(
        word: "HOLY", commonMeaning: "Sacred, divine", actualOrigin: "HELIOS — Greek word for SUN"),
      EtymologyReveal(
        word: "GOSPEL", commonMeaning: "Good news",
        actualOrigin: "GOD'S-SPELL — a spell cast on your mind"),
      EtymologyReveal(
        word: "HORUS", commonMeaning: "Egyptian god",
        actualOrigin: "HOURS — the sun's journey through the day"),
      EtymologyReveal(
        word: "HORIZON", commonMeaning: "Where sky meets earth",
        actualOrigin: "HORUS-RISING — where the sun rises"),
      EtymologyReveal(
        word: "MINISTER", commonMeaning: "Spiritual leader",
        actualOrigin: "MOON-STER — servant of the moon (reflects light)"),
    ],
    keyRevelation:
      "They gave you the SUN and told you it was a SON. The entire story is the sun's annual journey through the zodiac, dressed up as history."
  )
  ...
  static let judaism = ReligionDecodedData(
    ...
    characters: [
      DecodedCharacter(
        ...
        explanation:
          "EL is a Canaanite god associated with Saturn. Yahweh = 'I am that I am' — the timeless one. Saturn governs time."
      ),
      DecodedCharacter(
        name: "Abraham",
        ...
        explanation:
          "Abraham and Brahma share the same root. His wife Sarah = Saraswati (Brahma's consort). The stories traveled."
      ),
      DecodedCharacter(
        name: "Sarah",
        ...
        explanation:
          "Sarah/Sarai mirrors Saraswati, Brahma's wife. Same archetype, different culture."
      ),
      DecodedCharacter(
        name: "Moses",
        ...
        explanation:
          "Moses parts the Red Sea = sun passing through the celestial waters. The exodus is astronomical allegory."
      ),
      DecodedCharacter(
        ...
        decodedMeaning: "12 Zodiac Signs ♈♉♊♋♌♍♎♏♐♑♒♓",
        explanation:
          "Each tribe corresponds to a zodiac sign with specific characteristics. Jacob's blessing describes the zodiac."
      ),
      DecodedCharacter(
        name: "Solomon",
        ...
        explanation:
          "Sol (Latin sun) + Om (Hindu sacred sound) + On (Egyptian city of the sun). Three solar references in one name."
      ),
    ],
    symbols: [
      DecodedSymbol(
        ...
        explanation:
          "NASA photographed a hexagonal storm on Saturn's north pole. A hexagon internally connected = six-pointed star. Saturn = 6th planet.",
        icon: "star.fill"
      ),
      DecodedSymbol(
        ...
        explanation:
          "A BLACK CUBE worn on the forehead (third eye) and arm. Saturn worship in plain sight. Blocks divine connection.",
        icon: "square.fill"
      ),
      DecodedSymbol(
        ...
        explanation:
          "Sun, Moon, Mercury, Venus, Mars, Jupiter, Saturn — the 7 'planets' visible to ancient astronomers.",
        icon: "light.max"
      ),
      DecodedSymbol(
        ...
        explanation:
          "An 'ark' is an arc — the curved path the sun travels across the sky. The ark 'carries' the divine light.",
        icon: "shippingbox"
      ),
      DecodedSymbol(
        ...
        explanation:
          "Covers the crown chakra — the point of divine connection. Symbolic submission to Saturn's limitation.",
        icon: "circle.fill"
      ),
    ],
    holidays: [
      DecodedHoliday(
        ...
        astronomicalMeaning:
          "Spring Equinox — the sun 'passes over' the equator. Liberation from winter's darkness.",
      ...
      DecodedHoliday(
        ...
        astronomicalMeaning:
          "Winter Solstice celebration. 8 = Saturn's number (octave, infinity). Light in the darkness.",
    ...
    controlMechanisms: [
      ...
      ReligionControlMechanism(
        ...
        howItControls:
          "Endless rules = endless guilt = endless control. You can never be 'good enough'.",
        icon: "list.number"
      ),
      ReligionControlMechanism(
      ...
      ReligionControlMechanism(
        ...
        howItControls:
          "Marks the body — trauma bonding at 8 days old. Saturn's number. Irreversible.",
        icon: "scissors"
      ),
      ReligionControlMechanism(
    ...
    etymologies: [
      EtymologyReveal(
        word: "ISRAEL", commonMeaning: "The nation/people",
        actualOrigin: "IS-RA-EL = Isis (Moon) + Ra (Sun) + El (Saturn). A celestial formula."),
      EtymologyReveal(
        word: "SATURDAY", commonMeaning: "Seventh day",
        actualOrigin: "SATURN-DAY — dedicated to Saturn. The Sabbath."),
      EtymologyReveal(
        word: "SYNAGOGUE", commonMeaning: "House of worship",
        actualOrigin: "SIN-agogue — Sin was the Babylonian MOON god."),
      EtymologyReveal(
        word: "TORAH", commonMeaning: "The Law",
        actualOrigin: "TORA = TARO = ROTA (wheel) — the zodiac wheel."),
      EtymologyReveal(
        word: "RABBI", commonMeaning: "Teacher",
        actualOrigin: "RAB = great/master — intermediary class."),
      EtymologyReveal(
        word: "HEBREW", commonMeaning: "The language/people",
        actualOrigin: "From 'eber' — to cross over. Those who crossed the celestial river."),
    ],
    keyRevelation:
      "Judaism is SATURN worship. The black cube (Tefillin), the hexagram (Star of David = Saturn's hexagon), Saturday (Saturn-day). They worship the god of time, law, and limitation."
  )
  ...
  static let islam = ReligionDecodedData(
    ...
    characters: [
      DecodedCharacter(
        ...
        explanation:
          "Allah was one of many gods worshipped in pre-Islamic Arabia — specifically the moon god. The crescent moon symbol isn't coincidence."
      ),
      DecodedCharacter(
        name: "Muhammad",
        ...
        explanation:
          "Muhammad consolidated existing moon worship into monotheism. One god = monopoly of spiritual power."
      ),
      DecodedCharacter(
        name: "Gabriel (Jibril)",
        ...
        explanation:
          "Gabriel is always the MESSENGER angel across religions. Mercury = messenger of the gods."
      ),
      DecodedCharacter(
        ...
        explanation:
          "Same character, same root, different lineage claimed. The division tactic — Arab vs. Jewish."
      ),
      DecodedCharacter(
        name: "Ishmael",
        ...
        explanation:
          "Judaism claims Isaac, Islam claims Ishmael. Same father, divided children. Classic divide and conquer."
      ),
    ],
    symbols: [
      DecodedSymbol(
        ...
        explanation:
          "It's not hidden. It's right there. On every mosque, every flag. They worship the moon.",
        icon: "moon.fill"
      ),
      DecodedSymbol(
        name: "The Kaaba 🕋",
        ...
        explanation:
          "A black cube in Mecca. Muslims circle it counter-clockwise (like Saturn's rings). It's Saturn worship in plain sight.",
        icon: "cube.fill"
      ),
      DecodedSymbol(
      ...
      DecodedSymbol(
        ...
        explanation:
          "A black meteorite in the corner of the black cube. Worshipped as divine. Saturn = black.",
        icon: "circle.fill"
      ),
    ],
    holidays: [
      DecodedHoliday(
        ...
        astronomicalMeaning:
          "Lunar calendar — timing based on MOON sighting. From 'ramad' = scorching heat (sun reference).",
      ...
      DecodedHoliday(
        ...
        astronomicalMeaning:
          "Blood sacrifice tradition — appeasing the gods. Ancient fertility rite.",
      ...
      DecodedHoliday(
        ...
        astronomicalMeaning:
          "Revelation came at NIGHT — the moon's domain. Lunar power celebration.",
    ...
    controlMechanisms: [
      ReligionControlMechanism(
        ...
        howItControls:
          "Constant interruption — you're never free. Always oriented toward the cube.",
        icon: "clock"
      ),
      ReligionControlMechanism(
    ...
    etymologies: [
      EtymologyReveal(
        word: "ALLAH", commonMeaning: "'The God'",
        actualOrigin: "AL-ILAH — pre-Islamic moon god of Arabia."),
      EtymologyReveal(
        word: "ISLAM", commonMeaning: "'Peace'",
        actualOrigin: "Actually means SUBMISSION — to Allah's will."),
      EtymologyReveal(
        word: "MOSQUE", commonMeaning: "House of worship",
        actualOrigin: "From 'masjid' — place of prostration (bowing down)."),
      EtymologyReveal(
        word: "MECCA", commonMeaning: "Holiest city",
        actualOrigin: "Ancient center of MOON god worship before Muhammad."),
      EtymologyReveal(
        word: "KAABA", commonMeaning: "'The Cube'",
        actualOrigin: "Literally means CUBE. They worship a black cube."),
      EtymologyReveal(
        word: "MINARET", commonMeaning: "Tower for call to prayer",
        actualOrigin: "Astronomical observation tower — tracking celestial bodies."),
    ],
    keyRevelation:
      "Islam is MOON worship with SATURN's cube. The crescent moon is on every mosque. The Kaaba is a BLACK CUBE that they circle like Saturn's rings. The calendar is lunar. It's hidden in plain sight."
  )
}
...
extension FinalTruth {
  static let allTruths: [FinalTruth] = [
    ...
    FinalTruth(
      oldProgram: "You are born broken", newTruth: "You are born DIVINE", icon: "sparkles"),
    FinalTruth(
      oldProgram: "You need a savior", newTruth: "YOU are the savior", icon: "person.fill"),
    FinalTruth(
      oldProgram: "Worship the Son/Sun/Moon", newTruth: "Honor them — but YOU are the fractal",
      icon: "sun.max.fill"),
    FinalTruth(
      oldProgram: "The Kingdom is coming", newTruth: "The Kingdom is WITHIN", icon: "crown.fill"),
    FinalTruth(
      oldProgram: "Salvation is earned", newTruth: "You were never lost", icon: "checkmark.seal"),
    FinalTruth(
      oldProgram: "Follow the Church/Synagogue/Mosque", newTruth: "Follow your own consciousness",
      icon: "brain.head.profile"),
    FinalTruth(oldProgram: "Fear God", newTruth: "BE God (a fractal of Source)", icon: "bolt.fill"),
    FinalTruth(
      oldProgram: "One life, then judgment", newTruth: "Eternal energy, infinite experience",
      icon: "infinity"),
  ]
}
...
extension PreDatedSavior {
  static let all: [PreDatedSavior] = [
    PreDatedSavior(
      ...
      attributes: [
        "Virgin birth (Isis)", "Born December 25", "12 followers", "Crucified", "Resurrected",
        "Called 'The Light'",
      ]
    ),
    PreDatedSavior(
      ...
      attributes: [
        "Virgin birth (Devaki)", "Divine child hunted by king", "Performed miracles",
        "Called 'Son of God'", "Resurrected",
      ]
    ),
    PreDatedSavior(
      name: "MITHRA",
      ...
      attributes: [
        "Born December 25", "Born in a cave", "12 followers", "Called 'The Light of the World'",
        "Sunday worship",
      ]
    ),
    PreDatedSavior(
      ...
      approximateDate: "1500+ BCE",
      attributes: [
        "Born of a virgin", "Turned water into wine", "Called 'King of Kings'", "Resurrected",
        "Ate as bread/wine",
      ]
    ),
    PreDatedSavior(
      ...
      attributes: [
        "Born of a virgin", "Born December 25", "Crucified on a tree", "Resurrected after 3 days",
      ]
    ),
    PreDatedSavior(
      name: "BUDDHA",
      ...
      attributes: [
        "Miraculous birth", "Tempted by evil one", "Performed miracles", "Called 'The Light'",
        "Founded a path to liberation",
      ]
    ),
  ]
}
...
extension SunWorshipCulture {
  static let americas = SunWorshipCulture(
    ...
    cultures: [
      SunGodEntry(
        culture: "Mayan", flag: "🇬🇹🇲🇽", sunGod: "Kinich Ahau",
        notes: "\"Sun-Faced Lord\" — the sun was the highest deity"),
      SunGodEntry(
        culture: "Aztec", flag: "🇲🇽", sunGod: "Tonatiuh",
        notes: "The 5th Sun — our current era. Required \"feeding\""),
      SunGodEntry(
        culture: "Inca", flag: "🇵🇪", sunGod: "Inti",
        notes: "Emperors were \"Sons of the Sun\" — sound familiar?"),
      SunGodEntry(
        culture: "Taíno", flag: "🇵🇷🇩🇴", sunGod: "Yúcahu",
        notes: "Caribbean sun/sky god of the indigenous people"),
      SunGodEntry(
        culture: "Hopi", flag: "🏜️", sunGod: "Tawa", notes: "Creator sun spirit of the Southwest"),
      SunGodEntry(
        culture: "Lakota", flag: "🦅", sunGod: "Sun Dance",
        notes: "Sacred ritual across Plains tribes — still practiced"),
    ]
  )
  ...
  static let africa = SunWorshipCulture(
    ...
    cultures: [
      SunGodEntry(
        culture: "Egyptian", flag: "🇪🇬", sunGod: "Ra / Amen-Ra / Aten",
        notes: "The OG — Christianity copied this directly"),
      SunGodEntry(
        culture: "Berber/Amazigh", flag: "🇲🇦", sunGod: "Ayur",
        notes: "North African sun worship predating Islam"),
      SunGodEntry(
        culture: "Dogon", flag: "🇲🇱", sunGod: "Amma",
        notes: "Mali — knew about Sirius B before telescopes"),
      SunGodEntry(
        culture: "Zulu", flag: "🇿🇦", sunGod: "uNkulunkulu",
        notes: "Creator associated with the sun's life-giving power"),
    ]
  )
  ...
  static let europe = SunWorshipCulture(
    ...
    cultures: [
      SunGodEntry(
        culture: "Slavic", flag: "🇷🇺🇺🇦🇵🇱", sunGod: "Dazhbog / Khors / Svarog",
        notes: "\"Giving God\" — the giver of life and warmth"),
      SunGodEntry(
        culture: "Celtic", flag: "🇮🇪☘️", sunGod: "Lugh / Belenus / Brigid",
        notes: "Lughnasadh = sun festival, still celebrated"),
      SunGodEntry(
        culture: "Norse", flag: "🇳🇴🇸🇪", sunGod: "Sól (goddess) / Baldur",
        notes: "Sun was FEMININE in Norse tradition"),
      SunGodEntry(
        culture: "Greek", flag: "🇬🇷", sunGod: "Helios / Apollo", notes: "Helios = root of \"HOLY\""),
      SunGodEntry(
        culture: "Roman", flag: "🇮🇹", sunGod: "Sol Invictus",
        notes: "\"Unconquered Sun\" — Dec 25 was HIS birthday"),
    ]
  )
  ...
  static let asia = SunWorshipCulture(
    ...
    cultures: [
      SunGodEntry(
        culture: "Hindu", flag: "🇮🇳", sunGod: "Surya",
        notes: "Still worshipped today — Surya Namaskar (Sun Salutation)"),
      SunGodEntry(
        culture: "Japanese", flag: "🇯🇵", sunGod: "Amaterasu",
        notes: "Sun GODDESS — emperor descends from her"),
      SunGodEntry(
        culture: "Chinese", flag: "🇨🇳", sunGod: "Xihe",
        notes: "Mother of 10 suns in ancient mythology"),
      SunGodEntry(
        culture: "Persian", flag: "🇮🇷", sunGod: "Mithra",
        notes: "Born Dec 25, rose from dead — predates Jesus by 1000+ years"),
      SunGodEntry(
        culture: "Mesopotamian", flag: "🇮🇶", sunGod: "Shamash",
        notes: "God of justice — because the sun SEES ALL"),
    ]
  )
  ...
  static let oceania = SunWorshipCulture(
    ...
    cultures: [
      SunGodEntry(
        culture: "Hawaiian", flag: "🌺", sunGod: "Kāne / Lā",
        notes: "Creator god associated with sun and life"),
      SunGodEntry(
        culture: "Polynesian", flag: "🏝️", sunGod: "Tama-nui-te-rā",
        notes: "Maui lassoed the sun to slow it down"),
      SunGodEntry(
        culture: "Aboriginal", flag: "🇦🇺", sunGod: "Wala / Yhi",
        notes: "Sun beings in Dreamtime — 60,000+ year tradition"),
    ]
  )
...
extension ImperialismStep {
  static let all: [ImperialismStep] = [
    ...
    ImperialismStep(
      step: 2, action: "Burned the libraries (Mayan codices, Alexandria)", icon: "flame.fill"),
    ImperialismStep(
      step: 3, action: "Killed the priests/shamans who held the knowledge",
      icon: "person.fill.xmark"),
    ImperialismStep(
      step: 4, action: "Renamed the sun god \"Jesus\"", icon: "character.cursor.ibeam"),
    ...
    ImperialismStep(
      step: 7, action: "Told you your ancestors were \"savages\"", icon: "quote.bubble.fill"),
    ImperialismStep(
      step: 8, action: "Made you ashamed of your own cosmic truth", icon: "eye.slash.fill"),
  ]
}
...
extension SolarDisconnection {
  static let all: [SolarDisconnection] = [
    ...
    SolarDisconnection(
      method: "Sunglasses",
      description:
        "Blocks sunlight from entering your eyes → pineal gland. Disrupts melatonin, serotonin, and DMT production.",
      icon: "eyeglasses",
      color: "#666666"
    ),
    SolarDisconnection(
      method: "Sunscreen",
      description:
        "Blocks vitamin D synthesis. Contains chemicals absorbed into bloodstream. You're told the sun causes cancer while they block your immunity.",
    ...
    SolarDisconnection(
      ...
      description:
        "Keeps you INDOORS during peak sunlight hours. You commute in darkness, work under artificial light, return in darkness.",
    ...
    SolarDisconnection(
      ...
      description:
        "Homes → Cars → Offices → Cars → Homes. We live in BOXES, disconnected from sky, earth, and sun.",
      icon: "house.fill",
      color: "#555555"
    ),
    SolarDisconnection(
      ...
      description:
        "Fluorescent lights, LEDs lack the full spectrum. Your body doesn't recognize it as \"day\" — circadian confusion.",
      icon: "lightbulb.fill",
      color: "#FFCC00"
    ),
    SolarDisconnection(
      ...
      description:
        "Phones, TVs, computers emit blue light that tells your brain it's still daytime. Destroys melatonin production.",
      icon: "iphone.gen3",
      color: "#4488FF"
    ),
    SolarDisconnection(
      ...
      description:
        "Completely inverts your circadian rhythm. Associated with cancer, depression, metabolic disorders.",
      icon: "moon.fill",
      color: "#8866CC"
    ),
    SolarDisconnection(
      ...
      description:
        "\"Stay out of the sun!\" \"Cover up!\" \"Dangerous UV!\" — Meanwhile vitamin D deficiency is epidemic.",
      icon: "megaphone.fill",
      color: "#FF6666"
    ),
    SolarDisconnection(
      ...
      description:
        "Daylight Saving Time disrupts natural rhythm twice yearly. Time zones disconnect you from LOCAL solar noon.",
...
extension SolarBeingTruth {
  static let all: [SolarBeingTruth] = [
    SolarBeingTruth(
      ...
      explanation:
        "Your cells contain mitochondria — the \"powerhouse\" that converts light into energy. You are literally SOLAR POWERED.",
      icon: "sun.max.fill"
    ),
    SolarBeingTruth(
      truth: "Sunlight Through Eyes → Pineal Gland",
      explanation:
        "Light entering your eyes activates the pineal gland (third eye), regulating melatonin, serotonin, and DMT — your connection to higher consciousness.",
      icon: "eye.fill"
    ),
    SolarBeingTruth(
      truth: "Vitamin D is a HORMONE",
      explanation:
        "Not just a vitamin — it's a master hormone that regulates 2,000+ genes. Deficiency linked to cancer, depression, autoimmune disease, and death.",
      icon: "pill.fill"
    ),
    SolarBeingTruth(
      truth: "Circadian Rhythm = Life Rhythm",
      explanation:
        "Your body has a 24-hour clock synced to the SUN. Sleep, hormones, digestion, immunity — ALL tied to solar cycles.",
      icon: "clock.fill"
    ),
    SolarBeingTruth(
      truth: "Morning Sun = Cortisol Reset",
      explanation:
        "Sunlight in the first hour of waking sets your cortisol rhythm. This determines energy, mood, and sleep quality for the ENTIRE day.",
      icon: "sunrise.fill"
    ),
    SolarBeingTruth(
      truth: "Grounding + Sun = Full Circuit",
      explanation:
        "Bare feet on earth + sun on skin completes an electrical circuit. You become a conduit between sky and ground — as designed.",
      icon: "bolt.fill"
    ),
    SolarBeingTruth(
      truth: "Ancient Sungazing Practices",
      explanation:
        "Every culture practiced safe sungazing at sunrise/sunset. Now it's called \"dangerous.\" They don't want you activating your pineal.",
      icon: "sparkles"
    ),
    SolarBeingTruth(
      truth: "The Sun Doesn't Cause Cancer",
      explanation:
        "Sun BURNS cause damage. Gradual exposure builds melanin (protection). Vitamin D from sun actually PREVENTS cancer. The narrative is inverted.",
      icon: "shield.fill"
    ),
  ]
}
...
extension PinealCalcifier {
  static let all: [PinealCalcifier] = [
    PinealCalcifier(
      ...
      effect:
        "Accumulates in pineal more than any other organ. Creates calcium phosphate crystite deposits. Literally turns your third eye to stone.",
      icon: "drop.fill"
    ),
    PinealCalcifier(
      ...
      effect:
        "Creates acidic environment. Deposits calcium in soft tissues including pineal. Clogs the gateway.",
    ...
    PinealCalcifier(
      ...
      effect:
        "Neurotoxins that cross blood-brain barrier. Disrupt endocrine system. Attack the gland directly.",
      icon: "leaf.fill"
    ),
    PinealCalcifier(
      substance: "Mercury",
      ...
      effect:
        "Heavy metal that accumulates in brain tissue. Pineal is particularly vulnerable due to high blood flow.",
    ...
    PinealCalcifier(
      ...
      effect:
        "Excitotoxins that overstimulate and damage neurons. Disrupts natural DMT production.",
    ...
    PinealCalcifier(
      ...
      effect:
        "Inorganic calcium deposits in soft tissue. Your body can't use it properly — it just accumulates.",
      icon: "pills.fill"
    ),
    PinealCalcifier(
      substance: "Alcohol",
      ...
      effect:
        "Suppresses melatonin production. Disrupts sleep cycles. Keeps you out of REM — where consciousness expands.",
      icon: "wineglass.fill"
    ),
    PinealCalcifier(
      ...
      effect:
        "Overstimulates adrenals. Disrupts natural cortisol rhythm. Keeps you in fight-or-flight, never rest-and-digest.",
      icon: "mug.fill"
    ),
  ]
}
...
extension ChristWithinTruth {
  static let all: [ChristWithinTruth] = [
    ChristWithinTruth(
      ...
      explanation:
        "Pine cone shaped gland in center of brain. Contains rod and cone cells like your eyes. It literally SEES — but inward, not outward.",
      icon: "eye.trianglebadge.exclamationmark.fill"
    ),
    ChristWithinTruth(
      revelation: "\"Christ\" = Christos = Anointing Oil",
      explanation:
        "The Christ is not a person — it's the sacred oil (CSF) that rises up your spine to anoint (activate) your pineal gland. \"Awaken the Christ within.\"",
      icon: "drop.circle.fill"
    ),
    ChristWithinTruth(
      revelation: "Pine Cone Symbolism EVERYWHERE",
      explanation:
        "Vatican has giant pine cone statue. Pope's staff has pine cone. Egyptian staffs. Osiris. Buddha's head. Hindu gods. They KNOW — but don't tell YOU.",
      icon: "building.columns.fill"
    ),
    ChristWithinTruth(
      revelation: "\"Kingdom of Heaven is WITHIN You\"",
      explanation:
        "Jesus said it directly (Luke 17:21). Not in a church. Not in the sky. WITHIN. Your pineal gland is the gateway to the kingdom.",
      icon: "crown.fill"
    ),
    ChristWithinTruth(
      revelation: "DMT is Produced in Your Pineal",
      explanation:
        "The \"spirit molecule\" — released during deep meditation, dreams, birth, and death. Your brain makes its own connection to source.",
      icon: "sparkles"
    ),
    ChristWithinTruth(
      revelation: "Baptism Oil Blocks Your Chakras",
      explanation:
        "Catholic chrism oil placed on forehead (third eye) and crown during baptism. A ritual to BLOCK activation, disguised as blessing.",
      icon: "xmark.seal.fill"
    ),
    ChristWithinTruth(
      revelation: "You Are Electromagnetic",
      explanation:
        "Your heart generates an electromagnetic field measurable feet away. Your brain produces electricity. You are a FIELD of consciousness, not just a body.",
      icon: "bolt.heart.fill"
    ),
    ChristWithinTruth(
      revelation: "Quantum Consciousness Creates Reality",
      explanation:
        "Observer effect in physics: consciousness collapses wave function into reality. You are not observing reality — you are CREATING it.",
      icon: "atom"
    ),
  ]
}
...
extension SovereigntyPractice {
  static let all: [SovereigntyPractice] = [
    SovereigntyPractice(
      ...
      benefit:
        "Face the rising sun with closed eyes. Light penetrates eyelids, activates pineal. Ancient practice they tried to erase.",
      icon: "sunrise.fill"
    ),
    SovereigntyPractice(
      practice: "Conscious Breathing",
      benefit:
        "Breath is LIFE FORCE (prana, chi, ruach). Deep breathing oxygenates pineal, activates parasympathetic. Gateway to presence.",
      icon: "wind"
    ),
    SovereigntyPractice(
      practice: "Decalcify Your Pineal",
      benefit:
        "Filter water, avoid fluoride, eat organic, use iodine/boron, fast periodically. Reverse the calcification.",
      icon: "arrow.counterclockwise"
    ),
    SovereigntyPractice(
      practice: "Grounding (Earthing)",
      benefit:
        "Bare feet on earth. Electrons flow up, balancing your charge. Complete the circuit between sky and ground.",
      icon: "leaf.circle.fill"
    ),
    SovereigntyPractice(
      practice: "Blue Light Elimination",
      benefit:
        "No screens 2 hours before bed. Use red/amber light at night. Let your pineal know it's actually nighttime.",
      icon: "moon.fill"
    ),
    SovereigntyPractice(
      practice: "Heart Coherence",
      benefit:
        "Heart's electromagnetic field is 5000x stronger than brain's. Gratitude and love create coherent field that affects reality.",
      icon: "heart.fill"
    ),
    SovereigntyPractice(
      practice: "Silence & Solitude",
      benefit:
        "You don't need a church. Silence is the language of source. In stillness, you remember who you are.",
      icon: "person.fill.viewfinder"
    ),
    SovereigntyPractice(
      practice: "I AM Declarations",
      benefit:
        "\"I AM\" activates creation. Speak your sovereignty into existence. You are the word made flesh.",
...
extension PinealInHistory {
  static let all: [PinealInHistory] = [
    PinealInHistory(
      ...
      description:
        "Giant bronze pine cone (\"Pigna\") in Court of the Pine Cone. Pope's staff topped with pine cone. They KNOW.",
      icon: "building.columns.fill"
    ),
    PinealInHistory(
      location: "Egypt",
      ...
      description:
        "Eye of Horus = exact diagram of pineal gland cross-section. Staff of Osiris topped with pine cone. Eye of Ra.",
      icon: "pyramid.fill"
    ),
    PinealInHistory(
      location: "India",
      culture: "Hindu",
      description:
        "Shiva's third eye. Buddha's ushnisha (crown protrusion). Pine cone on deity heads. Ajna chakra = pineal.",
    ...
    PinealInHistory(
      ...
      description:
        "Annunaki gods depicted holding pine cones. \"Handbag\" + pine cone in carvings worldwide.",
    ...
    PinealInHistory(
      ...
      description:
        "Dionysus/Bacchus staff (thyrsus) topped with pine cone. Philosophers knew the seat of the soul.",
      icon: "laurel.leading"
    ),
    PinealInHistory(
      ...
      culture: "Mayan/Aztec",
      description:
        "Pine cone imagery in temples. Quetzalcoatl associated with pineal activation. Serpent energy rising.",
      icon: "building.2.fill"
    ),
    PinealInHistory(
      ...
      description:
        "All-seeing eye symbol. They preserve the knowledge while hiding it from the \"profane\" (public).",
    ...
    PinealInHistory(
      ...
      culture: "Corporate",
      description:
        "CBS eye. AOL. IRS building. Countless logos feature the eye or pine cone. Hidden in plain sight.",
      icon: "tv.fill"
    ),
  ]
}
...
extension RitualDecoded {
  static let all: [RitualDecoded] = [
    ...
    RitualDecoded(
      ...
      whatItActuallyIs:
        "Tracing a 2D pattern that FOLDS INTO A CUBE — Saturn's cube. You're marking yourself with Saturn.",
      icon: "cube.fill"
    ),
    RitualDecoded(
      ...
      whatItActuallyIs:
        "Strapping a BLACK CUBE to your forehead — directly over your third eye. Blocking pineal activation.",
      icon: "cube.fill"
    ),
    RitualDecoded(
    ...
    RitualDecoded(
      ...
      whatItActuallyIs:
        "Submission posture. Training you that you are BELOW, not equal. You bow to no one — you ARE source.",
      icon: "figure.stand"
    ),
    RitualDecoded(
      ritual: "Confession",
      ...
      whatItActuallyIs:
        "Giving your secrets to the institution. Information = power. They collect your vulnerabilities.",
      icon: "ear.fill"
    ),
    RitualDecoded(
      ritual: "Baptism",
      ...
      whatItActuallyIs:
        "Chrism OIL placed on third eye and crown chakra. A BLOCKING ritual disguised as blessing. Claiming your soul for the institution.",
      icon: "drop.fill"
    ),
    RitualDecoded(
      ...
      whatItActuallyIs:
        "Symbolic cannibalism ritual. Also: the round wafer = the SUN disc. You're eating the sun god.",
      icon: "circle.fill"
    ),
    RitualDecoded(
      ...
      whatItActuallyIs:
        "Facing where the SUN RISES. East = sun worship. They just won't tell you that.",
      icon: "sunrise.fill"
    ),
    RitualDecoded(
      ...
      whatItActuallyIs:
        "Repetitive mantras create trance state. Effective — but directed at external deity instead of internal awakening.",
    ...
    RitualDecoded(
      ...
      whatItActuallyIs:
        "Paying taxes to the institution. God doesn't need your money. The Vatican is the richest entity on Earth.",
    ...
    RitualDecoded(
      ...
      whatItActuallyIs:
        "SUN-day. The day of the SUN. They worship the sun openly but call it something else.",
      icon: "sun.max.fill"
    ),
  ]
}
...
extension PatternRecognitionEvent {
  ...
  static let epsteinVaticanTimeline: [PatternRecognitionEvent] = [
    PatternRecognitionEvent(
      ...
      icon: "doc.text.fill",
      significance:
        "Vatican Bank mentioned. Bannon/Epstein 'take down Francis' chats exposed. Global elite network revealed."
    ),
    PatternRecognitionEvent(
      date: "Jan 30 - Feb 10",
      ...
      significance:
        "Vatican says NOTHING. No statement on trafficking. No condemnation of elite networks. Complete silence."
    ),
    PatternRecognitionEvent(
      date: "Feb 10, 2026",
      ...
      icon: "person.3.fill",
      significance:
        "Suddenly speaks on 'authoritarianism' and 'nationalism.' Inserts Vatican into political narrative. Distraction."
    ),
    PatternRecognitionEvent(
      date: "Pattern",
      ...
      significance:
        "When exposed → Stay silent → Wait for news cycle → Pivot to 'moral authority' on unrelated topic → Escape accountability"
    ),
  ]
}
...
extension SelectiveChristianMorality {
  static let cases: [SelectiveChristianMorality] = [
    SelectiveChristianMorality(
      ...
      christiansAffected:
        "Palestinian Christians — one of the oldest Christian communities on Earth. Greek Orthodox, Catholic, Protestant.",
    ...
    SelectiveChristianMorality(
      ...
      situation:
        "US invasion destroyed ancient Christian communities. Churches bombed. Christians fled.",
      christiansAffected:
        "Iraqi Christians — Chaldean Catholics, Assyrian Christians. Community existed since 1st century AD.",
...
enum ZionismTruth {
  ...
  static let definitions: [(term: String, definition: String, age: String, icon: String)] = [
    (
      "Judaism", "A RELIGION based on the Torah and Jewish traditions", "3,000+ years old",
      "book.fill"
    ),
    (
      "Jewish People", "An ETHNICITY and CULTURE with shared heritage", "Thousands of years",
      "person.3.fill"
    ),
    (
      "Zionism", "A POLITICAL MOVEMENT advocating for a Jewish nation-state", "Founded 1897",
...
enum NarrativeControl {
  ...
  static let methods: [(method: String, description: String, icon: String)] = [
    (
      "Conflation",
      "Make political criticism = ethnic hatred. Zionism = Judaism. Criticism = anti-Semitism.",
      "equal.circle.fill"
    ),
    (
      "Labeling",
      "\"Conspiracy theorist\", \"Anti-Semite\", \"Extremist\" — weaponized terms to dismiss without debate.",
      "tag.fill"
    ),
    (
      "Deplatforming",
      "Remove dissenting voices from social media, academia, media. Control who speaks.",
      "xmark.circle.fill"
    ),
    (
      "Legal Pressure",
      "Anti-BDS laws in 35+ US states. Criminalizing boycotts of a foreign country.",
      "building.columns.fill"
    ),
    (
      "Media Control",
      "Ownership of major outlets. Decide what stories get told, which get buried.", "tv.fill"
    ),
    (
      "Campus Suppression", "Donors threaten universities. Professors fired. Students silenced.",
      "graduationcap.fill"
    ),
    (
      "Algorithm Control", "Social media suppresses certain content. Shadow bans. Reduced reach.",
      "network"
    ),
    (
      "Fact-Checker Capture",
      "\"Fact-checkers\" funded by interested parties. Truth becomes \"misinformation\".",
      "checkmark.seal.fill"
    ),
  ]
...
enum TrinityControlSystem {
  ...
  static let parallels: [TrinityParallel] = [
    TrinityParallel(
      ...
      function:
        "Tells you what's RIGHT and WRONG. Sets the rules of reality. You cannot question it.",
    ...
    TrinityParallel(
      ...
      function:
        "The authority made VISIBLE. Walks among you. Enforces the Father's will with real-world power.",
    ...
    TrinityParallel(
      ...
      function:
        "UNSEEN but everywhere. Moves all things. You feel it but can't see it. Controls without appearing to.",
      holyIcon: "wind",
