...
struct LivingNameCourseView: View {
            ...
            ForEach(0..<30, id: \.self) { i in
                Circle()
                    ...
                    .position(
                        ...
                        y: (geo.size.height - CGFloat(i) * 30 - particleOffset).truncatingRemainder(dividingBy: geo.size.height + 100)
                    )
    ...
    private var headerSection: some View {
        VStack(spacing: 20) {
            ...
            // Course stats
            HStack(spacing: 16) {
                LivingNameStatPill(icon: "square.stack.3d.up", value: "6", label: "Modules", color: course.color)
                LivingNameStatPill(icon: "text.book.closed", value: "18", label: "Lessons", color: course.color)
    ...
    private var hebrewSection: some View {
        VStack(spacing: 16) {
            ...
            HStack(spacing: 20) {
                HebrewLetterView(letter: "י", name: "YUD", meaning: "Divine Spark", color: course.color, delay: 0)
                HebrewLetterView(letter: "ש", name: "SHIN", meaning: "Eternal Fire", color: course.color, delay: 0.2)
                HebrewLetterView(letter: "ו", name: "VAV", meaning: "Connection", color: course.color, delay: 0.4)
                HebrewLetterView(letter: "ע", name: "AYIN", meaning: "Inner Eye", color: course.color, delay: 0.6)
            }
    ...
    private var introSection: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text("The man you know as Jesus was never called that. Not by his mother. Not by his followers. His name was Yeshua—and it wasn't just a name.")
                .font(.system(size: 16, weight: .medium, design: .rounded))
                .foregroundColor(Palette.text.primary)
                .lineSpacing(4)
            
            Text("It was a vibration. A code. A map back to the divine. They didn't just change his name—they buried a key.")
            ...
            VStack(alignment: .leading, spacing: 10) {
                LivingNameKeyPoint(text: "Yeshua → Iēsous → Iesus → Jesus: each step stripped the vibration", color: course.color)
                LivingNameKeyPoint(text: "Council of Nicaea (325 AD): Constantine needed control, not awakening", color: course.color)
                LivingNameKeyPoint(text: "The Gospel of Thomas buried: 'The kingdom is within you'", color: course.color)
                LivingNameKeyPoint(text: "The Christ is an inner anointing—not just a person to worship", color: course.color)
            }
            .padding(.top, 8)
        }
        .padding(18)
