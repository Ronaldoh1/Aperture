...
struct EvilCorporationsDatabaseView: View {
  ...
  private var totalEvilSection: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      Text(
        "These corporations aren't anomalies—they're the system working as designed. Capitalism incentivizes profit over people. The 'bad apples' ARE the barrel."
      )
      .font(.system(size: 13))
  ...
  private var allCorporations: [EvilCorporation] {
    [
      ...
      EvilCorporation(
        ...
        evilScore: 95,
        primarySin:
          "Manages $10 TRILLION, buys up housing, controls voting power over most corporations",
        allSins: [
        ...
        politicalInfluence:
          "Larry Fink connected to politicians across both parties. Advises Federal Reserve.",
      ...
      EvilCorporation(
        ...
        politicalInfluence:
          "Jamie Dimon is face of Wall Street, regular White House visitor regardless of party",
      ...
      EvilCorporation(
        ...
        evilScore: 90,
        primarySin:
          "Bet against clients in 2008 crash, coined 'Government Sachs' for revolving door",
        allSins: [
      ...
      EvilCorporation(
        ...
        evilScore: 92,
        primarySin:
          "Paid $0 federal income tax in 2018, workers pee in bottles, destroys small business",
        allSins: [
      ...
      EvilCorporation(
        ...
        evilScore: 92,
        primarySin:
          "Texaco (now Chevron) dumped 16B gallons of toxic waste in Amazon, evades cleanup",
        allSins: [
      ...
      EvilCorporation(
        ...
        alternatives:
          "Local products, avoid: Hot Pockets, Stouffer's, DiGiorno, Gerber, Poland Spring",
        currentThreat: true
      ),
      EvilCorporation(
        name: "Tyson Foods",
