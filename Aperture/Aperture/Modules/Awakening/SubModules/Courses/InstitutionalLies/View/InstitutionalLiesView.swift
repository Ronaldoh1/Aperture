...
struct InstitutionalLiesView: View {
    ...
    private var warningBanner: some View {
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("Everything here links to primary sources: DOJ cases, FDA communications, Senate reports, peer-reviewed journals, or declassified government documents. These are not theories - they are documented institutional actions.")
