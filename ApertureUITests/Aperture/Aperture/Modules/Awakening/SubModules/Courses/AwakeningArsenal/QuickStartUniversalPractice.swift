...
struct QuickStartUniversalPracticeView: View {
  ...
  private var fiveUniversalsSection: some View {
    VStack(alignment: .leading, spacing: 16) {
      ...
      universalPracticeCard(
        ...
        whatItDoes:
          "Activates the parasympathetic nervous system, quiets the mind, and opens the door to altered states. Breath is the bridge between body and consciousness.",
        howToDo: [
        ...
        tips:
          "Morning is ideal. Don't force—let breath be smooth. If you get dizzy, return to normal breathing.",
        scienceNote:
          "Research shows conscious breathing reduces cortisol, increases heart rate variability, and activates the prefrontal cortex."
      )
      ...
      universalPracticeCard(
        ...
        whatItDoes:
          "Creates space between stimulus and response. Reveals the nature of mind. Allows deeper patterns to surface and dissolve.",
        howToDo: [
        ...
        tips:
          "Consistency matters more than duration. Same time daily builds habit. Wandering mind isn't failure—noticing is the practice.",
        scienceNote:
          "Meditation physically changes brain structure—increases gray matter in prefrontal cortex and reduces amygdala reactivity."
      )
      ...
      universalPracticeCard(
        ...
        whatItDoes:
          "Breaks the cycle of craving and aversion that causes suffering. Reveals that you are not your thoughts, emotions, or circumstances.",
        howToDo: [
        ...
        tips:
          "Non-attachment isn't not caring—it's not clinging. You can prefer outcomes without demanding them. Start with physical objects.",
        scienceNote:
          "Attachment activates the brain's reward circuitry and creates dependency patterns. Non-attachment rewires these circuits."
      )
      ...
      universalPracticeCard(
        ...
        whatItDoes:
          "Opens the heart center. Dissolves the illusion of separation. Transforms both the giver and receiver. Is considered the highest practice in most traditions.",
        howToDo: [
        ...
        tips:
          "Self-compassion isn't selfish—it's necessary. If sending love to difficult people is too hard, start with 'May they be free from suffering.'",
        scienceNote:
          "Loving-kindness meditation increases vagal tone, positive emotions, and social connection while reducing implicit bias."
      )
      ...
      universalPracticeCard(
        ...
        whatItDoes:
          "Turns attention back on the observer. Questions assumed identities. Reveals that what you truly are cannot be found as an object.",
        howToDo: [
        ...
        tips:
          "This isn't intellectual—it's experiential. Don't try to answer with words. Let the question dissolve the questioner.",
        scienceNote:
          "Self-referential processing activates the default mode network. Self-inquiry interrupts these patterns, similar to psychedelic states."
      )
    }
    .padding(.bottom, 16)
  ...
  private var sevenDayChallengeSection: some View {
    VStack(alignment: .leading, spacing: 16) {
      ...
      Text(
        "After 7 days, you've touched the core of every major tradition. Choose which resonates most and go deeper."
      )
  ...
  private var afterYouStartSection: some View {
    VStack(alignment: .leading, spacing: 16) {
      ...
      VStack(alignment: .leading, spacing: 10) {
        ...
        nextRow(
          "Emotions may surface", "This is healing. Suppressed material comes up to be released.")
      ...
      Text(
        "The path finds you when you're ready. Your job is to show up consistently. The rest unfolds naturally."
      )
      .font(.system(size: 12, weight: .medium))
      .foregroundColor(.purple)
      .italic()
