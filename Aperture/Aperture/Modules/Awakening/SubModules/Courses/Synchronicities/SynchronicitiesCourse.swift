      ...
      lessons: [
        SyncLesson(
          ...
          example: SyncExample(
            ...
            description:
              "You think of someone you haven't talked to in years. Within hours, they call or text. No logical reason they would reach out at that exact moment."
          )
        ),
        ...
        SyncLesson(
          ...
          example: SyncExample(
            ...
            description:
              "A beetle appears at the exact moment patient describes dreaming of a scarab, breaking her resistance to non-rational experience."
          )
        ),
        ...
        SyncLesson(
          ...
          example: SyncExample(
            title: "The Balance",
            description:
              "Track your synchronicities for 30 days. Note the hits AND misses. Let the data show you whether patterns are real."
          )
        ),
      ]
    ),
      ...
      lessons: [
        SyncLesson(
          ...
          example: SyncExample(
            ...
            description:
              "You haven't thought about your college roommate in 2 years. Suddenly they cross your mind vividly. Your phone rings within the hour — it's them."
          )
        ),
        ...
        SyncLesson(
          ...
          example: SyncExample(
            title: "11:11 Pattern",
            description:
              "For a week, you keep seeing 11:11 on clocks, receipts ($11.11), addresses. Each time you pause and notice you were thinking about a major life decision."
          )
        ),
        ...
        SyncLesson(
          ...
          example: SyncExample(
            ...
            description:
              "In one week: dream about ocean, coworker mentions learning to swim, water main breaks on your street, friend invites you kayaking. Later you realize you've been suppressing emotions (water = feelings)."
          )
        ),
        ...
        SyncLesson(
          ...
          example: SyncExample(
            title: "The Door Test",
            description:
              "Stuck between two options, you ask for a sign. Within a day, one path gets blocked (literal closed door, canceled meeting). The other path opens unexpectedly. Message received."
          )
        ),
      ]
    ),
      ...
      lessons: [
        SyncLesson(
          ...
          example: SyncExample(
            ...
            description:
              "Keep a synchronicity journal for 30 days. At the end, review: What themes dominated? What was your hit rate? Did tracking change your experience?"
          )
        ),
        ...
        SyncLesson(
          ...
          example: SyncExample(
            ...
            description:
              "Spend one week in high awareness mode: meditate daily, reduce phone use, spend time in nature. Track whether synchronicity frequency changes."
          )
        ),
        ...
        SyncLesson(
          ...
          example: SyncExample(
            ...
            description:
              "A synchronicity suggests you contact an old mentor. You do. They mention a job opening that changes your career. Following the small sign led to something big."
          )
        ),
      ]
    ),
      ...
      lessons: [
        SyncLesson(
          ...
          example: SyncExample(
            ...
            description:
              "While studying synchronicities, you experience an unusual cluster of them — as if the universe is demonstrating the concept. This is commonly reported."
          )
        ),
        ...
        SyncLesson(
          ...
          example: SyncExample(
            ...
            description:
              "During a period of intense spiritual growth, synchronicities become almost daily. Books fall open to relevant pages. Conversations answer questions you were holding. It feels like the universe is teaching directly."
          )
        ),
        ...
        SyncLesson(
          ...
          example: SyncExample(
            ...
            description:
              "Years of practice later, synchronicities are natural. You notice them, smile, adjust course. No obsession. No doubt. Just a continuous conversation with reality."
          )
        ),
      ]
    ),
...
enum SyncPatternGame {
  ...
  static let scenarios: [Scenario] = [
    Scenario(
      description:
        "You've been thinking about your grandmother who passed away 5 years ago. While walking, you smell her exact perfume from a stranger passing by. This is:",
      options: [
      ...
      correctIndex: 1,
      explanation:
        "This has the synchronicity signature: inner state (thinking of grandmother) + outer event (her perfume) + meaningful timing. We don't need to claim it's 'definitely' a message, but it's worth noting as a possible synchronicity.",
      difficulty: .easy
    ),

    Scenario(
      description:
        "You see 11:11 on your phone. Then your coffee order is $11.11. Then your Uber is 11 minutes away. You've been anxious about a decision all day. This is:",
      options: [
      ...
      correctIndex: 1,
      explanation:
        "Number clusters during heightened emotional states are classic synchronicities. They're not telling you WHAT to decide, but to PAY ATTENTION. The 11s are a 'wake up' signal - get present with your decision.",
      difficulty: .medium
    ),

    Scenario(
      description:
        "You've been forcing yourself to see 'signs' everywhere for weeks. Everything feels meaningful. You're exhausted but can't stop looking for patterns. This is:",
      options: [
      ...
      correctIndex: 2,
      explanation:
        "When EVERYTHING feels like a sign, you've lost discernment. Genuine synchronicities are specific and relatively rare. Constant overwhelming meaning-making is a warning sign to ground, rest, and possibly seek support.",
      difficulty: .hard
    ),

    Scenario(
      description:
        "You ask the universe: 'If I should take this job, show me a red cardinal.' For 3 days, no cardinal. Then you see one, but you're not even thinking about the job. This is:",
      options: [
      ...
      correctIndex: 2,
      explanation:
        "Synchronicity depends on timing AND context. If you asked for a sign about a specific decision and the sign appears when you're not even holding the question, it's inconclusive. The synchronicity signature requires meaningful alignment of inner and outer.",
      difficulty: .hard
    ),

    Scenario(
      description:
        "Three different friends, unprompted, recommend the same book to you in one week. You've never heard of it. This is:",
      options: [
      ...
      correctIndex: 1,
      explanation:
        "Three independent sources pointing to the same thing is a classic theme synchronicity. Unless the book just went viral (check), this is a strong signal. The universe is highlighting this information for you.",
      difficulty: .easy
    ),
  ]
}
