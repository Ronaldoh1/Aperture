...
enum HistoryDebuggedDatabase {
  ...
  static let allTopics: [HistoryTopic] = [
    ...
    HistoryTopic(
      ...
      region: .americas,
      commonLie:
        "Columbus was the heroic first European to find the Americas in 1492, mistaking it for India and kindly interacting with 'Indians.' He proved the world wasn't flat and opened the New World to civilization.",
      thetruth: """
        ...
        """,
      awakeningAngle:
        "This narrative props up colonial justification for land grabs—the 'Doctrine of Discovery' is still cited in legal cases today. Truth empowers recognizing ongoing Indigenous rights and avoiding 'discovery' mindsets in modern geopolitics—like treating resources as 'unclaimed' when they're not.",
      keyFacts: [
      ...
      furtherReading: [
        HistoryResource(
          title: "A People's History of the United States", author: "Howard Zinn", type: .book,
          url: nil),
        HistoryResource(
          title: "1491: New Revelations of the Americas Before Columbus", author: "Charles C. Mann",
          type: .book, url: nil),
        HistoryResource(
          title: "Columbus Controversy", author: nil, type: .wikipedia,
          url: "https://en.wikipedia.org/wiki/Christopher_Columbus#Criticism_and_defense"),
      ],
      dragonComment:
        "They called it 'discovery' when millions already lived there. Imagine someone 'discovering' your house while you're in it. That's the logic we're working with. 🐉",
      impactLevel: 5
    ),
    ...
    HistoryTopic(
      ...
      region: .americas,
      commonLie:
        "The Pilgrims fled religious persecution, befriended Native Americans, and shared a jolly feast in 1621 as equals. This began a lasting friendship between cultures that built America together.",
      thetruth: """
        ...
        """,
      awakeningAngle:
        "It sanitizes settler colonialism into a feel-good story. Unpacking it helps us confront systemic inequalities today—land acknowledgments, treaty rights, and reparations debates require understanding this wasn't 'sharing' but the beginning of systematic displacement.",
      keyFacts: [
      ...
      furtherReading: [
        HistoryResource(
          title: "This Land Is Their Land", author: "David Silverman", type: .book, url: nil),
        HistoryResource(
          title: "Lies My Teacher Told Me", author: "James Loewen", type: .book, url: nil),
        HistoryResource(
          title: "National Day of Mourning", author: nil, type: .article,
          url: "https://www.uaine.org/"),
      ],
      dragonComment:
        "They taught you about sharing corn. They left out the part where, 16 years later, colonists burned hundreds of people alive and called it 'Thanksgiving.' 🐉",
      impactLevel: 4
    ),
    ...
    HistoryTopic(
      ...
      region: .americas,
      commonLie:
        "George Washington 'could not tell a lie' about chopping a cherry tree. The Founding Fathers were pure liberty-loving democrats who created the greatest democracy fighting tyranny for universal freedom.",
      thetruth: """
        ...
        """,
      awakeningAngle:
        "Hero worship blinds us to systemic hypocrisy baked into American institutions. Understanding that the Founders were slave-owning elites who feared democracy helps explain ongoing struggles: voter suppression, the Electoral College, wealth inequality. We can't fix bugs we refuse to see in the source code.",
      keyFacts: [
      ...
      furtherReading: [
        HistoryResource(
          title: "The Half Has Never Been Told", author: "Edward Baptist", type: .book, url: nil),
        HistoryResource(title: "Founding Myths", author: "Ray Raphael", type: .book, url: nil),
        HistoryResource(
          title: "Sally Hemings", author: nil, type: .wikipedia,
          url: "https://en.wikipedia.org/wiki/Sally_Hemings"),
      ],
      dragonComment:
        "'Cannot tell a lie' was itself a lie. The man who wrote 'all men are created equal' enslaved 600 people. The cognitive dissonance is the point—it keeps you from asking questions. 🐉",
      impactLevel: 5
    ),
    ...
    HistoryTopic(
      ...
      region: .americas,
      commonLie:
        "North America was sparsely populated by primitive nomadic tribes before Europeans 'settled' it peacefully. The land was mostly empty wilderness waiting to be civilized.",
      thetruth: """
        ...
        """,
      awakeningAngle:
        "The 'empty land' myth fueled Manifest Destiny and continues to justify resource extraction, treaty violations, and dismissing Indigenous sovereignty today. Understanding that this was replacement, not settlement, shifts us toward environmental stewardship, honoring treaties, and recognizing that 'unclaimed' resources rarely are.",
      keyFacts: [
      ...
      furtherReading: [
        ...
        HistoryResource(
          ...
          author: "Roxanne Dunbar-Ortiz", type: .book, url: nil),
        HistoryResource(
          title: "Cahokia", author: nil, type: .wikipedia,
          url: "https://en.wikipedia.org/wiki/Cahokia"),
      ],
      dragonComment:
        "They didn't find empty land—they found land emptied by plague. The crime scene became the real estate listing. 🐉",
      impactLevel: 5
    ),
    ...
    HistoryTopic(
      ...
      region: .americas,
      commonLie:
        "The American Revolution was a unified uprising of freedom-loving colonists against British tyranny, fighting for universal liberty, equality, and democratic self-governance.",
      thetruth: """
        ...
        """,
      awakeningAngle:
        "Glorifying revolution as pure idealism hides the economic drivers and exclusions. This lens helps us spot similar patterns today: who benefits from 'freedom' rhetoric? Which 'revolutions' serve elites vs. the people? True liberation requires examining who's funding the movement.",
      keyFacts: [
      ...
      furtherReading: [
        HistoryResource(
          title: "The Radicalism of the American Revolution", author: "Gordon Wood", type: .book,
          url: nil),
        HistoryResource(
          title: "Slave Nation", author: "Alfred & Ruth Blumrosen", type: .book, url: nil),
        HistoryResource(
          title: "Black Loyalists", author: nil, type: .wikipedia,
          url: "https://en.wikipedia.org/wiki/Black_Loyalist"),
      ],
      dragonComment:
        "One-third for, one-third against, one-third didn't care. The 'unified uprising' was elite marketing. Many slaves fought for Britain because Britain promised freedom. Let that sink in. 🐉",
      impactLevel: 4
    ),
    ...
    HistoryTopic(
      ...
      region: .americas,
      commonLie:
        "The 1692 Salem Witch Trials involved burning witches at the stake amid mass supernatural hysteria. Thousands were executed as Puritans went mad with fear of the devil.",
      thetruth: """
        Key corrections:
      ...
      furtherReading: [
        HistoryResource(
          title: "A Delusion of Satan", author: "Frances Hill", type: .book, url: nil),
        HistoryResource(
          title: "In the Devil's Snare", author: "Mary Beth Norton", type: .book, url: nil),
        HistoryResource(
          title: "Salem witch trials", author: nil, type: .wikipedia,
          url: "https://en.wikipedia.org/wiki/Salem_witch_trials"),
      ],
      dragonComment:
        "No one was burned. The witch burning you picture never happened in Salem. But property was seized and rivals eliminated. The real magic was turning grudges into executions. 🐉",
      impactLevel: 3
    ),
    ...
    HistoryTopic(
      ...
      region: .europe,
      commonLie:
        "Napoleon was comically short (5'2\" or less)—a tiny man with a 'Napoleon complex' compensating for his height with power-mad conquest.",
      thetruth: """
      ...
      furtherReading: [
        ...
        HistoryResource(
          title: "Height of Napoleon", author: nil, type: .wikipedia,
          url: "https://en.wikipedia.org/wiki/Napoleon#Height"),
      ],
      dragonComment:
        "5'7\" was average. The 'short tyrant' thing was British propaganda that outlived the British Empire. Enemy memes age into common knowledge. 🐉",
      impactLevel: 2
    ),
    ...
    HistoryTopic(
      ...
      region: .africa,
      commonLie:
        "Africa was a continent of isolated primitive tribes without empires, writing, or advancements until Europeans 'civilized' it. It had no significant history worth studying.",
      thetruth: """
        ...
        """,
      awakeningAngle:
        "This myth justified colonialism and continues to shape aid narratives, investment decisions, and geopolitical dismissal. 'Africa needs our help' assumes a baseline of incompetence that history disproves. Understanding African innovation fosters genuine partnership over patronizing 'development.'",
      keyFacts: [
      ...
      furtherReading: [
        HistoryResource(
          title: "The Fortunes of Africa", author: "Martin Meredith", type: .book, url: nil),
        HistoryResource(
          title: "How Europe Underdeveloped Africa", author: "Walter Rodney", type: .book, url: nil),
        HistoryResource(
          title: "Mansa Musa", author: nil, type: .wikipedia,
          url: "https://en.wikipedia.org/wiki/Mansa_Musa"),
      ],
      dragonComment:
        "The richest person in history was African. Timbuktu was a university city while Europe was in the 'Dark Ages.' The 'primitive continent' narrative was the primitive thinking. 🐉",
      impactLevel: 5
    ),
    ...
    HistoryTopic(
      ...
      region: .europe,
      commonLie:
        "Albert Einstein was a poor student who flunked math, proving that genius blooms late and academic failure doesn't matter. He only became brilliant later in life.",
      thetruth: """
        ...
        """,
      awakeningAngle:
        "This myth gets weaponized two ways: 1) Discouraging early effort ('Einstein failed, so I don't need to try'), and 2) Dismissing expertise ('Experts said Einstein was dumb!'). Understanding the grading system mix-up helps us question 'inspirational' stories that seem too convenient.",
      keyFacts: [
      ...
      furtherReading: [
        HistoryResource(
          title: "Einstein: His Life and Universe", author: "Walter Isaacson", type: .book, url: nil
        ),
        HistoryResource(
          title: "Einstein's education", author: nil, type: .wikipedia,
          url: "https://en.wikipedia.org/wiki/Albert_Einstein#Early_life_and_education"),
      ],
      dragonComment:
        "He got the highest possible grade. Someone misread the Swiss grading system, and now generations think failure leads to genius. It doesn't. He was brilliant the whole time. 🐉",
      impactLevel: 2
    ),
    ...
    HistoryTopic(
      ...
      region: .global,
      commonLie:
        "After Rome fell (476 CE), Europe entered 500-1000 years of darkness, ignorance, and barbarism. Nothing was invented, everyone was stupid, and the Church suppressed all knowledge until the Renaissance.",
      thetruth: """
      ...
      furtherReading: [
        ...
        HistoryResource(
          title: "Aristotle's Children", author: "Richard Rubenstein", type: .book, url: nil),
        HistoryResource(
          title: "Islamic Golden Age", author: nil, type: .wikipedia,
          url: "https://en.wikipedia.org/wiki/Islamic_Golden_Age"),
      ],
      dragonComment:
        "While Europe was 'dark,' Baghdad had universities and libraries. The knowledge didn't disappear—it moved East. Then Islamic scholars brought it back. 'Western civilization' was an import. 🐉",
      impactLevel: 4
    ),
  ]
}
...
struct HistoryTopicDetailView: View {
  ...
  private func sectionCard(
    title: String, icon: String, color: Color, content: String, isItalic: Bool
  ) -> some View {
    VStack(alignment: .leading, spacing: 8) {
      HStack {
