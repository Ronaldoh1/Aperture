...
struct KingdomWithinView: View {
    ...
    private func revelationCard(_ content: String, color: Color) -> some View {
        VStack(spacing: 12) {
            HStack {
    ...
    private func animateContent() {
        ...
        case 0:
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + Double(The33Connection.parallels.count) * 0.2 + 0.3) {
                withAnimation {
