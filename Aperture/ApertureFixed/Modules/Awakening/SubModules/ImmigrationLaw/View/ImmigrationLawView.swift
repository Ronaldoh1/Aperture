...
struct ImmigrationLawView: View {
    ...
    private var disclaimerBanner: some View {
        ...
        HStack(alignment: .top, spacing: 10) {
            ...
            Text("This is educational information, NOT legal advice. Immigration law changes frequently. Always consult a qualified immigration attorney for your specific situation.")
        ...
        return Button(action: { selectedModule = module }) {
            ...
            .background(
                RoundedRectangle(cornerRadius: 14)
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: 14)
                            .stroke(isCompleted ? ImmigrationLawCourse.color.opacity(0.3) : Color.clear, lineWidth: 1)
                    )
            )
