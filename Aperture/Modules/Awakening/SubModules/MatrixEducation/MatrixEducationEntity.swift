...
""",
            mechanisms: [
                MatrixLayer.Mechanism(
                    ...
                    howItWorks: "Rewards familiarity, punishes deviation with anxiety. Makes the unfamiliar feel dangerous even when it's just different."
                ),
                MatrixLayer.Mechanism(
                    name: "Attachment & Belonging",
                    description: "Ostracism activates same circuits as physical pain",
                    howItWorks: "Humans will betray truth to avoid exile. This makes conformity feel moral and necessary for survival."
                ),
                MatrixLayer.Mechanism(
                    name: "Trauma Imprinting",
                    description: "Early shocks become permanent filters",
                    howItWorks: "The system doesn't need to oppress you later if your nervous system already does it automatically."
                )
            ],
            realWorldExamples: [
...
""",
            mechanisms: [
                MatrixLayer.Mechanism(
                    ...
                    howItWorks: "Children absorb worldviews wholesale. By the time you can question, the beliefs feel like 'you' rather than 'programs.'"
                ),
                MatrixLayer.Mechanism(
                    name: "Love-Wrapped Authority",
                    description: "Truth claims bundled with emotional bonds",
                    howItWorks: "Rejecting a belief feels like rejecting the person who gave it. Loyalty and truth become confused."
                ),
                MatrixLayer.Mechanism(
                    name: "Shame Script Installation",
                    description: "Guilt as internal control mechanism",
                    howItWorks: "You learn to feel bad about certain thoughts, desires, or questions. Self-policing begins here."
                )
            ],
            realWorldExamples: [
...
""",
            mechanisms: [
                MatrixLayer.Mechanism(
                    ...
                    howItWorks: "Limited vocabulary = limited perception. The words available shape what thoughts are even possible."
                ),
                MatrixLayer.Mechanism(
                    name: "Label Collapse",
                    description: "Complex phenomena reduced to simple tags",
                    howItWorks: "Once labeled, inquiry stops. 'That's just a conspiracy theory' ends investigation before it begins."
                ),
                MatrixLayer.Mechanism(
                    name: "Definition Control",
                    description: "Who defines terms wins debates",
                    howItWorks: "If I define 'terrorism' or 'freedom' or 'success,' I control what qualifies and what doesn't."
                )
            ],
            realWorldExamples: [
...
""",
            mechanisms: [
                MatrixLayer.Mechanism(
                    ...
                    howItWorks: "Grades reward conformity. The 'best' students are often the most obedient, not the most curious."
                ),
                MatrixLayer.Mechanism(
                    name: "Permission-Seeking Installation",
                    description: "You learn to wait for authority to validate",
                    howItWorks: "Raise your hand. Ask permission. Wait to be called on. Don't act until approved."
                ),
                MatrixLayer.Mechanism(
                    name: "Failure Punishment",
                    description: "Mistakes are shameful, not educational",
                    howItWorks: "Fear of wrong answers kills experimentation. You learn to play it safe, not play."
                )
            ],
            realWorldExamples: [
...
""",
            mechanisms: [
                MatrixLayer.Mechanism(
                    ...
                    howItWorks: "Rest feels like laziness. Your identity becomes your job title. Without work, you feel worthless."
                ),
                MatrixLayer.Mechanism(
                    name: "Engineered Scarcity",
                    description: "Artificial limits create control",
                    howItWorks: "There's 'not enough' jobs, money, housing—but is that natural or designed? Scarcity makes you compete instead of cooperate."
                ),
                MatrixLayer.Mechanism(
                    name: "Debt Normalization",
                    description: "Owing money is just 'how things work'",
                    howItWorks: "Student loans, mortgages, credit cards—you start life in debt and work to escape a hole you didn't dig."
                )
            ],
            realWorldExamples: [
...
""",
            mechanisms: [
                MatrixLayer.Mechanism(
                    ...
                    howItWorks: "Familiar claims feel true. If you've heard it a hundred times, it must be right—right?"
                ),
                MatrixLayer.Mechanism(
                    name: "Outrage Monetization",
                    description: "Anger gets clicks, clicks get money",
                    howItWorks: "Media profits from division. Nuance doesn't trend. You're kept angry, not informed."
                ),
                MatrixLayer.Mechanism(
                    name: "Hero/Villain Reduction",
                    description: "Complex systems become simple stories",
                    howItWorks: "Systemic issues are blamed on individuals. Fixing the villain feels easier than fixing the system."
                )
            ],
            realWorldExamples: [
...
""",
            mechanisms: [
                MatrixLayer.Mechanism(
                    ...
                    howItWorks: "Changing your mind means changing your identity. The psychological cost is too high, so people double down."
                ),
                MatrixLayer.Mechanism(
                    name: "Tribal Proxy Thinking",
                    description: "Let the group think for you",
                    howItWorks: "Instead of evaluating ideas, check if your tribe approves. Saves cognitive effort, costs independent thought."
                ),
                MatrixLayer.Mechanism(
                    name: "Criticism-as-Attack",
                    description: "Disagreement triggers defense response",
                    howItWorks: "When identity and belief are fused, questioning ideas feels like questioning existence."
                )
            ],
            realWorldExamples: [
...
""",
            mechanisms: [
                MatrixLayer.Mechanism(
                    ...
                    howItWorks: "Algorithms reward engagement, not truth. Polarization and outrage perform better than nuance."
                ),
                MatrixLayer.Mechanism(
                    name: "Dopamine Hijacking",
                    description: "Validation becomes currency",
                    howItWorks: "Likes, shares, comments trigger dopamine. You become addicted to external validation."
                ),
                MatrixLayer.Mechanism(
                    name: "Surveillance Normalization",
                    description: "Knowing you might be watched changes behavior",
                    howItWorks: "You don't need actual surveillance—just the possibility. Self-censorship becomes automatic."
                )
            ],
            realWorldExamples: [
...
""",
            mechanisms: [
                ...
                MatrixLayer.Mechanism(
                    ...
                    howItWorks: "Hierarchy becomes sacred. Inequality is divine order, not human construction."
                ),
                MatrixLayer.Mechanism(
                    name: "Apocalypse Deferral",
                    description: "Justice comes later, so accept injustice now",
                    howItWorks: "Heaven, karma, the revolution—justice is always coming 'soon' so it never has to be enacted today."
                )
            ],
            realWorldExamples: [
...
""",
            mechanisms: [
                MatrixLayer.Mechanism(
                    ...
                    howItWorks: "Your first instinct is to assume you're wrong. 'Maybe I'm just being crazy' protects the system."
                ),
                MatrixLayer.Mechanism(
                    name: "Preemptive Compliance",
                    description: "Silence yourself before anyone makes you",
                    howItWorks: "You don't say the thing, apply for the job, or challenge the norm—just in case. Fear of hypothetical consequences."
                ),
                MatrixLayer.Mechanism(
                    name: "Identity Policing",
                    description: "You enforce the system on others",
                    howItWorks: "You correct others. You mock questioners. You become an unpaid enforcement node for the Matrix."
                )
            ],
            realWorldExamples: [
