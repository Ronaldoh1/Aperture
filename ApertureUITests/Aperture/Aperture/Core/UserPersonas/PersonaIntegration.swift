...
class PersonaManager: ObservableObject {
  ...
  init() {
    userName = UserDefaults.standard.string(forKey: "aperture_user_name") ?? ""
    hasSelectedPersona = UserDefaults.standard.bool(forKey: "has_selected_persona")
    loadPersona()
  }
