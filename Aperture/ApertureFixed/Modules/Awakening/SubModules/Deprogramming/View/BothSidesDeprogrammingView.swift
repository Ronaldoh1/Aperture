...
struct BothSidesDeprogrammingView: View {
    ...
    private var validationContent: some View {
        VStack(spacing: 24) {
            ...
            let receipts = otherSide == .democrat ? BothSidesData.democratReceipts : BothSidesData.republicanReceipts
        ...
        .onAppear {
            animateReceipts(selectedSide?.otherSide == .democrat ? BothSidesData.democratReceipts : BothSidesData.republicanReceipts)
        }
    }
    ...
    private var expansionContent: some View {
        VStack(spacing: 24) {
            ...
            let receipts = yourSide == .democrat ? BothSidesData.democratReceipts : BothSidesData.republicanReceipts
        ...
        .onAppear {
            ...
            let yourSide = selectedSide ?? .democrat
            animateReceipts(yourSide == .democrat ? BothSidesData.democratReceipts : BothSidesData.republicanReceipts)
        }
    }
    ...
    private var invitationContent: some View {
        VStack(spacing: 32) {
            ...
            VStack(spacing: 12) {
                ...
                invitationLine("LEFT bailed out banks. RIGHT bailed out corporations.", "SAME taxpayers paid.")
                invitationLine("LEFT expanded surveillance. RIGHT expanded surveillance.", "SAME citizens watched.")
            }
    ...
    private func animateMachineReceipts() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + Double(BothSidesData.machineReceipts.count) * 0.3 + 0.5) {
            withAnimation { showNextButton = true }
        }
    }
    ...
    private func animateBeneficiaries() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + Double(BothSidesData.beneficiaries.count) * 0.25 + 0.5) {
            withAnimation { showNextButton = true }
        }
    }
    ...
    private func animateCommonGround() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + Double(BothSidesData.commonGround.count) * 0.35 + 0.5) {
            withAnimation { showNextButton = true }
        }
    }
}
