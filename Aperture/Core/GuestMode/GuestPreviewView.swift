    ...
    private var welcomeTab: some View {
        ScrollView(showsIndicators: false) {
            VStack(spacing: 30) {
                ...
                // Description
                Text("Explore sample content from our library of suppressed texts, hidden history, and universal awakening paths.")
                    .font(.system(size: 15))
                ...
                // Features
                VStack(spacing: 16) {
                    featureRow(icon: "globe.americas.fill", title: "Cosmos", description: "Gnostic cosmology & hidden realms", color: .cyan)
                    featureRow(icon: "books.vertical.fill", title: "Alexandria", description: "Suppressed texts & lost gospels", color: .green)
                    featureRow(icon: "sun.max.fill", title: "Awakening", description: "25+ spiritual traditions unified", color: .orange)
                }
    ...
    private var cosmosPreviewTab: some View {
        ScrollView(showsIndicators: false) {
            VStack(spacing: 20) {
                ...
                Text("Explore the hidden realms of existence as described in ancient Gnostic texts. The truth about reality is stranger than you've been told.")
                    .font(.system(size: 14))
                    .foregroundColor(.white.opacity(0.7))
                    .multilineTextAlignment(.center)
                    .padding(.horizontal, 20)
    ...
    private var alexandriaPreviewTab: some View {
        ScrollView(showsIndicators: false) {
            VStack(spacing: 20) {
                ...
                Text("Access texts that were hidden, burned, or declared heretical. The Nag Hammadi library, Dead Sea Scrolls, and more.")
                    .font(.system(size: 14))
                    .foregroundColor(.white.opacity(0.7))
                    .multilineTextAlignment(.center)
                    .padding(.horizontal, 20)
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                Text("You've explored the samples. Create a free account to access the full library of 25+ awakening traditions, suppressed texts, and guided practices.")
                    .font(.system(size: 15))
                    .foregroundColor(.white.opacity(0.7))
                    .multilineTextAlignment(.center)
                    .padding(.horizontal, 30)
