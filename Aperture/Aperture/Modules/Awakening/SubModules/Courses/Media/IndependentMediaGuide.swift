...
struct IndependentMediaGuide: View {
  ...
  private var whyItMatters: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      Text(
        "Independent journalists aren't beholden to corporate advertisers or billionaire owners. They can cover stories the mainstream won't touch, challenge power without fear of losing their jobs, and represent perspectives excluded from corporate media."
      )
      .font(.system(size: 13))
  ...
  private var allIndieMedia: [IndieMediaOutlet] {
    [
      ...
      IndieMediaOutlet(
        ...
        description:
          "Pulitzer Prize-winning investigative journalism. Exposed Trump's tax returns, Supreme Court ethics scandals, PPP loan fraud. Free to read, funded by donations.",
      ...
      IndieMediaOutlet(
        ...
        category: .investigative,
        description:
          "Founded on Snowden documents. Covers national security, civil liberties, criminal justice. Strong investigative work with progressive perspective.",
      ...
      IndieMediaOutlet(
        ...
        category: .investigative,
        description:
          "Center for Investigative Reporting. Award-winning podcast and investigations into corporate abuse, government failures, systemic injustice.",
      ...
      IndieMediaOutlet(
        ...
        description:
          "Former Rolling Stone journalist. Covers media criticism, Wall Street, and government overreach. Sometimes controversial but does original reporting.",
      ...
      IndieMediaOutlet(
        ...
        category: .journalists,
        description:
          "Accountability journalism focused on corporate political donations and hypocrisy. Broke stories on companies backing insurrectionists.",
      ...
      IndieMediaOutlet(
        ...
        category: .journalists,
        description:
          "Boston College historian providing daily context on American politics and history. 'Letters from an American' has huge following.",
      ...
      IndieMediaOutlet(
        ...
        category: .journalists,
        description:
          "Australian independent journalist covering anti-war, anti-imperialist perspectives. Critical of US foreign policy from the left.",
      ...
      IndieMediaOutlet(
        ...
        category: .video,
        description:
          "Krystal Ball (left) and Saagar Enjeti (right) provide cross-partisan analysis. Left populist + right populist perspectives together.",
      ...
      IndieMediaOutlet(
        ...
        category: .video,
        description:
          "Daily independent news program since 1996. Amy Goodman. Covers movements, war, climate, labor—stories corporate media ignores.",
      ...
      IndieMediaOutlet(
        ...
        category: .video,
        description:
          "Sam Seder's daily political show. Progressive analysis with humor. Emma Vigeland. Covers politics, labor, media.",
      ...
      IndieMediaOutlet(
        ...
        category: .video,
        description:
          "JT Chapman explains socialist and anti-capitalist perspectives with high production value. Educational content on political economy.",
      ...
      IndieMediaOutlet(
        ...
        category: .video,
        description:
          "Cody Johnston's satirical but well-researched deep dives on political and media issues. Long-form, heavily sourced, funny.",
      ...
      IndieMediaOutlet(
        ...
        category: .nonprofit,
        description:
          "Nonpartisan Texas news. Free to read. Excellent state politics, policy, and data journalism. Model for nonprofit local news.",
      ...
      IndieMediaOutlet(
        ...
        category: .nonprofit,
        description:
          "Criminal justice journalism. Covers prisons, policing, courts, incarceration. Essential for understanding mass incarceration.",
      ...
      IndieMediaOutlet(
        ...
        category: .nonprofit,
        description:
          "Nonprofit investigative journalism with progressive perspective. Broke story on Romney's '47%' video. Strong investigative work.",
      ...
      IndieMediaOutlet(
        ...
        category: .nonprofit,
        description:
          "Nathan Robinson's socialist magazine. Long-form analysis, cultural criticism, and political commentary from the left.",
      ...
      IndieMediaOutlet(
        ...
        category: .podcasts,
        description:
          "Media criticism podcast examining media narratives and propaganda. Adam Johnson and Nima Shirazi. Excellent media literacy resource.",
      ...
      IndieMediaOutlet(
        ...
        category: .podcasts,
        description:
          "WNYC's media criticism show. Brooke Gladstone. Examines how media shapes stories. Essential for media literacy.",
      ...
      IndieMediaOutlet(
        ...
        category: .podcasts,
        description:
          "Jack O'Brien and Miles Gray break down daily news with humor. Left-leaning but accessible and entertaining.",
      ...
      IndieMediaOutlet(
        ...
        category: .podcasts,
        description:
          "Robert Evans profiles history's worst people. Well-researched, darkly funny. Covers authoritarians, grifters, and terrible people.",
      ...
      IndieMediaOutlet(
        ...
        description:
          "British paper with strong US coverage. Free to read (reader-supported). Good investigative work, international perspective.",
      ...
      IndieMediaOutlet(
        ...
        category: .international,
        description:
          "Qatar-funded but provides perspective on Middle East that US media lacks. Bias on Gulf issues, otherwise strong journalism.",
      ...
      IndieMediaOutlet(
        ...
        category: .international,
        description:
          "Academics writing for general audience. Experts explaining their research areas. High quality, well-sourced, educational.",
