      ...
      VStack(spacing: 24) {
        ...
        VStack(alignment: .leading, spacing: 16) {
          ...
          ForEach(AwakeningExercise.freeExercises) { exercise in
            AwakeningExerciseCard(
              exercise: exercise, isCompleted: completedExercises.contains(exercise.id))
          }
        }
        ...
        VStack(alignment: .leading, spacing: 16) {
          ...
          ForEach(AwakeningExercise.premiumExercises) { exercise in
            AwakeningExerciseCard(
              exercise: exercise, isCompleted: completedExercises.contains(exercise.id),
              isPremium: true, isLocked: !isPremium)
          }
        }
    ...
    ScrollView {
      VStack(spacing: 24) {
        ...
        NavigationLink(destination: AwakeningBiasCheckerView()) {
          ToolCard(
            icon: "🎯", title: "Bias Checker", desc: "Identify cognitive biases in your thinking")
        }
...
struct AwakeningExercise: Identifiable {
  ...
  static let freeExercises: [AwakeningExercise] = [
    AwakeningExercise(
      ...
      description:
        "Log a decision, identify potential fallacies. Ask: 'What data contradicts this?'",
      instructions: [
        "Write down a recent decision", "Identify 3 possible biases", "Find counter-evidence",
      ],
    ...
    AwakeningExercise(
      ...
      description:
        "Visualize brain regions, note emotions and link to functions (amygdala = fear).",
      instructions: [
        "Note your current emotion", "Identify the brain region",
        "Understand the evolutionary purpose",
      ],
    ...
    AwakeningExercise(
      ...
      instructions: [
        "State a belief as hypothesis", "Define testable predictions", "Log evidence for 7 days",
      ],
    ...
    AwakeningExercise(
      ...
      instructions: [
        "Identify a strong urge", "Research ancestral environment", "Understand adaptive value",
      ],
    ...
    AwakeningExercise(
      ...
      instructions: [
        "Set 10-minute timer", "Note each thought", "Label: logical, emotional, random",
      ],
    ...
    AwakeningExercise(
      ...
      instructions: [
        "Name a perceived flaw", "Find evolutionary advantage", "Identify contexts where it helps",
      ],
    ...
    AwakeningExercise(
      ...
      description:
        "Question one assumption; research quick fact-check. Fosters habitual rationality.",
  ...
  static let premiumExercises: [AwakeningExercise] = [
    AwakeningExercise(
      ...
      instructions: [
        "Describe your decision", "AI identifies bias patterns", "Review personalized strategies",
      ],
    ...
    AwakeningExercise(
      ...
      instructions: [
        "Record dream immediately", "AI analyzes patterns", "Connect to waking concerns",
      ],
    ...
    AwakeningExercise(
      ...
      description:
        "AR overlays probability waves on decisions; AI explains entanglement metaphors.",
      instructions: [
        "Visualize decision branches", "Understand superposition", "Collapse to choice",
      ],
    ...
    AwakeningExercise(
      ...
      instructions: [
        "Connect wearable", "Enter guided solitude", "Review stress-insight correlation",
      ],
...
struct RationalConcept: Identifiable {
  ...
  static let allConcepts: [RationalConcept] = [
    RationalConcept(
      ...
      explanation:
        "Bayesian reasoning is a method of statistical inference that updates the probability of a hypothesis as more evidence becomes available. Instead of binary true/false thinking, you hold beliefs with degrees of confidence and update them rationally when new data arrives.",
      keyPoints: [
    ...
    RationalConcept(
      ...
      explanation:
        "Cognitive biases are systematic patterns of deviation from rationality in judgment. They're not flaws but evolved mental shortcuts (heuristics) that were useful in ancestral environments but can mislead in modern contexts.",
      keyPoints: [
    ...
    RationalConcept(
      ...
      explanation:
        "The brain operates with two systems: System 1 (fast, automatic, emotional) and System 2 (slow, deliberate, logical). Most awakening is about strengthening System 2's oversight of System 1's impulses.",
      keyPoints: [
    ...
    RationalConcept(
      ...
      explanation:
        "The systematic pursuit of knowledge through observation, hypothesis formation, experimentation, and revision. Applied to personal growth, it means treating your beliefs as hypotheses to be tested, not truths to be defended.",
      keyPoints: [
    ...
    RationalConcept(
      ...
      explanation:
        "Understanding human behavior through the lens of natural selection. Our brains evolved for survival in ancestral environments, not for happiness or truth-seeking in modern ones. This mismatch explains many of our irrational tendencies.",
      keyPoints: [
