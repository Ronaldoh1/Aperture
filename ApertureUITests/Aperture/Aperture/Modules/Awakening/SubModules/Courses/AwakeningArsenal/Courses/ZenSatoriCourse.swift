  ...
  private var lessons: [ZenLesson] {
    [
      ZenLesson(
        ...
        practiceSteps: [],
        keyTakeaway:
          "Zen is direct seeing of your true nature—not through concepts but immediate recognition. You already have Buddha-nature; practice is simply seeing what's always been here."
      ),
      ...
      ZenLesson(
        ...
        keyTakeaway:
          "Zazen is the foundation: just sit, spine straight, eyes open, face wall. Not trying to achieve anything. Not stopping thoughts. Just sitting. The practice itself IS enlightenment."
      ),
      ...
      ZenLesson(
        ...
        keyTakeaway:
          "Koans break through conceptual mind through paradox. Don't analyze—become the koan. Mu is the classic first koan: carry it constantly until there's no you and no Mu, just this."
      ),
      ...
      ZenLesson(
        ...
        keyTakeaway:
          "Zen extends beyond the cushion. Every activity—eating, walking, working—is practice. Complete attention to ordinary acts IS enlightenment. When eating, just eat. When walking, just walk."
      ),
      ...
      ZenLesson(
        ...
        practiceSteps: [],
        keyTakeaway:
          "Sesshin is intensive retreat (3-7 days) with 8-10 hours of zazen daily in noble silence. The pressure of sustained practice can catalyze breakthrough. Start with shorter retreats after establishing daily practice."
      ),
      ...
      ZenLesson(
        ...
        keyTakeaway:
          "The Four Great Vows orient practice toward the benefit of all beings. They're impossible to complete—that's the point. The commitment to endless practice for all beings is the Bodhisattva path. Direction, not destination."
      ),
      ...
      ZenLesson(
        ...
        practiceSteps: [],
        keyTakeaway:
          "The Sixteen Bodhisattva Precepts aren't rules but descriptions of awakened living. They include taking refuge in Three Treasures, three pure precepts, and ten grave precepts. Study and apply them; notice where resistance arises."
      ),
      ...
      ZenLesson(
        ...
        practiceSteps: [],
        keyTakeaway:
          "Three essentials for Zen awakening: Great Doubt (not-knowing), Great Faith (trust in practice and Buddha-nature), Great Determination (perseverance). All three together create conditions for breakthrough."
      ),
      ...
      ZenLesson(
        ...
        practiceSteps: [],
        keyTakeaway:
          "Soto emphasizes shikantaza (just sitting)—practice IS enlightenment. Rinzai emphasizes koans and sudden breakthrough. Both are valid; most modern practice incorporates elements of both. Choose based on resonance."
      ),
      ...
      ZenLesson(
        ...
        practiceSteps: [],
        keyTakeaway:
          "A teacher is essential in Zen for transmission, correction, and confirmation. Look for authentic lineage, healthy students, ethical conduct. The teacher points to your own Buddha-nature—eventually, the outer teacher awakens the inner teacher."
      ),
    ]
  }
}
