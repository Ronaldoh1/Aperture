...
struct AuthenticationView: View {
  ...
  private var showAppleSignIn: Bool {
    false
  }
      ...
      VStack(spacing: 40) {
        ...
        ZStack {
          ...
          Circle()
            ...
            .animation(
              .easeOut(duration: 1.5).repeatForever(autoreverses: false), value: isAnimating)
...
struct BiometricEnablePrompt: View {
  ...
  var body: some View {
    VStack(spacing: 24) {
      ...
      // Description
      Text(
        "Use \(authManager.biometricType.displayName) for quick and secure access to Aperture next time."
      )
