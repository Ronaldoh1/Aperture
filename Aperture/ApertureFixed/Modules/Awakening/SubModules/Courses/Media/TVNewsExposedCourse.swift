...
struct TVNewsExposedCourse: View {
    ...
    private var keyInsightCard: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("TV news exists to sell advertising, not to inform you. Your attention is the product. Outrage keeps you watching. Fear keeps you tuned in. Truth is secondary to engagement.")
                .font(.system(size: 13))
                .foregroundColor(.white.opacity(0.9))
            
            Text("Fox News has successfully argued in court that its opinion hosts are 'entertainment' and no 'reasonable viewer' would take them as fact.")
                .font(.system(size: 12, weight: .medium))
        ...
        [
            TVNewsLesson(
                ...
                **You are the product being sold.**
                """,
                keyTakeaway: "TV news sells your attention to advertisers. Outrage drives engagement. You are the product, not the customer. The business model requires keeping you emotional, not informed."
            ),
            TVNewsLesson(
                ...
                **What Fox Actually Is:**
                ...
                """,
                keyTakeaway: "Fox's own lawyers argued no reasonable viewer should believe their hosts. They paid $787.5 million for knowingly airing election lies. Internal texts prove they knew the truth and lied anyway."
            ),
            TVNewsLesson(
                ...
                **The Problem:**
                ...
                """,
                keyTakeaway: "MSNBC uses Fox's business model for liberals—outrage drives ratings. Owned by Comcast, it has establishment/corporate bias. Being better than Fox is a very low bar."
            ),
            TVNewsLesson(
                ...
                **The Core Problem:**
                ...
                """,
                keyTakeaway: "CNN pioneered 24-hour news, then lost its identity chasing ratings. False 'both sides' balance treats lies as equal to truth. Now owned by cost-cutting conglomerate, trusted by neither side."
            ),
            TVNewsLesson(
                ...
                **What You Can Do:**
                ...
                """,
                keyTakeaway: "Sinclair owns 185+ local TV stations, requires right-wing 'must-run' segments. 2,500 newspapers have closed. 70 million Americans live in news deserts. Local journalism's death enables corruption."
            ),
            TVNewsLesson(
                ...
                **The news is the content between advertisements.**
                """,
                keyTakeaway: "TV news uses deliberate psychological manipulation: false urgency, outrage cycles, tribal identity, fear appeals, and perpetual crisis framing. You're being manipulated to stay watching, not to be informed."
            ),
            TVNewsLesson(
                ...
                **TV news operates within narrow acceptable boundaries.**
                ...
                """,
                keyTakeaway: "TV news undercoverages labor, climate, corporate crime, and poverty while overcovering crime, political theater, and stock markets. Six companies control 90% of media. Coverage serves owner and advertiser interests."
            ),
            TVNewsLesson(
                ...
                **Financial penalty, no real accountability.**
                """,
                keyTakeaway: "Fox paid $787.5M after internal texts proved they knew election lies were false. Both Fox and MSNBC have used 'we're entertainment, not news' as legal defense. Financial penalties don't change the business model."
            ),
            TVNewsLesson(
                ...
                **Use TV news knowing what it is: a business selling your attention.**
                """,
                keyTakeaway: "Every TV network has corporate ownership and resulting conflicts. Fox is entertainment not news. MSNBC/CNN are better but still flawed. PBS is best of TV but still has limits. No single source is sufficient."
            ),
            TVNewsLesson(
                ...
                **An informed citizen is a dangerous citizen—to those who profit from ignorance.**
                """,
                keyTakeaway: "Watch TV news knowing it's a business selling your attention. Separate news from opinion. Notice framing and manipulation. Diversify sources. Limit intake. What they don't cover is as important as what they do."
            )
        ]
    }
}
