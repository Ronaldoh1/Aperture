    ...
    CryptoModule(
      ...
      lessons: [
        CryptoLesson(
          ...
          duration: 12,
          honestTake:
            "Blockchain is genuinely innovative technology. Most crypto projects abuse the term without delivering the benefits."
        ),
        CryptoLesson(
          id: "bitcoin-basics",
          ...
          duration: 13,
          honestTake:
            "Bitcoin's value is real but speculative. It's survived 14 years but still might fail. Position size should reflect uncertainty."
        ),
        CryptoLesson(
          id: "altcoins-reality",
          ...
          duration: 14,
          honestTake:
            "Most altcoin investors lose money. The few who get rich are either early insiders or extremely lucky. The house usually wins."
        ),
      ]
    ),
    ...
    CryptoModule(
      ...
      lessons: [
        CryptoLesson(
          ...
          duration: 11,
          honestTake:
            "If you're checking prices hourly or losing sleep, you own too much. Reduce position until you can ignore it for months."
        ),
        CryptoLesson(
          id: "security-risks",
          ...
          duration: 12,
          honestTake:
            "The freedom of self-custody comes with total responsibility. Most hacks are user error, not blockchain failures."
        ),
        CryptoLesson(
          id: "regulatory-risk",
          ...
          duration: 11,
          honestTake:
            "Regulatory risk is real and underappreciated. The rules could change dramatically in either direction."
        ),
      ]
    ),
    ...
    CryptoModule(
      ...
      lessons: [
        CryptoLesson(
          ...
          duration: 12,
          honestTake:
            "99% of people in crypto skip research and gamble based on hype. Be in the 1% who actually understand what they own."
        ),
        CryptoLesson(
          ...
          duration: 11,
          honestTake:
            "Most crypto fortunes exist only on paper because people never sell. Have a plan for taking profits."
        ),
        CryptoLesson(
          ...
          duration: 10,
          honestTake:
            "Every experienced crypto investor has made these mistakes. The difference is surviving them and learning."
        ),
      ]
    ),
    ...
    CryptoModule(
      ...
      lessons: [
        CryptoLesson(
          ...
          duration: 12,
          honestTake:
            "Blockchain solves specific problems. Most projects just use the buzzword without delivering the benefits."
        ),
        CryptoLesson(
          id: "final-thoughts",
          ...
          duration: 10,
          honestTake:
            "I've tried to give you an honest picture. What you do with it is your choice. Just don't bet more than you can afford to lose."
        ),
      ]
    ),
  ]
