...
struct CourseEntityQuery: EntityQuery {
    ...
    private func getCourses() -> [CourseEntity] {
        ...
        return [
            CourseEntity(id: "dragonball", name: "Dragon Ball Awakening", description: "DB consciousness teachings"),
            CourseEntity(id: "consciousness_phd", name: "PhD Consciousness", description: "The science of mind"),
            CourseEntity(id: "sacred_geometry", name: "Sacred Geometry", description: "The language of creation"),
            CourseEntity(id: "quantum", name: "Quantum Reality", description: "Physics that changed everything"),
            CourseEntity(id: "money-fundamentals", name: "Money Fundamentals", description: "Financial education"),
            CourseEntity(id: "anti-scam-awareness", name: "Don't Fall For The Vibes", description: "Protection from scams"),
            CourseEntity(id: "stock-market-fundamentals", name: "Stock Market Decoded", description: "Investing vs gambling"),
            CourseEntity(id: "crypto-fundamentals", name: "Crypto Without The Hype", description: "Understanding blockchain")
        ]
    }
}
...
@available(iOS 16.0, *)
struct ShowDragonIntent: AppIntent {
    
    static var title: LocalizedStringResource = "Show My Dragon"
    static var description = IntentDescription("View your dragon companion in Aperture")
    static var openAppWhenRun: Bool = true
    
    func perform() async throws -> some IntentResult {
        await MainActor.run {
            DeepLinkHandler.shared.navigate(to: .dragon)
        }
        return .result()
    }
}
...
struct GetProgressIntent: AppIntent {
    ...
    func perform() async throws -> some IntentResult & ReturnsValue<String> {
        ...
        let message = "You've completed \(completedCourses) courses and \(completedLessons) lessons in Aperture."
...
struct ApertureShortcuts: AppShortcutsProvider {
    ...
    static var appShortcuts: [AppShortcut] {
        ...
        AppShortcut(
            intent: ShowDragonIntent(),
            phrases: [
                "Show my dragon in \(.applicationName)",
                "Open dragon companion in \(.applicationName)",
                "Show my \(.applicationName) dragon"
            ],
            shortTitle: "Show Dragon",
