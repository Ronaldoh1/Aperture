...
struct GospelOfJudasCourse {
    static let course = AlexandriaCourse(
        ...
        modules: [
            ACModule(id: "gj1", number: 1, title: "2,000 Years of Lies About One Man", subtitle: "What the Gnostic text reveals", icon: "scroll.fill", lessons: [
                ACLesson(id: "gj1_1", title: "The Name Synonymous With Betrayal",
                    content: """
...
""",
                    keyInsight: "The Gospel of Judas presents the 'betrayal' as a sacred act requested by Jesus himself — making Judas the most enlightened disciple, not the greatest villain.",
                    practice: "Sit with this question: if the 'worst person in the Bible' was actually the most awake, what other inversions might be hiding in plain sight?"
                ),
                ACLesson(id: "gj1_2", title: "Why This Changes Everything",
                    content: """
...
""",
                    keyInsight: "If Judas was following Jesus's direct instructions, the entire framework of sin, guilt, betrayal, and the need for Church-mediated salvation collapses.",
                    practice: "Read the Gospel of Judas yourself (National Geographic translation, freely available). Note how different Jesus sounds compared to the canonical gospels.",
                    interactiveElement: .inversionTable(rows: [
                        (told: "Judas betrayed Jesus for 30 silver coins", truth: "Judas fulfilled Jesus's direct request to free his spirit"),
                        (told: "Judas was the worst disciple", truth: "Judas was the ONLY one who understood Jesus's true nature"),
                        (told: "The crucifixion was punishment for humanity's sins", truth: "The crucifixion was planned spiritual liberation from matter"),
                        (told: "Judas hanged himself in shame", truth: "Judas carried the heaviest burden — being misunderstood forever"),
                        (told: "This gospel is heresy", truth: "This gospel was suppressed because it removes the need for institutional mediation")
                    ])
                )
            ])
        ],
        ...
        dragonComment: "The 'worst person in the Bible' might have been the only one who actually understood the teacher. If that doesn't make you question EVERYTHING you were taught, nothing will. 🐉"
    )
}
