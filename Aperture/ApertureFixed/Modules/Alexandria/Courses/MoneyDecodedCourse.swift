...
""",
                        keyInsight: "Money is created by private banks as debt, not by the government from a vault. When a bank issues a loan, they create that money from nothing. All money enters circulation as debt, which means there is always more debt than money in the system. This is the foundation nobody teaches you.",
                        practice: "Look at your bank account. That number isn't 'your money sitting in a vault.' It's a digital entry in a database — a promise from a bank. What backs that promise?"
                    ),
                    ACLesson(
                        id: "md1_2",
...
""",
                        keyInsight: "Every major monetary shift in history transferred power from the people to institutions: from real coins to fractional reserves to central banking to fiat currency. Each step made it easier for those who control the money supply to extract wealth from those who don't.",
                        practice: "Open your Aperture Timeline. Find: Federal Reserve (1913), Gold Standard End (1971). Read the institutional control mechanisms. These aren't ancient history — they're the system you live in RIGHT NOW.",
                        interactiveElement: .timeline(events: [
                            (year: "1694", event: "Bank of England created", significance: "First central bank — private institution controls national money"),
                            (year: "1913", event: "Federal Reserve Act", significance: "Private central bank controls US money supply — not federal, no reserves"),
                            (year: "1933", event: "FDR confiscates gold", significance: "Americans forced to sell gold at $20.67 — revalued to $35. Instant 40% theft"),
                            (year: "1944", event: "Bretton Woods", significance: "Dollar becomes world reserve currency, backed by gold"),
                            (year: "1971", event: "Nixon ends gold standard", significance: "Dollar backed by nothing. Money becomes pure faith. Printing unlimited"),
                        ])
                    ),
                ]
            ),
...
""",
                        keyInsight: "Inflation is wealth transfer, not a natural force. The Cantillon Effect means new money reaches banks and corporations first (who buy assets), then trickles to workers (who pay higher prices). Since 1971: CEO pay up 1,460%, worker pay up 18%. That gap IS the mechanism.",
                        practice: "Calculate your REAL wage: take your salary, subtract the actual cost increases in your rent/mortgage, food, insurance, and transportation. Are you actually making more — or less?",
...
""",
                        keyInsight: "The debt system is architecturally designed to require debt for basic needs (education, housing, transport, health), make it easy to access and hard to escape, then extract interest for decades. $17+ trillion in US consumer debt isn't individual failure — it's systemic design.",
                        practice: "List every debt you have. For each one, calculate the TOTAL cost including interest. How much of your lifetime labor is going to interest payments? This number is the price of not understanding the system."
                    ),
                ]
            ),
...
""",
                        keyInsight: "Paper assets (cash, stocks, bonds, 401k) are promises that work until they don't. Real assets (precious metals, owned land, skills, tools, community) have survived every monetary reset in history. Diversification isn't about getting rich — it's about not having a single point of failure.",
                        practice: "Honestly assess: what percentage of your wealth is paper (bank accounts, retirement, stocks) vs. real (owned property, metals, skills, tools)? You don't need to change anything yet — just KNOW where you stand.",
                        interactiveElement: .comparison(
                            ...
                            rows: [
                                ...
                                (leftVal: "Stocks — can lose 89% (1929)", rightVal: "Land — produces regardless of markets"),
                                (leftVal: "Bonds — dependent on issuer paying", rightVal: "Skills — no one can confiscate these"),
                                (leftVal: "401k — locked until 59½", rightVal: "Tools — produce value immediately"),
                                (leftVal: "Crypto — volatile, hackable", rightVal: "Community — oldest wealth on Earth"),
                            ]
                        )
                    ),
                    ACLesson(
...
""",
                        keyInsight: "Financial sovereignty is a progression, not a destination. Start with awareness (know your numbers), move to defense (emergency fund, kill high-interest debt), then positioning (real assets, skills, community), then sovereignty (multiple income streams, production capacity). Don't act from fear — act from knowledge.",
                        practice: "Pick ONE action from Level 1 and do it TODAY. Just one. Know your exact monthly expenses. Or calculate your savings rate. Or look at your credit report. The first step is always awareness."
                    ),
                ]
            ),
...
""",
                        keyInsight: "Three firms (BlackRock, Vanguard, State Street) manage $20+ trillion and are the largest shareholders in nearly every major corporation. The revolving door between government and industry means the regulators ARE the industry. Following the money reveals the pattern behind every policy decision.",
                        practice: "Pick any recent legislation that confused you. Search: 'Who lobbied for [bill name]' at OpenSecrets.org. The donor list will explain the vote better than any news analysis."
                    ),
                    ACLesson(
                        id: "md4_2",
...
""",
                        keyInsight: "Central banks are saying 'everything is fine' while buying gold at record rates, repatriating reserves, and building dollar alternatives. When words and actions contradict, always trust the actions. The institutions that print money are hedging against the money they print.",
                        practice: "Search: 'World Gold Council central bank demand [current year]' and read the actual report. Then search 'Federal Reserve balance sheet.' Compare what they say in press conferences with what the numbers show.",
                        interactiveElement: .inversionTable(rows: [
                            ...
                            (told: "There's no need for concern", truth: "BRICS building dollar alternatives for 40%+ of world population"),
                        ])
                    ),
                ]
            ),
...
""",
        ...
        dragonComment: "They'll teach you the lifecycle of a frog before they teach you how money works. Because a frog that understands money asks questions. A frog that doesn't just keeps working."
    )
}
