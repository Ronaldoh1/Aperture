...
struct BadgeCollectionView: View {
  ...
  private var heroSection: some View {
    VStack(spacing: 16) {
      ...
      Text(
        "Earn sacred symbols as you explore consciousness, complete courses, and unlock hidden knowledge. Each badge represents a milestone in your awakening journey."
      )
      .font(.subheadline)
    ...
    VStack(spacing: 16) {
      HStack {
        VStack(alignment: .leading, spacing: 4) {
          ...
          Text(
            "\(manager.uniqueShapesEarned().count) of \(allPossibleBadges.count) Shapes Discovered"
          )
          .font(.headline)
          .foregroundColor(.white)
        }
      ...
      HStack(spacing: 20) {
        ...
        BadgeStatBox(
          title: "Unique Shapes", value: "\(manager.uniqueShapesEarned().count)", icon: "seal")
      ...
      VStack(spacing: 30) {
        ...
        TabView(selection: $currentPage) {
          OnboardingPage(
            ...
            description:
              "As you explore Aperture, you'll earn sacred geometric symbols. Each shape holds ancient wisdom and marks your progress on the path of awakening."
          )
          .tag(0)
          ...
          OnboardingPage(
            ...
            description:
              "Complete course lessons, explore modules, maintain streaks, and share with friends. Each action unlocks unique geometries from simple circles to complex sacred forms."
          )
          .tag(1)
          ...
          OnboardingPage(
            ...
            description:
              "Tap any badge to customize its colors, save it to your photos, or share it on social media. Your collection is yours to display proudly."
          )
          .tag(2)
        }
