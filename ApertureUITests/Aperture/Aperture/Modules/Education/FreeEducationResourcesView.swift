...
struct FreeEducationResourcesView: View {
  ...
  private var tipsSection: some View {
    VStack(alignment: .leading, spacing: 16) {
      ...
      Text(
        "A motivated self-learner can match any college graduate. The knowledge is free—only effort has a price."
      )
  ...
  private var allResources: [FreeResource] {
    [
      ...
      FreeResource(
        ...
        description:
          "2,500+ courses from one of the world's top universities. Complete lecture notes, assignments, exams.",
      ...
      FreeResource(
        ...
        description:
          "Free courses from Harvard professors. CS50 is legendary for computer science beginners.",
      ...
      FreeResource(
        ...
        provider: "Nonprofit",
        description:
          "The gold standard for free education. Math, science, history—K-12 through college.",
      ...
      FreeResource(
        ...
        description:
          "Audit courses free from top universities. Pay only for certificate if you want one.",
