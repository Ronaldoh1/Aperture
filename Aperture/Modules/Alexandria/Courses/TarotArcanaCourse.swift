...
import SwiftUI
struct TarotArcanaCourse {
    static let course = AlexandriaCourse(
        id: "tarot_arcana", title: "The Arcana Within", subtitle: "The Soul's Map They Called the Devil's Cards",
        icon: "suit.spade.fill", colorHex: "#8E44AD", tier: 3, isPremium: false, isUltraPremium: false,
        modules: [
            ACModule(id: "ta1", number: 1, title: "Not Fortune-Telling — Soul-Reading", subtitle: "The consciousness map hidden in 78 cards", icon: "rectangle.stack.fill", lessons: [
                ACLesson(id: "ta1_1", title: "Before Religion Feared It",
                    content: """
...
""",
                    keyInsight: "The Tarot is a 22-stage map of consciousness — from ignorance (The Fool) to integration (The World). It doesn't tell your future — it shows your present state of awakening.",
                    practice: "Look up the Major Arcana. Which card resonates with where you are RIGHT NOW in your life? That's your current lesson."
                )
            ])
        ],
        sources: ["Antoine Court de Gébelin — first to link Tarot to ancient Egyptian wisdom (1781)", "The Rider-Waite-Smith Tarot — symbolism analysis", "Alejandro Jodorowsky, \"The Way of Tarot\"", "Joseph Campbell — Hero's Journey parallels in Major Arcana", "Pre-Christian divination traditions across cultures"],
        dragonComment: "78 cards. 22 stages of the soul's journey. They made you think it was the devil's work so you'd never look at the map. The map of YOUR consciousness. 🐉"
    )
}
