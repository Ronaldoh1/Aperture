...
""",
                    revelation: "The Demiurge was born from a cosmic mistake. He doesn't know what he doesn't know."
                ),
...
""",
                    revelation: "The Archons are the prison guards. They don't want you to know you're already free."
                )
            ]
        ),
...
""",
                    revelation: "You have divine light within you that the Demiurge didn't create and can't control."
                ),
...
""",
                    revelation: "Gnosis is direct knowledge that liberates. You don't need saving—you need waking."
                ),
...
""",
                    revelation: "The prison has no lock—only the illusion of one. Gnosis reveals the door was always open."
                )
            ]
        ),
...
struct DemiurgeProgress: Codable {
    ...
    static var `default`: DemiurgeProgress { DemiurgeProgress(completedLessons: [], lastAccessed: nil) }
}
