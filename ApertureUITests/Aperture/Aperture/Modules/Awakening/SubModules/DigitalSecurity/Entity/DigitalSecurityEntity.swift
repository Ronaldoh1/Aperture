      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            description:
              "The behavioral data market generates over $200 billion annually. Your data is more valuable than oil.",
          ...
          SecurityFact(
            ...
            description:
              "Tech companies don't just know what you did - they predict what you'll do. And sell that prediction.",
            source: nil
          ),
          SecurityFact(
            icon: "person.3.fill",
            ...
            description:
              "Facebook builds profiles on people who don't even have accounts, using data from friends and websites.",
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            description:
              "Google collects your location approximately 14,000 times per day on Android.",
          ...
          SecurityFact(
            ...
            description:
              "Some keyboard apps send every keystroke to remote servers, including passwords.",
            source: nil
          ),
          SecurityFact(
            ...
            description:
              "Some apps use inaudible sounds from your TV to link your devices and track viewing habits.",
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          ...
          SecurityFact(
            ...
            description:
              "Websites can identify you by how your specific hardware renders graphics.",
            source: nil
          ),
          SecurityFact(
            ...
            description:
              "Your audio hardware processes sound uniquely, creating another tracking vector.",
            source: nil
          ),
        ],
        actionItems: [
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          ...
          SecurityFact(
            ...
            description:
              "Your pharmacy purchases, health searches, and fitness data are sold to insurers.",
            source: nil
          ),
        ],
        actionItems: [
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            description:
              "TikTok measures how long you look at each video in milliseconds to profile your interests.",
          ...
          SecurityFact(
            ...
            description:
              "Facebook experimented with manipulating News Feed to affect users' emotions - without consent.",
          ...
          SecurityFact(
            ...
            description:
              "Facebook tracks your offline purchases through partnerships with Visa, Mastercard, and retailers.",
            source: nil
          ),
        ],
        actionItems: [
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            title: "Casino Design",
            description:
              "Tech companies hired the same psychologists who designed casino slot machines.",
          ...
          SecurityFact(
            ...
            description:
              "The timing, sound, and content of notifications are optimized to interrupt you at maximum vulnerability.",
            source: nil
          ),
          SecurityFact(
            ...
            description:
              "The 'pull down to refresh' gesture was designed to mimic a slot machine lever pull.",
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            description:
              "Facebook's own research showed their algorithm promoted divisive content because it drove more engagement.",
          ...
          SecurityFact(
            ...
            description:
              "False news stories spread 6x faster and reach more people than true stories.",
          ...
          SecurityFact(
            ...
            title: "Echo Chambers",
            description:
              "Algorithmic curation creates filter bubbles where you only see content that confirms your existing beliefs.",
            source: nil
          ),
        ],
        actionItems: [
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            description:
              "Target's algorithm predicted pregnancies with such accuracy, they had to mix in random ads so it wouldn't be obvious.",
          ...
          SecurityFact(
            ...
            description:
              "Facebook offered advertisers the ability to target teens when they felt 'insecure' or 'worthless'.",
          ...
          SecurityFact(
            ...
            description:
              "Payday loan companies specifically target people showing financial distress indicators.",
            source: nil
          ),
        ],
        actionItems: [
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            description:
              "Your phone continues to track location even when 'location services' is off, via WiFi and Bluetooth scanning.",
            source: nil
          ),
          SecurityFact(
            icon: "mic.fill",
            ...
            description:
              "Apps with microphone permission can technically listen even when not in use.",
            source: nil
          ),
          SecurityFact(
            icon: "antenna.radiowaves.left.and.right",
            ...
            description:
              "Government 'Stingray' devices can intercept your phone communications by pretending to be cell towers.",
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            title: "ATT Impact",
            description:
              "Apple's App Tracking Transparency cost Facebook $10 billion in ad revenue. That's how much YOUR tracking was worth.",
          ...
          SecurityFact(
            ...
            title: "Lockdown Mode",
            description:
              "iOS 16+ has 'Lockdown Mode' for extreme security - limits features but blocks advanced attacks.",
            source: nil
          ),
        ],
        actionItems: [
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            description:
              "Incognito/Private mode only hides from YOUR device. Websites, ISPs, and employers still see everything.",
            source: nil
          ),
          SecurityFact(
            icon: "link",
            ...
            description:
              "The average website loads scripts from 10+ third-party domains, each tracking you.",
            source: nil
          ),
          SecurityFact(
            icon: "chart.bar.fill",
            ...
            description:
              "Google Chrome has 65% market share - giving Google visibility into most of the world's browsing.",
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            description:
              "Many free VPNs sell your browsing data - the exact thing you're trying to prevent.",
          ...
          SecurityFact(
            ...
            title: "No-Log Lies",
            description:
              "PureVPN, IPVanish, and others claiming 'no logs' have provided user data to authorities.",
          ...
          SecurityFact(
            ...
            description:
              "VPNs based in Five Eyes countries can be compelled to log. Choose Swiss, Panamanian, or Romanian.",
            source: nil
          ),
        ],
        actionItems: [
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          ...
          SecurityFact(
            ...
            title: "Crack Time",
            description:
              "An 8-character password can be cracked in under 1 hour. A 16-character random password takes 34,000 years.",
            source: nil
          ),
          SecurityFact(
            ...
            title: "SIM Swapping",
            description:
              "Hackers can convince carriers to transfer your number, intercepting SMS 2FA codes.",
            source: nil
          ),
        ],
        actionItems: [
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            title: "Shadow Reach",
            description:
              "Even with private settings, your data is still collected. Privacy settings mainly affect other users, not the platform.",
            source: nil
          ),
          SecurityFact(
            ...
            description:
              "Platforms often reset privacy settings during updates. Check them regularly.",
            source: nil
          ),
        ],
        actionItems: [
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            description:
              "Platforms keep 'deleted' data for legal, advertising, and AI training purposes - often indefinitely.",
            source: nil
          ),
          SecurityFact(
            ...
            description:
              "Even after deletion, Facebook maintains shadow profiles using data from your friends.",
            source: nil
          ),
        ],
        actionItems: [
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            description:
              "Signal's encryption protocol is so good that WhatsApp, Facebook Messenger, and Skype all adopted it.",
            source: nil
          ),
          SecurityFact(
            ...
            title: "Swiss Privacy",
            description:
              "Switzerland has some of the strongest privacy laws in the world, making it ideal for privacy services.",
            source: nil
          ),
        ],
        actionItems: [
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            description:
              "Mark Zuckerberg covers his laptop webcam and microphone with tape. If HE doesn't trust it...",
          ...
          SecurityFact(
            ...
            description:
              "A proper Faraday bag blocks ALL signals - your phone can't be tracked or remotely accessed.",
            source: nil
          ),
        ],
        actionItems: [
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          ...
          SecurityFact(
            ...
            description:
              "Through programs like PRISM, tech companies share user data directly with intelligence agencies.",
      ...
      DigitalSecurityLesson(
        ...
        facts: [
          SecurityFact(
            ...
            description:
              "Each privacy measure multiplies the effectiveness of others. A VPN + private browser + encrypted email is far more than 3x protection.",
            source: nil
          ),
          SecurityFact(
            icon: "person.3.fill",
            ...
            description:
              "When you use Signal, you protect everyone you communicate with. Privacy is contagious.",
            source: nil
          ),
        ],
        actionItems: [
