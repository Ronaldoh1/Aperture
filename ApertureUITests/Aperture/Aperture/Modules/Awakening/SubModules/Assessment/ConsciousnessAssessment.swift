    ...
    case .sleepingProgrammed:
      return [
        AssessmentCourseRecommendation(
          ...
          reason:
            "Start with the foundations. This will gently introduce concepts that expand your understanding of what's possible.",
          priority: 1,
        ...
        AssessmentCourseRecommendation(
          ...
          reason:
            "See how your attention is being captured and monetized. This is the first step to reclaiming your consciousness.",
          priority: 2,
        ...
        AssessmentCourseRecommendation(
          ...
          reason:
            "Once you see the patterns of manipulation, you can never unsee them. This changes everything.",
          priority: 3,
    ...
    case .tribalPartisan:
      return [
        AssessmentCourseRecommendation(
          ...
          reason:
            "See how divide-and-conquer works on BOTH sides. This isn't about your team being wrong—it's about seeing the game itself.",
          priority: 1,
          icon: "exclamationmark.triangle.fill",
          colorHex: "#F44336"
        ),
        AssessmentCourseRecommendation(
          ...
          reason:
            "Understand why they NEED you fighting each other. When you see this, tribal identity loses its grip.",
          priority: 2,
        ...
        AssessmentCourseRecommendation(
          ...
          reason:
            "Expand your identity beyond political tribes. There's a bigger you waiting to emerge.",
          priority: 3,
          icon: "brain.head.profile",
          colorHex: "#4CAF50"
        ),
    ...
    case .overwhelmedEmpath:
      return [
        AssessmentCourseRecommendation(
          ...
          reason:
            "Learn to process the signals you're receiving without drowning. This will change your life.",
          priority: 1,
        ...
        AssessmentCourseRecommendation(
          ...
          reason:
            "Your nervous system is stuck in overdrive. Learn to shift into states where sensitivity becomes strength.",
          priority: 2,
        ...
        AssessmentCourseRecommendation(
          ...
          reason:
            "Your empathic nature is connected to Sophia's consciousness. This path honors your sensitivity as sacred.",
          priority: 3,
    ...
    case .skepticalSeeker:
      return [
        AssessmentCourseRecommendation(
          ...
          reason:
            "Explore consciousness through the lens of M-theory and neuroscience. Evidence-based expansion.",
          priority: 1,
        ...
        AssessmentCourseRecommendation(
          ...
          reason:
            "Apply your critical thinking to decode manipulation patterns. This satisfies the skeptic while opening new doors.",
          priority: 3,
          icon: "exclamationmark.triangle.fill",
          colorHex: "#F44336"
        ),
    ...
    case .disillusionedAwakening:
      return [
        AssessmentCourseRecommendation(
          ...
          reason:
            "You're in the dark night of the soul. This is normal. Let me help you navigate without losing yourself.",
          priority: 1,
        ...
        AssessmentCourseRecommendation(
          ...
          reason:
            "The old operating system is crashing. Here's the new one. It actually makes sense.",
          priority: 2,
          icon: "brain.head.profile",
          colorHex: "#4CAF50"
        ),
        AssessmentCourseRecommendation(
          ...
          reason:
            "Understanding WHY things are the way they are brings peace, even when the truth is dark.",
          priority: 3,
          icon: "eye.trianglebadge.exclamationmark",
          colorHex: "#FF5722"
        ),
    ...
    case .activeQuestioner:
      return [
        AssessmentCourseRecommendation(
          ...
          reason:
            "Turn your research into a systematic framework. Knowledge becomes wisdom when it's organized.",
          priority: 1,
          icon: "exclamationmark.triangle.fill",
          colorHex: "#F44336"
        ),
        ...
        AssessmentCourseRecommendation(
          ...
          reason:
            "Knowledge without integration is just noise. This path turns understanding into embodiment.",
          priority: 3,
          icon: "heart.circle.fill",
          colorHex: "#E040FB"
        ),
    ...
    case .spiritualBypasser:
      return [
        AssessmentCourseRecommendation(
          ...
          reason:
            "True light isn't the absence of darkness—it's the integration of it. Time to face what you've been avoiding.",
          priority: 1,
        ...
        AssessmentCourseRecommendation(
          ...
          reason:
            "See how spiritual truth connects to material reality. No more bypassing the world's problems.",
          priority: 2,
          icon: "eye.trianglebadge.exclamationmark",
          colorHex: "#FF5722"
        ),
        AssessmentCourseRecommendation(
          ...
          reason:
            "Spirituality without discernment is dangerous. Learn to stay awake in BOTH worlds.",
          priority: 3,
          icon: "exclamationmark.triangle.fill",
          colorHex: "#F44336"
        ),
    ...
    case .traumaCarrier:
      return [
        AssessmentCourseRecommendation(
          ...
          reason:
            "Before we go deeper, your nervous system needs to know it's safe. This is the foundation for everything else.",
          priority: 1,
          icon: "waveform.path.ecg",
          colorHex: "#00BCD4"
        ),
        AssessmentCourseRecommendation(
          ...
          reason:
            "Reconnect with your body in a safe, gradual way. Your body holds wisdom, not just wounds.",
          priority: 2,
          icon: "eye.circle.fill",
          colorHex: "#FFD700"
        ),
        AssessmentCourseRecommendation(
          ...
          reason:
            "Sophia's story IS a trauma story—and a healing story. Your wounds become your wisdom here.",
          priority: 3,
          icon: "heart.circle.fill",
          colorHex: "#E040FB"
        ),
    ...
    case .systemsThinking:
      return [
        AssessmentCourseRecommendation(
          ...
          reason:
            "Your pattern-recognition abilities are perfect for decoding control systems. Here's the framework.",
          priority: 1,
          icon: "exclamationmark.triangle.fill",
          colorHex: "#F44336"
        ),
        AssessmentCourseRecommendation(
          ...
          reason:
            "See the meta-system that all other control systems serve. This is engineering at the cosmic level.",
          priority: 2,
          icon: "eye.trianglebadge.exclamationmark",
          colorHex: "#FF5722"
        ),
        AssessmentCourseRecommendation(
          ...
          reason:
            "Understand consciousness itself as an information system operating across dimensions.",
          priority: 3,
          icon: "cube.transparent.fill",
          colorHex: "#7C4DFF"
        ),
    ...
    case .advancedSeeker:
      return [
        AssessmentCourseRecommendation(
          ...
          reason:
            "You're ready for the hidden teachings. This is the path for those who've done the preliminary work.",
          priority: 1,
          icon: "heart.circle.fill",
          colorHex: "#E040FB"
        ),
        ...
        AssessmentCourseRecommendation(
          ...
          reason:
            "Explore the physics of your multi-dimensional existence. Science meets mysticism.",
          priority: 3,
          icon: "cube.transparent.fill",
          colorHex: "#7C4DFF"
        ),
